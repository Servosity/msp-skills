...
<!-- hero-live:start -->
62 connectors are live today - including Servosity, ConnectWise PSA, HubSpot, and HaloPSA - and more PSA, RMM, backup, and M365 connectors ship every week.
<!-- hero-live:end -->
...
[![Skills](https://img.shields.io/badge/skills-62-green.svg)](./catalog.json)
...
| [grab-cookie](./skills/grab-cookie) | Session-credential capture for sites with no API key or OAuth path: httpOnly cookies and opaque bearer tokens. Windows verified, macOS untested | ![Meta](https://img.shields.io/badge/Meta-skill-6B7280) | [Marketplace](./skills/grab-cookie/README.md) |
...
<!-- agent-can-do:start -->
Outcomes, not hype - drawn from each of the 62 connectors' skill pages:
