...
<!-- hero-live:start -->
58 connectors are live today - including Servosity, ConnectWise PSA, HubSpot, and HaloPSA - and more PSA, RMM, backup, and M365 connectors ship every week.
<!-- hero-live:end -->
...
<<<<<<< HEAD
[![Skills](https://img.shields.io/badge/skills-58-green.svg)](./catalog.json)
=======
[![Skills](https://img.shields.io/badge/skills-58-green.svg)](./catalog.json)
>>>>>>> origin/main
...
<!-- agent-can-do:start -->
Outcomes, not hype - drawn from each of the 58 connectors' skill pages:
