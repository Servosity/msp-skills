...
<!-- hero-live:start -->
6 connectors are live today - including Servosity, ConnectWise PSA, HubSpot, and HaloPSA - and more PSA, RMM, backup, and M365 connectors ship every week.
<!-- hero-live:end -->
...
[![Skills](https://img.shields.io/badge/skills-6-green.svg)](./catalog.json)
...
<!-- agent-can-do:start -->
Outcomes, not hype - drawn from each of the 6 connectors' skill pages:
...
| Which clients are about to blow through their block-hours agreement? | connectwise-manage | `connectwise-manage-cli agreement-burn --period 30d` |
...
| Where is EXCHANGE01 - server, service org, customer, site? | n-central | `n-central-cli whereis EXCHANGE01` |
| Where is my attention needed today, ranked worst-first? | servosity | `servosity-cli attention --top 5` |
| What got worse since yesterday, and what recovered? | servosity | `servosity-cli drift` |
<!-- agent-can-do:end -->
