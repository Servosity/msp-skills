...
[![Skills](https://img.shields.io/badge/skills-60-green.svg)](./catalog.json)
...
<!-- agent-can-do:start -->
Outcomes, not hype - drawn from each of the 60 connectors' skill pages:
