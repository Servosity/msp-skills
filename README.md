...
<!-- hero-live:start -->
64 connectors are live today - including Servosity, ConnectWise PSA, HubSpot, and HaloPSA - and more PSA, RMM, backup, and M365 connectors ship every week.
<!-- hero-live:end -->
...
[![Skills](https://img.shields.io/badge/skills-64-green.svg)](./catalog.json)
...
| [immybot](./skills/immybot) | ImmyBot software deployment and desired-state automation: computers, deployments, maintenance sessions, and cross-tenant software inventory | ![Awaiting live verification](https://img.shields.io/badge/Awaiting-live_verification-EAB308) | [Install](./skills/immybot/README.md) |
...
<!-- agent-can-do:start -->
Outcomes, not hype - drawn from each of the 64 connectors' skill pages:
...
| What failed in last night's maintenance window, by root cause? | immybot | `immybot-pp-cli session-triage --since 24h` |
