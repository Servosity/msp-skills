...
<!-- hero-live:start -->
7 connectors are live today - including Servosity, ConnectWise PSA, HubSpot, and HaloPSA - and more PSA, RMM, backup, and M365 connectors ship every week.
<!-- hero-live:end -->
...
[![Skills](https://img.shields.io/badge/skills-7-green.svg)](./catalog.json)
...
<!-- agent-can-do:start -->
Outcomes, not hype - drawn from each of the 7 connectors' skill pages:
...
| TODO: question an MSP keeps asking | superops | `superops-cli TODO` |
<!-- agent-can-do:end -->
