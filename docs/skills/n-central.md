...
faqs:
  - q: "Does this work with ChatGPT?"
    a: "Yes, on paid ChatGPT plans. ChatGPT connects to remote MCP servers over HTTPS, so you expose the local N-able N-central MCP server via a secure bridge. Step-by-step in the install guide."
  - q: "Do I need to know how to code?"
    a: "No. Paste one sentence into Claude Code or Codex and your agent does the install, or run a one-line installer. You enter your credentials once."
  - q: "Is my N-able N-central data safe?"
    a: "Your data stays on your machine. The CLI, MCP server, and the local mirror are all local. The AI sees query results, not raw bulk data, and credentials are never bundled or transmitted by MSP Skills."
  - q: "What does it cost?"
    a: "Free. Apache-2.0 licensed. You pay only for whichever AI agent you already use."
  - q: "TODO: vendor-specific question MSP owners actually search (rate limits, partner requirements, replacing the N-able N-central portal)"
    a: "TODO"
howto:
...
TODO: <=70 words, MSP-owner language, leads with the outcome. What does N-able N-central + your AI answer in one sentence that the portal cannot?
...
<sub>Your agent runs: <code>n-central-cli TODO</code></sub>
...
| --- | --- |
| TODO: question an MSP keeps asking | `n-central-cli TODO` |
...
TODO: one or two sentences vs typical MCP wrappers (generic, no competitor names): most N-able N-central integrations proxy each question into a live API call ...

TODO: one sentence vs N-able N-central's own AI features (complements, not replaces). If the vendor has no AI integration, say what this adds that the portal cannot.
...
TODO: 2-3 plain-language sentences from governance.md - what the skill can read, what it can change, and the recommended agent policy per tier. Full details in [governance.md](https://github.com/servosity/msp-skills/blob/main/skills/n-central/governance.md).

## Frequently asked questions

### Does this work with ChatGPT?

Yes, on paid ChatGPT plans. ChatGPT connects to remote MCP servers over HTTPS, so you expose the local N-able N-central MCP server via a secure bridge. Step-by-step in the install guide.
...
### TODO: vendor-specific question MSP owners actually search (rate limits, partner requirements, replacing the N-able N-central portal)
