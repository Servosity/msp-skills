...
howto:
  ...
  - name: "Authenticate"
    text: "Enter your Sherweb credentials once; sherweb-cli doctor confirms they work."
...
Run more than one Billing tool, or comparing options? These connectors work the same way: [AppDirect](/skills/appdirect/) · [AWS](/skills/aws-billing/) · [Gradient MSP](/skills/gradient/) · [Pax8](/skills/pax8/) · [QuickBooks Online](/skills/quickbooks/) · [Xero](/skills/xero/)
