...
large datasets as it has no memory pressure.`,
  ...
  abnormal-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  abnormal-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  abnormal-cli export <resource> --format jsonl | jq '.id'`,
