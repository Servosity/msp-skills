...
Health check: run 'abnormal-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("abnormal-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'abnormal-cli profile list')")
	...
	rootCmd.AddCommand(newAbusecampaignsCmd(flags))
	rootCmd.AddCommand(newAggregationsCmd(flags))
	rootCmd.AddCommand(newApiResourcesCmd(flags))
	rootCmd.AddCommand(newCasesCmd(flags))
	rootCmd.AddCommand(newDetection360Cmd(flags))
	rootCmd.AddCommand(newEmailSearchCmd(flags))
	rootCmd.AddCommand(newMessagesCmd(flags))
	rootCmd.AddCommand(newSpmV2Cmd(flags))
	rootCmd.AddCommand(newThreatsCmd(flags))
	rootCmd.AddCommand(newVendorCasesCmd(flags))
	...
	rootCmd.AddCommand(newNovelEmployeeRiskCmd(flags))
	rootCmd.AddCommand(newNovelRemediateWatchCmd(flags))
	rootCmd.AddCommand(newNovelReportSnapshotCmd(flags))
	rootCmd.AddCommand(newNovelSmokeCmd(flags))
	rootCmd.AddCommand(newNovelTriageCmd(flags))
	rootCmd.AddCommand(newNovelVendorRiskCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAbuseMailboxPromotedCmd(flags))
	...
	rootCmd.AddCommand(newSecuritySettingsPromotedCmd(flags))
	rootCmd.AddCommand(newSoarPromotedCmd(flags))
	rootCmd.AddCommand(newThreatsExportPromotedCmd(flags))
	rootCmd.AddCommand(newUrlRewritePromotedCmd(flags))
