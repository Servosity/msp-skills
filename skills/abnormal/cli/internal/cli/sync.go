...
Resource scoping:
  ...
  abnormal-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  abnormal-cli sync --full

  # Incremental sync: only records from the last 7 days
  abnormal-cli sync --since 7d

  # Parallel sync with 8 workers
  abnormal-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  abnormal-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("abnormal-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/abnormal-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "abuse-mailbox":
		return db.UpsertAbuseMailbox(data)
	case "abusecampaigns":
		return db.UpsertAbusecampaigns(data)
	case "aggregations":
		return db.UpsertAggregations(data)
	case "api_resources":
		return db.UpsertApiResources(data)
	case "auditlogs":
		return db.UpsertAuditlogs(data)
	case "cases":
		return db.UpsertCases(data)
	case "cases_actions":
		return db.UpsertCasesActions(data)
	case "analysis":
		return db.UpsertAnalysis(data)
	case "detection360":
		return db.UpsertDetection360(data)
	case "email_search":
		return db.UpsertEmailSearch(data)
	case "employee":
		return db.UpsertEmployee(data)
	case "identity":
	...
	case "remediation_history":
		return db.UpsertRemediationHistory(data)
	case "roles":
		return db.UpsertRoles(data)
	case "soar":
		return db.UpsertSoar(data)
	case "spm-v2":
		return db.UpsertSpmV2(data)
	case "threats":
		return db.UpsertThreats(data)
	case "threats_actions":
		return db.UpsertThreatsActions(data)
	case "attachments":
		return db.UpsertAttachments(data)
	case "links":
		return db.UpsertLinks(data)
	case "url-rewrite":
		return db.UpsertUrlRewrite(data)
	case "users":
		return db.UpsertUsers(data)
	case "vendor-cases":
		return db.UpsertVendorCases(data)
	case "activity":
...
func defaultSyncResources() []string {
	return []string{
		...
		"abusecampaigns",
		"aggregations",
		"aggregations-attack-frequency",
		"aggregations-attack-strategy-breakdown",
		"aggregations-attack-vector-breakdown",
		"aggregations-attacker-origin",
		"aggregations-most-impersonated-employee",
		"aggregations-most-impersonated-employee-non-vip",
		"aggregations-most-impersonated-employee-vip",
		"aggregations-most-impersonated-vendor",
		"aggregations-recipient-employees",
		"aggregations-recipient-employees-non-vip",
		"aggregations-recipient-employees-vip",
		"aggregations-sender-impersonation-breakdown",
		"aggregations-trending-attacks",
		"api_resources",
		"auditlogs",
		"cases",
		"detection360",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"abuse-mailbox":                                   "/abuse_mailbox/not_analyzed",
		"abusecampaigns":                                  "/abusecampaigns",
		"aggregations":                                    "/aggregations/attack_stopped",
		"aggregations-attack-frequency":                   "/aggregations/attack_frequency",
		"aggregations-attack-strategy-breakdown":          "/aggregations/attack_strategy_breakdown",
		"aggregations-attack-vector-breakdown":            "/aggregations/attack_vector_breakdown",
		"aggregations-attacker-origin":                    "/aggregations/attacker_origin",
		"aggregations-dashboard-summary":                  "/aggregations/dashboard_summary",
		"aggregations-most-impersonated-employee":         "/aggregations/most_impersonated_employee",
		"aggregations-most-impersonated-employee-non-vip": "/aggregations/most_impersonated_employee_non_vip",
		"aggregations-most-impersonated-employee-vip":     "/aggregations/most_impersonated_employee_vip",
		"aggregations-most-impersonated-vendor":           "/aggregations/most_impersonated_vendor",
		"aggregations-recipient-employees":                "/aggregations/recipient_employees",
		"aggregations-recipient-employees-non-vip":        "/aggregations/recipient_employees_non_vip",
		"aggregations-recipient-employees-vip":            "/aggregations/recipient_employees_vip",
		"aggregations-sender-impersonation-breakdown":     "/aggregations/sender_impersonation_breakdown",
		"aggregations-trending-attacks":                   "/aggregations/trending_attacks",
		"api_resources":                                   "/resources",
		"auditlogs":                                       "/auditlogs",
		"cases":                                           "/cases",
		"detection360":                                    "/detection360/reports",
		"email_search":                                    "/search/activities",
		"roles":                                           "/roles",
		"soar":                                            "/soar/tokens",
		"spm-v2":                                          "/spm-v2/posture-catalog",
		"spm-v2-reports-summary":                          "/spm-v2/reports/summary",
		"threats":                                         "/threats",
		"url-rewrite":                                     "/url-rewrite/clicked-events",
		"users":                                           "/users",
		"vendor-cases":                                    "/vendor-cases",
		"vendors":                                         "/vendors",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "threats", ParentTable: "threats", ParentIDParam: "threat_id", PathTemplate: "/threats/{threat_id}", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "threat_id", Field: "id"},
		}},
	}
}
