# install.ps1 - install abnormal-cli and abnormal-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (abnormal-v*).
...
$Skill   = "abnormal"
$CliBin  = "abnormal-cli.exe"
$McpBin  = "abnormal-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (abnormal-vX.Y.Z),
...
Write-Host "  abnormal-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/abnormal#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/abnormal/mcp-install.md"
