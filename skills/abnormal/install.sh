#!/usr/bin/env bash
# install.sh - install abnormal-cli and abnormal-mcp on macOS / Linux.
#
...
SKILL="abnormal"
CLI_BIN="abnormal-cli"
MCP_BIN="abnormal-mcp"
...
# Each skill is versioned and tagged independently (abnormal-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/abnormal#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/abnormal/mcp-install.md"
