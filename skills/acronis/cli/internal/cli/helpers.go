...
func classifyAPIError(err error, flags *rootFlags) error {
	...
	case strings.Contains(msg, "HTTP 401"):
		return authErr(fmt.Errorf("%w\nhint: check your token. Set it with: acronis-cli auth set-token <token>"+
			"\n      or: export ACRONIS_CYBER_PROTECT_BEARER_AUTH=<your-token>"+
			"\n      See API docs: https://developer.acronis.com"+
			"\n      Run 'acronis-cli doctor' to check auth status.", err))
