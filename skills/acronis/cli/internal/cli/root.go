...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "acronis-cli",
		Short: `Acronis CLI — The first real CLI for the Acronis Cyber Protect Cloud platform — every tenant, agent, and usage metric mirrored locall…`,
		Long: `Acronis CLI — The first real CLI for the Acronis Cyber Protect Cloud platform — every tenant, agent, and usage metric mirrored locall…
...
Health check: run 'acronis-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("acronis-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'acronis-cli profile list')")
	...
	rootCmd.AddCommand(newAgentManagerCmd(flags))
	rootCmd.AddCommand(newClientsCmd(flags))
	rootCmd.AddCommand(newIdpCmd(flags))
	rootCmd.AddCommand(newTaskManagerCmd(flags))
	...
	rootCmd.AddCommand(newNovelAgentsCmd(flags))
	...
	rootCmd.AddCommand(newNovelTreeCmd(flags))
	rootCmd.AddCommand(newNovelUsagesCmd(flags))
