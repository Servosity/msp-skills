...
type Config struct {
	...
	Path                          string            `toml:"-"`
	AcronisCyberProtectBearerAuth string            `toml:"cyber_protect_bearer_auth"`
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("ACRONIS_CYBER_PROTECT_BEARER_AUTH"); v != "" {
		cfg.AcronisCyberProtectBearerAuth = v
		cfg.AuthSource = "env:ACRONIS_CYBER_PROTECT_BEARER_AUTH"
	}
	...
	if cfg.AuthSource == "" && cfg.AcronisCyberProtectBearerAuth != "" {
		cfg.AuthSource = "config"
	}
...
func (c *Config) AuthHeader() string {
	...
	if c.AcronisCyberProtectBearerAuth != "" {
		if c.AuthSource == "" {
			c.AuthSource = "env:ACRONIS_CYBER_PROTECT_BEARER_AUTH"
		}
		return "Bearer " + c.AcronisCyberProtectBearerAuth
	}
	if c.AccessToken != "" {
...
func (c *Config) ClearTokens() error {
	...
	c.ClientID = ""
	c.ClientSecret = ""
	c.AcronisCyberProtectBearerAuth = ""
	return c.save()
}
