# install.ps1 - install acronis-cli and acronis-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (acronis-v*).
...
$Skill   = "acronis"
$CliBin  = "acronis-cli.exe"
$McpBin  = "acronis-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (acronis-vX.Y.Z),
...
Write-Host "  acronis-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/acronis#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/acronis/mcp-install.md"
