#!/usr/bin/env bash
# install.sh - install acronis-cli and acronis-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (acronis-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/acronis#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/acronis/mcp-install.md"
