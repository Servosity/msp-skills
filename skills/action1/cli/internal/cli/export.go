...
large datasets as it has no memory pressure.`,
  ...
  action1-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  action1-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  action1-cli export <resource> --format jsonl | jq '.id'`,
