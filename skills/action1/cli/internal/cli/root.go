...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "action1-cli",
		Short: `Action1 CLI — Every Action1 endpoint, plus the fleet-wide patch and vulnerability views the org-siloed API cannot give you.`,
		Long: `Action1 CLI — Every Action1 endpoint, plus the fleet-wide patch and vulnerability views the org-siloed API cannot give you.
...
Health check: run 'action1-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("action1-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'action1-cli profile list')")
	...
	rootCmd.AddCommand(newCveDescriptionsPromotedCmd(flags))
