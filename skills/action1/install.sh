#!/usr/bin/env bash
# install.sh - install action1-cli and action1-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (action1-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/action1#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/action1/mcp-install.md"
