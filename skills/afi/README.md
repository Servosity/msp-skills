...
[**Download Afi MCP (.mcpb)**](https://github.com/servosity/msp-skills/releases/download/afi-v0.1.1/afi-mcp.mcpb) - then open **Claude Desktop > Settings > Extensions** and select the file. One click, no JSON, no shell. (Browse every Afi release on the [releases page](https://github.com/servosity/msp-skills/releases?q=afi).)
