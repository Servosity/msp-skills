...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "afi-cli",
		Short: `Afi CLI — The first CLI for Afi SaaS backup — full public-API coverage plus the fleet-wide coverage, staleness, and offboarding a…`,
		Long: `Afi CLI — The first CLI for Afi SaaS backup — full public-API coverage plus the fleet-wide coverage, staleness, and offboarding a…
...
Health check: run 'afi-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("afi-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'afi-cli profile list')")
	...
	rootCmd.AddCommand(newNovelBackupStaleCmd(flags))
	...
	rootCmd.AddCommand(newNovelOffboardCmd(flags))
	rootCmd.AddCommand(newNovelReconcileLicensesCmd(flags))
	rootCmd.AddCommand(newNovelResolveCmd(flags))
	rootCmd.AddCommand(newNovelTenantScorecardCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newApplicationsPromotedCmd(flags))
