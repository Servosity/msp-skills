...
func newTenantsArchivesDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/api/v1/tenants/{tenant_id}/archives/{id}"
	...
	cmd.Flags().StringVar(&flagReason, "reason", "", "Reason for requesting archive deletion. Provide a mandatory description up to 128 bytes long.")
