#!/usr/bin/env bash
# install.sh - install afi-cli and afi-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (afi-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/afi#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/afi/mcp-install.md"
