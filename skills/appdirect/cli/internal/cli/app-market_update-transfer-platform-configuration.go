...
func newAppMarketUpdateTransferPlatformConfigurationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyParameters, "parameters", "", "The transfer platform parameters.")
