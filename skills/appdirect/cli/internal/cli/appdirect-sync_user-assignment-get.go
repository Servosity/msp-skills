...
func newAppdirectSyncUserAssignmentGetCmd(flags *rootFlags) *cobra.Command {
	var flagDeveloperIdentifier string
	var flagAccountIdentifier string
	...
	cmd.Flags().StringVar(&flagDeveloperIdentifier, "developer-identifier", "", "Developer identifier")
	cmd.Flags().StringVar(&flagAccountIdentifier, "account-identifier", "", "Account identifier")
	cmd.Flags().StringVar(&flagUserIdentifier, "user-identifier", "", "User identifier")
