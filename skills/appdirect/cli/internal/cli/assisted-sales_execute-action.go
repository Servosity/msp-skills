...
func newAssistedSalesExecuteActionCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyAction, "action", "", "Action name to be executed to a quote version")
