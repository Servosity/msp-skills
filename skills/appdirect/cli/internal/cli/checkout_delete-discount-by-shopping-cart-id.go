...
func newCheckoutDeleteDiscountByShoppingCartIdCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if len(args) < 2 {
				return usageErr(fmt.Errorf("discountCode is required\nUsage: %s <%s>", cmd.CommandPath(), "discountCode"))
			}
	...
	cmd.Flags().StringVar(&flagItemId, "item-id", "", "Cart item IDs")
