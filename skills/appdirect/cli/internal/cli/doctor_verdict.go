...
//
// See issue #282 and skills/appdirect/handfixes.json.
//
...
const doctorBaseURLEnv = "APPDIRECT_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://marketplace.appdirect.com/api"
