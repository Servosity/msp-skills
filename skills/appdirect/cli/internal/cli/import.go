...
but do not stop the import.`,
  ...
  appdirect-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  appdirect-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | appdirect-cli import <resource> --input -`,
