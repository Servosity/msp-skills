...
func newNotificationResourceTemplateApiGetEmailTemplateGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().BoolVar(&flagDirectSales, "direct-sales", false, "Get the developer email template")
