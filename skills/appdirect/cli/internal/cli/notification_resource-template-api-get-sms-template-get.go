...
func newNotificationResourceTemplateApiGetSmsTemplateGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().BoolVar(&flagDirectSales, "direct-sales", false, "Get the developer sms tempalte")
