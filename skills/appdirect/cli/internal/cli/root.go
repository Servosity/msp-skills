...
Health check: run 'appdirect-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("appdirect-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'appdirect-cli profile list')")
	...
	rootCmd.AddCommand(newAppMarketCmd(flags))
	rootCmd.AddCommand(newAppResellerCmd(flags))
	rootCmd.AddCommand(newAppdirectSyncCmd(flags))
	rootCmd.AddCommand(newAppwiseCmd(flags))
	rootCmd.AddCommand(newAssistedSalesCmd(flags))
	rootCmd.AddCommand(newBillingCmd(flags))
	rootCmd.AddCommand(newChannelCmd(flags))
	...
	rootCmd.AddCommand(newNovelPaymentsCmd(flags))
	rootCmd.AddCommand(newNovelPipelineCmd(flags))
	rootCmd.AddCommand(newNovelReconcileCmd(flags))
	rootCmd.AddCommand(newNovelSubsCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newReconciliationPromotedCmd(flags))
