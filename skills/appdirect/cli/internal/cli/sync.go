...
Resource scoping:
  ...
  appdirect-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  appdirect-cli sync --full

  # Incremental sync: only records from the last 7 days
  appdirect-cli sync --since 7d

  # Parallel sync with 8 workers
  appdirect-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  appdirect-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/appdirect-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "account":
		return true
	case "account-v2-companies":
		return true
	case "app-reseller":
		return true
	case "app-reseller-v1-catalog-sellable-products":
		return true
	case "assisted-sales":
		return true
	case "billing":
		return true
	case "billing-v1-invoices":
		return true
	case "billing-v1-payments":
		return true
	case "billing-v1-subscriptions":
		return true
	case "channel":
		return true
	case "channel-v1-applications":
		return true
	case "channel-v1-discounts":
		return true
	case "channel-v1-exchange-rates":
		return true
	case "channel-v1-staging-catalog":
		return true
	case "marketplace":
		return true
	case "marketplace-v1-listing":
		return true
	case "reporting":
		return true
	}
...
func syncResourceFieldSelector(resource string) (string, string) {
	switch resource {
	case "billing-v1-subscriptions":
		return "expand", "company,edition,order,product,upcomingOrder,user"
	}
	return "", ""
}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "app-market":
		return db.UpsertAppMarket(data)
	case "app-reseller":
		return db.UpsertAppReseller(data)
	case "assisted-sales":
		return db.UpsertAssistedSales(data)
	case "channel":
	...
	case "product-uploader-api":
		return db.UpsertProductUploaderApi(data)
	case "reseller":
...
func defaultSyncResources() []string {
	return []string{
		...
		"app-market",
		"app-market-v2-transfer-methods",
		"app-market-v2-transfer-platform-configurations",
		"app-reseller",
		"app-reseller-v1-catalog-sellable-products",
		"assisted-sales",
		"assisted-sales-v1-opportunities",
		"billing",
		"billing-v1-invoices",
		"billing-v1-payments",
		...
		"channel-v1-company-groups",
		"channel-v1-discounts",
		"channel-v1-exchange-rates",
		"channel-v1-segments-dynamic-segments-filter-parameters",
		"channel-v1-staging-catalog",
		"checkout",
		"marketplace",
		...
		"notification-v1-templates-default",
		"reporting",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"account":                        "/account/v2/users",
		"account-v2-companies":           "/account/v2/companies",
		"app-market":                     "/appMarket/v2/paymentMethodTypes",
		"app-market-v2-transfer-methods": "/api/appMarket/v2/transferMethods",
		"app-market-v2-transfer-platform-configurations": "/api/appMarket/v2/transferPlatformConfigurations",
		"app-reseller": "/appReseller/v1/users",
		"app-reseller-v1-catalog-sellable-products": "/appReseller/v1/catalog/sellableProducts",
		"assisted-sales":                  "/assistedSales/v1/quotes",
		"assisted-sales-v1-opportunities": "/assistedSales/v1/opportunities",
		"billing":                         "/billing/v1/orders",
		"billing-v1-invoices":             "/billing/v1/invoices",
		"billing-v1-payments":             "/billing/v1/payments",
		"billing-v1-subscriptions":        "/billing/v1/subscriptions",
		"channel":                         "/channel/v1/events",
		"channel-v1-applications":         "/channel/v1/applications",
		"channel-v1-company-groups":       "/channel/v1/companyGroups",
		"channel-v1-discounts":            "/channel/v1/discounts",
		"channel-v1-exchange-rates":       "/channel/v1/exchangeRates",
		"channel-v1-segments-dynamic-segments-filter-parameters": "/channel/v1/segments/dynamicSegments/filterParameters",
		"channel-v1-staging-catalog":                             "/channel/v1/stagingCatalog",
		"checkout":                                               "/v3/checkout/shoppingCarts",
		"marketplace":                                            "/marketplace/v1/addons",
		"marketplace-v1-bundles":                                 "/marketplace/v1/bundles",
		"marketplace-v1-listing":                                 "/marketplace/v1/listing",
		"notification":                                           "/notification/v1/templates",
		"notification-v1-templates-common":                       "/notification/v1/templates/common",
		"notification-v1-templates-default":                      "/notification/v1/templates/default",
		"reporting":                                              "/reporting/v1/reports",
		"reporting-v2-reports":                                   "/reporting/v2/reports",
		"reseller":                                               "/reseller/v1/reconciliation/transfers",
	}
