...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  appdirect-cli which "stale tickets"
  appdirect-cli which "bottleneck"
  appdirect-cli which --limit 1 "send message"
  appdirect-cli which                                # list the full capability index`,
