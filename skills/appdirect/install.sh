#!/usr/bin/env bash
# install.sh - install appdirect-cli and appdirect-mcp on macOS / Linux.
#
...
SKILL="appdirect"
CLI_BIN="appdirect-cli"
MCP_BIN="appdirect-mcp"
...
# Each skill is versioned and tagged independently (appdirect-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/appdirect#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/appdirect/mcp-install.md"
