...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [atera-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/atera/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/atera/install.ps1
---
...
The installer places the `atera-cli` and `atera-mcp` binaries on your PATH. It does not
