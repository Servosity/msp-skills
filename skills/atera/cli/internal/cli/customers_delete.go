...
func newCustomersDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Deletes a specified customer. Requires the customer ID.",
		Example:     "  atera-cli customers delete 42",
		Annotations: map[string]string{"pp:endpoint": "customers.delete", "pp:method": "DELETE", "pp:path": "/customers/{customerId}"},
