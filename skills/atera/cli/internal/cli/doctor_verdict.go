...
//
// See issue #282 and skills/atera/handfixes.json.
//
...
const doctorBaseURLEnv = "ATERA_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://app.atera.com/api/v3"
