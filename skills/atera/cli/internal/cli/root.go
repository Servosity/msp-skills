...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "atera-cli",
		Short: `Atera CLI — Every Atera RMM + PSA endpoint, plus a local SQLite mirror that answers fleet-health, SLA, and book-of-business questio…`,
		Long: `Atera CLI — Every Atera RMM + PSA endpoint, plus a local SQLite mirror that answers fleet-health, SLA, and book-of-business questio…
...
Health check: run 'atera-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("atera-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'atera-cli profile list')")
	...
	rootCmd.AddCommand(newCustomvaluesCmd(flags))
	...
	rootCmd.AddCommand(newKnowledgebasesPromotedCmd(flags))
