...
func newTicketsGetBillableDurationsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "get-billable-durations",
		Aliases:     []string{"create"},
		Short:       "Returns the tickets (billable duration). Requires the ticket ID's.",
		Example:     "  atera-cli tickets get-billable-durations",
		Annotations: map[string]string{"pp:endpoint": "tickets.get-billable-durations", "pp:method": "POST", "pp:path": "/tickets/billableduration"},
