...
func newTicketsGetBillableWorkhoursSiteDurationCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "get-billable-workhours-site-duration",
		Short:       "Returns a summary of the specified tickets on-site and off-site workhours duration",
		Example:     "  atera-cli tickets get-billable-workhours-site-duration",
		Annotations: map[string]string{"pp:endpoint": "tickets.get-billable-workhours-site-duration", "pp:method": "POST", "pp:path": "/tickets/billableworkhourssiteduration"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "tickets", data, "TicketsWorkHoursSiteDurationSummaries")
			}
