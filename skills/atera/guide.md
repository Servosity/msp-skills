...
For the short install path (one-line installer, `.mcpb` one-click, and per-agent MCP setup) see [README.md](./README.md) and [mcp-install.md](./mcp-install.md). This file is the command reference.
...
### Narrow a large agent list for an agent
