# install.ps1 - install atera-cli and atera-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (atera-v*).
...
$Skill   = "atera"
$CliBin  = "atera-cli.exe"
$McpBin  = "atera-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (atera-vX.Y.Z),
...
Write-Host "  atera-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/atera#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/atera/mcp-install.md"
