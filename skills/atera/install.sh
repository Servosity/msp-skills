#!/usr/bin/env bash
# install.sh - install atera-cli and atera-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (atera-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/atera#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/atera/mcp-install.md"
