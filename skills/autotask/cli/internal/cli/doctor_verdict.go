...
//
// See issue #282 and skills/autotask/handfixes.json.
//
...
const doctorBaseURLEnv = "AUTOTASK_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://webservices5.autotask.net/atservicesrest/V1.0"
