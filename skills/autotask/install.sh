#!/usr/bin/env bash
# install.sh - install autotask-cli and autotask-mcp on macOS / Linux.
#
...
SKILL="autotask"
CLI_BIN="autotask-cli"
MCP_BIN="autotask-mcp"
...
# Each skill is versioned and tagged independently (autotask-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/autotask#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/autotask/mcp-install.md"
