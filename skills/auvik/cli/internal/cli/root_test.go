...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"alert",
		"alert dismiss-single",
		"alert read-multiple-info",
		"alert read-single-info",
		"asm",
		"asm read-multiple-asmapp-info",
		"asm read-multiple-asmclient-info",
		"asm read-multiple-asmlicense-info",
		"asm read-multiple-asmsecurity-log-info",
		"asm read-multiple-asmtag-info",
		"asm read-multiple-asmuser-info",
		"authentication",
		"auvik-inventory",
		"auvik-inventory read-multiple-device-discovery-status-v2",
		"auvik-inventory read-multiple-device-info-v2",
		"auvik-inventory read-multiple-device-lifecycle-v2",
		"auvik-inventory read-multiple-interface-info-v2",
		"auvik-inventory read-single-device-discovery-status-v2",
		"auvik-inventory read-single-device-info-v2",
		"auvik-inventory read-single-device-lifecycle-v2",
		"auvik-inventory read-single-interface-info-v2",
		"auvik-stat",
		"billing",
		"billing read-client-usage",
		"billing read-device-usage",
		"inventory",
		"inventory read-multiple-component-info",
		"inventory read-multiple-configurations",
		"inventory read-multiple-device-details",
		"inventory read-multiple-device-extended-detail",
		"inventory read-multiple-device-info",
		"inventory read-multiple-device-lifecycle",
		"inventory read-multiple-device-warranty",
		"inventory read-multiple-entity-audit",
		"inventory read-multiple-entity-note",
		"inventory read-multiple-interface-info",
		"inventory read-multiple-network-details",
		"inventory read-multiple-network-info",
		"inventory read-single-component-info",
		"inventory read-single-configuration",
		"inventory read-single-device-details",
		"inventory read-single-device-extended-detail",
		"inventory read-single-device-info",
		"inventory read-single-device-lifecycle",
		"inventory read-single-device-warranty",
		"inventory read-single-entity-audit",
		"inventory read-single-entity-note",
		"inventory read-single-interface-info",
		"inventory read-single-network-details",
		"inventory read-single-network-info",
		"meta",
		"settings",
		"settings read-multiple-snmp-poller",
		"settings read-multiple-snmp-poller-devices",
		"settings read-snmp-poller-single",
		"stat",
		"stat read-component-statistics",
		"stat read-device-availability-statistics",
		"stat read-device-statistics",
		"stat read-interface-statistics",
		"stat read-multiple-snmp-poller-setting-int-history",
		"stat read-multiple-snmp-poller-setting-string-history",
		"stat read-oid-statistics",
		"stat read-service-statistics",
		"tenants",
		"tenants read-multiple",
		"tenants read-multiple-detail",
		"tenants read-single-detail",
	}
