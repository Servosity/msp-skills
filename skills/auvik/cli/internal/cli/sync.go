...
func applySyncGlobalScopeEnvDefaults(userParams *syncUserParams) {
	if v := globalScopeParamDefault("AUVIK_TENANT", ""); v != "" {
		userParams.setGlobalDefault("tenant", v)
	}
}
...
Resource scoping:
  ...
  auvik-cli sync --resources alert,asm

  # Full resync (ignore previous checkpoint)
  auvik-cli sync --full

  # Incremental sync: only records from the last 7 days
  auvik-cli sync --since 7d

  # Parallel sync with 8 workers
  auvik-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  auvik-cli sync --latest-only`,
...
func syncResourceSinceParam(resource string) string {
	switch resource {
	case "auvik-inventory":
		return "filter[notSeenSince]"
	case "inventory":
		return "filter[modifiedAfter]"
	case "inventory-component-info":
		return "filter[modifiedAfter]"
	case "inventory-device-detail-extended":
		return "filter[modifiedAfter]"
	case "inventory-entity-audit":
		return "filter[modifiedAfter]"
	case "inventory-entity-note":
		return "filter[modifiedAfter]"
	case "inventory-interface-info":
		return "filter[modifiedAfter]"
	case "inventory-network-detail":
		return "filter[modifiedAfter]"
	case "inventory-network-info":
		return "filter[modifiedAfter]"
	}
	return ""
}
...
func defaultSyncResources() []string {
	return []string{
		...
		"asm-client-info",
		"auvik-inventory",
		"auvik-inventory-discovery-status",
		"auvik-inventory-info",
		"auvik-inventory-lifecycle",
		"inventory",
		"inventory-component-info",
		"inventory-configuration",
		"inventory-device-detail",
		"inventory-device-detail-extended",
		"inventory-device-lifecycle",
		"inventory-device-warranty",
		"inventory-entity-audit",
		"inventory-entity-note",
		"inventory-interface-info",
		"inventory-network-detail",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"asm":                              "/v1/asm/app/info",
		"asm-client-info":                  "/v1/asm/client/info",
		"asm-license-info":                 "/v1/asm/license/info",
		"asm-security-log-info":            "/v1/asm/securityLog/info",
		"asm-tag-info":                     "/v1/asm/tag/info",
		"asm-user-info":                    "/v1/asm/user/info",
		"auvik-inventory":                  "/v2/api/inventory/device/info",
		"auvik-inventory-discovery-status": "/v2/api/inventory/device/discoveryStatus",
		"auvik-inventory-info":             "/v2/api/inventory/interface/info",
		"auvik-inventory-lifecycle":        "/v2/api/inventory/device/lifecycle",
		"billing":                          "/v1/billing/usage/client",
		"inventory":                        "/v1/inventory/device/info",
		"inventory-component-info":         "/v1/inventory/component/info",
		"inventory-configuration":          "/v1/inventory/configuration",
		"inventory-device-detail":          "/v1/inventory/device/detail",
		"inventory-device-detail-extended": "/v1/inventory/device/detail/extended",
		"inventory-device-lifecycle":       "/v1/inventory/device/lifecycle",
		"inventory-device-warranty":        "/v1/inventory/device/warranty",
		"inventory-entity-audit":           "/v1/inventory/entity/audit",
		"inventory-entity-note":            "/v1/inventory/entity/note",
		"inventory-interface-info":         "/v1/inventory/interface/info",
		"inventory-network-detail":         "/v1/inventory/network/detail",
		"inventory-network-info":           "/v1/inventory/network/info",
		"meta":                             "/v1/meta/field/info",
		"settings":                         "/v1/settings/snmppoller",
		"stat":                             "/v1/stat/snmppoller/int",
		"stat-snmppoller-string":           "/v1/stat/snmppoller/string",
		"tenants":                          "/v1/tenants",
		"tenants-detail":                   "/v1/tenants/detail",
	}
...
var resourceIDFieldOverrides = map[string]string{
	...
	"asm-client-info":                  "id",
	"asm-license-info":                 "id",
	"asm-security-log-info":            "id",
	"asm-tag-info":                     "id",
	"asm-user-info":                    "id",
	"auvik-inventory":                  "id",
	"auvik-inventory-discovery-status": "id",
	"auvik-inventory-info":             "id",
	"auvik-inventory-lifecycle":        "id",
	"billing":                          "id",
	"inventory":                        "id",
	"inventory-component-info":         "id",
	"inventory-configuration":          "id",
	"inventory-device-detail":          "id",
	"inventory-device-detail-extended": "id",
	"inventory-device-lifecycle":       "id",
	"inventory-device-warranty":        "id",
	"inventory-entity-audit":           "id",
	"inventory-entity-note":            "id",
	"inventory-interface-info":         "id",
	"inventory-network-detail":         "id",
	"inventory-network-info":           "id",
	"settings":                         "id",
	"stat":                             "id",
	"stat-snmppoller-string":           "id",
	"tenants":                          "id",
	"tenants-detail":                   "id",
}
...
func responsePathForResource(resource, path string) []string {
	...
	case "alert\x00/v1/alert/history/info":
		return []string{"data"}
	case "asm\x00/v1/asm/app/info":
		return []string{"data"}
	case "asm\x00/v1/asm/client/info":
		return []string{"data"}
	case "asm\x00/v1/asm/license/info":
		return []string{"data"}
	case "asm\x00/v1/asm/securityLog/info":
		return []string{"data"}
	case "asm\x00/v1/asm/tag/info":
		return []string{"data"}
	case "asm\x00/v1/asm/user/info":
		return []string{"data"}
	case "auvik-inventory\x00/v2/api/inventory/device/discoveryStatus":
		return []string{"data"}
	case "auvik-inventory\x00/v2/api/inventory/device/info":
		return []string{"data"}
	case "auvik-inventory\x00/v2/api/inventory/device/lifecycle":
		return []string{"data"}
	case "auvik-inventory\x00/v2/api/inventory/interface/info":
		return []string{"data"}
	case "billing\x00/v1/billing/usage/client":
		return []string{"data"}
	case "inventory\x00/v1/inventory/component/info":
		return []string{"data"}
	case "inventory\x00/v1/inventory/configuration":
		return []string{"data"}
	case "inventory\x00/v1/inventory/device/detail":
		return []string{"data"}
	case "inventory\x00/v1/inventory/device/detail/extended":
		return []string{"data"}
	case "inventory\x00/v1/inventory/device/info":
		return []string{"data"}
	case "inventory\x00/v1/inventory/device/lifecycle":
		return []string{"data"}
	case "inventory\x00/v1/inventory/device/warranty":
		return []string{"data"}
	case "inventory\x00/v1/inventory/entity/audit":
		return []string{"data"}
	case "inventory\x00/v1/inventory/entity/note":
		return []string{"data"}
	case "inventory\x00/v1/inventory/interface/info":
		return []string{"data"}
	case "inventory\x00/v1/inventory/network/detail":
		return []string{"data"}
	case "inventory\x00/v1/inventory/network/info":
		return []string{"data"}
	case "inventory\x00/v1/inventory/device/info/{id}":
		return []string{"included"}
	case "inventory\x00/v1/inventory/network/info/{id}":
		return []string{"included"}
	case "settings\x00/v1/settings/snmppoller":
		return []string{"data"}
	case "settings\x00/v1/settings/snmppoller/{snmpPollerSettingId}/devices":
		return []string{"data"}
	case "stat\x00/v1/stat/snmppoller/int":
		return []string{"data"}
	case "stat\x00/v1/stat/snmppoller/string":
		return []string{"data"}
	case "stat\x00/v1/stat/oid/{statId}":
		return []string{"data"}
	case "tenants\x00/v1/tenants":
		return []string{"data"}
	case "tenants\x00/v1/tenants/detail":
		return []string{"data"}
	}
	return nil
}
