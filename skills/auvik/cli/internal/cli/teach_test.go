...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"auvik-cli auth login",
		"auvik-cli doctor",
		"auvik-cli help items",
		"auvik-cli sync",
		"auvik-cli profile list",
		"auvik-cli feedback list",
		"auvik-cli which",
		"auvik-cli agent-context",
		"auvik-cli completion bash",
		"auvik-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"auvik-cli recall",
		"auvik-cli learnings",
		"auvik-cli teach-pattern",
		"auvik-cli teach-lookup",
		"auvik-cli items list",
	}
