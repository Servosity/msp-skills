# install.ps1 - install auvik-cli and auvik-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (auvik-v*).
...
$Skill   = "auvik"
$CliBin  = "auvik-cli.exe"
$McpBin  = "auvik-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (auvik-vX.Y.Z),
...
Write-Host "  auvik-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/auvik#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/auvik/mcp-install.md"
