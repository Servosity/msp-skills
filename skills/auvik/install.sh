#!/usr/bin/env bash
# install.sh - install auvik-cli and auvik-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (auvik-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/auvik#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/auvik/mcp-install.md"
