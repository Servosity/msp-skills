...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [avanan-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/avanan/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/avanan/install.ps1
---
...
The installer places the `avanan-cli` and `avanan-mcp` binaries on your PATH. It does not
