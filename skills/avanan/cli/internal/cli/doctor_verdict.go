...
//
// See issue #282 and skills/avanan/handfixes.json.
//
...
const doctorBaseURLEnv = "AVANAN_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://smart-api-production-1-us.avanan.net"
