...
large datasets as it has no memory pressure.`,
  ...
  avanan-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  avanan-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  avanan-cli export <resource> --format jsonl | jq '.id'`,
