...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"action post-event",
		"avanan-search",
		"avanan-search get-saas-entity",
		"avanan-search query-saas-entity",
		"download",
		...
		"exceptions",
		"exceptions create",
		"exceptions create-whitelist",
		"exceptions delete",
		"exceptions delete ap-exception",
		"exceptions get-ap",
		"exceptions get-ap-exctype",
		"exceptions update",
		"exceptions update-whitelist",
		"msp",
		"msp create",
		"msp create-tenants",
		"msp create-users",
		...
		"msp list",
		"msp list-addons",
		"msp list-daily-usages",
		"msp list-licenses",
		"msp list-monthly-usages",
		"msp list-tenants",
		"msp list-users",
		"msp update",
		"msp update-or-create-tenant-license",
		"report",
		"scopes",
		"sectool-exceptions",
		"sectool-exceptions create",
		"sectool-exceptions delete",
		"sectool-exceptions exceptions",
		"sectool-exceptions exceptions create-sectool-entry",
		"sectool-exceptions exceptions delete-sectool-entries",
		"sectool-exceptions exceptions get-sectool",
		"sectool-exceptions exceptions list-sectool",
		"sectool-exceptions update",
		"sectools",
		"sectools create-anomaly-exception",
		"sectools create-ctp-item",
		"sectools delete-anomaly-exceptions",
		"sectools delete-ctp-item",
		"sectools delete-ctp-items",
		"sectools delete-ctp-lists",
		"sectools get-ctp-item",
		"sectools get-ctp-list",
		"sectools list-anomaly-exceptions",
		"sectools list-ctp-items",
		"sectools list-ctp-lists",
		"sectools update-ctp-item",
		"sectools update-ctp-items",
		"soar",
		"soar get-entity",
		"soar post-notify",
		"task",
