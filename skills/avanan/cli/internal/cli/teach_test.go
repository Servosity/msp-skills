...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		...
		"avanan-cli doctor",
		"avanan-cli help items",
		"avanan-cli sync",
		"avanan-cli profile list",
		"avanan-cli feedback list",
		"avanan-cli which",
		"avanan-cli agent-context",
		"avanan-cli completion bash",
		"avanan-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"avanan-cli teach",
		"avanan-cli recall",
		"avanan-cli learnings",
		"avanan-cli teach-pattern",
		"avanan-cli teach-lookup",
		"avanan-cli items list",
	}
