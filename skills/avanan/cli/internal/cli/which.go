...
var whichIndex = []whichEntry{
	...
	{Command: "timeline", Description: "Reconstruct one message's full history: detection, state changes, actions submitted, task outcomes, and restore disposition, in order.", Group: "Local state that compounds", WhyItMatters: "Reach for this when a user disputes a quarantine or a ticket needs evidence of what actually happened to a message."},
	...
	{Command: "exceptions audit", Description: "Flag exceptions that contradict each other across sub-systems, exact duplicates, and entries that have never matched real traffic.", Group: "Collapsing the seven-headed exception system", WhyItMatters: "Reach for this on a policy review to find the contractor domain nobody removed and the string that is allowlisted in one engine and blocked in another."},
