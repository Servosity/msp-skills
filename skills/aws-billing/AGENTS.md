...
This directory is a generated `aws-billing-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
aws-billing-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
aws-billing-cli which "<capability>" --json
aws-billing-cli <command> --help
```
...
```bash
aws-billing-cli <command> --help
aws-billing-cli <command> --dry-run --agent
```
