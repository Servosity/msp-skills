# install.ps1 - install aws-billing-cli and aws-billing-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (aws-billing-v*).
...
$Skill   = "aws-billing"
$CliBin  = "aws-billing-cli.exe"
$McpBin  = "aws-billing-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (aws-billing-vX.Y.Z),
...
Write-Host "  aws-billing-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/aws-billing#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/aws-billing/mcp-install.md"
