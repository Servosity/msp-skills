#!/usr/bin/env bash
# install.sh - install aws-billing-cli and aws-billing-mcp on macOS / Linux.
#
...
SKILL="aws-billing"
CLI_BIN="aws-billing-cli"
MCP_BIN="aws-billing-mcp"
...
# Each skill is versioned and tagged independently (aws-billing-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/aws-billing#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/aws-billing/mcp-install.md"
