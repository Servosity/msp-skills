...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [axcient-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/axcient/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/axcient/install.ps1
---
...
The installer places the `axcient-cli` and `axcient-mcp` binaries on your PATH. It does not
