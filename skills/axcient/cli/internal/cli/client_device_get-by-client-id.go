...
func newClientDeviceGetByClientIdCmd(flags *rootFlags) *cobra.Command {
	var flagServiceId string
	var flagD2cOnly bool
	...
	cmd.Flags().BoolVar(&flagD2cOnly, "d2c-only", false, "Include D2C devices only.")
