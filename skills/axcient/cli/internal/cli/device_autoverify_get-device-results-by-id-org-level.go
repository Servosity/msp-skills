...
func newDeviceAutoverifyGetDeviceResultsByIdOrgLevelCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/device/{device_id}/autoverify"
			path = replacePathParam(path, "device_id", args[0])
			params := map[string]string{}
			data, prov, err := resolveReadWithStrategy(cmd.Context(), c, flags, "auto", "autoverify", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
