...
func newDeviceGetByOrgIdOrgLevelCmd(flags *rootFlags) *cobra.Command {
	var flagLocalPsId string
	var flagLimit int
	...
	cmd.Flags().StringVar(&flagLocalPsId, "local-ps-id", "", "UUID to filter the output")
	cmd.Flags().IntVar(&flagLimit, "limit", 500, "Records limit for pagination")
