...
large datasets as it has no memory pressure.`,
  ...
  axcient-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  axcient-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  axcient-cli export <resource> --format jsonl | jq '.id'`,
