# install.ps1 - install axcient-cli and axcient-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (axcient-v*).
...
$Skill   = "axcient"
$CliBin  = "axcient-cli.exe"
$McpBin  = "axcient-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (axcient-vX.Y.Z),
...
Write-Host "  axcient-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/axcient#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/axcient/mcp-install.md"
