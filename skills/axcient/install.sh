#!/usr/bin/env bash
# install.sh - install axcient-cli and axcient-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (axcient-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/axcient#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/axcient/mcp-install.md"
