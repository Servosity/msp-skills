...
var readCommandResources = map[string][]string{
	"betterstack-cli heartbeat-groups":        {"heartbeat-groups"},
	"betterstack-cli heartbeat-groups list":   {"heartbeat-groups"},
	"betterstack-cli heartbeat-groups get":    {"heartbeat-groups"},
	"betterstack-cli heartbeat-groups search": {"heartbeat-groups"},
	"betterstack-cli heartbeats":              {"heartbeats"},
	"betterstack-cli heartbeats list":         {"heartbeats"},
	"betterstack-cli heartbeats get":          {"heartbeats"},
	"betterstack-cli heartbeats search":       {"heartbeats"},
	"betterstack-cli incidents":               {"incidents"},
	"betterstack-cli incidents list":          {"incidents"},
	"betterstack-cli incidents get":           {"incidents"},
	"betterstack-cli incidents search":        {"incidents"},
	"betterstack-cli monitor-groups":          {"monitor-groups"},
	"betterstack-cli monitor-groups list":     {"monitor-groups"},
	"betterstack-cli monitor-groups get":      {"monitor-groups"},
	"betterstack-cli monitor-groups search":   {"monitor-groups"},
	"betterstack-cli monitors":                {"monitors"},
	"betterstack-cli monitors list":           {"monitors"},
	"betterstack-cli monitors get":            {"monitors"},
	"betterstack-cli monitors search":         {"monitors"},
	"betterstack-cli on-calls":                {"on-calls"},
	"betterstack-cli on-calls list":           {"on-calls"},
	"betterstack-cli on-calls get":            {"on-calls"},
	"betterstack-cli on-calls search":         {"on-calls"},
	"betterstack-cli policies":                {"policies"},
	"betterstack-cli policies list":           {"policies"},
	"betterstack-cli policies get":            {"policies"},
	"betterstack-cli policies search":         {"policies"},
	"betterstack-cli status-pages":            {"status-pages"},
	"betterstack-cli status-pages list":       {"status-pages"},
	"betterstack-cli status-pages get":        {"status-pages"},
	"betterstack-cli status-pages search":     {"status-pages"},
...
func cachePolicy() cliutil.Policy {
	...
	envOptOut := "BETTERSTACK_NO_AUTO_REFRESH"
...
func autoRefreshIfStale(ctx context.Context, flags *rootFlags, resources []string) (meta cliutil.FreshnessMeta) {
	...
	if err := runAutoRefresh(refreshCtx, flags, db, resources); err != nil {
		fmt.Fprintf(os.Stderr, "warning: using stale betterstack-cli cache (refresh failed: %v)\n", err)
