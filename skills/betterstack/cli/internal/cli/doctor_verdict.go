...
//
// See issue #282 and skills/betterstack/handfixes.json.
//
...
const doctorBaseURLEnv = "BETTERSTACK_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://uptime.betterstack.com/api/v2"
