...
large datasets as it has no memory pressure.`,
  ...
  betterstack-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  betterstack-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  betterstack-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.MinimumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				"heartbeat-groups": true,
				"heartbeats":       true,
				"incidents":        true,
				"monitor-groups":   true,
				"monitors":         true,
