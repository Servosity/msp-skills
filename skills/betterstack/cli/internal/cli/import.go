...
but do not stop the import.`,
  ...
  betterstack-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  betterstack-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | betterstack-cli import <resource> --input -`,
