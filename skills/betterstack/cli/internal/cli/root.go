...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "betterstack-cli",
		Short: `Every Better Stack Uptime feature, plus an offline SQLite mirror, full-text search, and cross-resource fleet analytics — monitor coverage, incident MTTA/MTTR, and on-call gaps — that the API alone ca…`,
		Long: `Every Better Stack Uptime feature, plus an offline SQLite mirror, full-text search, and cross-resource fleet analytics — monitor coverage, incident MTTA/MTTR, and on-call gaps — that the API alone ca…
...
Health check: run 'betterstack-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("betterstack-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'betterstack-cli profile list')")
	...
	rootCmd.AddCommand(newHeartbeatGroupsCmd(flags))
	rootCmd.AddCommand(newHeartbeatsCmd(flags))
	rootCmd.AddCommand(newIncidentsCmd(flags))
	rootCmd.AddCommand(newMonitorGroupsCmd(flags))
	rootCmd.AddCommand(newMonitorsCmd(flags))
	rootCmd.AddCommand(newOnCallsCmd(flags))
	rootCmd.AddCommand(newPoliciesCmd(flags))
	rootCmd.AddCommand(newStatusPageResourcesCmd(flags))
	rootCmd.AddCommand(newStatusPageSectionsCmd(flags))
	...
	rootCmd.AddCommand(newNovelGroupHealthCmd(flags))
	rootCmd.AddCommand(newNovelHeartbeatRiskCmd(flags))
	rootCmd.AddCommand(newNovelMttrCmd(flags))
	rootCmd.AddCommand(newNovelOncallGapsCmd(flags))
	rootCmd.AddCommand(newNovelStatuspageAuditCmd(flags))
