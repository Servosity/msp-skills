# install.ps1 - install betterstack-cli and betterstack-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (betterstack-v*).
...
$Skill   = "betterstack"
$CliBin  = "betterstack-cli.exe"
$McpBin  = "betterstack-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (betterstack-vX.Y.Z),
...
Write-Host "  betterstack-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/betterstack#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/betterstack/mcp-install.md"
