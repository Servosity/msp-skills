#!/usr/bin/env bash
# install.sh - install betterstack-cli and betterstack-mcp on macOS / Linux.
#
...
SKILL="betterstack"
CLI_BIN="betterstack-cli"
MCP_BIN="betterstack-mcp"
...
# Each skill is versioned and tagged independently (betterstack-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/betterstack#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/betterstack/mcp-install.md"
