...
large datasets as it has no memory pressure.`,
  ...
  blumira-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  blumira-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  blumira-cli export <resource> --format jsonl | jq '.id'`,
