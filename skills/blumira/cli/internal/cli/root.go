...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "blumira-cli",
		Short: `Blumira CLI — Every Blumira finding, detection, and agent across your direct org and every MSP sub-account — in one offline-searchabl…`,
		Long: `Blumira CLI — Every Blumira finding, detection, and agent across your direct org and every MSP sub-account — in one offline-searchabl…
...
Health check: run 'blumira-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("blumira-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'blumira-cli profile list')")
	...
	rootCmd.AddCommand(newNovelDcRosterCmd(flags))
	rootCmd.AddCommand(newNovelDriftCmd(flags))
	rootCmd.AddCommand(newNovelEvidenceSearchCmd(flags))
	rootCmd.AddCommand(newNovelExposureCmd(flags))
	...
	rootCmd.AddCommand(newNovelSlaCmd(flags))
	...
	rootCmd.AddCommand(newResolutionsPromotedCmd(flags))
