...
func TestRecipeIntentHandlerBuildsRecipeArgs(t *testing.T) {
	...
	result, err := handleFindUnprotectedDomainControllers(context.Background(), req)
	if err != nil {
...
func TestRecipeIntentHandlerOverridesAndRejectsArgs(t *testing.T) {
	...
	got := recipeToolText(t, result)
	if strings.Contains(got, "--flag-dc-stale") {
		t.Fatalf("boolean false override should suppress --flag-dc-stale: %q", got)
	}
}
