...
This CLI ships as a Claude Code Skill and MCP server in [Servosity/msp-skills](https://github.com/Servosity/msp-skills). The installer places the `blumira-cli` and `blumira-mcp` binaries and registers the skill with your agent:
