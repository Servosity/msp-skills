# install.ps1 - install blumira-cli and blumira-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (blumira-v*).
...
$Skill   = "blumira"
$CliBin  = "blumira-cli.exe"
$McpBin  = "blumira-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (blumira-vX.Y.Z),
...
Write-Host "  blumira-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/blumira#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/blumira/mcp-install.md"
