#!/usr/bin/env bash
# install.sh - install blumira-cli and blumira-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (blumira-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/blumira#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/blumira/mcp-install.md"
