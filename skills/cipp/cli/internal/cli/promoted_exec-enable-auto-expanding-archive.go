...
func newExecEnableAutoExpandingArchivePromotedCmd(flags *rootFlags) *cobra.Command {
	var bodyID string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "exec-enable-auto-expanding-archive", data, "Results")
			}
