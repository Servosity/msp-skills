...
func newExecListBackupPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagBackupName string
	var flagNameOnly string
	...
	cmd.Flags().StringVar(&flagBackupName, "backup-name", "", "Backup name")
	cmd.Flags().StringVar(&flagNameOnly, "name-only", "", "Name only")
