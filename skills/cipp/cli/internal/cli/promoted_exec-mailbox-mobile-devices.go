...
func newExecMailboxMobileDevicesPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagDelete string
	var flagDeviceid string
	var flagGuid string
	var flagQuarantine string
	...
	cmd.Flags().StringVar(&flagDelete, "delete", "", "Delete")
	cmd.Flags().StringVar(&flagDeviceid, "deviceid", "", "Deviceid")
	cmd.Flags().StringVar(&flagGuid, "guid", "", "Guid")
	cmd.Flags().StringVar(&flagQuarantine, "quarantine", "", "Quarantine")
