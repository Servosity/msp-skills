...
func newExecModifyMbpermsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string

	cmd := &cobra.Command{
		Use:         "exec-modify-mbperms",
		Short:       "Exec modify mbperms",
		Long:        "Exec modify mbperms",
		Example:     "  cipp-cli exec-modify-mbperms",
		Annotations: map[string]string{"pp:endpoint": "exec-modify-mbperms.create", "pp:method": "POST", "pp:path": "/ExecModifyMBPerms"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "exec-modify-mbperms", data, "Results")
			}
