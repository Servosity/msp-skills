...
func newListAuditLogsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagEndDate string
	var flagLogId string
	var flagRelativeTime string
	...
	cmd.Flags().StringVar(&flagLogId, "log-id", "", "Log id")
	cmd.Flags().StringVar(&flagRelativeTime, "relative-time", "", "Relative time")
