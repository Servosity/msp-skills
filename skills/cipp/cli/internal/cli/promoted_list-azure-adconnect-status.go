...
func newListAzureAdconnectStatusPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagDataToReturn string
	...
	cmd.Flags().StringVar(&flagDataToReturn, "data-to-return", "", "Data to return")
