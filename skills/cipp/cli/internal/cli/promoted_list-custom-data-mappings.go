...
func newListCustomDataMappingsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagDirectoryObject string
	...
	cmd.Flags().StringVar(&flagDirectoryObject, "directory-object", "", "Directory object")
