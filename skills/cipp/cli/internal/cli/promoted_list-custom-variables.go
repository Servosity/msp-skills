...
func newListCustomVariablesPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagExcludeGlobalReserved string
	var flagIncludeSystem string
	...
	cmd.Flags().StringVar(&flagExcludeGlobalReserved, "exclude-global-reserved", "", "Exclude global reserved")
	cmd.Flags().StringVar(&flagIncludeSystem, "include-system", "", "Include system")
