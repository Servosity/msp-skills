...
func newListDeviceDetailsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagDeviceID string
	var flagDeviceName string
	var flagDeviceSerial string
	...
	cmd.Flags().StringVar(&flagDeviceName, "device-name", "", "Device name")
	cmd.Flags().StringVar(&flagDeviceSerial, "device-serial", "", "Device serial")
