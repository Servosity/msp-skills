...
func newListFunctionStatsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagFunctionType string
	...
	cmd.Flags().StringVar(&flagFunctionType, "function-type", "", "Function type")
