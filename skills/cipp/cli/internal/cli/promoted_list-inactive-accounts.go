...
func newListInactiveAccountsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagInactiveDays string
	...
	cmd.Flags().StringVar(&flagInactiveDays, "inactive-days", "", "Inactive days")
