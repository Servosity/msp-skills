...
func newListSignInsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagDays string
	var flagFailedLogonsOnly string
	var flagFailureThreshold string
	...
	cmd.Flags().StringVar(&flagFailedLogonsOnly, "failed-logons-only", "", "Failed logons only")
	cmd.Flags().StringVar(&flagFailureThreshold, "failure-threshold", "", "Failure threshold")
