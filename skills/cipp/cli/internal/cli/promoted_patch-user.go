...
func newPatchUserPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Patch user",
		Long:        "Patch user",
		Example:     "  cipp-cli patch-user",
		Annotations: map[string]string{"pp:endpoint": "patch-user.update", "pp:method": "PATCH", "pp:path": "/PatchUser"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "patch-user", data, "Results")
			}
