#!/usr/bin/env bash
# install.sh - install cipp-cli and cipp-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (cipp-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/cipp#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/cipp/mcp-install.md"
