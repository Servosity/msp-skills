...
func newAlertsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List open alerts across all computers",
		Example:     "  connectwise-automate-cli alerts list",
	...
	cmd.Flags().StringVar(&flagCondition, "condition", "", "Filter expression, e.g. 'Priority>=3'")
