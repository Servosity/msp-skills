...
//
// See issue #282 and skills/connectwise-automate/handfixes.json.
//
...
import (
	...
	"connectwise-automate-pp-cli/internal/client"
...
const doctorBaseURLEnv = "CONNECTWISE_AUTOMATE_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://{server}/cwa/api/v1"
