...
but do not stop the import.`,
  ...
  connectwise-automate-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  connectwise-automate-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | connectwise-automate-cli import <resource> --input -`,
