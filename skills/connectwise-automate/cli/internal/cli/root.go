...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "connectwise-automate-cli",
		Short: `Sync your entire ConnectWise Automate fleet into local SQLite and answer cross-client questions the per-server web UI can't: fleet-wide health roll-ups, stale-agent sweeps, patch-compliance-by-client…`,
		Long: `Sync your entire ConnectWise Automate fleet into local SQLite and answer cross-client questions the per-server web UI can't: fleet-wide health roll-ups, stale-agent sweeps, patch-compliance-by-client…
...
Run 'connectwise-automate-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("connectwise-automate-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'connectwise-automate-cli profile list')")
	...
	rootCmd.AddCommand(newApitokenCmd(flags))
	rootCmd.AddCommand(newClientsCmd(flags))
	rootCmd.AddCommand(newCommandsCmd(flags))
	...
	rootCmd.AddCommand(newPatchingCmd(flags))
	...
	rootCmd.AddCommand(newNovelAlertTriageCmd(flags))
	rootCmd.AddCommand(newNovelClientRollupCmd(flags))
	rootCmd.AddCommand(newNovelFleetHealthCmd(flags))
	rootCmd.AddCommand(newNovelOsInventoryCmd(flags))
	rootCmd.AddCommand(newNovelPatchComplianceCmd(flags))
	rootCmd.AddCommand(newNovelSinceCmd(flags))
	rootCmd.AddCommand(newNovelStaleAgentsCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newContactsPromotedCmd(flags))
	rootCmd.AddCommand(newNetworkDevicesPromotedCmd(flags))
