...
Resource scoping:
  ...
  connectwise-automate-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  connectwise-automate-cli sync --full

  # Incremental sync: only records from the last 7 days
  connectwise-automate-cli sync --since 7d

  # Parallel sync with 8 workers
  connectwise-automate-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  connectwise-automate-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/connectwise-automate-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "locations":
		return true
	case "monitors-monitor-statistics":
		return true
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "network-devices":
		return db.UpsertNetworkDevices(data)
	case "patching":
		return db.UpsertPatching(data)
	case "scripts":
...
func defaultSyncResources() []string {
	return []string{
		...
		"locations",
		"monitors",
		"monitors-monitor-statistics",
		"network-devices",
		"patching",
		"patching-approval-policies",
		"patching-microsoft-update-policies",
		"patching-patch-information",
		"patching-third-party-update-policies",
		"scripts",
		"scripts-running-scripts",
		"scripts-script-schedules",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"groups":                               "/Groups",
		"locations":                            "/Locations",
		"monitors":                             "/SensorChecks",
		"monitors-monitor-statistics":          "/MonitorStatistics",
		"network-devices":                      "/NetworkDevices",
		"patching":                             "/PatchHistory",
		"patching-approval-policies":           "/ApprovalPolicies",
		"patching-microsoft-update-policies":   "/MicrosoftUpdatePolicies",
		"patching-patch-information":           "/PatchInformation",
		"patching-third-party-update-policies": "/ThirdPartyUpdatePolicies",
		"scripts":                              "/Scripts",
		"scripts-running-scripts":              "/Scripting/RunningScripts",
		"scripts-script-schedules":             "/Scripting/ScriptSchedules",
	}
