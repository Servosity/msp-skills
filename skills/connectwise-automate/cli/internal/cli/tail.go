...
native streaming instead of polling.`,
  ...
  connectwise-automate-cli tail --interval 10s

  # Tail a specific resource
  connectwise-automate-cli tail messages --interval 5s

  # Pipe to jq for filtering
  connectwise-automate-cli tail events --interval 30s | jq 'select(.type == "error")'`,
