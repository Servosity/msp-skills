# install.ps1 - install connectwise-automate-cli and connectwise-automate-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (connectwise-automate-v*).
...
$Skill   = "connectwise-automate"
$CliBin  = "connectwise-automate-cli.exe"
$McpBin  = "connectwise-automate-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (connectwise-automate-vX.Y.Z),
...
Write-Host "  connectwise-automate-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/connectwise-automate#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/connectwise-automate/mcp-install.md"
