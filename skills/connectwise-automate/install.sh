#!/usr/bin/env bash
# install.sh - install connectwise-automate-cli and connectwise-automate-mcp on macOS / Linux.
#
...
CLI_BIN="connectwise-automate-cli"
MCP_BIN="connectwise-automate-mcp"
...
# Each skill is versioned and tagged independently (connectwise-automate-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/connectwise-automate#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/connectwise-automate/mcp-install.md"
