...
but do not stop the import.`,
  ...
  connectwise-control-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  connectwise-control-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | connectwise-control-cli import <resource> --input -`,
