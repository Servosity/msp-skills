...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "connectwise-control-cli",
		Short: "Manage connectwise-control resources via the connectwise-control API",
		Long: `Manage connectwise-control resources via the connectwise-control API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'connectwise-control-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("connectwise-control-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'connectwise-control-cli profile list')")
	...
	rootCmd.AddCommand(newSessionGroupsPromotedCmd(flags))
