...
func newSessionsAddEventToCmd(flags *rootFlags) *cobra.Command {
	var bodyData string
	var bodyEventType int
	...
	cmd.Flags().StringVar(&bodyData, "data", "", "Optional event data.")
	cmd.Flags().IntVar(&bodyEventType, "event-type", 0, "Numeric session event type to queue.")
