...
native streaming instead of polling.`,
  ...
  connectwise-control-cli tail --interval 10s

  # Tail a specific resource
  connectwise-control-cli tail messages --interval 5s

  # Pipe to jq for filtering
  connectwise-control-cli tail events --interval 30s | jq 'select(.type == "error")'`,
