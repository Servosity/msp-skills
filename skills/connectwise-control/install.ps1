# install.ps1 - install connectwise-control-cli and connectwise-control-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (connectwise-control-v*).
...
$Skill   = "connectwise-control"
$CliBin  = "connectwise-control-cli.exe"
$McpBin  = "connectwise-control-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (connectwise-control-vX.Y.Z),
...
Write-Host "  connectwise-control-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/connectwise-control#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/connectwise-control/mcp-install.md"
