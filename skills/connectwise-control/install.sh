#!/usr/bin/env bash
# install.sh - install connectwise-control-cli and connectwise-control-mcp on macOS / Linux.
#
...
CLI_BIN="connectwise-control-cli"
MCP_BIN="connectwise-control-mcp"
...
# Each skill is versioned and tagged independently (connectwise-control-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/connectwise-control#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/connectwise-control/mcp-install.md"
