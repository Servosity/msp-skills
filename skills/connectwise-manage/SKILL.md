  ...
  openclaw:
    ...
    install:
      - kind: script
        ...
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/connectwise-manage/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/connectwise-manage/install.ps1
---
...
The installer places the `connectwise-manage-cli` and `connectwise-manage-mcp` binaries on your PATH. It does not
