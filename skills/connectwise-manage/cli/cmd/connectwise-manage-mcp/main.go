...
import (
	...
	mcptools "connectwise-manage-pp-cli/internal/mcp"
...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "connectwise-manage-pp-mcp serving MCP over streamable HTTP at %s\n", *addr)
