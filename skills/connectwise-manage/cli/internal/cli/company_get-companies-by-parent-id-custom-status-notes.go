...
func newCompanyGetCompaniesByParentIdCustomStatusNotesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-by-parent-id-custom-status-notes <parentId>",
		Short:       "Get List of CompanyCustomNote",
		Example:     "  connectwise-manage-cli company get-companies-by-parent-id-custom-status-notes 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-by-parent-id-custom-status-notes", "pp:method": "GET", "pp:path": "/company/companies/{parentId}/customStatusNotes", "mcp:read-only": "true"},
