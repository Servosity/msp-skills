...
func newCompanyGetCompaniesByParentIdGroupsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-by-parent-id-groups <parentId>",
		Short:       "Get List of CompanyGroup",
		Example:     "  connectwise-manage-cli company get-companies-by-parent-id-groups 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-by-parent-id-groups", "pp:method": "GET", "pp:path": "/company/companies/{parentId}/groups", "mcp:read-only": "true"},
