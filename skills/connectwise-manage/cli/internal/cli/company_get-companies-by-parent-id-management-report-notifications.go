...
func newCompanyGetCompaniesByParentIdManagementReportNotificationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-by-parent-id-management-report-notifications <parentId>",
		Short:       "Get List of ManagementReportNotification",
		Example:     "  connectwise-manage-cli company get-companies-by-parent-id-management-report-notifications 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-by-parent-id-management-report-notifications", "pp:method": "GET", "pp:path": "/company/companies/{parentId}/managementReportNotifications", "mcp:read-only": "true"},
