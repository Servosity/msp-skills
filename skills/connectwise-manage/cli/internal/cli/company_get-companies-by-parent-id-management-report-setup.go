...
func newCompanyGetCompaniesByParentIdManagementReportSetupCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-by-parent-id-management-report-setup <parentId>",
		Short:       "Get List of ManagementReportSetup",
		Example:     "  connectwise-manage-cli company get-companies-by-parent-id-management-report-setup 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-by-parent-id-management-report-setup", "pp:method": "GET", "pp:path": "/company/companies/{parentId}/managementReportSetup", "mcp:read-only": "true"},
