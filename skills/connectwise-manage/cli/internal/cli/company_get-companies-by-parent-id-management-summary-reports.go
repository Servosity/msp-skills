...
func newCompanyGetCompaniesByParentIdManagementSummaryReportsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-by-parent-id-management-summary-reports <parentId>",
		Short:       "Get List of CompanyManagementSummary",
		Example:     "  connectwise-manage-cli company get-companies-by-parent-id-management-summary-reports 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-by-parent-id-management-summary-reports", "pp:method": "GET", "pp:path": "/company/companies/{parentId}/managementSummaryReports", "mcp:read-only": "true"},
