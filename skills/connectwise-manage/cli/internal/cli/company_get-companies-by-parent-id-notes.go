...
func newCompanyGetCompaniesByParentIdNotesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-by-parent-id-notes <parentId>",
		Short:       "Get List of CompanyNote",
		Example:     "  connectwise-manage-cli company get-companies-by-parent-id-notes 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-by-parent-id-notes", "pp:method": "GET", "pp:path": "/company/companies/{parentId}/notes", "mcp:read-only": "true"},
