...
func newCompanyGetCompaniesByParentIdSitesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-by-parent-id-sites <parentId>",
		Short:       "Get List of CompanySite",
		Example:     "  connectwise-manage-cli company get-companies-by-parent-id-sites 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-by-parent-id-sites", "pp:method": "GET", "pp:path": "/company/companies/{parentId}/sites", "mcp:read-only": "true"},
