...
func newCompanyGetCompaniesByParentIdTeamsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-by-parent-id-teams <parentId>",
		Short:       "Get List of CompanyTeam",
		Example:     "  connectwise-manage-cli company get-companies-by-parent-id-teams 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-by-parent-id-teams", "pp:method": "GET", "pp:path": "/company/companies/{parentId}/teams", "mcp:read-only": "true"},
