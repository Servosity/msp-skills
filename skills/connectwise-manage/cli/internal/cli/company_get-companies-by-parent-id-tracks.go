...
func newCompanyGetCompaniesByParentIdTracksCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-by-parent-id-tracks <parentId>",
		Short:       "Get List of ContactTrack",
		Example:     "  connectwise-manage-cli company get-companies-by-parent-id-tracks 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-by-parent-id-tracks", "pp:method": "GET", "pp:path": "/company/companies/{parentId}/tracks", "mcp:read-only": "true"},
