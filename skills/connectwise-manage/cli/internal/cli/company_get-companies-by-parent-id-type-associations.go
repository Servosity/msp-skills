...
func newCompanyGetCompaniesByParentIdTypeAssociationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-by-parent-id-type-associations <parentId>",
		Short:       "Get List of CompanyTypeAssociation",
		Example:     "  connectwise-manage-cli company get-companies-by-parent-id-type-associations 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-by-parent-id-type-associations", "pp:method": "GET", "pp:path": "/company/companies/{parentId}/typeAssociations", "mcp:read-only": "true"},
