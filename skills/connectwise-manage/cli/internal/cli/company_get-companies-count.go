...
func newCompanyGetCompaniesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-count",
		Short:       "Get Count of ConnectWise.Apis.v3_0.v2015_3.Company.Company.Company",
		Example:     "  connectwise-manage-cli company get-companies-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-count", "pp:method": "GET", "pp:path": "/company/companies/count", "mcp:read-only": "true"},
