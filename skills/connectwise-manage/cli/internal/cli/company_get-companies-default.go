...
func newCompanyGetCompaniesDefaultCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-default",
		Short:       "Get ConnectWise.Apis.v3_0.v2015_3.Company.Company.Company",
		Example:     "  connectwise-manage-cli company get-companies-default",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-default", "pp:method": "GET", "pp:path": "/company/companies/default", "mcp:read-only": "true"},
