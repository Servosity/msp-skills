...
func newCompanyGetCompaniesInfoCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-info-count",
		Short:       "Get Count of CompanyInfos",
		Example:     "  connectwise-manage-cli company get-companies-info-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-info-count", "pp:method": "GET", "pp:path": "/company/companies/info/count", "mcp:read-only": "true"},
