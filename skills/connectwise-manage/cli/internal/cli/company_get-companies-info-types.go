...
func newCompanyGetCompaniesInfoTypesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-info-types",
		Short:       "Get List of CompanyTypeInfo",
		Example:     "  connectwise-manage-cli company get-companies-info-types",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-info-types", "pp:method": "GET", "pp:path": "/company/companies/info/types", "mcp:read-only": "true"},
