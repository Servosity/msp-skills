...
func newCompanyGetCompaniesInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-info",
		Short:       "Get List of CompanyInfos",
		Example:     "  connectwise-manage-cli company get-companies-info",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-info", "pp:method": "GET", "pp:path": "/company/companies/info", "mcp:read-only": "true"},
