...
func newCompanyGetCompaniesStatusesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-statuses-count",
		Short:       "Get Count of CompanyStatus",
		Example:     "  connectwise-manage-cli company get-companies-statuses-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-statuses-count", "pp:method": "GET", "pp:path": "/company/companies/statuses/count", "mcp:read-only": "true"},
