...
func newCompanyGetCompaniesStatusesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-statuses",
		Short:       "Get List of CompanyStatus",
		Example:     "  connectwise-manage-cli company get-companies-statuses",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-statuses", "pp:method": "GET", "pp:path": "/company/companies/statuses", "mcp:read-only": "true"},
