...
func newCompanyGetCompaniesTypesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-types-count",
		Short:       "Get Count of CompanyType",
		Example:     "  connectwise-manage-cli company get-companies-types-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-types-count", "pp:method": "GET", "pp:path": "/company/companies/types/count", "mcp:read-only": "true"},
