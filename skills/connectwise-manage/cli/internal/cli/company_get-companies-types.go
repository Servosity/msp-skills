...
func newCompanyGetCompaniesTypesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies-types",
		Short:       "Get List of CompanyType",
		Example:     "  connectwise-manage-cli company get-companies-types",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies-types", "pp:method": "GET", "pp:path": "/company/companies/types", "mcp:read-only": "true"},
