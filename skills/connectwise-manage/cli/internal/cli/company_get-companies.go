...
func newCompanyGetCompaniesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-companies",
		Aliases:     []string{"list"},
		Short:       "Get List of ConnectWise.Apis.v3_0.v2015_3.Company.Company.Company",
		Example:     "  connectwise-manage-cli company get-companies",
		Annotations: map[string]string{"pp:endpoint": "company.get-companies", "pp:method": "GET", "pp:path": "/company/companies", "mcp:read-only": "true"},
