...
func newCompanyGetConfigurationsCountCmd(flags *rootFlags) *cobra.Command {
	var flagManagedIdentifier string
	...
	cmd := &cobra.Command{
		Use:         "get-configurations-count",
		Short:       "Get Count of Configuration",
		Example:     "  connectwise-manage-cli company get-configurations-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-configurations-count", "pp:method": "GET", "pp:path": "/company/configurations/count", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "company", path, map[string]string{
				"managedIdentifier":     formatCLIParamValue(flagManagedIdentifier),
	...
	cmd.Flags().StringVar(&flagManagedIdentifier, "managed-identifier", "", "managedIdentifier")
