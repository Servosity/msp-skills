...
func newCompanyGetConfigurationsStatusesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-configurations-statuses-count",
		Short:       "Get Count of ConfigurationStatus",
		Example:     "  connectwise-manage-cli company get-configurations-statuses-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-configurations-statuses-count", "pp:method": "GET", "pp:path": "/company/configurations/statuses/count", "mcp:read-only": "true"},
