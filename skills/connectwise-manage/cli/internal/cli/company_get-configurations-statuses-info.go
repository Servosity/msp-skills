...
func newCompanyGetConfigurationsStatusesInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-configurations-statuses-info",
		Short:       "Get List of ConfigurationStatusInfos",
		Example:     "  connectwise-manage-cli company get-configurations-statuses-info",
		Annotations: map[string]string{"pp:endpoint": "company.get-configurations-statuses-info", "pp:method": "GET", "pp:path": "/company/configurations/statuses/info", "mcp:read-only": "true"},
