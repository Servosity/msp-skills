...
func newCompanyGetConfigurationsStatusesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-configurations-statuses",
		Short:       "Get List of ConfigurationStatus",
		Example:     "  connectwise-manage-cli company get-configurations-statuses",
		Annotations: map[string]string{"pp:endpoint": "company.get-configurations-statuses", "pp:method": "GET", "pp:path": "/company/configurations/statuses", "mcp:read-only": "true"},
