...
func newCompanyGetConfigurationsTypesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-configurations-types-count",
		Short:       "Get Count of ConfigurationType",
		Example:     "  connectwise-manage-cli company get-configurations-types-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-configurations-types-count", "pp:method": "GET", "pp:path": "/company/configurations/types/count", "mcp:read-only": "true"},
