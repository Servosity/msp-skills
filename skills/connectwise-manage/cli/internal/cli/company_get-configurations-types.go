...
func newCompanyGetConfigurationsTypesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-configurations-types",
		Short:       "Get List of ConfigurationType",
		Example:     "  connectwise-manage-cli company get-configurations-types",
		Annotations: map[string]string{"pp:endpoint": "company.get-configurations-types", "pp:method": "GET", "pp:path": "/company/configurations/types", "mcp:read-only": "true"},
