...
func newCompanyGetConfigurationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Get List of Configuration",
		Example:     "  connectwise-manage-cli company get-configurations",
		Annotations: map[string]string{"pp:endpoint": "company.get-configurations", "pp:method": "GET", "pp:path": "/company/configurations", "mcp:read-only": "true"},
