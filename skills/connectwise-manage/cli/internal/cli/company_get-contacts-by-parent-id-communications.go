...
func newCompanyGetContactsByParentIdCommunicationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-by-parent-id-communications <parentId>",
		Short:       "Get List of ContactCommunication",
		Example:     "  connectwise-manage-cli company get-contacts-by-parent-id-communications 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-by-parent-id-communications", "pp:method": "GET", "pp:path": "/company/contacts/{parentId}/communications", "mcp:read-only": "true"},
