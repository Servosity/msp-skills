...
func newCompanyGetContactsByParentIdGroupsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-by-parent-id-groups <parentId>",
		Short:       "Get List of ContactGroup",
		Example:     "  connectwise-manage-cli company get-contacts-by-parent-id-groups 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-by-parent-id-groups", "pp:method": "GET", "pp:path": "/company/contacts/{parentId}/groups", "mcp:read-only": "true"},
