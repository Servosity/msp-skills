...
func newCompanyGetContactsByParentIdNotesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-by-parent-id-notes <parentId>",
		Short:       "Get List of ContactNote",
		Example:     "  connectwise-manage-cli company get-contacts-by-parent-id-notes 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-by-parent-id-notes", "pp:method": "GET", "pp:path": "/company/contacts/{parentId}/notes", "mcp:read-only": "true"},
