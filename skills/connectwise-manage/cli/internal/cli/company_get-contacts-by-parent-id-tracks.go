...
func newCompanyGetContactsByParentIdTracksCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-by-parent-id-tracks <parentId>",
		Short:       "Get List of ContactTrack",
		Example:     "  connectwise-manage-cli company get-contacts-by-parent-id-tracks 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-by-parent-id-tracks", "pp:method": "GET", "pp:path": "/company/contacts/{parentId}/tracks", "mcp:read-only": "true"},
