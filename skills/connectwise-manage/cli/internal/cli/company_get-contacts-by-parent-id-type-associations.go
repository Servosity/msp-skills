...
func newCompanyGetContactsByParentIdTypeAssociationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-by-parent-id-type-associations <parentId>",
		Short:       "Get List of ContactTypeAssociation",
		Example:     "  connectwise-manage-cli company get-contacts-by-parent-id-type-associations 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-by-parent-id-type-associations", "pp:method": "GET", "pp:path": "/company/contacts/{parentId}/typeAssociations", "mcp:read-only": "true"},
