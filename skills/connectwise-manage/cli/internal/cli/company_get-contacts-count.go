...
func newCompanyGetContactsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-count",
		Short:       "Get Count of Usage",
		Example:     "  connectwise-manage-cli company get-contacts-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-count", "pp:method": "GET", "pp:path": "/company/contacts/count", "mcp:read-only": "true"},
