...
func newCompanyGetContactsDefaultCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-default",
		Short:       "Get ApiContact",
		Example:     "  connectwise-manage-cli company get-contacts-default --company-id 42",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-default", "pp:method": "GET", "pp:path": "/company/contacts/default", "mcp:read-only": "true"},
	...
	cmd.Flags().StringVar(&flagCompanyId, "company-id", "", "companyId")
