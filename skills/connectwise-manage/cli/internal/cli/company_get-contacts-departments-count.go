...
func newCompanyGetContactsDepartmentsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-departments-count",
		Short:       "Get Count of ContactDepartment",
		Example:     "  connectwise-manage-cli company get-contacts-departments-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-departments-count", "pp:method": "GET", "pp:path": "/company/contacts/departments/count", "mcp:read-only": "true"},
