...
func newCompanyGetContactsDepartmentsInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-departments-info",
		Short:       "Get List of ContactDepartmentInfos",
		Example:     "  connectwise-manage-cli company get-contacts-departments-info",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-departments-info", "pp:method": "GET", "pp:path": "/company/contacts/departments/info", "mcp:read-only": "true"},
