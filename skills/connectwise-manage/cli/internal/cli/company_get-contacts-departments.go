...
func newCompanyGetContactsDepartmentsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-departments",
		Short:       "Get List of ContactDepartment",
		Example:     "  connectwise-manage-cli company get-contacts-departments",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-departments", "pp:method": "GET", "pp:path": "/company/contacts/departments", "mcp:read-only": "true"},
