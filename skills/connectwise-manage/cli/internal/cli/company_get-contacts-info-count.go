...
func newCompanyGetContactsInfoCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-info-count",
		Short:       "Get Count of ContactInfos",
		Example:     "  connectwise-manage-cli company get-contacts-info-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-info-count", "pp:method": "GET", "pp:path": "/company/contacts/info/count", "mcp:read-only": "true"},
