...
func newCompanyGetContactsInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-info",
		Short:       "Get List of ContactInfos",
		Example:     "  connectwise-manage-cli company get-contacts-info",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-info", "pp:method": "GET", "pp:path": "/company/contacts/info", "mcp:read-only": "true"},
