...
func newCompanyGetContactsRelationshipsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-relationships-count",
		Short:       "Get Count of ContactRelationship",
		Example:     "  connectwise-manage-cli company get-contacts-relationships-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-relationships-count", "pp:method": "GET", "pp:path": "/company/contacts/relationships/count", "mcp:read-only": "true"},
