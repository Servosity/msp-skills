...
func newCompanyGetContactsRelationshipsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-relationships",
		Short:       "Get List of ContactRelationship",
		Example:     "  connectwise-manage-cli company get-contacts-relationships",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-relationships", "pp:method": "GET", "pp:path": "/company/contacts/relationships", "mcp:read-only": "true"},
