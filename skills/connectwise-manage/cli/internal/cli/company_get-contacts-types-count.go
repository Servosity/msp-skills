...
func newCompanyGetContactsTypesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-types-count",
		Short:       "Get Count of ContactType",
		Example:     "  connectwise-manage-cli company get-contacts-types-count",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-types-count", "pp:method": "GET", "pp:path": "/company/contacts/types/count", "mcp:read-only": "true"},
