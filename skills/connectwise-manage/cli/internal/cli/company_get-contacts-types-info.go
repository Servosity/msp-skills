...
func newCompanyGetContactsTypesInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-types-info",
		Short:       "Get List of ContactTypeInfo",
		Example:     "  connectwise-manage-cli company get-contacts-types-info",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-types-info", "pp:method": "GET", "pp:path": "/company/contacts/types/info", "mcp:read-only": "true"},
