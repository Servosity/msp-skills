...
func newCompanyGetContactsTypesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts-types",
		Short:       "Get List of ContactType",
		Example:     "  connectwise-manage-cli company get-contacts-types",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts-types", "pp:method": "GET", "pp:path": "/company/contacts/types", "mcp:read-only": "true"},
