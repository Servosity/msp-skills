...
func newCompanyGetContactsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-contacts",
		Short:       "Get List of ApiContact",
		Example:     "  connectwise-manage-cli company get-contacts",
		Annotations: map[string]string{"pp:endpoint": "company.get-contacts", "pp:method": "GET", "pp:path": "/company/contacts", "mcp:read-only": "true"},
