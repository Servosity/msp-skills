...
func newCompanyPostConfigurationsBulkCmd(flags *rootFlags) *cobra.Command {
	var flagManagedInformation string
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "post-configurations-bulk",
		Short:       "Post Configuration",
		Example:     "  connectwise-manage-cli company post-configurations-bulk",
		Annotations: map[string]string{"pp:endpoint": "company.post-configurations-bulk", "pp:method": "POST", "pp:path": "/company/configurations/bulk"},
