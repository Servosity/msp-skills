...
func newCompanyPutConfigurationsBulkCmd(flags *rootFlags) *cobra.Command {
	var flagManagedInformation string
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "put-configurations-bulk",
		Short:       "Put Configuration",
		Example:     "  connectwise-manage-cli company put-configurations-bulk",
		Annotations: map[string]string{"pp:endpoint": "company.put-configurations-bulk", "pp:method": "PUT", "pp:path": "/company/configurations/bulk"},
