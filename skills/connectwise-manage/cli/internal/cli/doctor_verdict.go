...
//
// See issue #282 and skills/connectwise-manage/handfixes.json.
//
...
const doctorBaseURLEnv = "CONNECTWISE_MANAGE_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://api-na.myconnectwise.net/v4_6_release/apis/3.0"
