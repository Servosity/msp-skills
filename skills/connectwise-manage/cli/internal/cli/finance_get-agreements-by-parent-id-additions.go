...
func newFinanceGetAgreementsByParentIdAdditionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-by-parent-id-additions <parentId>",
		Short:       "Get List of Addition",
		Example:     "  connectwise-manage-cli finance get-agreements-by-parent-id-additions 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-by-parent-id-additions", "pp:method": "GET", "pp:path": "/finance/agreements/{parentId}/additions", "mcp:read-only": "true"},
