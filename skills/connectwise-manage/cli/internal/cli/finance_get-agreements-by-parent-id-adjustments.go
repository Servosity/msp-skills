...
func newFinanceGetAgreementsByParentIdAdjustmentsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-by-parent-id-adjustments <parentId>",
		Short:       "Get List of Adjustment",
		Example:     "  connectwise-manage-cli finance get-agreements-by-parent-id-adjustments 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-by-parent-id-adjustments", "pp:method": "GET", "pp:path": "/finance/agreements/{parentId}/adjustments", "mcp:read-only": "true"},
