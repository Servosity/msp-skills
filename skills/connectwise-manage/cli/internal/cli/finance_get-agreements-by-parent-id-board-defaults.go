...
func newFinanceGetAgreementsByParentIdBoardDefaultsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-by-parent-id-board-defaults <parentId>",
		Short:       "Get List of BoardDefault",
		Example:     "  connectwise-manage-cli finance get-agreements-by-parent-id-board-defaults 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-by-parent-id-board-defaults", "pp:method": "GET", "pp:path": "/finance/agreements/{parentId}/boardDefaults", "mcp:read-only": "true"},
