...
func newFinanceGetAgreementsByParentIdConfigurationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-by-parent-id-configurations <parentId>",
		Short:       "Get List of ConfigurationReference",
		Example:     "  connectwise-manage-cli finance get-agreements-by-parent-id-configurations 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-by-parent-id-configurations", "pp:method": "GET", "pp:path": "/finance/agreements/{parentId}/configurations", "mcp:read-only": "true"},
