...
func newFinanceGetAgreementsByParentIdSitesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-by-parent-id-sites <parentId>",
		Short:       "Get List of AgreementSite",
		Example:     "  connectwise-manage-cli finance get-agreements-by-parent-id-sites 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-by-parent-id-sites", "pp:method": "GET", "pp:path": "/finance/agreements/{parentId}/sites", "mcp:read-only": "true"},
