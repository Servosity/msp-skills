...
func newFinanceGetAgreementsByParentIdWorkRoleExclusionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-by-parent-id-work-role-exclusions <parentId>",
		Short:       "Get List of AgreementWorkRoleExclusion",
		Example:     "  connectwise-manage-cli finance get-agreements-by-parent-id-work-role-exclusions 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-by-parent-id-work-role-exclusions", "pp:method": "GET", "pp:path": "/finance/agreements/{parentId}/workRoleExclusions", "mcp:read-only": "true"},
