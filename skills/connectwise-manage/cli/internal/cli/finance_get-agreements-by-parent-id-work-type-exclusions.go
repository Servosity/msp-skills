...
func newFinanceGetAgreementsByParentIdWorkTypeExclusionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-by-parent-id-work-type-exclusions <parentId>",
		Short:       "Get List of AgreementWorkTypeExclusion",
		Example:     "  connectwise-manage-cli finance get-agreements-by-parent-id-work-type-exclusions 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-by-parent-id-work-type-exclusions", "pp:method": "GET", "pp:path": "/finance/agreements/{parentId}/workTypeExclusions", "mcp:read-only": "true"},
