...
func newFinanceGetAgreementsByParentIdWorkrolesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-by-parent-id-workroles <parentId>",
		Short:       "Get List of AgreementWorkRole",
		Example:     "  connectwise-manage-cli finance get-agreements-by-parent-id-workroles 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-by-parent-id-workroles", "pp:method": "GET", "pp:path": "/finance/agreements/{parentId}/workroles", "mcp:read-only": "true"},
