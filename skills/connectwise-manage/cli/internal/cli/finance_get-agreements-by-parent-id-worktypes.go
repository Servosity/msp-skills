...
func newFinanceGetAgreementsByParentIdWorktypesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-by-parent-id-worktypes <parentId>",
		Short:       "Get List of AgreementWorkType",
		Example:     "  connectwise-manage-cli finance get-agreements-by-parent-id-worktypes 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-by-parent-id-worktypes", "pp:method": "GET", "pp:path": "/finance/agreements/{parentId}/worktypes", "mcp:read-only": "true"},
