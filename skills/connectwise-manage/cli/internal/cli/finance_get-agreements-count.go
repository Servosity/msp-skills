...
func newFinanceGetAgreementsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-count",
		Short:       "Get Count of Agreement",
		Example:     "  connectwise-manage-cli finance get-agreements-count",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-count", "pp:method": "GET", "pp:path": "/finance/agreements/count", "mcp:read-only": "true"},
