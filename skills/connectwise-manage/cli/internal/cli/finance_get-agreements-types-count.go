...
func newFinanceGetAgreementsTypesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-types-count",
		Short:       "Get Count of AgreementType",
		Example:     "  connectwise-manage-cli finance get-agreements-types-count",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-types-count", "pp:method": "GET", "pp:path": "/finance/agreements/types/count", "mcp:read-only": "true"},
