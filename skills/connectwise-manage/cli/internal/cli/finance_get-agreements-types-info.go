...
func newFinanceGetAgreementsTypesInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-types-info",
		Short:       "Get List of AgreementTypeInfo",
		Example:     "  connectwise-manage-cli finance get-agreements-types-info",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-types-info", "pp:method": "GET", "pp:path": "/finance/agreements/types/info", "mcp:read-only": "true"},
