...
func newFinanceGetAgreementsTypesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements-types",
		Short:       "Get List of AgreementType",
		Example:     "  connectwise-manage-cli finance get-agreements-types",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements-types", "pp:method": "GET", "pp:path": "/finance/agreements/types", "mcp:read-only": "true"},
