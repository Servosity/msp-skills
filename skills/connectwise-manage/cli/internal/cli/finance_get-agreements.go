...
func newFinanceGetAgreementsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-agreements",
		Aliases:     []string{"list"},
		Short:       "Get List of Agreement",
		Example:     "  connectwise-manage-cli finance get-agreements",
		Annotations: map[string]string{"pp:endpoint": "finance.get-agreements", "pp:method": "GET", "pp:path": "/finance/agreements", "mcp:read-only": "true"},
