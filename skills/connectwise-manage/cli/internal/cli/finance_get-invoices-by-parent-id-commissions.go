...
func newFinanceGetInvoicesByParentIdCommissionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-invoices-by-parent-id-commissions <parentId>",
		Short:       "Get List of InvoiceCommissions",
		Example:     "  connectwise-manage-cli finance get-invoices-by-parent-id-commissions 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-invoices-by-parent-id-commissions", "pp:method": "GET", "pp:path": "/finance/invoices/{parentId}/commissions", "mcp:read-only": "true"},
