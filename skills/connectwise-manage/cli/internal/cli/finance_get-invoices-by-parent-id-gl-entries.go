...
func newFinanceGetInvoicesByParentIdGlEntriesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-invoices-by-parent-id-gl-entries <parentId>",
		Short:       "Get List of GLEntries",
		Example:     "  connectwise-manage-cli finance get-invoices-by-parent-id-gl-entries 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-invoices-by-parent-id-gl-entries", "pp:method": "GET", "pp:path": "/finance/invoices/{parentId}/glEntries/", "mcp:read-only": "true"},
