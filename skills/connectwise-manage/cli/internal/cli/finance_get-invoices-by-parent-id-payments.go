...
func newFinanceGetInvoicesByParentIdPaymentsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-invoices-by-parent-id-payments <parentId>",
		Short:       "Get List of Payment",
		Example:     "  connectwise-manage-cli finance get-invoices-by-parent-id-payments 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-invoices-by-parent-id-payments", "pp:method": "GET", "pp:path": "/finance/invoices/{parentId}/payments", "mcp:read-only": "true"},
