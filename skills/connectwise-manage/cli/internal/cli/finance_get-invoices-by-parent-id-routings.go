...
func newFinanceGetInvoicesByParentIdRoutingsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-invoices-by-parent-id-routings <parentId>",
		Short:       "Get List of Invoice Routings",
		Example:     "  connectwise-manage-cli finance get-invoices-by-parent-id-routings 42",
		Annotations: map[string]string{"pp:endpoint": "finance.get-invoices-by-parent-id-routings", "pp:method": "GET", "pp:path": "/finance/invoices/{parentId}/routings", "mcp:read-only": "true"},
