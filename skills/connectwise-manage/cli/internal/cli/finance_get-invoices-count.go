...
func newFinanceGetInvoicesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Get Count of Invoice",
		Example:     "  connectwise-manage-cli finance get-invoices-count",
		Annotations: map[string]string{"pp:endpoint": "finance.get-invoices-count", "pp:method": "GET", "pp:path": "/finance/invoices/count", "mcp:read-only": "true"},
