...
func newFinanceGetInvoicesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-invoices",
		Short:       "Get List of Invoice",
		Example:     "  connectwise-manage-cli finance get-invoices",
		Annotations: map[string]string{"pp:endpoint": "finance.get-invoices", "pp:method": "GET", "pp:path": "/finance/invoices", "mcp:read-only": "true"},
