...
but do not stop the import.`,
  ...
  connectwise-manage-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  connectwise-manage-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | connectwise-manage-cli import <resource> --input -`,
