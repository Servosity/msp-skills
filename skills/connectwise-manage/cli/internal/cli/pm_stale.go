...
the specified number of days. Useful for identifying forgotten or blocked work.`,
  ...
  connectwise-manage-cli stale

  # Find items not updated in 14 days
  connectwise-manage-cli stale --days 14

  # Filter by team
  connectwise-manage-cli stale --days 7 --team backend

  # Output as JSON
  connectwise-manage-cli stale --days 30 --json`,
