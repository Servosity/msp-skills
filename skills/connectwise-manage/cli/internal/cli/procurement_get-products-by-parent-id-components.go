...
func newProcurementGetProductsByParentIdComponentsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-products-by-parent-id-components <parentId>",
		Short:       "Get List of ProductComponent",
		Example:     "  connectwise-manage-cli procurement get-products-by-parent-id-components 42",
		Annotations: map[string]string{"pp:endpoint": "procurement.get-products-by-parent-id-components", "pp:method": "GET", "pp:path": "/procurement/products/{parentId}/components", "mcp:read-only": "true"},
