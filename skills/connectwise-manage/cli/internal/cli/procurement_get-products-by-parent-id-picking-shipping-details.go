...
func newProcurementGetProductsByParentIdPickingShippingDetailsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-products-by-parent-id-picking-shipping-details <parentId>",
		Short:       "Get List of ProductPickingShippingDetail",
		Example:     "  connectwise-manage-cli procurement get-products-by-parent-id-picking-shipping-details 42",
		Annotations: map[string]string{"pp:endpoint": "procurement.get-products-by-parent-id-picking-shipping-details", "pp:method": "GET", "pp:path": "/procurement/products/{parentId}/pickingShippingDetails", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "procurement", path, map[string]string{
