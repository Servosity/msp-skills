...
func newProcurementGetProductsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Get Count of ProductItem",
		Example:     "  connectwise-manage-cli procurement get-products-count",
		Annotations: map[string]string{"pp:endpoint": "procurement.get-products-count", "pp:method": "GET", "pp:path": "/procurement/products/count", "mcp:read-only": "true"},
