...
func newProcurementGetProductsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-products",
		Aliases:     []string{"list"},
		Short:       "Get List of ProductItem",
		Example:     "  connectwise-manage-cli procurement get-products",
		Annotations: map[string]string{"pp:endpoint": "procurement.get-products", "pp:method": "GET", "pp:path": "/procurement/products", "mcp:read-only": "true"},
