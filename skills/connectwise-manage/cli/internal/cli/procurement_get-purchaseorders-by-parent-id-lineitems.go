...
func newProcurementGetPurchaseordersByParentIdLineitemsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-purchaseorders-by-parent-id-lineitems <parentId>",
		Short:       "Get List of PurchaseOrderLineItem",
		Example:     "  connectwise-manage-cli procurement get-purchaseorders-by-parent-id-lineitems 42",
		Annotations: map[string]string{"pp:endpoint": "procurement.get-purchaseorders-by-parent-id-lineitems", "pp:method": "GET", "pp:path": "/procurement/purchaseorders/{parentId}/lineitems", "mcp:read-only": "true"},
