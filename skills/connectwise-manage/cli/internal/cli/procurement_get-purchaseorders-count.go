...
func newProcurementGetPurchaseordersCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-purchaseorders-count",
		Short:       "Get Count of PurchaseOrder",
		Example:     "  connectwise-manage-cli procurement get-purchaseorders-count",
		Annotations: map[string]string{"pp:endpoint": "procurement.get-purchaseorders-count", "pp:method": "GET", "pp:path": "/procurement/purchaseorders/count", "mcp:read-only": "true"},
