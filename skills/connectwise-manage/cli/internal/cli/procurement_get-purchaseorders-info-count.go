...
func newProcurementGetPurchaseordersInfoCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-purchaseorders-info-count",
		Short:       "Get Count of PurchaseOrderInfo",
		Example:     "  connectwise-manage-cli procurement get-purchaseorders-info-count",
		Annotations: map[string]string{"pp:endpoint": "procurement.get-purchaseorders-info-count", "pp:method": "GET", "pp:path": "/procurement/purchaseorders/info/count", "mcp:read-only": "true"},
