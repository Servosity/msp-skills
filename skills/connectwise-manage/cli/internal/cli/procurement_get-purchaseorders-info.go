...
func newProcurementGetPurchaseordersInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-purchaseorders-info",
		Short:       "Get List of PurchaseOrderInfo",
		Example:     "  connectwise-manage-cli procurement get-purchaseorders-info",
		Annotations: map[string]string{"pp:endpoint": "procurement.get-purchaseorders-info", "pp:method": "GET", "pp:path": "/procurement/purchaseorders/info", "mcp:read-only": "true"},
