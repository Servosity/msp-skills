...
func newProcurementGetPurchaseordersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-purchaseorders",
		Short:       "Get List of PurchaseOrder",
		Example:     "  connectwise-manage-cli procurement get-purchaseorders",
		Annotations: map[string]string{"pp:endpoint": "procurement.get-purchaseorders", "pp:method": "GET", "pp:path": "/procurement/purchaseorders", "mcp:read-only": "true"},
