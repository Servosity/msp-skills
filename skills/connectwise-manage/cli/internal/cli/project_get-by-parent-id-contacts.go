...
func newProjectGetByParentIdContactsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-by-parent-id-contacts <parentId>",
		Short:       "Get List of ProjectContact",
		Example:     "  connectwise-manage-cli project get-by-parent-id-contacts 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-by-parent-id-contacts", "pp:method": "GET", "pp:path": "/project/projects/{parentId}/contacts", "mcp:read-only": "true"},
