...
func newProjectGetByParentIdNotesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-by-parent-id-notes <parentId>",
		Short:       "Get List of ProjectNote",
		Example:     "  connectwise-manage-cli project get-by-parent-id-notes 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-by-parent-id-notes", "pp:method": "GET", "pp:path": "/project/projects/{parentId}/notes", "mcp:read-only": "true"},
