...
func newProjectGetByParentIdPhasesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-by-parent-id-phases <parentId>",
		Short:       "Get List of ProjectPhase",
		Example:     "  connectwise-manage-cli project get-by-parent-id-phases 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-by-parent-id-phases", "pp:method": "GET", "pp:path": "/project/projects/{parentId}/phases", "mcp:read-only": "true"},
