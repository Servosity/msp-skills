...
func newProjectGetByParentIdTeamMembersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-by-parent-id-team-members <parentId>",
		Short:       "Get List of ProjectTeamMember",
		Example:     "  connectwise-manage-cli project get-by-parent-id-team-members 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-by-parent-id-team-members", "pp:method": "GET", "pp:path": "/project/projects/{parentId}/teamMembers", "mcp:read-only": "true"},
