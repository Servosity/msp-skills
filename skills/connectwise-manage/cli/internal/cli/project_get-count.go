...
func newProjectGetCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-count",
		Short:       "Get Count of ApiProject",
		Example:     "  connectwise-manage-cli project get-count",
		Annotations: map[string]string{"pp:endpoint": "project.get-count", "pp:method": "GET", "pp:path": "/project/projects/count", "mcp:read-only": "true"},
