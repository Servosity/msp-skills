...
func newProjectGetTicketsByParentIdActivitiesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-activities <parentId>",
		Short:       "Get List of ActivityReference Gets activities associated to the ticket Please use the /sales/activities?",
		Example:     "  connectwise-manage-cli project get-tickets-by-parent-id-activities 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets-by-parent-id-activities", "pp:method": "GET", "pp:path": "/project/tickets/{parentId}/activities", "mcp:read-only": "true"},
