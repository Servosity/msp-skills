...
func newProjectGetTicketsByParentIdAllNotesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Get List of ProjectTicketNote",
		Example:     "  connectwise-manage-cli project get-tickets-by-parent-id-all-notes 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets-by-parent-id-all-notes", "pp:method": "GET", "pp:path": "/project/tickets/{parentId}/allNotes", "mcp:read-only": "true"},
