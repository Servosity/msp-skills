...
func newProjectGetTicketsByParentIdConfigurationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  connectwise-manage-cli project get-tickets-by-parent-id-configurations 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets-by-parent-id-configurations", "pp:method": "GET", "pp:path": "/project/tickets/{parentId}/configurations", "mcp:read-only": "true"},
