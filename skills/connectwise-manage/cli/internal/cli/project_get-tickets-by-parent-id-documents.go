...
func newProjectGetTicketsByParentIdDocumentsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-documents <parentId>",
		Short:       "Get List of DocumentReference Gets the documents associated to the ticket Please use the /system/documents?",
		Example:     "  connectwise-manage-cli project get-tickets-by-parent-id-documents 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets-by-parent-id-documents", "pp:method": "GET", "pp:path": "/project/tickets/{parentId}/documents", "mcp:read-only": "true"},
