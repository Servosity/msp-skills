...
func newProjectGetTicketsByParentIdNotesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Get List of TicketNote",
		Example:     "  connectwise-manage-cli project get-tickets-by-parent-id-notes 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets-by-parent-id-notes", "pp:method": "GET", "pp:path": "/project/tickets/{parentId}/notes", "mcp:read-only": "true"},
