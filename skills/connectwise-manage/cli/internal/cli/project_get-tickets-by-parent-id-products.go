...
func newProjectGetTicketsByParentIdProductsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-products <parentId>",
		Short:       "Get List of ProductReference Gets the products associated to the ticket Please use the /procurement/products?",
		Example:     "  connectwise-manage-cli project get-tickets-by-parent-id-products 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets-by-parent-id-products", "pp:method": "GET", "pp:path": "/project/tickets/{parentId}/products", "mcp:read-only": "true"},
