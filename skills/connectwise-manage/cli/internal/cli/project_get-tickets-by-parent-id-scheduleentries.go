...
func newProjectGetTicketsByParentIdScheduleentriesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  connectwise-manage-cli project get-tickets-by-parent-id-scheduleentries 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets-by-parent-id-scheduleentries", "pp:method": "GET", "pp:path": "/project/tickets/{parentId}/scheduleentries", "mcp:read-only": "true"},
