...
func newProjectGetTicketsByParentIdTasksCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-tasks <parentId>",
		Short:       "Get List of TicketTask",
		Example:     "  connectwise-manage-cli project get-tickets-by-parent-id-tasks 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets-by-parent-id-tasks", "pp:method": "GET", "pp:path": "/project/tickets/{parentId}/tasks", "mcp:read-only": "true"},
