...
func newProjectGetTicketsByParentIdTimeentriesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  connectwise-manage-cli project get-tickets-by-parent-id-timeentries 42",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets-by-parent-id-timeentries", "pp:method": "GET", "pp:path": "/project/tickets/{parentId}/timeentries", "mcp:read-only": "true"},
