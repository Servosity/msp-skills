...
func newProjectGetTicketsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Get Count of ProjectTicket",
		Example:     "  connectwise-manage-cli project get-tickets-count",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets-count", "pp:method": "GET", "pp:path": "/project/tickets/count", "mcp:read-only": "true"},
