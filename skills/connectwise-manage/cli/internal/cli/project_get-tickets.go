...
func newProjectGetTicketsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets",
		Short:       "Get List of ProjectTicket",
		Example:     "  connectwise-manage-cli project get-tickets",
		Annotations: map[string]string{"pp:endpoint": "project.get-tickets", "pp:method": "GET", "pp:path": "/project/tickets", "mcp:read-only": "true"},
