...
func newProjectGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Aliases:     []string{"list"},
		Short:       "Get List of ApiProject",
		Example:     "  connectwise-manage-cli project get",
		Annotations: map[string]string{"pp:endpoint": "project.get", "pp:method": "GET", "pp:path": "/project/projects", "mcp:read-only": "true"},
