...
func newProjectPostByParentIdApplyTemplatesCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "post-by-parent-id-apply-templates <parentId>",
		Short:       "Post ApplyTemplates",
		Example:     "  connectwise-manage-cli project post-by-parent-id-apply-templates 42",
		Annotations: map[string]string{"pp:endpoint": "project.post-by-parent-id-apply-templates", "pp:method": "POST", "pp:path": "/project/projects/{parentId}/applyTemplates"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "project", data, "phases")
			}
