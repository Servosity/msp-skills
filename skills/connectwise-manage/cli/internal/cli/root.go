...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "connectwise-manage-cli",
		Short: `Connectwise Manage CLI — Every ConnectWise PSA workflow from the terminal — with a typed conditions query builder, offline SQLite sync, and cros…`,
		Long: `Connectwise Manage CLI — Every ConnectWise PSA workflow from the terminal — with a typed conditions query builder, offline SQLite sync, and cros…
...
Health check: run 'connectwise-manage-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("connectwise-manage-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'connectwise-manage-cli profile list')")
	...
	rootCmd.AddCommand(newProcurementCmd(flags))
	...
	rootCmd.AddCommand(newNovelConditionCmd(flags))
