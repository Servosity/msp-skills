...
func newSalesGetActivitiesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-activities-count",
		Short:       "Get Count of Activity",
		Example:     "  connectwise-manage-cli sales get-activities-count",
		Annotations: map[string]string{"pp:endpoint": "sales.get-activities-count", "pp:method": "GET", "pp:path": "/sales/activities/count", "mcp:read-only": "true"},
