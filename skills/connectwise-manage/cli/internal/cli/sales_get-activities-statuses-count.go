...
func newSalesGetActivitiesStatusesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-activities-statuses-count",
		Short:       "Get Count of ActivityStatus",
		Example:     "  connectwise-manage-cli sales get-activities-statuses-count",
		Annotations: map[string]string{"pp:endpoint": "sales.get-activities-statuses-count", "pp:method": "GET", "pp:path": "/sales/activities/statuses/count", "mcp:read-only": "true"},
