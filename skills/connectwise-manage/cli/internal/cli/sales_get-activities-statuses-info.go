...
func newSalesGetActivitiesStatusesInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-activities-statuses-info",
		Short:       "Get List of ActivityStatusInfos",
		Example:     "  connectwise-manage-cli sales get-activities-statuses-info",
		Annotations: map[string]string{"pp:endpoint": "sales.get-activities-statuses-info", "pp:method": "GET", "pp:path": "/sales/activities/statuses/info", "mcp:read-only": "true"},
