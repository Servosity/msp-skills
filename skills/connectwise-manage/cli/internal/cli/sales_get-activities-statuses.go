...
func newSalesGetActivitiesStatusesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-activities-statuses",
		Short:       "Get List of ActivityStatus",
		Example:     "  connectwise-manage-cli sales get-activities-statuses",
		Annotations: map[string]string{"pp:endpoint": "sales.get-activities-statuses", "pp:method": "GET", "pp:path": "/sales/activities/statuses", "mcp:read-only": "true"},
