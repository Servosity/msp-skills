...
func newSalesGetActivitiesTypesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-activities-types-count",
		Short:       "Get Count of ActivityType",
		Example:     "  connectwise-manage-cli sales get-activities-types-count",
		Annotations: map[string]string{"pp:endpoint": "sales.get-activities-types-count", "pp:method": "GET", "pp:path": "/sales/activities/types/count", "mcp:read-only": "true"},
