...
func newSalesGetActivitiesTypesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-activities-types",
		Short:       "Get List of ActivityType",
		Example:     "  connectwise-manage-cli sales get-activities-types",
		Annotations: map[string]string{"pp:endpoint": "sales.get-activities-types", "pp:method": "GET", "pp:path": "/sales/activities/types", "mcp:read-only": "true"},
