...
func newSalesGetActivitiesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-activities",
		Aliases:     []string{"list"},
		Short:       "Get List of Activity",
		Example:     "  connectwise-manage-cli sales get-activities",
		Annotations: map[string]string{"pp:endpoint": "sales.get-activities", "pp:method": "GET", "pp:path": "/sales/activities", "mcp:read-only": "true"},
