...
func newSalesGetOpportunitiesByParentIdContactsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-by-parent-id-contacts <parentId>",
		Short:       "Get List of OpportunityContact",
		Example:     "  connectwise-manage-cli sales get-opportunities-by-parent-id-contacts 42",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-by-parent-id-contacts", "pp:method": "GET", "pp:path": "/sales/opportunities/{parentId}/contacts", "mcp:read-only": "true"},
