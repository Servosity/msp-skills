...
func newSalesGetOpportunitiesByParentIdForecastCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-by-parent-id-forecast <parentId>",
		Short:       "Get List of Forecast",
		Example:     "  connectwise-manage-cli sales get-opportunities-by-parent-id-forecast 42",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-by-parent-id-forecast", "pp:method": "GET", "pp:path": "/sales/opportunities/{parentId}/forecast", "mcp:read-only": "true"},
