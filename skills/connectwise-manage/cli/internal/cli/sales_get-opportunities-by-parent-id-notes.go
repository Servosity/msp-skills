...
func newSalesGetOpportunitiesByParentIdNotesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-by-parent-id-notes <parentId>",
		Short:       "Get List of OpportunityNote",
		Example:     "  connectwise-manage-cli sales get-opportunities-by-parent-id-notes 42",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-by-parent-id-notes", "pp:method": "GET", "pp:path": "/sales/opportunities/{parentId}/notes", "mcp:read-only": "true"},
