...
func newSalesGetOpportunitiesByParentIdTeamCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-by-parent-id-team <parentId>",
		Short:       "Get List of Team",
		Example:     "  connectwise-manage-cli sales get-opportunities-by-parent-id-team 42",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-by-parent-id-team", "pp:method": "GET", "pp:path": "/sales/opportunities/{parentId}/team", "mcp:read-only": "true"},
