...
func newSalesGetOpportunitiesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-count",
		Short:       "Get Count of ConnectWise.Apis.v3_0.v2015_3.Sales.Opportunity.Opportunity",
		Example:     "  connectwise-manage-cli sales get-opportunities-count",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-count", "pp:method": "GET", "pp:path": "/sales/opportunities/count", "mcp:read-only": "true"},
