...
func newSalesGetOpportunitiesDefaultCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-default",
		Short:       "Get ConnectWise.Apis.v3_0.v2015_3.Sales.Opportunity.Opportunity",
		Example:     "  connectwise-manage-cli sales get-opportunities-default",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-default", "pp:method": "GET", "pp:path": "/sales/opportunities/default", "mcp:read-only": "true"},
