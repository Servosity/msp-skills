...
func newSalesGetOpportunitiesRatingsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-ratings-count",
		Short:       "Get Count of OpportunityRating",
		Example:     "  connectwise-manage-cli sales get-opportunities-ratings-count",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-ratings-count", "pp:method": "GET", "pp:path": "/sales/opportunities/ratings/count", "mcp:read-only": "true"},
