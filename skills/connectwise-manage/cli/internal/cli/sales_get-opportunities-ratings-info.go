...
func newSalesGetOpportunitiesRatingsInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-ratings-info",
		Short:       "Get List of OpportunityRatingInfo",
		Example:     "  connectwise-manage-cli sales get-opportunities-ratings-info",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-ratings-info", "pp:method": "GET", "pp:path": "/sales/opportunities/ratings/info", "mcp:read-only": "true"},
