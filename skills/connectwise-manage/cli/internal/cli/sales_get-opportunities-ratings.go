...
func newSalesGetOpportunitiesRatingsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-ratings",
		Short:       "Get List of OpportunityRating",
		Example:     "  connectwise-manage-cli sales get-opportunities-ratings",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-ratings", "pp:method": "GET", "pp:path": "/sales/opportunities/ratings", "mcp:read-only": "true"},
