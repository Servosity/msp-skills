...
func newSalesGetOpportunitiesStatusesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-statuses-count",
		Short:       "Get Count of OpportunityStatus",
		Example:     "  connectwise-manage-cli sales get-opportunities-statuses-count",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-statuses-count", "pp:method": "GET", "pp:path": "/sales/opportunities/statuses/count", "mcp:read-only": "true"},
