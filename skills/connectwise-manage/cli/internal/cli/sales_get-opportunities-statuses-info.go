...
func newSalesGetOpportunitiesStatusesInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-statuses-info",
		Short:       "Get List of OpportunityStatusInfos",
		Example:     "  connectwise-manage-cli sales get-opportunities-statuses-info",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-statuses-info", "pp:method": "GET", "pp:path": "/sales/opportunities/statuses/info", "mcp:read-only": "true"},
