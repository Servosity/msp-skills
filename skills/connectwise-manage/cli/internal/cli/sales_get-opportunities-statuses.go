...
func newSalesGetOpportunitiesStatusesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-statuses",
		Short:       "Get List of OpportunityStatus",
		Example:     "  connectwise-manage-cli sales get-opportunities-statuses",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-statuses", "pp:method": "GET", "pp:path": "/sales/opportunities/statuses", "mcp:read-only": "true"},
