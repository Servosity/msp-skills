...
func newSalesGetOpportunitiesTypesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-types-count",
		Short:       "Get Count of OpportunityType",
		Example:     "  connectwise-manage-cli sales get-opportunities-types-count",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-types-count", "pp:method": "GET", "pp:path": "/sales/opportunities/types/count", "mcp:read-only": "true"},
