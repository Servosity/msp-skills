...
func newSalesGetOpportunitiesTypesInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-types-info",
		Short:       "Get List of OpportunityTypeInfos",
		Example:     "  connectwise-manage-cli sales get-opportunities-types-info",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-types-info", "pp:method": "GET", "pp:path": "/sales/opportunities/types/info", "mcp:read-only": "true"},
