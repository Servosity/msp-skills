...
func newSalesGetOpportunitiesTypesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities-types",
		Short:       "Get List of OpportunityType",
		Example:     "  connectwise-manage-cli sales get-opportunities-types",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities-types", "pp:method": "GET", "pp:path": "/sales/opportunities/types", "mcp:read-only": "true"},
