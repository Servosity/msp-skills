...
func newSalesGetOpportunitiesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-opportunities",
		Short:       "Get List of ConnectWise.Apis.v3_0.v2015_3.Sales.Opportunity.Opportunity",
		Example:     "  connectwise-manage-cli sales get-opportunities",
		Annotations: map[string]string{"pp:endpoint": "sales.get-opportunities", "pp:method": "GET", "pp:path": "/sales/opportunities", "mcp:read-only": "true"},
