...
func newSalesPatchOpportunitiesByParentIdForecastCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "patch-opportunities-by-parent-id-forecast <parentId>",
		Short:       "Patch Forecast",
		Example:     "  connectwise-manage-cli sales patch-opportunities-by-parent-id-forecast 42",
		Annotations: map[string]string{"pp:endpoint": "sales.patch-opportunities-by-parent-id-forecast", "pp:method": "PATCH", "pp:path": "/sales/opportunities/{parentId}/forecast/"},
