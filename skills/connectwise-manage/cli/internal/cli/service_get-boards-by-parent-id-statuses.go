...
func newServiceGetBoardsByParentIdStatusesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-boards-by-parent-id-statuses <parentId>",
		Short:       "Get List of BoardStatus",
		Example:     "  connectwise-manage-cli service get-boards-by-parent-id-statuses 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-boards-by-parent-id-statuses", "pp:method": "GET", "pp:path": "/service/boards/{parentId}/statuses", "mcp:read-only": "true"},
