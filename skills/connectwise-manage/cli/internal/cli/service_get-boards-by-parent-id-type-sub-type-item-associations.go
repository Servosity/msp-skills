...
func newServiceGetBoardsByParentIdTypeSubTypeItemAssociationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-boards-by-parent-id-type-sub-type-item-associations <parentId>",
		Short:       "Get List of BoardTypeSubTypeItemAssociation",
		Example:     "  connectwise-manage-cli service get-boards-by-parent-id-type-sub-type-item-associations 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-boards-by-parent-id-type-sub-type-item-associations", "pp:method": "GET", "pp:path": "/service/boards/{parentId}/typeSubTypeItemAssociations", "mcp:read-only": "true"},
