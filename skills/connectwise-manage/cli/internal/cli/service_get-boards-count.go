...
func newServiceGetBoardsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-boards-count",
		Short:       "Get Count of Board",
		Example:     "  connectwise-manage-cli service get-boards-count",
		Annotations: map[string]string{"pp:endpoint": "service.get-boards-count", "pp:method": "GET", "pp:path": "/service/boards/count", "mcp:read-only": "true"},
