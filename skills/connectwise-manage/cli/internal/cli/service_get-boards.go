...
func newServiceGetBoardsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-boards",
		Aliases:     []string{"list"},
		Short:       "Get List of Board",
		Example:     "  connectwise-manage-cli service get-boards",
		Annotations: map[string]string{"pp:endpoint": "service.get-boards", "pp:method": "GET", "pp:path": "/service/boards", "mcp:read-only": "true"},
