...
func newServiceGetPrioritiesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-priorities-count",
		Short:       "Get Count of Priority",
		Example:     "  connectwise-manage-cli service get-priorities-count",
		Annotations: map[string]string{"pp:endpoint": "service.get-priorities-count", "pp:method": "GET", "pp:path": "/service/priorities/count", "mcp:read-only": "true"},
