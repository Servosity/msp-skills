...
func newServiceGetPrioritiesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-priorities",
		Short:       "Get List of Priority",
		Example:     "  connectwise-manage-cli service get-priorities",
		Annotations: map[string]string{"pp:endpoint": "service.get-priorities", "pp:method": "GET", "pp:path": "/service/priorities", "mcp:read-only": "true"},
