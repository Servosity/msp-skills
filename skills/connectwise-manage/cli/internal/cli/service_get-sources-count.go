...
func newServiceGetSourcesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-sources-count",
		Short:       "Get Count of Source",
		Example:     "  connectwise-manage-cli service get-sources-count",
		Annotations: map[string]string{"pp:endpoint": "service.get-sources-count", "pp:method": "GET", "pp:path": "/service/sources/count", "mcp:read-only": "true"},
