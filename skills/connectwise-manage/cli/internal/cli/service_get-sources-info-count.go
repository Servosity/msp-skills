...
func newServiceGetSourcesInfoCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-sources-info-count",
		Short:       "Get Count of SourceInfo",
		Example:     "  connectwise-manage-cli service get-sources-info-count",
		Annotations: map[string]string{"pp:endpoint": "service.get-sources-info-count", "pp:method": "GET", "pp:path": "/service/sources/info/count", "mcp:read-only": "true"},
