...
func newServiceGetSourcesInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-sources-info",
		Short:       "Get List of SourceInfos",
		Example:     "  connectwise-manage-cli service get-sources-info",
		Annotations: map[string]string{"pp:endpoint": "service.get-sources-info", "pp:method": "GET", "pp:path": "/service/sources/info", "mcp:read-only": "true"},
