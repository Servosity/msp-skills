...
func newServiceGetSourcesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-sources",
		Short:       "Get List of Source",
		Example:     "  connectwise-manage-cli service get-sources",
		Annotations: map[string]string{"pp:endpoint": "service.get-sources", "pp:method": "GET", "pp:path": "/service/sources", "mcp:read-only": "true"},
