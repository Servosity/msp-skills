...
func newServiceGetTicketsByParentIdActivitiesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-activities-count <parentId>",
		Short:       "Get Count of ActivityReference Gets count of activities associated to the ticket Please use the /sales/activities/count?",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-activities-count 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-activities-count", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/activities/count", "mcp:read-only": "true"},
