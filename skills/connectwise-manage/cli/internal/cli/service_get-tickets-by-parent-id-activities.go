...
func newServiceGetTicketsByParentIdActivitiesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-activities 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-activities", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/activities", "mcp:read-only": "true"},
