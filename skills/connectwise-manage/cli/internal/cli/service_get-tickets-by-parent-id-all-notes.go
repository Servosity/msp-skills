...
func newServiceGetTicketsByParentIdAllNotesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-all-notes <parentId>",
		Short:       "Get List of ServiceTicketNote",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-all-notes 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-all-notes", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/allNotes", "mcp:read-only": "true"},
