...
func newServiceGetTicketsByParentIdConfigurationsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-configurations-count <parentId>",
		Short:       "Get Count of ConfigurationReference",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-configurations-count 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-configurations-count", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/configurations/count", "mcp:read-only": "true"},
