...
func newServiceGetTicketsByParentIdConfigurationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-configurations <parentId>",
		Short:       "Get List of ConfigurationReference",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-configurations 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-configurations", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/configurations", "mcp:read-only": "true"},
