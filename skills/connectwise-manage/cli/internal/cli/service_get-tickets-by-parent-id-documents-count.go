...
func newServiceGetTicketsByParentIdDocumentsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-documents-count <parentId>",
		Short:       "Get Count of DocumentReference",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-documents-count 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-documents-count", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/documents/count", "mcp:read-only": "true"},
