...
func newServiceGetTicketsByParentIdDocumentsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-documents 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-documents", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/documents", "mcp:read-only": "true"},
