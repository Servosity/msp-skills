...
func newServiceGetTicketsByParentIdNotesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-notes-count <parentId>",
		Short:       "Get Count of ServiceNote",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-notes-count 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-notes-count", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/notes/count", "mcp:read-only": "true"},
