...
func newServiceGetTicketsByParentIdNotesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-notes <parentId>",
		Short:       "Get List of ServiceNote",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-notes 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-notes", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/notes", "mcp:read-only": "true"},
