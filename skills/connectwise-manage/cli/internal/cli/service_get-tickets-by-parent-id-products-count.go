...
func newServiceGetTicketsByParentIdProductsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-products-count <parentId>",
		Short:       "Get Count of ProductReference Gets the products associated to the ticket Please use the /procurement/products/count?",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-products-count 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-products-count", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/products/count", "mcp:read-only": "true"},
