...
func newServiceGetTicketsByParentIdProductsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-products 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-products", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/products", "mcp:read-only": "true"},
