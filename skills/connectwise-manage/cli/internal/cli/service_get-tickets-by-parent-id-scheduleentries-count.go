...
func newServiceGetTicketsByParentIdScheduleentriesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-scheduleentries-count <parentId>",
		Short:       "Get Count of ScheduleEntryReference Gets the schedule entries count associated to the ticket Please use the",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-scheduleentries-count 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-scheduleentries-count", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/scheduleentries/count", "mcp:read-only": "true"},
