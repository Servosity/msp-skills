...
func newServiceGetTicketsByParentIdScheduleentriesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-scheduleentries <parentId>",
		Short:       "Get List of ScheduleEntryReference Gets the schedule entries associated to the ticket Please use the /schedule/entries?",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-scheduleentries 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-scheduleentries", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/scheduleentries", "mcp:read-only": "true"},
