...
func newServiceGetTicketsByParentIdTasksCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-tasks-count <parentId>",
		Short:       "Get Count of Task",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-tasks-count 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-tasks-count", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/tasks/count", "mcp:read-only": "true"},
