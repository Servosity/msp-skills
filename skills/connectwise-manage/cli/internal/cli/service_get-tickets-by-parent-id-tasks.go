...
func newServiceGetTicketsByParentIdTasksCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Get List of Task",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-tasks 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-tasks", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/tasks", "mcp:read-only": "true"},
