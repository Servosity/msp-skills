...
func newServiceGetTicketsByParentIdTimeentriesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-timeentries-count <parentId>",
		Short:       "Get Count of TimeEntryReference Gets time entries count associated to the ticket Please use the /time/entries/count?",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-timeentries-count 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-timeentries-count", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/timeentries/count", "mcp:read-only": "true"},
