...
func newServiceGetTicketsByParentIdTimeentriesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-by-parent-id-timeentries <parentId>",
		Short:       "Get List of TimeEntryReference Gets time entries associated to the ticket Please use the /time/entries?",
		Example:     "  connectwise-manage-cli service get-tickets-by-parent-id-timeentries 42",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-by-parent-id-timeentries", "pp:method": "GET", "pp:path": "/service/tickets/{parentId}/timeentries", "mcp:read-only": "true"},
