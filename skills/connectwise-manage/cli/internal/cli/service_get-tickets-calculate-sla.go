...
func newServiceGetTicketsCalculateSlaCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-calculate-sla",
		Short:       "Get List of ConnectWise.Apis.v3_0.v2015_3.Service.Ticket.Ticket with SLA calculated",
		Example:     "  connectwise-manage-cli service get-tickets-calculate-sla",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-calculate-sla", "pp:method": "GET", "pp:path": "/service/tickets/calculateSla", "mcp:read-only": "true"},
