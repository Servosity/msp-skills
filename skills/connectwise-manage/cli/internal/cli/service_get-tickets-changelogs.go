...
func newServiceGetTicketsChangelogsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-changelogs",
		Short:       "Get List of Ticket Change Log",
		Example:     "  connectwise-manage-cli service get-tickets-changelogs",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-changelogs", "pp:method": "GET", "pp:path": "/service/tickets/changelogs", "mcp:read-only": "true"},
