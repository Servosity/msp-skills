...
func newServiceGetTicketsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Get Count of ConnectWise.Apis.v3_0.v2015_3.Service.Ticket.Ticket",
		Example:     "  connectwise-manage-cli service get-tickets-count",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-count", "pp:method": "GET", "pp:path": "/service/tickets/count", "mcp:read-only": "true"},
