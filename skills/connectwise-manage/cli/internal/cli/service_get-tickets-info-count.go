...
func newServiceGetTicketsInfoCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-info-count",
		Short:       "Get Count of TicketInfo",
		Example:     "  connectwise-manage-cli service get-tickets-info-count",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-info-count", "pp:method": "GET", "pp:path": "/service/tickets/info/count", "mcp:read-only": "true"},
