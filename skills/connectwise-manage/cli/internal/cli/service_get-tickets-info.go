...
func newServiceGetTicketsInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-tickets-info",
		Short:       "Get List of TicketInfos",
		Example:     "  connectwise-manage-cli service get-tickets-info",
		Annotations: map[string]string{"pp:endpoint": "service.get-tickets-info", "pp:method": "GET", "pp:path": "/service/tickets/info", "mcp:read-only": "true"},
