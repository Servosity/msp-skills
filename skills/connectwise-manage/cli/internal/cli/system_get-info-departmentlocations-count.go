...
func newSystemGetInfoDepartmentlocationsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-departmentlocations-count",
		Short:       "Get Count of DepartmentLocationInfo",
		Example:     "  connectwise-manage-cli system get-info-departmentlocations-count",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-departmentlocations-count", "pp:method": "GET", "pp:path": "/system/info/departmentlocations/count", "mcp:read-only": "true"},
