...
func newSystemGetInfoDepartmentlocationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-departmentlocations",
		Short:       "Get List of DepartmentLocationInfo",
		Example:     "  connectwise-manage-cli system get-info-departmentlocations",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-departmentlocations", "pp:method": "GET", "pp:path": "/system/info/departmentlocations", "mcp:read-only": "true"},
