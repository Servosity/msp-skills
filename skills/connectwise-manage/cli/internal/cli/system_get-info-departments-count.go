...
func newSystemGetInfoDepartmentsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-departments-count",
		Short:       "Get Count of DepartmentInfo",
		Example:     "  connectwise-manage-cli system get-info-departments-count",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-departments-count", "pp:method": "GET", "pp:path": "/system/info/departments/count", "mcp:read-only": "true"},
