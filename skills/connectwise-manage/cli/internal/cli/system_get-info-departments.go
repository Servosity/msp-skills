...
func newSystemGetInfoDepartmentsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-departments",
		Short:       "Get List of DepartmentInfo",
		Example:     "  connectwise-manage-cli system get-info-departments",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-departments", "pp:method": "GET", "pp:path": "/system/info/departments", "mcp:read-only": "true"},
