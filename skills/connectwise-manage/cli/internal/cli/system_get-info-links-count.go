...
func newSystemGetInfoLinksCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-links-count",
		Short:       "Get Count of LinkInfo",
		Example:     "  connectwise-manage-cli system get-info-links-count",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-links-count", "pp:method": "GET", "pp:path": "/system/info/links/count", "mcp:read-only": "true"},
