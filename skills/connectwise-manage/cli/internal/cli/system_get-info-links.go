...
func newSystemGetInfoLinksCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-links",
		Short:       "Get List of LinkInfo",
		Example:     "  connectwise-manage-cli system get-info-links",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-links", "pp:method": "GET", "pp:path": "/system/info/links", "mcp:read-only": "true"},
