...
func newSystemGetInfoLocalesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-locales-count",
		Short:       "Get Count of LocaleInfo",
		Example:     "  connectwise-manage-cli system get-info-locales-count",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-locales-count", "pp:method": "GET", "pp:path": "/system/info/locales/count", "mcp:read-only": "true"},
