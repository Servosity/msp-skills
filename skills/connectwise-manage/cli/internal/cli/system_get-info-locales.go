...
func newSystemGetInfoLocalesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-locales",
		Short:       "Get List of LocaleInfo",
		Example:     "  connectwise-manage-cli system get-info-locales",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-locales", "pp:method": "GET", "pp:path": "/system/info/locales", "mcp:read-only": "true"},
