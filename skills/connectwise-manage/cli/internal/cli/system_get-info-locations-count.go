...
func newSystemGetInfoLocationsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-locations-count",
		Short:       "Get Count of LocationInfo",
		Example:     "  connectwise-manage-cli system get-info-locations-count",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-locations-count", "pp:method": "GET", "pp:path": "/system/info/locations/count", "mcp:read-only": "true"},
