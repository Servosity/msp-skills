...
func newSystemGetInfoLocationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-locations",
		Short:       "Get List of LocationInfo",
		Example:     "  connectwise-manage-cli system get-info-locations",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-locations", "pp:method": "GET", "pp:path": "/system/info/locations", "mcp:read-only": "true"},
