...
func newSystemGetInfoMembersCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-members-count",
		Short:       "Get Count of MemberInfo",
		Example:     "  connectwise-manage-cli system get-info-members-count",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-members-count", "pp:method": "GET", "pp:path": "/system/info/members/count", "mcp:read-only": "true"},
