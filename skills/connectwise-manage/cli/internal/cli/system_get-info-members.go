...
func newSystemGetInfoMembersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-members",
		Short:       "Get List of MemberInfo",
		Example:     "  connectwise-manage-cli system get-info-members",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-members", "pp:method": "GET", "pp:path": "/system/info/members", "mcp:read-only": "true"},
