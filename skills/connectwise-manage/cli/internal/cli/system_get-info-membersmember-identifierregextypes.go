...
func newSystemGetInfoMembersmemberIdentifierregextypesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-membersmember-identifierregextypes",
		Short:       "Get MemberInfo",
		Example:     "  connectwise-manage-cli system get-info-membersmember-identifierregextypes",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-membersmember-identifierregextypes", "pp:method": "GET", "pp:path": "/system/info/members/{memberIdentifier:regex(^(types. |(", "mcp:read-only": "true"},
