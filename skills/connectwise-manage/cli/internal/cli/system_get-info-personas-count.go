...
func newSystemGetInfoPersonasCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-personas-count",
		Short:       "Get Count of PersonasInfo",
		Example:     "  connectwise-manage-cli system get-info-personas-count",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-personas-count", "pp:method": "GET", "pp:path": "/system/info/personas/count", "mcp:read-only": "true"},
