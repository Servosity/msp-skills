...
func newSystemGetInfoPersonasCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-personas",
		Short:       "Get List of PersonasInfo",
		Example:     "  connectwise-manage-cli system get-info-personas",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-personas", "pp:method": "GET", "pp:path": "/system/info/personas", "mcp:read-only": "true"},
