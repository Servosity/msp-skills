...
func newSystemGetInfoStandardNotesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-standard-notes-count",
		Short:       "Get Count of StandardNoteInfo",
		Example:     "  connectwise-manage-cli system get-info-standard-notes-count",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-standard-notes-count", "pp:method": "GET", "pp:path": "/system/info/standardNotes/count", "mcp:read-only": "true"},
