...
func newSystemGetInfoStandardNotesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-info-standard-notes",
		Short:       "Get List of StandardNoteInfo",
		Example:     "  connectwise-manage-cli system get-info-standard-notes",
		Annotations: map[string]string{"pp:endpoint": "system.get-info-standard-notes", "pp:method": "GET", "pp:path": "/system/info/standardNotes", "mcp:read-only": "true"},
