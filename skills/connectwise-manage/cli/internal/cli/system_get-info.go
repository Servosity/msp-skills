...
func newSystemGetInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Aliases:     []string{"list"},
		Short:       "Get Info",
		Example:     "  connectwise-manage-cli system get-info",
		Annotations: map[string]string{"pp:endpoint": "system.get-info", "pp:method": "GET", "pp:path": "/system/info", "mcp:read-only": "true"},
