...
func newSystemGetMembersByParentIdCertificationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-by-parent-id-certifications <parentId>",
		Short:       "Get List of MemberCertification",
		Example:     "  connectwise-manage-cli system get-members-by-parent-id-certifications 42",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-by-parent-id-certifications", "pp:method": "GET", "pp:path": "/system/members/{parentId}/certifications", "mcp:read-only": "true"},
