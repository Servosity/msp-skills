...
func newSystemGetMembersByParentIdManagedDeviceAccountsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-by-parent-id-managed-device-accounts <parentId>",
		Short:       "Get List of ManagedDeviceAccount",
		Example:     "  connectwise-manage-cli system get-members-by-parent-id-managed-device-accounts 42",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-by-parent-id-managed-device-accounts", "pp:method": "GET", "pp:path": "/system/members/{parentId}/managedDeviceAccounts", "mcp:read-only": "true"},
