...
func newSystemGetMembersByParentIdMycertificationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-by-parent-id-mycertifications <parentId>",
		Short:       "Get List of MemberCertification",
		Example:     "  connectwise-manage-cli system get-members-by-parent-id-mycertifications 42",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-by-parent-id-mycertifications", "pp:method": "GET", "pp:path": "/system/members/{parentId}/mycertifications", "mcp:read-only": "true"},
