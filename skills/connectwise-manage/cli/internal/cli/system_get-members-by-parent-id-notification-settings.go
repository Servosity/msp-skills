...
func newSystemGetMembersByParentIdNotificationSettingsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-by-parent-id-notification-settings <parentId>",
		Short:       "Get List of MemberNotificationSetting",
		Example:     "  connectwise-manage-cli system get-members-by-parent-id-notification-settings 42",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-by-parent-id-notification-settings", "pp:method": "GET", "pp:path": "/system/members/{parentId}/notificationSettings", "mcp:read-only": "true"},
