...
func newSystemGetMembersByParentIdPersonasCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-by-parent-id-personas <parentId>",
		Short:       "Get List of MemberPersona",
		Example:     "  connectwise-manage-cli system get-members-by-parent-id-personas 42",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-by-parent-id-personas", "pp:method": "GET", "pp:path": "/system/members/{parentId}/personas", "mcp:read-only": "true"},
