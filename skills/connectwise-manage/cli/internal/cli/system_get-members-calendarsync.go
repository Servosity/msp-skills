...
func newSystemGetMembersCalendarsyncCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-calendarsync",
		Short:       "Get List of Member to be use for calendar sync subscriptions",
		Example:     "  connectwise-manage-cli system get-members-calendarsync",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-calendarsync", "pp:method": "GET", "pp:path": "/system/members/calendarsync", "mcp:read-only": "true"},
