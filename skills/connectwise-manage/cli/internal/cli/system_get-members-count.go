...
func newSystemGetMembersCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-count",
		Short:       "Get Count of Usage",
		Example:     "  connectwise-manage-cli system get-members-count",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-count", "pp:method": "GET", "pp:path": "/system/members/count", "mcp:read-only": "true"},
