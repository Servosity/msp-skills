...
func newSystemGetMembersTypesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-types-count",
		Short:       "Get Count of MemberType",
		Example:     "  connectwise-manage-cli system get-members-types-count",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-types-count", "pp:method": "GET", "pp:path": "/system/members/types/count", "mcp:read-only": "true"},
