...
func newSystemGetMembersTypesInfoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-types-info",
		Short:       "Get List of MemberType",
		Example:     "  connectwise-manage-cli system get-members-types-info",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-types-info", "pp:method": "GET", "pp:path": "/system/members/types/info", "mcp:read-only": "true"},
