...
func newSystemGetMembersTypesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-types",
		Short:       "Get List of MemberType",
		Example:     "  connectwise-manage-cli system get-members-types",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-types", "pp:method": "GET", "pp:path": "/system/members/types", "mcp:read-only": "true"},
