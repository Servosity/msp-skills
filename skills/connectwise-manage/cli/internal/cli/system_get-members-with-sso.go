...
func newSystemGetMembersWithSsoCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-members-with-sso",
		Short:       "Get List of Member",
		Example:     "  connectwise-manage-cli system get-members-with-sso",
		Annotations: map[string]string{"pp:endpoint": "system.get-members-with-sso", "pp:method": "GET", "pp:path": "/system/members/withSso", "mcp:read-only": "true"},
