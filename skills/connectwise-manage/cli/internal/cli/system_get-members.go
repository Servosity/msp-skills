...
func newSystemGetMembersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  connectwise-manage-cli system get-members",
		Annotations: map[string]string{"pp:endpoint": "system.get-members", "pp:method": "GET", "pp:path": "/system/members", "mcp:read-only": "true"},
