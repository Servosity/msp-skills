...
native streaming instead of polling.`,
  ...
  connectwise-manage-cli tail --interval 10s

  # Tail a specific resource
  connectwise-manage-cli tail messages --interval 5s

  # Pipe to jq for filtering
  connectwise-manage-cli tail events --interval 30s | jq 'select(.type == "error")'`,
