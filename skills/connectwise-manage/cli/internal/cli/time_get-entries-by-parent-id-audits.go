...
func newTimeGetEntriesByParentIdAuditsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-entries-by-parent-id-audits <parentId>",
		Short:       "Get List of TimeEntryAudit",
		Example:     "  connectwise-manage-cli time get-entries-by-parent-id-audits 42",
		Annotations: map[string]string{"pp:endpoint": "time.get-entries-by-parent-id-audits", "pp:method": "GET", "pp:path": "/time/entries/{parentId}/audits", "mcp:read-only": "true"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolvePaginatedReadWithStrategy(cmd.Context(), c, flags, "auto", "time", path, map[string]string{
