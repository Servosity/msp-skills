...
func newTimeGetEntriesCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-entries-count",
		Short:       "Get Count of TimeEntry",
		Example:     "  connectwise-manage-cli time get-entries-count",
		Annotations: map[string]string{"pp:endpoint": "time.get-entries-count", "pp:method": "GET", "pp:path": "/time/entries/count", "mcp:read-only": "true"},
