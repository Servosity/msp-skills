...
func newTimeGetEntriesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-entries",
		Aliases:     []string{"list"},
		Short:       "Get List of TimeEntry",
		Example:     "  connectwise-manage-cli time get-entries",
		Annotations: map[string]string{"pp:endpoint": "time.get-entries", "pp:method": "GET", "pp:path": "/time/entries", "mcp:read-only": "true"},
