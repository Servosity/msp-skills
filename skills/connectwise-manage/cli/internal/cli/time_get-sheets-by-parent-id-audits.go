...
func newTimeGetSheetsByParentIdAuditsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-sheets-by-parent-id-audits <parentId>",
		Short:       "Get List of TimeSheetAudit",
		Example:     "  connectwise-manage-cli time get-sheets-by-parent-id-audits 42",
		Annotations: map[string]string{"pp:endpoint": "time.get-sheets-by-parent-id-audits", "pp:method": "GET", "pp:path": "/time/sheets/{parentId}/audits", "mcp:read-only": "true"},
