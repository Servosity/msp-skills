...
func newTimeGetSheetsCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-sheets-count",
		Short:       "Get Count of TimeSheet",
		Example:     "  connectwise-manage-cli time get-sheets-count",
		Annotations: map[string]string{"pp:endpoint": "time.get-sheets-count", "pp:method": "GET", "pp:path": "/time/sheets/count", "mcp:read-only": "true"},
