...
func newTimeGetSheetsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-sheets",
		Short:       "Get List of TimeSheet",
		Example:     "  connectwise-manage-cli time get-sheets",
		Annotations: map[string]string{"pp:endpoint": "time.get-sheets", "pp:method": "GET", "pp:path": "/time/sheets", "mcp:read-only": "true"},
