...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  connectwise-manage-cli which "stale tickets"
  connectwise-manage-cli which "bottleneck"
  connectwise-manage-cli which --limit 1 "send message"
  connectwise-manage-cli which                                # list the full capability index`,
