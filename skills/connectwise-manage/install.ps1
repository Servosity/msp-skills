...
$Skill   = "connectwise-manage"
$CliBin  = "connectwise-manage-cli.exe"
$McpBin  = "connectwise-manage-mcp.exe"
...
Write-Host "  connectwise-manage-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/connectwise-manage#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/connectwise-manage/mcp-install.md"
