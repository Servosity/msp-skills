#!/usr/bin/env bash
# install.sh - install connectwise-manage-cli and connectwise-manage-mcp on macOS / Linux.
#
...
CLI_BIN="connectwise-manage-cli"
MCP_BIN="connectwise-manage-mcp"
...
echo ""
echo "Next:"
echo "  Read skills/${SKILL}/README.md for first command + auth."
echo "  For Claude Desktop or ChatGPT, read skills/${SKILL}/mcp-install.md."
