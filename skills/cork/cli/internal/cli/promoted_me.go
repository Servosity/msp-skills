...
func newMePromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "me",
		Short:       "Information on the authenticated user",
		Long:        "Information on the authenticated user",
		Example:     "  cork-cli me",
		Annotations: map[string]string{"pp:endpoint": "me.who-am-i", "pp:method": "GET", "pp:path": "/me", "mcp:read-only": "true"},
