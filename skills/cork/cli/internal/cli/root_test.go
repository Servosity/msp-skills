...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		"clients",
		"clients devices",
		"clients devices get-client",
		"clients domains",
		"clients domains get-client",
		"clients inboxes",
		"clients inboxes get-clients",
		"clients score-history",
		"clients score-history get-client",
		"compliance",
		"compliance get-event-notification-settings",
		"compliance get-event-types",
		"compliance get-events",
		"distributor",
		"distributor get-partners",
		"distributor provision-partner",
		"integrations",
		"integrations connect",
		"integrations credentials",
		"integrations credentials get-integration",
		"integrations delete",
		"integrations devices",
		"integrations devices get-integration",
		"integrations get-available",
		"integrations get-connected",
		"integrations raw-data",
		"integrations raw-data get-integration",
		"integrations resync",
		"integrations resync integration",
		"integrations tenants",
		"integrations tenants get-integration",
		"integrations update",
		"integrations users",
		"integrations users get-integration",
		"invoices",
		"invoices line-items",
		"invoices line-items get-invoice",
		"me",
		"software",
		"software get-installer-history",
		"software get-installer-setup",
		"software get-packages",
		"software install",
		"vulnerabilities",
		"vulnerabilities get-software",
		"vulnerabilities get-software-vulnerability-summary",
		"warranties",
	}
