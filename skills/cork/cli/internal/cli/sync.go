...
Resource scoping:
  ...
  cork-cli sync --resources clients,compliance

  # Full resync (ignore previous checkpoint)
  cork-cli sync --full

  # Incremental sync: only records from the last 7 days
  cork-cli sync --since 7d

  # Parallel sync with 8 workers
  cork-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  cork-cli sync --latest-only`,
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "integrations/integrations_devices":
		return paginationDefaults{
			cursorParam:    "page",
			cursorType:     "page",
			nextCursorPath: "",
	...
	case "software-installer-history":
		return paginationDefaults{
			cursorParam:    "page",
			cursorType:     "page",
			nextCursorPath: "",
	...
	case "software-installer-packages":
		return paginationDefaults{
			cursorParam:    "page",
			cursorType:     "page",
			nextCursorPath: "",
	...
	case "vulnerabilities-software-summary":
		return paginationDefaults{
			cursorParam:    "page",
			cursorType:     "page",
			nextCursorPath: "",
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "clients_devices":
		return db.UpsertClientsDevices(data)
	case "domains":
		return db.UpsertDomains(data)
	case "inboxes":
		return db.UpsertInboxes(data)
	case "score_history":
		return db.UpsertScoreHistory(data)
	case "compliance":
		return db.UpsertCompliance(data)
	case "distributor":
		return db.UpsertDistributor(data)
	case "integrations":
		return db.UpsertIntegrations(data)
	case "credentials":
		return db.UpsertCredentials(data)
	case "integrations_devices":
		return db.UpsertIntegrationsDevices(data)
	case "raw_data":
		return db.UpsertRawData(data)
	case "resync":
	...
	case "vulnerabilities":
		return db.UpsertVulnerabilities(data)
	case "warranties":
		return db.UpsertWarranties(data)
	default:
...
func knownSyncResourceNames() []string {
	names := []string{
		...
		"invoices",
		"software",
		"software-installer-history",
		"software-installer-packages",
		"vulnerabilities",
		"vulnerabilities-software-summary",
		"warranties",
	}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"invoices":                         "/invoices",
		"software":                         "/software/installer/setup",
		"software-installer-history":       "/software/installer/history",
		"software-installer-packages":      "/software/installer/packages",
		"vulnerabilities":                  "/vulnerabilities/software",
		"vulnerabilities-software-summary": "/vulnerabilities/software/summary",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "clients_devices", ParentTable: "clients", ParentIDParam: "client-uuid", PathTemplate: "/clients/{client-uuid}/devices", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.client", PathParams: []dependentPathParamDef{
			{Param: "client-uuid", Field: "uuid"},
		}},
		{Name: "domains", ParentTable: "clients", ParentIDParam: "client-uuid", PathTemplate: "/clients/{client-uuid}/domains", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.client", PathParams: []dependentPathParamDef{
			{Param: "client-uuid", Field: "uuid"},
		}},
		{Name: "inboxes", ParentTable: "clients", ParentIDParam: "client-uuid", PathTemplate: "/clients/{client-uuid}/inboxes", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.client", PathParams: []dependentPathParamDef{
			{Param: "client-uuid", Field: "uuid"},
		}},
		{Name: "integrations_devices", ParentTable: "integrations", ParentIDParam: "integration-uuid", PathTemplate: "/integrations/{integration-uuid}/devices", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.integration", PathParams: []dependentPathParamDef{
			{Param: "integration-uuid", Field: "integration_uuid"},
		}},
		{Name: "line_items", ParentTable: "invoices", ParentIDParam: "invoice-uuid", PathTemplate: "/invoices/{invoice-uuid}/line-items", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.invoice", PathParams: []dependentPathParamDef{
			{Param: "invoice-uuid", Field: "uuid"},
		}},
		{Name: "score_history", ParentTable: "clients", ParentIDParam: "client-uuid", PathTemplate: "/clients/{client-uuid}/score-history", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "client-uuid", Field: "uuid"},
		}},
		{Name: "tenants", ParentTable: "integrations", ParentIDParam: "integration-uuid", PathTemplate: "/integrations/{integration-uuid}/tenants", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.integration", PathParams: []dependentPathParamDef{
			{Param: "integration-uuid", Field: "integration_uuid"},
		}},
		{Name: "users", ParentTable: "integrations", ParentIDParam: "integration-uuid", PathTemplate: "/integrations/{integration-uuid}/users", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.integration", PathParams: []dependentPathParamDef{
			{Param: "integration-uuid", Field: "integration_uuid"},
		}},
	}
}
...
var reconcileTypedTables = map[string]string{
	"clients":              "clients",
	"clients_devices":      "clients_devices",
	...
	"integrations_devices": "integrations_devices",
	"invoices":             "invoices",
...
func responsePathForResource(resource, path string) []string {
	...
	case "clients\x00/clients":
		return []string{"items"}
	case "compliance\x00/compliance/client/{client-uuid}/notification-settings":
		return []string{"items"}
	case "compliance\x00/compliance/client/{client-uuid}/events":
		return []string{"items"}
	case "distributor\x00/distributor/partners":
		return []string{"items"}
	case "integrations\x00/integrations/available":
		return []string{"items"}
	case "integrations\x00/integrations/connected":
		return []string{"items"}
	case "invoices\x00/invoices":
		return []string{"items"}
	case "software\x00/software/installer/history":
		return []string{"items"}
	case "software\x00/software/installer/packages":
		return []string{"items"}
	case "vulnerabilities\x00/vulnerabilities/software":
		return []string{"items"}
	case "vulnerabilities\x00/vulnerabilities/software/summary":
		return []string{"items"}
	case "warranties\x00/warranties":
		return []string{"items"}
	}
	return nil
}
