#!/usr/bin/env bash
# install.sh - install cork-cli and cork-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (cork-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/cork#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/cork/mcp-install.md"
