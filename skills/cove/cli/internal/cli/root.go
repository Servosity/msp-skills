...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "cove-cli",
		Short: `Fleet-wide Cove Data Protection backup health, billing usage, and storage trends from your terminal`,
		Long: `Fleet-wide Cove Data Protection backup health, billing usage, and storage trends from your terminal
...
Health check: run 'cove-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("cove-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'cove-cli profile list')")
	...
	rootCmd.AddCommand(newCoveAuthCmd(flags))
	rootCmd.AddCommand(newCoveCallCmd(flags))
	rootCmd.AddCommand(newCoveSnapshotCmd(flags))
	...
	rootCmd.AddCommand(newColumnsPromotedCmd(flags))
	...
	rootCmd.AddCommand(newServerPromotedCmd(flags))
