# install.ps1 - install cove-cli and cove-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (cove-v*).
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (cove-vX.Y.Z),
...
Write-Host "  cove-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/cove#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/cove/mcp-install.md"
