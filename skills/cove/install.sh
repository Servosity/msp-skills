#!/usr/bin/env bash
# install.sh - install cove-cli and cove-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (cove-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/cove#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/cove/mcp-install.md"
