...
```bash
COVE_PARTNER="<full customer string from Cove console dropdown, e.g. Acme Corp (admin@acme.com)>" COVE_PASSWORD=<api-token> COVE_USERNAME=<api-user-login-name> cove-mcp --transport http --addr :7777
```
