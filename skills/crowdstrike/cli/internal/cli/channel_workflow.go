...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  crowdstrike-cli workflow archive

  # Full re-archive (ignore previous sync state)
  crowdstrike-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"alerts", "devices", "devices-combined-devices-hidden-v1", "devices-combined-devices-v1", "devices-combined-host-group-members-v1", "devices-combined-host-groups-v1", "devices-queries-devices-hidden-v1", "devices-queries-devices-scroll-v1", "devices-queries-host-group-members-v1", "devices-queries-host-groups-v1", "incidents", "incidents-combined-crowdscores-v1", "incidents-queries-incidents-v1", "mssp", "mssp-queries-cid-groups-v1", "mssp-queries-mssp-roles-v1", "mssp-queries-user-groups-v1", "policy", "policy-combined-prevention-members-v1", "policy-combined-prevention-v1", "policy-queries-prevention-members-v1"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  crowdstrike-cli workflow status

  # Show status as JSON
  crowdstrike-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("crowdstrike-cli")
			}
