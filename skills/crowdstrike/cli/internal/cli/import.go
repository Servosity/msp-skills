...
but do not stop the import.`,
  ...
  crowdstrike-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  crowdstrike-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | crowdstrike-cli import <resource> --input -`,
