...
func newMsspDeleteCidgroupsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !cmd.Flags().Changed("cid-group-ids") && !flags.dryRun {
				return fmt.Errorf("required flag \"%s\" not set", "cid-group-ids")
			}
	...
	cmd.Flags().StringVar(&flagCidGroupIds, "cid-group-ids", "", "CID group ids to delete")
