...
func newMsspGetRolesByIdCmd(flags *rootFlags) *cobra.Command {
	var flagIds string
	...
	cmd.Flags().StringVar(&flagIds, "ids", "", "Link ID is a string consisting of multiple components, but should be treated as opaque.")
