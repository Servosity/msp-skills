...
func newSpotlightCombinedQueryVulnerabilitiesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().IntVar(&flagLimit, "limit", 0, "The number of items to return in this response (default: 100, max: 5000).")
	cmd.Flags().StringVar(&flagSort, "sort", "", "Sort vulnerabilities by their properties. Common sort options include: updated_timestamp|asc closed_timestamp|asc")
	...
	cmd.Flags().StringVar(&flagFacet, "facet", "", "Select various details blocks to be returned for each vulnerability entity.")
