...
func newSpotlightGetVulnerabilitiesCmd(flags *rootFlags) *cobra.Command {
	var flagIds string
	...
	cmd.Flags().StringVar(&flagIds, "ids", "", "One or more vulnerability IDs (max: 400). Find vulnerability IDs with GET /spotlight/queries/vulnerabilities/v1")
