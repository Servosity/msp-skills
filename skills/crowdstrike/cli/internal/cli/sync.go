...
Resource scoping:
  ...
  crowdstrike-cli sync

  # Sync specific resources only
  crowdstrike-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  crowdstrike-cli sync --full

  # Incremental sync: only records from the last 7 days
  crowdstrike-cli sync --since 7d

  # Parallel sync with 8 workers
  crowdstrike-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  crowdstrike-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/crowdstrike-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "devices":
		return true
	case "devices-combined-devices-hidden-v1":
		return true
	case "devices-combined-devices-v1":
		return true
	case "devices-combined-host-group-members-v1":
		return true
	case "devices-combined-host-groups-v1":
		return true
	case "devices-queries-devices-hidden-v1":
		return true
	case "devices-queries-devices-scroll-v1":
		return true
	case "devices-queries-host-group-members-v1":
		return true
	case "devices-queries-host-groups-v1":
		return true
	case "incidents":
		return true
	case "incidents-combined-crowdscores-v1":
		return true
	case "incidents-queries-incidents-v1":
		return true
	case "mssp":
		return true
	case "mssp-queries-cid-groups-v1":
		return true
	case "mssp-queries-mssp-roles-v1":
		return true
	case "mssp-queries-user-groups-v1":
		return true
	case "policy":
		return true
	case "policy-combined-prevention-members-v1":
		return true
	case "policy-combined-prevention-v1":
		return true
	case "policy-queries-prevention-members-v1":
		return true
	}
	return false
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"alerts":                                 "/alerts/queries/alerts/v2",
		"devices":                                "/devices/queries/devices/v1",
		"devices-combined-devices-hidden-v1":     "/devices/combined/devices-hidden/v1",
		"devices-combined-devices-v1":            "/devices/combined/devices/v1",
		"devices-combined-host-group-members-v1": "/devices/combined/host-group-members/v1",
		"devices-combined-host-groups-v1":        "/devices/combined/host-groups/v1",
		"devices-queries-devices-hidden-v1":      "/devices/queries/devices-hidden/v1",
		"devices-queries-devices-scroll-v1":      "/devices/queries/devices-scroll/v1",
		"devices-queries-host-group-members-v1":  "/devices/queries/host-group-members/v1",
		"devices-queries-host-groups-v1":         "/devices/queries/host-groups/v1",
		"incidents":                              "/incidents/queries/behaviors/v1",
		"incidents-combined-crowdscores-v1":      "/incidents/combined/crowdscores/v1",
		"incidents-queries-incidents-v1":         "/incidents/queries/incidents/v1",
		"mssp":                                   "/mssp/queries/children/v1",
		"mssp-queries-cid-groups-v1":             "/mssp/queries/cid-groups/v1",
		"mssp-queries-mssp-roles-v1":             "/mssp/queries/mssp-roles/v1",
		"mssp-queries-user-groups-v1":            "/mssp/queries/user-groups/v1",
		"policy":                                 "/policy/queries/prevention/v1",
		"policy-combined-prevention-members-v1":  "/policy/combined/prevention-members/v1",
		"policy-combined-prevention-v1":          "/policy/combined/prevention/v1",
		"policy-queries-prevention-members-v1":   "/policy/queries/prevention-members/v1",
	}
