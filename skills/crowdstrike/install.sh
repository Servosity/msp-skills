#!/usr/bin/env bash
# install.sh - install crowdstrike-cli and crowdstrike-mcp on macOS / Linux.
#
...
SKILL="crowdstrike"
CLI_BIN="crowdstrike-cli"
MCP_BIN="crowdstrike-mcp"
...
# Each skill is versioned and tagged independently (crowdstrike-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/crowdstrike#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/crowdstrike/mcp-install.md"
