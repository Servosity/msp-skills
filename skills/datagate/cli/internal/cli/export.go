...
large datasets as it has no memory pressure.`,
  ...
  datagate-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  datagate-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  datagate-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.RangeArgs(1, 2),
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			validResources := map[string]bool{
				"account-managers":     true,
				"agreements":           true,
				"assignments":          true,
				"customer-users":       true,
				"customers":            true,
				"delivery-methods":     true,
				"kit-templates":        true,
				"product-templates":    true,
				"product-transactions": true,
				"products":             true,
				"rate-cards":           true,
				"service-items":        true,
				"sites":                true,
