...
// "mcp-filesystem-flag-floor" entry. External test package so it can import
// internal/cli even where internal/cli imports internal/mcp.
...
import (
	...
	"datagate-cli/internal/mcp/cobratree"
)
