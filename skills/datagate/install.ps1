# install.ps1 - install datagate-cli and datagate-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (datagate-v*).
...
$Skill   = "datagate"
$CliBin  = "datagate-cli.exe"
$McpBin  = "datagate-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (datagate-vX.Y.Z),
...
Write-Host "  datagate-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/datagate#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/datagate/mcp-install.md"
