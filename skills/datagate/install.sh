#!/usr/bin/env bash
# install.sh - install datagate-cli and datagate-mcp on macOS / Linux.
#
...
SKILL="datagate"
CLI_BIN="datagate-cli"
MCP_BIN="datagate-mcp"
...
# Each skill is versioned and tagged independently (datagate-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/datagate#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/datagate/mcp-install.md"
