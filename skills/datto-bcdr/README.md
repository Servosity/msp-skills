...
<p align="center">
  <a href="https://msp-skills.compoundingteams.com/skills/datto-bcdr/">
    <img src="../../docs/assets/social/datto-bcdr/wide-1200x630.png" alt="Datto BCDR - MCP server and Claude Code Skill" width="600">
  </a>
</p>
<p align="center"><sub><a href="https://msp-skills.compoundingteams.com/skills/datto-bcdr/">Full skill page</a> - install, outcomes, safety model.</sub></p>
<!-- media:end -->
...
Most Datto BCDR integrations and MCP servers proxy each question into a live API call. That's fine for one record. It dies at scale, when you're asking <!-- TODO: vendor-specific QBR-time example: e.g. "how many backup-failure tickets across all 47 clients last quarter" -->.

This skill syncs Datto BCDR into a **local SQLite mirror** with full-text search. Aggregate questions become one local SQL join: instant, offline, and the AI sees the answer, not the raw data. Compound commands like <!-- TODO: 2-3 highest-leverage compound commands from this skill --> join across <!-- TODO: which entities --> - work a stateless API wrapper can't do.
