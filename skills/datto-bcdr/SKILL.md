...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [datto-bcdr-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/datto-bcdr/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/datto-bcdr/install.ps1
---
...
The installer places the `datto-bcdr-cli` and `datto-bcdr-mcp` binaries on your PATH. It does not
