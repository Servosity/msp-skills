...
Data must be synced first with the sync command.`,
  ...
  datto-bcdr-cli analytics --type messages

  # Group by a field
  datto-bcdr-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  datto-bcdr-cli analytics --type messages --group-by channel_id --limit 10 --json`,
