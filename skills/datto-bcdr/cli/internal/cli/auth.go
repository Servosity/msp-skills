...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  datto-bcdr-cli auth setup\n  datto-bcdr-cli auth setup --launch",
...
func newAuthStatusCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  datto-bcdr-cli auth status",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  datto-bcdr-cli auth logout",
		RunE: func(cmd *cobra.Command, args []string) error {
			cfg, err := config.Load(flags.configPath)
			if err != nil {
				return configErr(err)
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("DATTO_BCDR_PUBLIC_KEY") != "" {
				envStillSet = "DATTO_BCDR_PUBLIC_KEY"
			}
			if envStillSet == "" && os.Getenv("DATTO_BCDR_SECRET_KEY") != "" {
				envStillSet = "DATTO_BCDR_SECRET_KEY"
			}
