...
but do not stop the import.`,
  ...
  datto-bcdr-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  datto-bcdr-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | datto-bcdr-cli import <resource> --input -`,
