...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "datto-bcdr-cli",
		Short: `Sync your entire Datto BCDR fleet into local SQLite and answer fleet-wide questions the per-device Partner Portal can't: screenshot-verification audits, stale-backup roll-ups, and cross-client alert …`,
		Long: `Sync your entire Datto BCDR fleet into local SQLite and answer fleet-wide questions the per-device Partner Portal can't: screenshot-verification audits, stale-backup roll-ups, and cross-client alert …
...
Health check: run 'datto-bcdr-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("datto-bcdr-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'datto-bcdr-cli profile list')")
	...
	rootCmd.AddCommand(newNovelAgentVersionsCmd(flags))
	rootCmd.AddCommand(newNovelAlertTriageCmd(flags))
	rootCmd.AddCommand(newNovelClientReportCmd(flags))
	rootCmd.AddCommand(newNovelClientRiskCmd(flags))
	rootCmd.AddCommand(newNovelForgottenAssetsCmd(flags))
	rootCmd.AddCommand(newNovelRecoverabilityCmd(flags))
	rootCmd.AddCommand(newNovelScreenshotsCmd(flags))
	rootCmd.AddCommand(newNovelStaleBackupsCmd(flags))
	rootCmd.AddCommand(newNovelStorageRunwayCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAlertPromotedCmd(flags))
	rootCmd.AddCommand(newSharesPromotedCmd(flags))
	rootCmd.AddCommand(newVmRestorePromotedCmd(flags))
