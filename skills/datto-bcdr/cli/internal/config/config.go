...
type Config struct {
	...
	DattoBcdrPublicKey string            `toml:"bcdr_public_key"`
	DattoBcdrSecretKey string            `toml:"bcdr_secret_key"`
}
...
func Load(configPath string) (*Config, error) {
	...
	path := configPath
	if path == "" {
		path = os.Getenv("DATTO_BCDR_CONFIG")
	}
	if path == "" {
		home, _ := os.UserHomeDir()
		path = filepath.Join(home, ".config", "datto-bcdr-cli", "config.toml")
	}
	cfg.Path = path
	...
	// Env var overrides
	if v := os.Getenv("DATTO_BCDR_PUBLIC_KEY"); v != "" {
		cfg.DattoBcdrPublicKey = v
		cfg.markEnvOverride("DattoBcdrPublicKey")
		cfg.AuthSource = "env:DATTO_BCDR_PUBLIC_KEY"
	}
	if v := os.Getenv("DATTO_BCDR_SECRET_KEY"); v != "" {
		cfg.DattoBcdrSecretKey = v
		cfg.markEnvOverride("DattoBcdrSecretKey")
		cfg.AuthSource = "env:DATTO_BCDR_SECRET_KEY"
	}
	...
	if cfg.AuthSource == "" && cfg.DattoBcdrPublicKey != "" {
		cfg.AuthSource = "config"
	}
	if cfg.AuthSource == "" && cfg.DattoBcdrSecretKey != "" {
		cfg.AuthSource = "config"
	}
	...
	if v := os.Getenv("DATTO_BCDR_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func (c *Config) AuthHeader() string {
	...
	if c.DattoBcdrPublicKey == "" || c.DattoBcdrSecretKey == "" {
		return ""
	}
	credentials := c.DattoBcdrPublicKey + ":" + c.DattoBcdrSecretKey
...
func (c *Config) SaveCredential(token string) error {
	...
	c.updateFileConfigField("AccessToken")
	c.DattoBcdrPublicKey = token
	delete(c.envOverrides, "DattoBcdrPublicKey")
	c.updateFileConfigField("DattoBcdrPublicKey")
	return c.save()
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientID")
	c.updateFileConfigField("ClientSecret")
	c.DattoBcdrPublicKey = ""
	delete(c.envOverrides, "DattoBcdrPublicKey")
	c.DattoBcdrSecretKey = ""
	delete(c.envOverrides, "DattoBcdrSecretKey")
	return c.save()
}
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["DattoBcdrPublicKey"] {
			out.DattoBcdrPublicKey = c.fileConfig.DattoBcdrPublicKey
		}
		if c.envOverrides["DattoBcdrSecretKey"] {
			out.DattoBcdrSecretKey = c.fileConfig.DattoBcdrSecretKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "DattoBcdrPublicKey":
		c.fileConfig.DattoBcdrPublicKey = c.DattoBcdrPublicKey
	case "DattoBcdrSecretKey":
		c.fileConfig.DattoBcdrSecretKey = c.DattoBcdrSecretKey
	}
}
