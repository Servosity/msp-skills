# datto-bcdr skill - governance and safety model

> Unofficial. Community-built skill for the Datto BCDR API. Not affiliated with,
> endorsed by, or sponsored by the vendor.
> This page tells an MSP owner exactly what the datto-bcdr skill can touch and how to
...
the Datto BCDR API, and you can read every line of how it does so. The skill is
