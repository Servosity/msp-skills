# install.ps1 - install datto-bcdr-cli and datto-bcdr-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (datto-bcdr-v*).
...
$Skill   = "datto-bcdr"
$CliBin  = "datto-bcdr-cli.exe"
$McpBin  = "datto-bcdr-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (datto-bcdr-vX.Y.Z),
...
Write-Host "  datto-bcdr-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/datto-bcdr#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/datto-bcdr/mcp-install.md"
