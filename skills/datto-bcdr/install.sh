#!/usr/bin/env bash
# install.sh - install datto-bcdr-cli and datto-bcdr-mcp on macOS / Linux.
#
...
SKILL="datto-bcdr"
CLI_BIN="datto-bcdr-cli"
MCP_BIN="datto-bcdr-mcp"
...
# Each skill is versioned and tagged independently (datto-bcdr-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/datto-bcdr#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/datto-bcdr/mcp-install.md"
