...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Datto Rmm",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  datto-rmm-cli auth setup\n  datto-rmm-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			launchURL := "https://rmm.datto.com/help/en/Content/2SETUP/APIv2.htm"
...
func newAuthStatusCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  datto-rmm-cli auth status",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  datto-rmm-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  datto-rmm-cli auth logout",
		RunE: func(cmd *cobra.Command, args []string) error {
			cfg, err := config.Load(flags.configPath)
			if err != nil {
				return configErr(err)
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("DATTO_RMM_API_KEY") != "" {
				envStillSet = "DATTO_RMM_API_KEY"
			}
			if envStillSet == "" && os.Getenv("DATTO_RMM_API_SECRET_KEY") != "" {
				envStillSet = "DATTO_RMM_API_SECRET_KEY"
			}
			if envStillSet == "" && os.Getenv("DATTO_RMM_TOKEN") != "" {
				envStillSet = "DATTO_RMM_TOKEN"
			}
