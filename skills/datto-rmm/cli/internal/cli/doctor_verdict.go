...
//
// See issue #282 and skills/datto-rmm/handfixes.json.
//
...
const doctorBaseURLEnv = "DATTO_RMM_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://merlot-api.centrastage.net/api"
