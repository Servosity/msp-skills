...
but do not stop the import.`,
  ...
  datto-rmm-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  datto-rmm-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | datto-rmm-cli import <resource> --input -`,
