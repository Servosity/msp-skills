...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "datto-rmm-cli",
		Short: `Datto Rmm CLI — Every Datto RMM API operation, plus a local SQLite fleet store and fleet-wide analytics no other Datto tool has.`,
		Long: `Datto Rmm CLI — Every Datto RMM API operation, plus a local SQLite fleet store and fleet-wide analytics no other Datto tool has.
...
Health check: run 'datto-rmm-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("datto-rmm-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'datto-rmm-cli profile list')")
	...
	rootCmd.AddCommand(newJobPromotedCmd(flags))
