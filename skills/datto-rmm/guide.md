...
datto-rmm-cli alert <alertUid>

# JSON for scripting and agents
datto-rmm-cli alert <alertUid> --json

# Filter to specific fields
datto-rmm-cli alert <alertUid> --json --select id,name,status

# Dry run  -  show the request without sending
datto-rmm-cli alert <alertUid> --dry-run

# Agent mode  -  JSON + compact + no prompts in one flag
datto-rmm-cli alert <alertUid> --agent
```
