# install.ps1 - install datto-rmm-cli and datto-rmm-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (datto-rmm-v*).
...
$Skill   = "datto-rmm"
$CliBin  = "datto-rmm-cli.exe"
$McpBin  = "datto-rmm-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (datto-rmm-vX.Y.Z),
...
Write-Host "  datto-rmm-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/datto-rmm#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/datto-rmm/mcp-install.md"
