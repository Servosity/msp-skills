#!/usr/bin/env bash
# install.sh - install datto-rmm-cli and datto-rmm-mcp on macOS / Linux.
#
...
SKILL="datto-rmm"
CLI_BIN="datto-rmm-cli"
MCP_BIN="datto-rmm-mcp"
...
# Each skill is versioned and tagged independently (datto-rmm-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/datto-rmm#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/datto-rmm/mcp-install.md"
