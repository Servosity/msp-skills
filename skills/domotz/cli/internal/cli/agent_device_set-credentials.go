...
func newAgentDeviceSetCredentialsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyScope, "scope", "DEVICE_MANAGEMENT", "The Scope for the Credentials. Default is 'DEVICE_MANAGEMENT' used for device integrations")
