...
func newAgentDeviceSetSnmpCommunityCmd(flags *rootFlags) *cobra.Command {
	var bodyRead string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				if !cmd.Flags().Changed("read") && !flags.dryRun {
					return fmt.Errorf("required flag \"%s\" not set", "read")
				}
			}
	...
	cmd.Flags().StringVar(&bodyRead, "read", "", "Defines new read snmp community")
	cmd.Flags().StringVar(&bodyWrite, "write", "", "Defines new write snmp community (defaults to read community if not used)")
