...
//
// See issue #282 and skills/domotz/handfixes.json.
//
...
const doctorBaseURLEnv = "DOMOTZ_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://api-{region}.domotz.com/public-api/v1"
