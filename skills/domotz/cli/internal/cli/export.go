...
large datasets as it has no memory pressure.`,
  ...
  domotz-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  domotz-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  domotz-cli export <resource> --format jsonl | jq '.id'`,
