...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "domotz-cli",
		Short: `Domotz CLI — Every Domotz endpoint, plus a local SQLite fleet mirror that answers cross-site questions.`,
		Long: `Domotz CLI — Every Domotz endpoint, plus a local SQLite fleet mirror that answers cross-site questions.
...
Health check: run 'domotz-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("domotz-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'domotz-cli profile list')")
	...
	rootCmd.AddCommand(newAlertProfileCmd(flags))
	rootCmd.AddCommand(newCustomDriverCmd(flags))
	rootCmd.AddCommand(newCustomTagCmd(flags))
	...
	rootCmd.AddCommand(newAreaPromotedCmd(flags))
	rootCmd.AddCommand(newDeviceProfilePromotedCmd(flags))
