# install.ps1 - install domotz-cli and domotz-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (domotz-v*).
...
$Skill   = "domotz"
$CliBin  = "domotz-cli.exe"
$McpBin  = "domotz-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (domotz-vX.Y.Z),
...
Write-Host "  domotz-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/domotz#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/domotz/mcp-install.md"
