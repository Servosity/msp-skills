#!/usr/bin/env bash
# install.sh - install domotz-cli and domotz-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (domotz-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/domotz#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/domotz/mcp-install.md"
