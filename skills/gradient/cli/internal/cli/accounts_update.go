...
func newAccountsUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "update",
		Short:       "Updates 1 or more fields per Account",
		Example:     "  gradient-cli accounts update",
		Annotations: map[string]string{"pp:endpoint": "accounts.update", "pp:method": "PATCH", "pp:path": "/vendor-api/organization/accounts"},
