...
func newMappingsCreateCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create Service for a Vendor for an Organization",
		Example:     "  gradient-cli mappings create",
		Annotations: map[string]string{"pp:endpoint": "mappings.create", "pp:method": "POST", "pp:path": "/vendor-api/organization/services"},
