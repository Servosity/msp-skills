...
func newMappingsUpdateBulkCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "update-bulk",
		Short:       "Updates 1 or more fields for each Service",
		Example:     "  gradient-cli mappings update-bulk",
		Annotations: map[string]string{"pp:endpoint": "mappings.update-bulk", "pp:method": "PATCH", "pp:path": "/vendor-api/organization/services"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/vendor-api/organization/services"
