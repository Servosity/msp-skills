...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "gradient-cli",
		Short: `Gradient CLI — The Synthesize partner API from the terminal - every endpoint, plus a usage-push ledger, billing drift detection, and a…`,
		Long: `Gradient CLI — The Synthesize partner API from the terminal - every endpoint, plus a usage-push ledger, billing drift detection, and a…
...
Health check: run 'gradient-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("gradient-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'gradient-cli profile list')")
	...
	rootCmd.AddCommand(newMappingsCmd(flags))
