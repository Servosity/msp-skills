#!/usr/bin/env bash
# install.sh - install gradient-cli and gradient-mcp on macOS / Linux.
#
...
SKILL="gradient"
CLI_BIN="gradient-cli"
MCP_BIN="gradient-mcp"
...
# Each skill is versioned and tagged independently (gradient-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/gradient#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/gradient/mcp-install.md"
