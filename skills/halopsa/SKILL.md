...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [halopsa-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/halopsa/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/halopsa/install.ps1
---
...
The installer places the `halopsa-cli` and `halopsa-mcp` binaries on your PATH. It does not
