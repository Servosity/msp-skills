...
func newClientsCreateClient2Cmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-client-2",
		Short:       "Create client 2",
		Example:     "  halopsa-cli clients create-client-2",
		Annotations: map[string]string{"pp:endpoint": "clients.create-client-2", "pp:method": "POST", "pp:path": "/Client/PaymentMethodUpdate"},
