...
func newClientsCreateClientCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create-client",
		Short:       "Create client",
		Example:     "  halopsa-cli clients create-client",
		Annotations: map[string]string{"pp:endpoint": "clients.create-client", "pp:method": "POST", "pp:path": "/Client/NewAccountsId"},
