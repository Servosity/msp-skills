...
large datasets as it has no memory pressure.`,
  ...
  halopsa-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  halopsa-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  halopsa-cli export <resource> --format jsonl | jq '.id'`,
