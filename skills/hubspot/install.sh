#!/usr/bin/env bash
# install.sh - install hubspot-cli and hubspot-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (hubspot-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/hubspot#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/hubspot/mcp-install.md"
