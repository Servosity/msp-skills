...
func newIpAddressesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List IP address records (paginated)",
		Example:     "  hudu-cli ip-addresses list",
		Annotations: map[string]string{"pp:endpoint": "ip-addresses.list", "pp:method": "GET", "pp:path": "/ip_addresses", "mcp:read-only": "true"},
