...
func newMagicDashListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List Magic Dash tiles (paginated)",
		Example:     "  hudu-cli magic-dash list",
		Annotations: map[string]string{"pp:endpoint": "magic-dash.list", "pp:method": "GET", "pp:path": "/magic_dash", "mcp:read-only": "true"},
	...
	cmd.Flags().StringVar(&flagTitle, "title", "", "Filter by title")
