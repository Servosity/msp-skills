...
func newNetworksListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List networks (paginated)",
		Example:     "  hudu-cli networks list",
		Annotations: map[string]string{"pp:endpoint": "networks.list", "pp:method": "GET", "pp:path": "/networks", "mcp:read-only": "true"},
