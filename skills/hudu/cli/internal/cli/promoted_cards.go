...
func newCardsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagIntegrationSlug string
	var flagIntegrationId string
	var flagIntegrationIdentifier string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !cmd.Flags().Changed("integration-slug") && !flags.dryRun {
				return fmt.Errorf("required flag \"%s\" not set", "integration-slug")
			}
	...
	cmd.Flags().StringVar(&flagIntegrationSlug, "integration-slug", "", "Integration slug (e.g. cw_manage, autotask)")
	cmd.Flags().StringVar(&flagIntegrationId, "integration-id", "", "External record id (one of integration-id / integration-identifier required)")
	cmd.Flags().StringVar(&flagIntegrationIdentifier, "integration-identifier", "", "External record identifier (alternative to integration-id)")
