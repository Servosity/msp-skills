...
func newRackStorageItemsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List rack storage items (paginated)",
		Example:     "  hudu-cli rack-storage-items list",
		Annotations: map[string]string{"pp:endpoint": "rack-storage-items.list", "pp:method": "GET", "pp:path": "/rack_storage_items", "mcp:read-only": "true"},
