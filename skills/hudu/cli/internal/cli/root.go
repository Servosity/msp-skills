...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "hudu-cli",
		Short: `Every Hudu cmdlet, plus an offline SQLite mirror, cross-entity FTS, stale-password and expiration audits, and agent-native --json/--select that no PowerShell module or read-only MCP ships.`,
		Long: `Every Hudu cmdlet, plus an offline SQLite mirror, cross-entity FTS, stale-password and expiration audits, and agent-native --json/--select that no PowerShell module or read-only MCP ships.
...
Health check: run 'hudu-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("hudu-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'hudu-cli profile list')")
	...
	rootCmd.AddCommand(newAssetLayoutsCmd(flags))
	rootCmd.AddCommand(newAssetPasswordsCmd(flags))
	rootCmd.AddCommand(newAssetsCmd(flags))
	rootCmd.AddCommand(newCompaniesCmd(flags))
	rootCmd.AddCommand(newExportsCmd(flags))
	rootCmd.AddCommand(newFlagTypesCmd(flags))
	rootCmd.AddCommand(newFlagsCmd(flags))
	rootCmd.AddCommand(newFoldersCmd(flags))
	rootCmd.AddCommand(newGroupsCmd(flags))
	rootCmd.AddCommand(newIpAddressesCmd(flags))
	rootCmd.AddCommand(newListsCmd(flags))
	rootCmd.AddCommand(newMagicDashCmd(flags))
	rootCmd.AddCommand(newMatchersCmd(flags))
	rootCmd.AddCommand(newNetworksCmd(flags))
	rootCmd.AddCommand(newProcedureTasksCmd(flags))
	rootCmd.AddCommand(newProceduresCmd(flags))
	rootCmd.AddCommand(newRackStorageItemsCmd(flags))
	rootCmd.AddCommand(newRackStoragesCmd(flags))
	rootCmd.AddCommand(newRelationsCmd(flags))
	rootCmd.AddCommand(newUploadsCmd(flags))
	rootCmd.AddCommand(newUsersCmd(flags))
	rootCmd.AddCommand(newVlanZonesCmd(flags))
	rootCmd.AddCommand(newVlansCmd(flags))
	...
	rootCmd.AddCommand(newNovelOnboardCmd(flags))
	...
	rootCmd.AddCommand(newApiInfoPromotedCmd(flags))
	rootCmd.AddCommand(newCardsPromotedCmd(flags))
	rootCmd.AddCommand(newExpirationsPromotedCmd(flags))
	rootCmd.AddCommand(newPublicPhotosPromotedCmd(flags))
