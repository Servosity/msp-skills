...
Resource scoping:
  ...
  hudu-cli sync --resources channels,messages
  ...
  hudu-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/hudu-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "api-info":
		return db.UpsertApiInfo(data)
	case "articles":
		return db.UpsertArticles(data)
	case "asset-layouts":
		return db.UpsertAssetLayouts(data)
	case "asset-passwords":
		return db.UpsertAssetPasswords(data)
	case "assets":
	...
	case "expirations":
		return db.UpsertExpirations(data)
	case "exports":
		return db.UpsertExports(data)
	case "flag-types":
		return db.UpsertFlagTypes(data)
	case "flags":
	...
	case "ip-addresses":
		return db.UpsertIpAddresses(data)
	case "lists":
		return db.UpsertLists(data)
	case "magic-dash":
		return db.UpsertMagicDash(data)
	case "matchers":
		return db.UpsertMatchers(data)
	case "networks":
		return db.UpsertNetworks(data)
	case "procedure-tasks":
		return db.UpsertProcedureTasks(data)
	case "procedures":
		return db.UpsertProcedures(data)
	case "public-photos":
		return db.UpsertPublicPhotos(data)
	case "rack-storage-items":
		return db.UpsertRackStorageItems(data)
	case "rack-storages":
		return db.UpsertRackStorages(data)
	case "relations":
	...
	case "vlan-zones":
		return db.UpsertVlanZones(data)
	case "vlans":
		return db.UpsertVlans(data)
	case "websites":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"lists":              "/lists",
		"magic-dash":         "/magic_dash",
		"matchers":           "/matchers",
		"networks":           "/networks",
		"procedure-tasks":    "/procedure_tasks",
		"procedures":         "/procedures",
		"public-photos":      "/public_photos",
		"rack-storage-items": "/rack_storage_items",
		"rack-storages":      "/rack_storages",
		"relations":          "/relations",
		"uploads":            "/uploads",
		"users":              "/users",
		"vlan-zones":         "/vlan_zones",
		"vlans":              "/vlans",
		"websites":           "/websites",
	}
