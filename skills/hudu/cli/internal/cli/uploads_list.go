...
func newUploadsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List uploads (paginated)",
		Example:     "  hudu-cli uploads list",
		Annotations: map[string]string{"pp:endpoint": "uploads.list", "pp:method": "GET", "pp:path": "/uploads", "mcp:read-only": "true"},
