...
func newVlanZonesListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List VLAN zones (paginated)",
		Example:     "  hudu-cli vlan-zones list",
		Annotations: map[string]string{"pp:endpoint": "vlan-zones.list", "pp:method": "GET", "pp:path": "/vlan_zones", "mcp:read-only": "true"},
