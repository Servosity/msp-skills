...
func newVlansListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List VLANs (paginated)",
		Example:     "  hudu-cli vlans list",
		Annotations: map[string]string{"pp:endpoint": "vlans.list", "pp:method": "GET", "pp:path": "/vlans", "mcp:read-only": "true"},
