...
var whichIndex = []whichEntry{
	{Command: "audit completeness", Description: "Score how completely each company's assets fill their layout's required fields, worst-first.", Group: "Documentation hygiene audits", WhyItMatters: "Reach for this when an agent needs a hard documentation-hygiene number per client before a QBR instead of eyeballing asset lists."},
	...
	{Command: "audit stale-articles", Description: "Rank knowledge-base articles by how long since they were last updated.", Group: "Documentation hygiene audits", WhyItMatters: "Reach for this to find documentation that hasn't been touched in a year and likely lies about the current environment."},
	{Command: "resolve", Description: "Paste a Hudu object URL or exact name and get the object plus its company, layout, and relations.", Group: "Reliability", WhyItMatters: "Reach for this when an agent has a Hudu link or an exact asset name and needs full object context without paging list endpoints."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  hudu-cli which "stale tickets"
  hudu-cli which "bottleneck"
  hudu-cli which --limit 1 "send message"
  hudu-cli which                                # list the full capability index`,
