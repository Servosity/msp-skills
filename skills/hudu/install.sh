#!/usr/bin/env bash
# install.sh - install hudu-cli and hudu-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (hudu-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/hudu#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/hudu/mcp-install.md"
