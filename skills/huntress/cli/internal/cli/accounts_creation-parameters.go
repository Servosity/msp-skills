...
func newAccountsCreationParametersCmd(flags *rootFlags) *cobra.Command {
	var bodyAdditionalAdminEmails string
	var bodyAdminEmail string
	var bodyAdminFirstName string
	var bodyAdminLastName string
	...
	var bodyProductTrials string
	var bodyProductTrialsStartDate string
	...
	cmd.Flags().StringVar(&bodyAdminEmail, "admin-email", "", "Email address of the initial admin user for this account")
	cmd.Flags().StringVar(&bodyAdminFirstName, "admin-first-name", "", "First name of the initial admin user for this account")
	cmd.Flags().StringVar(&bodyAdminLastName, "admin-last-name", "", "Last name of the initial admin user for this account")
	...
	cmd.Flags().StringVar(&bodyName, "name", "", "Name of the account to be created")
	cmd.Flags().StringVar(&bodyPhoneNumber, "phone-number", "", "Primary phone number used to contact account owner")
	cmd.Flags().StringVar(&bodyProductTrials, "product-trials", "", "A list of the products that should receive trials for this account.")
	cmd.Flags().StringVar(&bodyProductTrialsStartDate, "product-trials-start-date", "", "The date that the trials in product_trials should start in ISO-8601 format (YYYY-MM-DD).")
	cmd.Flags().StringVar(&bodyProducts, "products", "", "A list of the products to provision for this account. NOTE: This field is only relevant for Aggregators.")
