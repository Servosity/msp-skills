...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Huntress Reference",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  huntress-cli auth setup\n  huntress-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			launchURL := "https://www.huntress.com/terms-of-service"
...
func newAuthStatusCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  huntress-cli auth status",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  huntress-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  huntress-cli auth logout",
		RunE: func(cmd *cobra.Command, args []string) error {
			cfg, err := config.Load(flags.configPath)
			if err != nil {
				return configErr(err)
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("HUNTRESS_API_KEY") != "" {
				envStillSet = "HUNTRESS_API_KEY"
			}
			if envStillSet == "" && os.Getenv("HUNTRESS_API_SECRET") != "" {
				envStillSet = "HUNTRESS_API_SECRET"
			}
