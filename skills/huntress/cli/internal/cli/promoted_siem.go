...
func newSiemPromotedCmd(flags *rootFlags) *cobra.Command {
	var bodyEsql string
	var bodyPageToken string
	var bodyRangeEnd string
	...
	cmd.Flags().StringVar(&bodyPageToken, "page-token", "", "Pagination token from previous response")
	cmd.Flags().StringVar(&bodyRangeEnd, "range-end", "", "Query range end (ISO 8601)")
	cmd.Flags().StringVar(&bodyRangeStart, "range-start", "", "Query range start (ISO 8601)")
