...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "huntress-cli",
		Short: `Huntress CLI — Every Huntress endpoint, plus fleet-wide incident, coverage, and billing rollups the API can't.`,
		Long: `Huntress CLI — Every Huntress endpoint, plus fleet-wide incident, coverage, and billing rollups the API can't.
...
Health check: run 'huntress-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("huntress-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'huntress-cli profile list')")
	...
	rootCmd.AddCommand(newExternalPortsCmd(flags))
	rootCmd.AddCommand(newIdentitiesCmd(flags))
	rootCmd.AddCommand(newIncidentReportsCmd(flags))
	...
	rootCmd.AddCommand(newResellerCmd(flags))
	rootCmd.AddCommand(newSignalsCmd(flags))
	rootCmd.AddCommand(newUnwantedAccessRulesCmd(flags))
	...
	rootCmd.AddCommand(newNovelFleetSummaryCmd(flags))
	rootCmd.AddCommand(newNovelIncidentDetailCmd(flags))
	rootCmd.AddCommand(newNovelResellerRollupCmd(flags))
	registerTranscendence(rootCmd, flags)
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newAccountPromotedCmd(flags))
	rootCmd.AddCommand(newActorPromotedCmd(flags))
	rootCmd.AddCommand(newKnownVpnsPromotedCmd(flags))
	rootCmd.AddCommand(newSiemPromotedCmd(flags))
