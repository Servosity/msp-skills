...
Resource scoping:
  ...
  huntress-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  huntress-cli sync --full

  # Incremental sync: only records from the last 7 days
  huntress-cli sync --since 7d

  # Parallel sync with 8 workers
  huntress-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  huntress-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("huntress-cli")
			}
...
func resourceSupportsPagination(resource string) bool {
	...
	case "accounts_incident_reports":
		return true
	case "accounts_incident_reports_remediations":
		return true
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "accounts_agents":
		return db.UpsertAccountsAgents(data)
	case "accounts_external_ports":
		return db.UpsertAccountsExternalPorts(data)
	case "accounts_incident_reports":
		return db.UpsertAccountsIncidentReports(data)
	case "accounts_invoices":
		return db.UpsertAccountsInvoices(data)
	case "accounts_memberships":
		return db.UpsertAccountsMemberships(data)
	case "accounts_organizations":
		return db.UpsertAccountsOrganizations(data)
	case "accounts_reports":
		return db.UpsertAccountsReports(data)
	case "accounts_signals":
		return db.UpsertAccountsSignals(data)
	case "agents":
		return db.UpsertAgents(data)
	case "escalations":
		return db.UpsertEscalations(data)
	case "escalations_resolution":
		return db.UpsertEscalationsResolution(data)
	case "external-ports":
		return db.UpsertExternalPorts(data)
	case "identities":
		return db.UpsertIdentities(data)
	case "incident-reports":
		return db.UpsertIncidentReports(data)
	case "remediations":
		return db.UpsertRemediations(data)
	case "incident_reports_resolution":
		return db.UpsertIncidentReportsResolution(data)
	case "invoices":
		return db.UpsertInvoices(data)
	case "known-vpns":
		return db.UpsertKnownVpns(data)
	case "memberships":
	...
	case "reseller":
		return db.UpsertReseller(data)
	case "signals":
		return db.UpsertSignals(data)
	case "unwanted-access-rules":
		return db.UpsertUnwantedAccessRules(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"external-ports":         "/v1/external_ports",
		"identities":             "/v1/identities",
		"incident-reports":       "/v1/incident_reports",
		"invoices":               "/v1/invoices",
		"known-vpns":             "/v1/known_vpns",
		"memberships":            "/v1/memberships",
		"organizations":          "/v1/organizations",
		"reports":                "/v1/reports",
		"reseller":               "/v1/reseller/invoices",
		"reseller-subscriptions": "/v1/reseller/subscriptions",
		"signals":                "/v1/signals",
		"unwanted-access-rules":  "/v1/unwanted_access_rules",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "accounts_agents", ParentTable: "accounts", ParentIDParam: "account_id", PathTemplate: "/v1/accounts/{account_id}/agents", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "account_id", Field: "id"},
		}},
		{Name: "accounts_external_ports", ParentTable: "accounts", ParentIDParam: "account_id", PathTemplate: "/v1/accounts/{account_id}/external_ports", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "account_id", Field: "id"},
		}},
		{Name: "accounts_incident_reports", ParentTable: "accounts", ParentIDParam: "account_id", PathTemplate: "/v1/accounts/{account_id}/incident_reports", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "account_id", Field: "id"},
		}},
		{Name: "accounts_invoices", ParentTable: "accounts", ParentIDParam: "account_id", PathTemplate: "/v1/accounts/{account_id}/invoices", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "account_id", Field: "id"},
		}},
		{Name: "accounts_memberships", ParentTable: "accounts", ParentIDParam: "account_id", PathTemplate: "/v1/accounts/{account_id}/memberships", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "account_id", Field: "id"},
		}},
		{Name: "accounts_organizations", ParentTable: "accounts", ParentIDParam: "account_id", PathTemplate: "/v1/accounts/{account_id}/organizations", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "account_id", Field: "id"},
		}},
		{Name: "accounts_reports", ParentTable: "accounts", ParentIDParam: "account_id", PathTemplate: "/v1/accounts/{account_id}/reports", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "account_id", Field: "id"},
		}},
		{Name: "accounts_signals", ParentTable: "accounts", ParentIDParam: "account_id", PathTemplate: "/v1/accounts/{account_id}/signals", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "account_id", Field: "id"},
		}},
		{Name: "remediations", ParentTable: "incident-reports", ParentIDParam: "incident_report_id", PathTemplate: "/v1/incident_reports/{incident_report_id}/remediations", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_report_id", Field: "id"},
		}},
		{Name: "accounts_incident_reports_remediations", ParentTable: "accounts_incident_reports", ParentIDParam: "incident_report_id", PathTemplate: "/v1/accounts/{account_id}/incident_reports/{incident_report_id}/remediations", KeyField: "", PathParams: []dependentPathParamDef{
