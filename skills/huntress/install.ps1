# install.ps1 - install huntress-cli and huntress-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (huntress-v*).
...
$Skill   = "huntress"
$CliBin  = "huntress-cli.exe"
$McpBin  = "huntress-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (huntress-vX.Y.Z),
...
Write-Host "  huntress-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/huntress#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/huntress/mcp-install.md"
