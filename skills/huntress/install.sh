#!/usr/bin/env bash
# install.sh - install huntress-cli and huntress-mcp on macOS / Linux.
#
...
SKILL="huntress"
CLI_BIN="huntress-cli"
MCP_BIN="huntress-mcp"
...
# Each skill is versioned and tagged independently (huntress-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/huntress#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/huntress/mcp-install.md"
