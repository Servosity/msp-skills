...
func newChangeRequestsGetOpenCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "auto", "change-requests", false, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
