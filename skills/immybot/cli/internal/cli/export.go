  ...
  immybot-cli export <resource> --format jsonl | jq '.id'`,
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			validResources := map[string]bool{
				...
				"chocolatey":             true,
				"computers":              true,
				"dynamic-provider-types": true,
				"groups":                 true,
				"inventory-tasks":        true,
				"licenses":               true,
				"maintenance-actions":    true,
				"maintenance-sessions":   true,
				...
				"system":                 true,
				"tags":                   true,
				"target-assignments":     true,
				"tenants":                true,
				"user-role-assignments":  true,
				"users":                  true,
			}
