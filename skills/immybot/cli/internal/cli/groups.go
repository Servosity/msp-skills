...
func newGroupsCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:         "groups",
		Short:       "List, get, create, update, and delete groups",
	...
	cmd.AddCommand(newGroupsDeleteByIdCmd(flags))
	cmd.AddCommand(newGroupsGetByIdCmd(flags))
	cmd.AddCommand(newGroupsListCmd(flags))
	cmd.AddCommand(newGroupsUpdateByIdCmd(flags))
	cmd.AddCommand(newGroupsMembersCmd(flags))
	cmd.AddCommand(newGroupsRoleAssignmentsCmd(flags))
	return cmd
}
