...
but do not stop the import.`,
  ...
  immybot-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  immybot-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | immybot-pp-cli import <resource> --input -`,
