...
func newNotificationsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return printOutputWithFlagsMeta(cmd.OutOrStdout(), formatData, flags, map[string]any{"source": "live"}, map[string]bool{"dateSilencedUtc": true, "id": true, "notificationObjectId": true, "notificationType": true, "userId": true})
		},
	}
