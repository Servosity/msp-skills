...
type rootFlags struct {
	...
	// invocation. Mirrors the IMMYBOT_NO_LEARN env var.
	noLearn bool
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.selectFields, "select", "", "Comma-separated fields to include in output (e.g. --select addons,backendRegAppId,canManageCrossTenantDeployments)")
	...
	rootCmd.AddCommand(newApplicationLocksCmd(flags))
	rootCmd.AddCommand(newApplicationLogsCmd(flags))
	rootCmd.AddCommand(newAuditsCmd(flags))
	rootCmd.AddCommand(newAzureCmd(flags))
	rootCmd.AddCommand(newAzureErrorsCmd(flags))
	rootCmd.AddCommand(newBillingCmd(flags))
	rootCmd.AddCommand(newBrandingsCmd(flags))
	rootCmd.AddCommand(newChangeRequestsCmd(flags))
	rootCmd.AddCommand(newChocolateyCmd(flags))
	rootCmd.AddCommand(newComputersCmd(flags))
	rootCmd.AddCommand(newDynamicProviderTypesCmd(flags))
	rootCmd.AddCommand(newEffectivePermissionsCmd(flags))
	rootCmd.AddCommand(newEphemeralSessionCmd(flags))
	rootCmd.AddCommand(newGettingStartedCmd(flags))
	rootCmd.AddCommand(newGroupsCmd(flags))
	rootCmd.AddCommand(newInventoryTasksCmd(flags))
	rootCmd.AddCommand(newLicensesCmd(flags))
	rootCmd.AddCommand(newMaintenanceActionsCmd(flags))
	rootCmd.AddCommand(newMaintenanceEmailsCmd(flags))
	rootCmd.AddCommand(newMaintenanceSessionsCmd(flags))
	rootCmd.AddCommand(newMaintenanceTasksCmd(flags))
	...
	rootCmd.AddCommand(newProviderAgentsCmd(flags))
	rootCmd.AddCommand(newProviderLinksCmd(flags))
	rootCmd.AddCommand(newProviderTypesCmd(flags))
	rootCmd.AddCommand(newRmmLinksCmd(flags))
	rootCmd.AddCommand(newRolesCmd(flags))
	rootCmd.AddCommand(newSchedulesCmd(flags))
	rootCmd.AddCommand(newScriptsCmd(flags))
	rootCmd.AddCommand(newSmtpConfigsCmd(flags))
	rootCmd.AddCommand(newSoftwareCmd(flags))
	rootCmd.AddCommand(newSyncsCmd(flags))
	rootCmd.AddCommand(newSystemCmd(flags))
	rootCmd.AddCommand(newTagsCmd(flags))
	rootCmd.AddCommand(newTargetAssignmentsCmd(flags))
	rootCmd.AddCommand(newTenantsCmd(flags))
	rootCmd.AddCommand(newUserRoleAssignmentsCmd(flags))
	rootCmd.AddCommand(newUserSessionCmd(flags))
	...
	rootCmd.AddCommand(newImmyAgentMetadataPromotedCmd(flags))
	rootCmd.AddCommand(newInstallerPromotedCmd(flags))
	rootCmd.AddCommand(newMePromotedCmd(flags))
	rootCmd.AddCommand(newRunImmyServicePromotedCmd(flags))
	rootCmd.AddCommand(newRunImmyServiceNewPromotedCmd(flags))
	...
	addNovelCommandIfAbsent(rootCmd, newNovelAssignmentExplainCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelFleetDiffCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelOnboardingStalledCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelPsaReconcileCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelScriptBlastRadiusCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelSessionTriageCmd(flags))
	addNovelCommandIfAbsent(rootCmd, newNovelVersionSpreadCmd(flags))
