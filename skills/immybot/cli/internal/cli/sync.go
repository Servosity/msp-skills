...
import (
	...
	"immybot-pp-cli/internal/learn/lookups"
...
func determinePaginationDefaults(resource string) paginationDefaults {
	...
	case "scripts/api_v1_scripts_global_audit":
		return paginationDefaults{
			cursorParam:    "skip",
			cursorType:     "offset",
			nextCursorPath: "",
	...
	case "scripts/api_v1_scripts_local_audit":
		return paginationDefaults{
			cursorParam:    "skip",
			cursorType:     "offset",
			nextCursorPath: "",
	...
	case "target-assignments-global":
		return paginationDefaults{
			cursorParam:    "Page",
			cursorType:     "page",
			nextCursorPath: "",
...
func resourceSupportsPagination(resource string) bool {
	switch resource {
	case "api_v1_scripts_global_audit":
		return true
	case "api_v1_scripts_local_audit":
		return true
	case "assignments":
		return true
	case "computers":
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "application-locks":
		return db.UpsertApplicationLocks(data)
	case "application-logs":
		return db.UpsertApplicationLogs(data)
	case "audits":
		return db.UpsertAudits(data)
	case "azure":
		return db.UpsertAzure(data)
	case "azure-errors":
		return db.UpsertAzureErrors(data)
	case "billing":
		return db.UpsertBilling(data)
	case "brandings":
		return db.UpsertBrandings(data)
	case "approve":
		return db.UpsertApprove(data)
	case "comment":
		return db.UpsertComment(data)
	case "deny":
		return db.UpsertDeny(data)
	case "require_changes":
		return db.UpsertRequireChanges(data)
	case "chocolatey":
		return db.UpsertChocolatey(data)
	case "computers":
		return db.UpsertComputers(data)
	case "detected_computer_software":
		return db.UpsertDetectedComputerSoftware(data)
	case "device_update_form_data":
		return db.UpsertDeviceUpdateFormData(data)
	case "ephemeral_agent":
		return db.UpsertEphemeralAgent(data)
	case "ephemeral_agent_circuit_breaker":
		return db.UpsertEphemeralAgentCircuitBreaker(data)
	case "events":
		return db.UpsertEvents(data)
	case "exclude_from_maintenance":
		return db.UpsertExcludeFromMaintenance(data)
	case "exclude_from_user_affinity":
		return db.UpsertExcludeFromUserAffinity(data)
	case "inventory_script_results":
		return db.UpsertInventoryScriptResults(data)
	case "launch_ephemeral_agent":
		return db.UpsertLaunchEphemeralAgent(data)
	case "computers_notes":
		return db.UpsertComputersNotes(data)
	case "parent_tenant_info":
		return db.UpsertParentTenantInfo(data)
	case "computers_provider_links":
		return db.UpsertComputersProviderLinks(data)
	case "registry":
		return db.UpsertRegistry(data)
	case "reinventory":
		return db.UpsertReinventory(data)
	case "resolve_onboarding_overridable_target_assignments":
		return db.UpsertResolveOnboardingOverridableTargetAssignments(data)
	case "set_to_needs_onboarding":
		return db.UpsertSetToNeedsOnboarding(data)
	case "status":
		return db.UpsertStatus(data)
	case "update_additional_persons":
		return db.UpsertUpdateAdditionalPersons(data)
	case "update_primary_person":
		return db.UpsertUpdatePrimaryPerson(data)
	case "dynamic-provider-types":
		return db.UpsertDynamicProviderTypes(data)
	case "effective-permissions":
		return db.UpsertEffectivePermissions(data)
	case "getting-started":
		return db.UpsertGettingStarted(data)
	case "groups":
	...
	case "inventory-tasks":
		return db.UpsertInventoryTasks(data)
	case "licenses":
		return db.UpsertLicenses(data)
	case "request_download":
		return db.UpsertRequestDownload(data)
	case "maintenance-actions":
		return db.UpsertMaintenanceActions(data)
	case "maintenance_actions_logs":
		return db.UpsertMaintenanceActionsLogs(data)
	case "jobs":
		return db.UpsertJobs(data)
	case "maintenance-sessions":
		return db.UpsertMaintenanceSessions(data)
	case "actions":
		return db.UpsertActions(data)
	case "maintenance_sessions_cancel":
		return db.UpsertMaintenanceSessionsCancel(data)
	case "last_log":
		return db.UpsertLastLog(data)
	case "maintenance_sessions_logs":
		return db.UpsertMaintenanceSessionsLogs(data)
	case "old_logs":
		return db.UpsertOldLogs(data)
	case "phases":
	...
	case "maintenance-tasks":
		return db.UpsertMaintenanceTasks(data)
	case "maintenance_tasks_authorization":
		return db.UpsertMaintenanceTasksAuthorization(data)
	case "media":
	...
	case "silence":
		return db.UpsertSilence(data)
	case "unsilence":
		return db.UpsertUnsilence(data)
	case "oauth":
		return db.UpsertOauth(data)
	case "persons":
		return db.UpsertPersons(data)
	case "deny_access":
		return db.UpsertDenyAccess(data)
	case "detected_software":
		return db.UpsertDetectedSoftware(data)
	case "grant_access":
		return db.UpsertGrantAccess(data)
	case "self_service":
		return db.UpsertSelfService(data)
	case "preferences":
		return db.UpsertPreferences(data)
	case "provider-agents":
		return db.UpsertProviderAgents(data)
	case "identification_logs":
		return db.UpsertIdentificationLogs(data)
	case "pending_conflicts":
		return db.UpsertPendingConflicts(data)
	case "resolve_failures":
		return db.UpsertResolveFailures(data)
	case "provider-links":
		return db.UpsertProviderLinks(data)
	case "agents":
		return db.UpsertAgents(data)
	case "asset_field_mappings":
		return db.UpsertAssetFieldMappings(data)
	case "asset_fields":
		return db.UpsertAssetFields(data)
	case "asset_match_fields":
		return db.UpsertAssetMatchFields(data)
	case "assets":
		return db.UpsertAssets(data)
	case "provider_links_audits":
		return db.UpsertProviderLinksAudits(data)
	case "clients":
		return db.UpsertClients(data)
	case "cross_references":
		return db.UpsertCrossReferences(data)
	case "immy_field_samples":
		return db.UpsertImmyFieldSamples(data)
	case "reload":
		return db.UpsertReload(data)
	case "tickets":
		return db.UpsertTickets(data)
	case "provider-types":
		return db.UpsertProviderTypes(data)
	case "bind_parameters":
		return db.UpsertBindParameters(data)
	case "rmm-links":
		return db.UpsertRmmLinks(data)
	case "roles":
	...
	case "schedules_cancel":
		return db.UpsertSchedulesCancel(data)
	case "duplicate":
		return db.UpsertDuplicate(data)
	case "run_now":
		return db.UpsertRunNow(data)
	case "scripts":
		return db.UpsertScripts(data)
	case "smtp-configs":
		return db.UpsertSmtpConfigs(data)
	case "software":
	...
	case "tags_authorization":
		return db.UpsertTagsAuthorization(data)
	case "target-assignments":
		return db.UpsertTargetAssignments(data)
	case "change_request":
		return db.UpsertChangeRequest(data)
	case "target_assignments_change_requests":
		return db.UpsertTargetAssignmentsChangeRequests(data)
	case "target_assignments_notes":
		return db.UpsertTargetAssignmentsNotes(data)
	case "override":
	...
	case "azure_groups":
		return db.UpsertAzureGroups(data)
	case "tenants_computers":
		return db.UpsertTenantsComputers(data)
	case "user-role-assignments":
		return db.UpsertUserRoleAssignments(data)
	case "user_session":
		return db.UpsertUserSession(data)
	case "users":
		return db.UpsertUsers(data)
	case "users_groups":
		return db.UpsertUsersGroups(data)
	case "impersonate":
		return db.UpsertImpersonate(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"roles-permissions",
		"schedules",
		"schedules-running-schedule-ids",
		"scripts",
		"scripts-dx",
		"scripts-functions",
		"scripts-global",
		"scripts-global-names",
		"scripts-local",
		"scripts-local-names",
		"smtp-configs",
		"software",
		...
		"target-assignments-global",
		"target-assignments-maintenance-item-orders",
		"tenants",
		"tenants-computer-counts",
		"tenants-excluded-from-cross-tenant-deployments",
...
func knownSyncResourceNames() []string {
	names := []string{
		...
		"azure",
		"azure-errors",
		"azure-partner-tenant-infos",
		"billing",
		"billing-product-catalog",
		"billing-product-catalog-items",
		...
		"computers-dx",
		"computers-inventory",
		"computers-inventory-software-search-by-name",
		"computers-inventory-software-search-by-upgrade-code",
		"computers-my",
		"computers-onboarding",
		"computers-paged",
		"computers-user-affinities",
		...
		"target-assignments-global",
		"target-assignments-maintenance-item-orders",
		"target-assignments-recommended-approvals",
		"tenants",
		"tenants-computer-counts",
		"tenants-excluded-from-cross-tenant-deployments",
		"tenants-software-from-inventory-dx",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"audits-local-dx":               "/api/v1/audits/local/dx",
		"azure":                         "/api/v1/azure/app-registration-options",
		"azure-errors":                  "/api/v1/azure-errors/dx",
		"azure-partner-tenant-infos":    "/api/v1/azure/partner-tenant-infos",
		"billing":                       "/api/v1/billing/feature-usage-counts",
		"billing-product-catalog":       "/api/v1/billing/product-catalog",
		"billing-product-catalog-items": "/api/v1/billing/product-catalog-items",
		"billing-subscription-details":  "/api/v1/billing/subscription-details",
		...
		"computers-agent-status":        "/api/v1/computers/agent-status",
		"computers-dx":                  "/api/v1/computers/dx",
		"computers-inventory":           "/api/v1/computers/inventory",
		"computers-inventory-software-search-by-name":         "/api/v1/computers/inventory-software/search-by-name",
		"computers-inventory-software-search-by-upgrade-code": "/api/v1/computers/inventory-software/search-by-upgrade-code",
		"computers-my":                         "/api/v1/computers/my",
		"computers-onboarding":                 "/api/v1/computers/onboarding",
		"computers-paged":                      "/api/v1/computers/paged",
		"computers-user-affinities":            "/api/v1/computers/user-affinities",
		"dynamic-provider-types":               "/api/v1/dynamic-provider-types",
		"groups":                               "/api/v1/groups",
		"inventory-tasks":                      "/api/v1/inventory-tasks",
		"licenses":                             "/api/v1/licenses",
		"licenses-dx":                          "/api/v1/licenses/dx",
		"maintenance-actions":                  "/api/v1/maintenance-actions/dx",
		"maintenance-actions-maintenance-item": "/api/v1/maintenance-actions/maintenance-item",
		"maintenance-actions-version":          "/api/v1/maintenance-actions/version",
		"maintenance-sessions":                 "/api/v1/maintenance-sessions/dx",
		"maintenance-tasks":                    "/api/v1/maintenance-tasks/global",
		"maintenance-tasks-local":              "/api/v1/maintenance-tasks/local",
		"media":                                "/api/v1/media/global",
		"media-local":                          "/api/v1/media/local",
		"metrics":                              "/api/v1/metrics/circuit-breakers",
		"notifications":                        "/api/v1/notifications",
		"notifications-dx":                     "/api/v1/notifications/dx",
		"notifications-unacknowledged":         "/api/v1/notifications/unacknowledged",
		"oauth":                                "/api/v1/oauth/oauth-access-tokens",
		"persons":                              "/api/v1/persons",
		"persons-dx":                           "/api/v1/persons/dx",
		"persons-requesting-access":            "/api/v1/persons/requesting-access",
		...
		"schedules-running-schedule-ids":       "/api/v1/schedules/running-schedule-ids",
		"scripts":                              "/api/v1/scripts/disabled-preflight-scripts",
		"scripts-dx":                           "/api/v1/scripts/dx",
		"scripts-functions":                    "/api/v1/scripts/functions",
		"scripts-global":                       "/api/v1/scripts/global",
		"scripts-global-names":                 "/api/v1/scripts/global/names",
		"scripts-local":                        "/api/v1/scripts/local",
		"scripts-local-names":                  "/api/v1/scripts/local/names",
		"smtp-configs":                         "/api/v1/smtp-configs",
		"software":                             "/api/v1/software/global",
		"software-local":                       "/api/v1/software/local",
		"system":                               "/api/v1/system/timezones",
		"system-releases":                      "/api/v1/system/releases",
		"tags":                                 "/api/v1/tags",
		"target-assignments":                   "/api/v1/target-assignments",
		"target-assignments-change-requests":   "/api/v1/target-assignments/change-requests",
		"target-assignments-global":            "/api/v1/target-assignments/global",
		"target-assignments-maintenance-item-orders": "/api/v1/target-assignments/maintenance-item-orders",
		"target-assignments-recommended-approvals":   "/api/v1/target-assignments/recommended-approvals",
		"tenants":                 "/api/v1/tenants",
		"tenants-computer-counts": "/api/v1/tenants/computer-counts",
		"tenants-excluded-from-cross-tenant-deployments": "/api/v1/tenants/excluded-from-cross-tenant-deployments",
		"tenants-software-from-inventory-dx":             "/api/v1/tenants/software-from-inventory/dx",
		"user-role-assignments":                          "/api/v1/user-role-assignments",
		"users":                                          "/api/v1/users",
		"users-claims":                                   "/api/v1/users/claims",
	}
...
var itemHydrationPaths = map[string]itemHydrationConfig{
	"schedules-running-schedule-ids": {path: "/api/v1/schedules/{scheduleId}", idParam: "scheduleId"},
}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "api_v1_scripts_global_audit", ParentTable: "scripts", ParentIDParam: "scriptId", PathTemplate: "/api/v1/scripts/global/{scriptId}/audit", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "scriptId", Field: "id"},
		}},
		{Name: "api_v1_scripts_local_audit", ParentTable: "scripts", ParentIDParam: "scriptId", PathTemplate: "/api/v1/scripts/local/{scriptId}/audit", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "scriptId", Field: "id"},
		}},
		{Name: "assignments", ParentTable: "roles", ParentIDParam: "roleId", PathTemplate: "/api/v1/roles/{roleId}/assignments", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.role", PathParams: []dependentPathParamDef{
			{Param: "roleId", Field: "id"},
		}},
		{Name: "role_assignments", ParentTable: "groups", ParentIDParam: "groupId", PathTemplate: "/api/v1/groups/{groupId}/role-assignments", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.group", PathParams: []dependentPathParamDef{
...
var flatReconcileModes = map[string]string{
	"audits":                               "flat_global",
	"audits-local-dx":                      "flat_global",
	"azure-errors":                         "flat_global",
	"brandings":                            "flat_global",
	"chocolatey":                           "flat_global",
	"computers":                            "flat_global",
	"computers-agent-status":               "flat_global",
	"computers-inventory":                  "flat_global",
	"computers-my":                         "flat_global",
	"computers-onboarding":                 "flat_global",
	"computers-paged":                      "flat_global",
	"computers-user-affinities":            "flat_global",
	"dynamic-provider-types":               "flat_global",
	"groups":                               "flat_global",
	"inventory-tasks":                      "flat_global",
	"licenses":                             "flat_global",
	"maintenance-actions":                  "flat_global",
	"maintenance-actions-maintenance-item": "flat_global",
	"maintenance-actions-version":          "flat_global",
	"maintenance-tasks":                    "flat_global",
	"maintenance-tasks-local":              "flat_global",
	"notifications":                        "flat_global",
	"notifications-dx":                     "flat_global",
	"notifications-unacknowledged":         "flat_global",
	"oauth":                                "flat_global",
	"persons":                              "flat_global",
	"persons-dx":                           "flat_global",
	"persons-requesting-access":            "flat_global",
	"provider-agents":                      "flat_global",
	"provider-links":                       "flat_global",
	"provider-types":                       "flat_global",
	"rmm-links":                            "flat_global",
	"roles":                                "flat_global",
	"roles-permissions":                    "flat_global",
	"schedules":                            "flat_global",
	"scripts":                              "flat_global",
	"scripts-functions":                    "flat_global",
	"scripts-global":                       "flat_global",
	"scripts-global-names":                 "flat_global",
	"scripts-local":                        "flat_global",
	"scripts-local-names":                  "flat_global",
	"smtp-configs":                         "flat_global",
	"software":                             "flat_global",
	"software-local":                       "flat_global",
	"system":                               "flat_global",
	"tags":                                 "flat_global",
	"target-assignments":                   "flat_global",
	"target-assignments-change-requests":   "flat_global",
	"target-assignments-global":            "flat_global",
	"target-assignments-maintenance-item-orders": "flat_global",
	"tenants":                 "flat_global",
	"tenants-computer-counts": "flat_global",
	"tenants-excluded-from-cross-tenant-deployments": "flat_global",
	"tenants-software-from-inventory-dx":             "flat_global",
	"user-role-assignments":                          "flat_global",
	"users":                                          "flat_global",
}
...
var reconcileTypedTables = map[string]string{
	...
	"actions":                         "actions",
	"agents":                          "agents",
	"application-locks":               "application_locks",
	"application-logs":                "application_logs",
	"approve":                         "approve",
	"asset_field_mappings":            "asset_field_mappings",
	"asset_fields":                    "asset_fields",
	"asset_match_fields":              "asset_match_fields",
	"assets":                          "assets",
	"assignments":                     "assignments",
	"audits":                          "audits",
	"azure":                           "azure",
	"azure-errors":                    "azure_errors",
	...
	"comment":                         "comment",
	"computers":                       "computers",
	"computers_notes":                 "computers_notes",
	"computers_provider_links":        "computers_provider_links",
	"cross_references":                "cross_references",
	"deny":                            "deny",
	"deny_access":                     "deny_access",
	"detected_computer_software":      "detected_computer_software",
	"detected_software":               "detected_software",
	"device_update_form_data":         "device_update_form_data",
	"duplicate":                       "duplicate",
	"dynamic-provider-types":          "dynamic_provider_types",
	"effective-permissions":           "effective_permissions",
	"ephemeral_agent":                 "ephemeral_agent",
	"ephemeral_agent_circuit_breaker": "ephemeral_agent_circuit_breaker",
	"events":                          "events",
	"exclude_from_maintenance":        "exclude_from_maintenance",
	"exclude_from_user_affinity":      "exclude_from_user_affinity",
	"getting-started":                 "getting_started",
	"grant_access":                    "grant_access",
	"groups":                          "groups",
	"identification_logs":             "identification_logs",
	"immy_field_samples":              "immy_field_samples",
	"impersonate":                     "impersonate",
	"inventory-tasks":                 "inventory_tasks",
	"inventory_script_results":        "inventory_script_results",
	"jobs":                            "jobs",
	"last_log":                        "last_log",
	"launch_ephemeral_agent":          "launch_ephemeral_agent",
	"licenses":                        "licenses",
	"maintenance-actions":             "maintenance_actions",
	"maintenance-sessions":            "maintenance_sessions",
	"maintenance-tasks":               "maintenance_tasks",
	"maintenance_actions_logs":        "maintenance_actions_logs",
	"maintenance_sessions_cancel":     "maintenance_sessions_cancel",
	"maintenance_sessions_logs":       "maintenance_sessions_logs",
	"maintenance_tasks_authorization": "maintenance_tasks_authorization",
	"media":                           "media",
	"members":                         "members",
	"metrics":                         "metrics",
	...
	"old_logs":                        "old_logs",
	"override":                        "override",
	"parent_tenant_info":              "parent_tenant_info",
	"pending_conflicts":               "pending_conflicts",
	"persons":                         "persons",
	"phases":                          "phases",
	"preferences":                     "preferences",
	"provider-agents":                 "provider_agents",
	"provider-links":                  "provider_links",
	"provider-types":                  "provider_types",
	"provider_links_audits":           "provider_links_audits",
	"registry":                        "registry",
	...
	"resolve_onboarding_overridable_target_assignments": "resolve_onboarding_overridable_target_assignments",
	"resume":                             "resume",
	"rmm-links":                          "rmm_links",
	...
	"run_now":                            "run_now",
	"schedules":                          "schedules",
	"schedules_cancel":                   "schedules_cancel",
	"scripts":                            "scripts",
	"self_service":                       "self_service",
	"set_to_needs_onboarding":            "set_to_needs_onboarding",
	"silence":                            "silence",
	...
	"system":                             "system",
	"tags":                               "tags",
	"tags_authorization":                 "tags_authorization",
	"target-assignments":                 "target_assignments",
	"target_assignments_change_requests": "target_assignments_change_requests",
	"target_assignments_notes":           "target_assignments_notes",
	"tenants":                            "tenants",
	"tenants_computers":                  "tenants_computers",
	"tickets":                            "tickets",
	"type":                               "type",
	"unsilence":                          "unsilence",
	"update_additional_persons":          "update_additional_persons",
	"update_primary_person":              "update_primary_person",
...
func responsePathForResource(resource, path string) []string {
	...
	case "application-logs\x00/api/v1/application-logs/source-contexts":
		return []string{"sourceContextLogLevels"}
	case "billing\x00/api/v1/billing/subscription-details":
		return []string{"featuresEnabledFromSubscription"}
	case "change-requests\x00/api/v1/change-requests/dx":
		return []string{"data"}
	case "computers\x00/api/v1/computers/dx":
		return []string{"data"}
	case "computers\x00/api/v1/computers/paged":
		return []string{"results"}
	case "effective-permissions\x00/api/v1/effective-permissions/groups/{groupId}/evaluate/all-assignments":
		return []string{"permissions"}
	case "effective-permissions\x00/api/v1/effective-permissions/groups/{groupId}/evaluate/resource":
		return []string{"permissions"}
	case "effective-permissions\x00/api/v1/effective-permissions/groups/{groupId}/evaluate/tenant":
		return []string{"permissions"}
	case "effective-permissions\x00/api/v1/effective-permissions/users/{userId}/evaluate/all-assignments":
		return []string{"permissions"}
	case "effective-permissions\x00/api/v1/effective-permissions/users/{userId}/evaluate/resource":
		return []string{"permissions"}
	case "effective-permissions\x00/api/v1/effective-permissions/users/{userId}/evaluate/tenant":
		return []string{"permissions"}
	case "inventory-tasks\x00/api/v1/inventory-tasks/local":
		return []string{"scripts"}
	case "inventory-tasks\x00/api/v1/inventory-tasks/local/{id}":
		return []string{"scripts"}
	case "inventory-tasks\x00/api/v1/inventory-tasks/local/{taskId}/scripts/{inventoryKey}":
		return []string{"scripts"}
	case "licenses\x00/api/v1/licenses/dx":
		return []string{"data"}
	case "maintenance-actions\x00/api/v1/maintenance-actions/dx-for-computer/{computerId}":
		return []string{"data"}
	case "maintenance-sessions\x00/api/v1/maintenance-sessions/dx":
		return []string{"data"}
	case "maintenance-tasks\x00/api/v1/maintenance-tasks/duplicate":
		return []string{"parameters"}
	case "maintenance-tasks\x00/api/v1/maintenance-tasks/global":
		return []string{"parameters"}
	case "maintenance-tasks\x00/api/v1/maintenance-tasks/global/{id}":
		return []string{"parameters"}
	case "maintenance-tasks\x00/api/v1/maintenance-tasks/local":
		return []string{"parameters"}
	case "maintenance-tasks\x00/api/v1/maintenance-tasks/local/{id}":
		return []string{"parameters"}
	case "media\x00/api/v1/media/local/{id}/authorization":
		return []string{"authorizedViewerTenants"}
	case "media\x00/api/v1/media/global":
		return []string{"data"}
	case "media\x00/api/v1/media/local":
		return []string{"data"}
	case "persons\x00/api/v1/persons":
		return []string{"personTagIds"}
	case "persons\x00/api/v1/persons/{id}":
		return []string{"personTagIds"}
	case "provider-agents\x00/api/v1/provider-agents/pending":
		return []string{"results"}
	case "roles\x00/api/v1/roles":
		return []string{"roleClaims"}
	case "roles\x00/api/v1/roles/{roleId}":
		return []string{"roleClaims"}
	case "scripts\x00/api/v1/scripts/local/{scriptId}/authorization":
		return []string{"authorizedViewerTenants"}
	case "scripts\x00/api/v1/scripts/syntax-check":
		return []string{"errors"}
	case "scripts\x00/api/v1/scripts/dx":
		return []string{"data"}
	case "software\x00/api/v1/software/local/{softwareIdentifier}/authorization":
		return []string{"authorizedViewerTenants"}
	case "system\x00/api/v1/system/releases":
		return []string{"latestReleases"}
	case "target-assignments\x00/api/v1/target-assignments/change-request/{changeRequestId}":
		return []string{"comments"}
	case "target-assignments\x00/api/v1/target-assignments/change-request":
		return []string{"comments"}
	case "target-assignments\x00/api/v1/target-assignments/duplicates":
		return []string{"duplicateIds"}
	case "target-assignments\x00/api/v1/target-assignments/target-preview":
		return []string{"targetedComputers"}
	case "target-assignments\x00/api/v1/target-assignments/change-request/{changeRequestId}/diff":
		return []string{"parameterDiffs"}
	case "tenants\x00/api/v1/tenants/bulk-delete":
		return []string{"tenantResults"}
	case "users\x00/api/v1/users/bulk-create":
		return []string{"createdUserIds"}
	case "users\x00/api/v1/users/{userId}":
		return []string{"groups"}
	case "users\x00/api/v1/users/claims":
