...
func newUserRoleAssignmentsGetUsersByUserIdCountCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveReadWithStrategyAndResponsePath(cmd.Context(), c, flags, "live", "user-role-assignments", false, path, params, nil, "", cmd.ErrOrStderr())
			if err != nil {
