...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  immybot-cli which "stale tickets"
  immybot-cli which "bottleneck"
  immybot-cli which --limit 1 "send message"
  immybot-cli which                                # list the full capability index`,
