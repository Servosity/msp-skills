...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [itglue-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/itglue/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/itglue/install.ps1
---
...
The installer places the `itglue-cli` and `itglue-mcp` binaries on your PATH. It does not
