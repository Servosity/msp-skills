...
large datasets as it has no memory pressure.`,
  ...
  itglue-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  itglue-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  itglue-cli export <resource> --format jsonl | jq '.id'`,
