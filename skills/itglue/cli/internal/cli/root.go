...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "itglue-cli",
		Short: `Itglue CLI — Every IT Glue resource, plus an offline SQLite mirror, fleet-wide cross-resource search, and documentation-hygiene anal…`,
		Long: `Itglue CLI — Every IT Glue resource, plus an offline SQLite mirror, fleet-wide cross-resource search, and documentation-hygiene anal…
...
Health check: run 'itglue-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("itglue-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'itglue-cli profile list')")
	...
	rootCmd.AddCommand(newConfigurationsCmd(flags))
	...
	rootCmd.AddCommand(newPasswordsCmd(flags))
	...
	rootCmd.AddCommand(newNovelOrgCmd(flags))
