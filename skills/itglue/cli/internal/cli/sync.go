...
Resource scoping:
  ...
  itglue-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  itglue-cli sync --full

  # Incremental sync: only records from the last 7 days
  itglue-cli sync --since 7d

  # Parallel sync with 8 workers
  itglue-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  itglue-cli sync --latest-only`,
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "relationships", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/organizations/{organization_id}/relationships/configurations", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "organization_id", Field: "id"},
		}},
		{Name: "relationships", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/organizations/{organization_id}/relationships/contacts", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "organization_id", Field: "id"},
		}},
		{Name: "relationships", ParentTable: "organizations", ParentIDParam: "organization_id", PathTemplate: "/organizations/{organization_id}/relationships/documents", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "organization_id", Field: "id"},
		}},
	}
}
