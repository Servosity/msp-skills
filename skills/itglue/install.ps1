# install.ps1 - install itglue-cli and itglue-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (itglue-v*).
...
$Skill   = "itglue"
$CliBin  = "itglue-cli.exe"
$McpBin  = "itglue-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (itglue-vX.Y.Z),
...
Write-Host "  itglue-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/itglue#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/itglue/mcp-install.md"
