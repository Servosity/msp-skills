#!/usr/bin/env bash
# install.sh - install itglue-cli and itglue-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (itglue-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/itglue#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/itglue/mcp-install.md"
