...
func newAdminGetChartOfAccountsLookupCmd(flags *rootFlags) *cobra.Command {
	var flagPageSize int
	var flagPageNumber int
	var flagAll bool

	cmd := &cobra.Command{
		Use:         "get-chart-of-accounts-lookup <parentAccountCodeId>",
		Short:       "Get chart of accounts lookup",
		Example:     "  kaseya-bms-cli admin get-chart-of-accounts-lookup 50",
		Annotations: map[string]string{"pp:endpoint": "admin.get-chart-of-accounts-lookup", "pp:method": "GET", "pp:path": "/v2/admin/finance/chartofaccounts/lookup/{parentAccountCodeId}", "mcp:read-only": "true"},
