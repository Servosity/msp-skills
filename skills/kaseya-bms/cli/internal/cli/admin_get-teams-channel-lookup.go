...
func newAdminGetTeamsChannelLookupCmd(flags *rootFlags) *cobra.Command {
	var flagIds string
	var flagName string
	var flagSort string
	...
	cmd := &cobra.Command{
		Use:         "get-teams-channel-lookup",
		Short:       "Get teams channel lookup",
		Example:     "  kaseya-bms-cli admin get-teams-channel-lookup",
		Annotations: map[string]string{"pp:endpoint": "admin.get-teams-channel-lookup", "pp:method": "GET", "pp:path": "/v2/admin/teamschannel/lookup", "mcp:read-only": "true"},
