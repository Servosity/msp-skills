...
but do not stop the import.`,
  ...
  kaseya-bms-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  kaseya-bms-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | kaseya-bms-cli import <resource> --input -`,
