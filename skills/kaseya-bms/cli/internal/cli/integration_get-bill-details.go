...
func newIntegrationGetBillDetailsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !cmd.Flags().Changed("bill-ids") && !flags.dryRun {
				return fmt.Errorf("required flag \"%s\" not set", "bill-ids")
			}
	...
	cmd.Flags().StringVar(&flagBillIds, "bill-ids", "", "Bill ids")
