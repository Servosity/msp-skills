...
func newIntegrationGetInvoiceDetailsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !cmd.Flags().Changed("invoice-numbers") && !flags.dryRun {
				return fmt.Errorf("required flag \"%s\" not set", "invoice-numbers")
			}
	...
	cmd.Flags().StringVar(&flagInvoiceNumbers, "invoice-numbers", "", "Invoice numbers")
