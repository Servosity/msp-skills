...
func newIntegrationGetReimbursementDetailsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !cmd.Flags().Changed("reimbursement-ids") && !flags.dryRun {
				return fmt.Errorf("required flag \"%s\" not set", "reimbursement-ids")
			}
	...
	cmd.Flags().StringVar(&flagReimbursementIds, "reimbursement-ids", "", "Reimbursement ids")
