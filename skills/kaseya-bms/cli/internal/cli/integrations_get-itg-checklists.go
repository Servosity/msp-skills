...
func newIntegrationsGetItgChecklistsCmd(flags *rootFlags) *cobra.Command {
	var flagName string
	...
	cmd := &cobra.Command{
		Use:         "get-itg-checklists",
		Short:       "Get itg checklists",
		Example:     "  kaseya-bms-cli integrations get-itg-checklists --account-id 50",
		Annotations: map[string]string{"pp:endpoint": "integrations.get-itg-checklists", "pp:method": "GET", "pp:path": "/v2/integrations/itglue/checklists", "mcp:read-only": "true"},
