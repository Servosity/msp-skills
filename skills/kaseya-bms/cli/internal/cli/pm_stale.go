...
func init() {
	...
	for _, f := range []string{
		...
		"ExpiresOn",
		"ExpiryDate",
		"Filter.CompletedDateFrom",
		"Filter.CompletedDateTo",
		"Filter.CreatedFrom",
		"Filter.CreatedOnFrom",
		"Filter.CreatedOnTo",
		"Filter.CreatedTo",
		"Filter.DueDateFrom",
		"Filter.DueDateTo",
		"Filter.EndDate",
		"Filter.LastActivityUpdateFrom",
		"Filter.LastActivityUpdateTo",
		"Filter.LastPriorityUpdateFrom",
		"Filter.LastPriorityUpdateTo",
		"Filter.LastQueueUpdateFrom",
		"Filter.LastQueueUpdateTo",
		"Filter.LastStatusUpdateFrom",
		"Filter.LastStatusUpdateTo",
		"Filter.ModifiedOnFrom",
		"Filter.ModifiedOnTo",
		"Filter.OpenDateFrom",
		"Filter.OpenDateTo",
		"Filter.ResolutionTargetTimeFrom",
		"Filter.ResolutionTargetTimeTo",
		"Filter.StartDate",
		"Filter.StartDateFrom",
		"Filter.StartDateTo",
		"FirstCheckIn",
		"FirstResponseActualTime",
		"FirstResponseTargetTime",
		"FromDate",
		"FromDeliveryDate",
		"GeneratedOn",
		"InvoiceDate",
		...
		"LastOccurrenceDate",
		"LastPriorityUpdate",
		"LastPriorityUpdateFrom",
		"LastPriorityUpdateTo",
		"LastQueueUpdate",
		"LastQueueUpdateFrom",
		"LastQueueUpdateTo",
		"LastReboot",
		"LastStatusUpdate",
		"LastStatusUpdateFrom",
		"LastStatusUpdateTo",
		"LastUpdated",
		"ModifiedOn",
		"NoteDate",
		...
		"ReimbursementDate",
		"ResolutionActualTime",
		"ResolutionTargetTime",
		"ResolutionTargetTimeFrom",
...
the specified number of days. Useful for identifying forgotten or blocked work.`,
  ...
  kaseya-bms-cli stale

  # Find items not updated in 14 days
  kaseya-bms-cli stale --days 14

  # Filter by team
  kaseya-bms-cli stale --days 7 --team backend

  # Output as JSON
  kaseya-bms-cli stale --days 30 --json`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if err != nil {
				return fmt.Errorf("opening local database: %w\nRun 'kaseya-bms-cli sync' first.", err)
			}
			defer db.Close()
