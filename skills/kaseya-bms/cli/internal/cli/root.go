...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "kaseya-bms-cli",
		Short: `Kaseya Bms CLI — The first dedicated CLI and MCP server for Kaseya BMS - the full PSA surface plus offline sync, full-text search, and t…`,
		Long: `Kaseya Bms CLI — The first dedicated CLI and MCP server for Kaseya BMS - the full PSA surface plus offline sync, full-text search, and t…
...
Health check: run 'kaseya-bms-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("kaseya-bms-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'kaseya-bms-cli profile list')")
	...
	rootCmd.AddCommand(newClientportalCmd(flags))
	rootCmd.AddCommand(newCrmCmd(flags))
	rootCmd.AddCommand(newFinanceCmd(flags))
	rootCmd.AddCommand(newHrCmd(flags))
	rootCmd.AddCommand(newIntegrationCmd(flags))
	rootCmd.AddCommand(newIntegrationsCmd(flags))
	rootCmd.AddCommand(newInventoryCmd(flags))
	rootCmd.AddCommand(newKaseyaOneCmd(flags))
	rootCmd.AddCommand(newListingCmd(flags))
	rootCmd.AddCommand(newMyCmd(flags))
	rootCmd.AddCommand(newProjectCmd(flags))
	rootCmd.AddCommand(newRmmCmd(flags))
	rootCmd.AddCommand(newSecurityCmd(flags))
	rootCmd.AddCommand(newServicedeskCmd(flags))
	...
	rootCmd.AddCommand(newNovelQueueHealthCmd(flags))
	...
	rootCmd.AddCommand(newTimelogsPromotedCmd(flags))
