...
func newServicedeskGetServiceCallsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get-service-calls <ticketId>",
		Short:       "Get service calls",
		Example:     "  kaseya-bms-cli servicedesk get-service-calls 42",
		Annotations: map[string]string{"pp:endpoint": "servicedesk.get-service-calls", "pp:method": "GET", "pp:path": "/v2/servicedesk/tickets/{ticketId}/servicecalls", "mcp:read-only": "true"},
