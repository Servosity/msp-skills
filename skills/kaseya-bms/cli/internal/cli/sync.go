...
Resource scoping:
  ...
  kaseya-bms-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  kaseya-bms-cli sync --full

  # Incremental sync: only records from the last 7 days
  kaseya-bms-cli sync --since 7d

  # Parallel sync with 8 workers
  kaseya-bms-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  kaseya-bms-cli sync --latest-only`,
...
func resourceSupportsPagination(resource string) bool {
	switch resource {
	case "admin-finance-accountcodes-lookup":
		return true
	case "admin-finance-chartofaccounts":
		return true
	case "admin-finance-chartofaccounts-types":
		return true
	case "admin-finance-services-lookup":
		return true
	case "admin-security-roles-lookup":
		return true
	case "admin-teamschannel-lookup":
		return true
	case "crm":
		return true
	case "crm-accounts-lookup":
		return true
	case "crm-accounts-summary":
		return true
	case "crm-contacts-summary":
		return true
	case "crm-productquotes-summary":
		return true
	case "crm-quotes-summary":
		return true
	case "crm-salesaccelerator-dashboard-data":
		return true
	case "finance-contracts-summary":
		return true
	case "finance-invoices-summary":
		return true
	case "hr":
		return true
	case "hr-assignees-lookup":
		return true
	case "hr-employees-lookup":
		return true
	case "hr-employees-searchselect":
		return true
	case "integrations-itglue-servicedesk-globalsearch":
		return true
	case "integrations-itglue-servicedesk-ticketsync":
		return true
	case "inventory-products-categories-lookup":
		return true
	case "inventory-products-searchselect":
		return true
	case "inventory-purchaseorders-lookup":
		return true
	case "mappings":
		return true
	case "project":
		return true
	case "project-projects-summary":
		return true
	case "servicedesk":
		return true
	case "servicedesk-dashboard-ticketsdue":
		return true
	case "servicedesk-dashboard-ticketsupcoming":
		return true
	case "servicedesk-hardwareasset-searchselect":
		return true
	case "servicedesk-mytickets":
		return true
	case "servicedesk-queuetickets":
		return true
	case "servicedesk-software-assets-searchselect":
		return true
	case "servicedesk-tickets-searchselect":
		return true
	case "servicedesk-tickets-summary":
		return true
	case "timelogs":
		return true
	}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "agentprocedures":
		return db.UpsertAgentprocedures(data)
	case "calendar":
		return db.UpsertCalendar(data)
	case "clientportal":
		return db.UpsertClientportal(data)
	case "crm":
		return db.UpsertCrm(data)
	case "finance":
		return db.UpsertFinance(data)
	case "hr":
		return db.UpsertHr(data)
	case "integration":
		return db.UpsertIntegration(data)
	case "integrations":
		return db.UpsertIntegrations(data)
	case "inventory":
		return db.UpsertInventory(data)
	case "kaseya-one":
		return db.UpsertKaseyaOne(data)
	case "listing":
		return db.UpsertListing(data)
	case "my":
		return db.UpsertMy(data)
	case "project":
		return db.UpsertProject(data)
	case "rmm":
		return db.UpsertRmm(data)
	case "assets":
		return db.UpsertAssets(data)
	case "mappings":
		return db.UpsertMappings(data)
	case "remotesessions":
		return db.UpsertRemotesessions(data)
	case "status":
	...
	case "servicedesk":
		return db.UpsertServicedesk(data)
	case "system":
		return db.UpsertSystem(data)
	case "timelogs":
		return db.UpsertTimelogs(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		"admin",
		"admin-copilot-configuration",
		"admin-finance-accountcodes-lookup",
		"admin-finance-chartofaccounts",
		"admin-finance-chartofaccounts-types",
		"admin-finance-chartofaccounts-types-lookup",
		"admin-finance-servicecategory-lookup",
		"admin-finance-services-lookup",
		"admin-hr-departments-lookup",
		"admin-hr-jobtitles-lookup",
		"admin-k1-accesscontrol-accessgroups",
		"admin-security-roles-lookup",
		"admin-teamschannel-lookup",
		"admin-webhooks-events-lookup",
		"admin-workflows-satisfactionscore-lookup",
		"admin-workflows-system-servicetype-lookup",
		"crm",
		"crm-accounts-lookup",
		"crm-accounts-summary",
		"crm-contacts-summary",
		"crm-dashboard-nextopportunities",
		"crm-dashboard-topopportunities",
		"crm-opportunities-statuses-lookup",
		"crm-productquotes-summary",
		"crm-quotes-summary",
		"finance",
		"finance-contracts-summary",
		"finance-invoices-summary",
		"hr",
		"hr-assignees-lookup",
		"hr-employees-lookup",
		"hr-employees-searchselect",
		"integrations-itglue-servicedesk-globalsearch",
		"integrations-itglue-servicedesk-ticketsync",
		"integrations-surveyhistory",
		"inventory",
		"inventory-products-categories-lookup",
		"inventory-products-searchselect",
		"inventory-purchaseorders-lookup",
		"my",
		"project",
		"project-projects-summary",
		"project-statuses-lookup",
		"servicedesk",
		"servicedesk-hardwareasset-searchselect",
		"servicedesk-mytickets",
		"servicedesk-queuetickets",
		"servicedesk-software-assets-searchselect",
		"servicedesk-templates-notes-lookup",
		"servicedesk-templates-tickets-lookup",
		"servicedesk-templates-timelogs-lookup",
		"servicedesk-tickets-searchselect",
		"servicedesk-tickets-summary",
		"system",
		"system-accounttypes-lookup",
		"system-approvalroutes-lookup",
		"system-colors-lookup",
		"system-expensetypes-lookup",
		"system-issuetypes-lookup",
		"system-locations-lookup",
...
func knownSyncResourceNames() []string {
	names := []string{
		...
		"admin-hr-jobtitles-lookup",
		"admin-k1-accesscontrol-accessgroups",
		"admin-k1-accesscontrol-mappings",
		"admin-security-roles-lookup",
		"admin-teamschannel-lookup",
		"admin-webhooks-events-lookup",
		"admin-workflows-customfieldoperator",
		"admin-workflows-satisfactionscore-lookup",
		"admin-workflows-system-servicetype-lookup",
		"crm",
		"crm-accounts-lookup",
		"crm-accounts-summary",
		"crm-contacts-summary",
		"crm-dashboard-leaderboard",
		"crm-dashboard-nextopportunities",
		"crm-dashboard-recurringservices-performance",
		"crm-dashboard-topopportunities",
		"crm-opportunities-statuses-lookup",
		"crm-productquotes-summary",
		"crm-quotes-summary",
		"crm-salesaccelerator-dashboard-data",
		"finance",
		"finance-contracts-summary",
		"finance-invoices-summary",
		"hr",
		...
		"hr-employees-searchselect",
		"integrations",
		"integrations-etilize-distributors-integrations-status",
		"integrations-etilize-products-pricing",
		"integrations-itglue-accessinfo",
		"integrations-itglue-servicedesk-globalsearch",
		"integrations-itglue-servicedesk-ticketsync",
		"integrations-surveyhistory",
		"inventory",
		...
		"rmm",
		"servicedesk",
		"servicedesk-dashboard-ticketscount-bypriority",
		"servicedesk-dashboard-ticketscount-byqueue",
		"servicedesk-dashboard-ticketscount-bystatus",
		"servicedesk-dashboard-ticketsdue",
		"servicedesk-dashboard-ticketsupcoming",
		"servicedesk-hardwareasset-searchselect",
		"servicedesk-mytickets",
		"servicedesk-queuetickets",
		"servicedesk-software-assets-searchselect",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"admin":                                      "/v2/admin/k1/modules",
		"admin-companysettings":                      "/v2/admin/companysettings",
		"admin-copilot-configuration":                "/v2/admin/copilot/configuration",
		"admin-finance-accountcodes-lookup":          "/v2/admin/finance/accountcodes/lookup",
		"admin-finance-chartofaccounts":              "/v2/admin/finance/chartofaccounts",
		"admin-finance-chartofaccounts-types":        "/v2/admin/finance/chartofaccounts/types",
		"admin-finance-chartofaccounts-types-lookup": "/v2/admin/finance/chartofaccounts/types/lookup",
		"admin-finance-servicecategory-lookup":       "/v2/admin/finance/servicecategory/lookup",
		"admin-finance-services-lookup":              "/v2/admin/finance/services/lookup",
		"admin-hr-departments-lookup":                "/v2/admin/hr/departments/lookup",
		"admin-hr-jobtitles-lookup":                  "/v2/admin/hr/jobtitles/lookup",
		"admin-k1-accesscontrol-accessgroups":        "/v2/admin/k1/accesscontrol/accessgroups",
		"admin-k1-accesscontrol-mappings":            "/v2/admin/k1/accesscontrol/mappings",
		"admin-security-roles-lookup":                "/v2/admin/security/roles/lookup",
		"admin-teamschannel-lookup":                  "/v2/admin/teamschannel/lookup",
		"admin-webhooks-events-lookup":               "/v2/admin/webhooks/events/lookup",
		"admin-workflows-customfieldoperator":        "/v2/admin/workflows/customfieldoperator",
		"admin-workflows-satisfactionscore-lookup":   "/v2/admin/workflows/satisfactionscore/lookup",
		"admin-workflows-system-servicetype-lookup":  "/v2/admin/workflows/system/servicetype/lookup",
		"crm":                                         "/v2/crm/opportunities",
		"crm-accounts-lookup":                         "/v2/crm/accounts/lookup",
		"crm-accounts-summary":                        "/v2/crm/accounts/summary",
		"crm-contacts-summary":                        "/v2/crm/contacts/summary",
		"crm-dashboard-leaderboard":                   "/v2/crm/dashboard/leaderboard",
		"crm-dashboard-nextopportunities":             "/v2/crm/dashboard/nextopportunities",
		"crm-dashboard-recurringservices-performance": "/v2/crm/dashboard/recurringservices/performance",
		"crm-dashboard-topopportunities":              "/v2/crm/dashboard/topopportunities",
		"crm-opportunities-statuses-lookup":           "/v2/crm/opportunities/statuses/Lookup",
		"crm-productquotes-summary":                   "/v2/crm/productquotes/summary",
		"crm-quotes-summary":                          "/v2/crm/quotes/summary",
		"crm-salesaccelerator-dashboard-data":         "/v2/crm/salesaccelerator/dashboard/data",
		"finance":                                     "/v2/finance/contracts/lookup",
		"finance-contracts-summary":                   "/v2/finance/contracts/summary",
		"finance-invoices-summary":                    "/v2/finance/invoices/summary",
		"hr":                                          "/v2/hr/assignees",
		"hr-assignees-lookup":                         "/v2/hr/assignees/lookup",
		"hr-employees-lookup":                         "/v2/hr/employees/lookup",
		"hr-employees-searchselect":                   "/v2/hr/employees/searchselect",
		"integrations":                                "/v2/integrations/itglue/status",
		"integrations-etilize-distributors-integrations-status": "/v2/integrations/etilize/distributors/integrations/status",
		"integrations-etilize-products-pricing":                 "/v2/integrations/etilize/products/pricing",
		"integrations-itglue-accessinfo":                        "/v2/integrations/itglue/accessinfo",
		"integrations-itglue-servicedesk-globalsearch":          "/v2/integrations/itglue/servicedesk/globalsearch",
		"integrations-itglue-servicedesk-ticketsync":            "/v2/integrations/itglue/servicedesk/ticketsync",
		"integrations-surveyhistory":                            "/v2/integrations/surveyhistory",
		"inventory":                                             "/v2/inventory/warehouses/lookup",
		"inventory-products-categories-lookup":                  "/v2/inventory/products/categories/lookup",
		"inventory-products-searchselect":                       "/v2/inventory/products/searchselect",
		"inventory-purchaseorders-lookup":                       "/v2/inventory/purchaseorders/lookup",
		"my":                                                    "/v2/my/expensesheets/lookup",
		"project":                                               "/v2/project/projects/lookup",
		"project-projects-summary":                              "/v2/project/projects/summary",
		"project-statuses-lookup":                               "/v2/project/statuses/lookup",
		"rmm":                                                   "/v2/rmm/integrations",
		"servicedesk":                                           "/v2/servicedesk/tickets",
		"servicedesk-dashboard-ticketscount-bypriority":         "/v2/servicedesk/dashboard/ticketscount/bypriority",
		"servicedesk-dashboard-ticketscount-byqueue":            "/v2/servicedesk/dashboard/ticketscount/byqueue",
		"servicedesk-dashboard-ticketscount-bystatus":           "/v2/servicedesk/dashboard/ticketscount/bystatus",
		"servicedesk-dashboard-ticketsdue":                      "/v2/servicedesk/dashboard/ticketsdue",
		"servicedesk-dashboard-ticketsupcoming":                 "/v2/servicedesk/dashboard/ticketsupcoming",
		"servicedesk-hardwareasset-searchselect":                "/v2/servicedesk/hardwareasset/searchselect",
		"servicedesk-mytickets":                                 "/v2/servicedesk/mytickets",
		"servicedesk-queuetickets":                              "/v2/servicedesk/queuetickets",
		"servicedesk-software-assets-searchselect":              "/v2/servicedesk/softwareAssets/searchselect",
		"servicedesk-templates-notes-lookup":                    "/v2/servicedesk/templates/notes/lookup",
		"servicedesk-templates-tickets-lookup":                  "/v2/servicedesk/templates/tickets/lookup",
		"servicedesk-templates-timelogs-lookup":                 "/v2/servicedesk/templates/timelogs/lookup",
		"servicedesk-tickets-searchselect":                      "/v2/servicedesk/tickets/searchselect",
		"servicedesk-tickets-summary":                           "/v2/servicedesk/tickets/summary",
		"system":                                                "/v2/system/views",
		"system-accounttypes-lookup":                            "/v2/system/accounttypes/lookup",
		"system-approvalroutes-lookup":                          "/v2/system/approvalroutes/lookup",
		"system-colors-lookup":                                  "/v2/system/colors/lookup",
		"system-expensetypes-lookup":                            "/v2/system/expensetypes/lookup",
		"system-issuetypes-lookup":                              "/v2/system/issuetypes/lookup",
		"system-locations-lookup":                               "/v2/system/locations/lookup",
		"system-priorities-lookup":                              "/v2/system/priorities/lookup",
		"system-queues-lookup":                                  "/v2/system/queues/lookup",
		"system-roles-lookup":                                   "/v2/system/roles/lookup",
		"system-slas-lookup":                                    "/v2/system/slas/lookup",
		"system-statuses-lookup":                                "/v2/system/statuses/lookup",
		"system-worktypes-lookup":                               "/v2/system/worktypes/lookup",
		"timelogs":                                              "/v2/timelogs",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "mappings", ParentTable: "rmm", ParentIDParam: "integrationType", PathTemplate: "/v2/rmm/{integrationType}/mappings/{entityType}", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "integrationType", Field: "integration_type"},
			{Param: "entityType", Field: "mappings_id"},
		}},
	}
}
