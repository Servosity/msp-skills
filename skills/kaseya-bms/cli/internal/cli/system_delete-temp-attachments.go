...
func newSystemDeleteTempAttachmentsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "delete-temp-attachments",
		Short:       "Delete temp attachments",
		Example:     "  kaseya-bms-cli system delete-temp-attachments",
		Annotations: map[string]string{"pp:endpoint": "system.delete-temp-attachments", "pp:method": "DELETE", "pp:path": "/v2/system/attachments/temp"},
