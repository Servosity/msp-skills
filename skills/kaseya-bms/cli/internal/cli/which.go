...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  kaseya-bms-cli which "stale tickets"
  kaseya-bms-cli which "bottleneck"
  kaseya-bms-cli which --limit 1 "send message"
  kaseya-bms-cli which                                # list the full capability index`,
