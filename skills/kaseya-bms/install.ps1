# install.ps1 - install kaseya-bms-cli and kaseya-bms-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (kaseya-bms-v*).
...
$Skill   = "kaseya-bms"
$CliBin  = "kaseya-bms-cli.exe"
$McpBin  = "kaseya-bms-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (kaseya-bms-vX.Y.Z),
...
Write-Host "  kaseya-bms-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/kaseya-bms#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/kaseya-bms/mcp-install.md"
