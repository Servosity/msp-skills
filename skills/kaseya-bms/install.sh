#!/usr/bin/env bash
# install.sh - install kaseya-bms-cli and kaseya-bms-mcp on macOS / Linux.
#
...
SKILL="kaseya-bms"
CLI_BIN="kaseya-bms-cli"
MCP_BIN="kaseya-bms-mcp"
...
# Each skill is versioned and tagged independently (kaseya-bms-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/kaseya-bms#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/kaseya-bms/mcp-install.md"
