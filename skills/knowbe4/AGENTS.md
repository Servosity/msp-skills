# KnowBe4 Printed CLI Agent Guide

This directory is a generated `knowbe4-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
knowbe4-cli doctor --json
knowbe4-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
knowbe4-cli which "<capability>" --json
knowbe4-cli <command> --help
```
...
```bash
knowbe4-cli <command> --help
knowbe4-cli <command> --dry-run --agent
```
