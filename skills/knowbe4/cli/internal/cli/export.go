...
large datasets as it has no memory pressure.`,
  ...
  knowbe4-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  knowbe4-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  knowbe4-cli export <resource> --format jsonl | jq '.id'`,
