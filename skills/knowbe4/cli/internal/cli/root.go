...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "knowbe4-cli",
		Short: `Sync your KnowBe4 KMSAT tenant into local SQLite and answer the questions the console cannot: repeat-clicker hunts, risk-score drift, training-coverage anti-joins, and phish-prone roll-ups.`,
		Long: `Sync your KnowBe4 KMSAT tenant into local SQLite and answer the questions the console cannot: repeat-clicker hunts, risk-score drift, training-coverage anti-joins, and phish-prone roll-ups.
...
Health check: run 'knowbe4-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("knowbe4-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'knowbe4-cli profile list')")
	...
	rootCmd.AddCommand(newPhishingCampaignsCmd(flags))
	rootCmd.AddCommand(newPhishingTestsCmd(flags))
	rootCmd.AddCommand(newPoliciesCmd(flags))
	rootCmd.AddCommand(newStorePurchasesCmd(flags))
	rootCmd.AddCommand(newTrainingCampaignsCmd(flags))
	rootCmd.AddCommand(newTrainingEnrollmentsCmd(flags))
	...
	rootCmd.AddCommand(newNovelFreshnessCmd(flags))
	rootCmd.AddCommand(newNovelGroupRiskContributionCmd(flags))
	rootCmd.AddCommand(newNovelPhishProneTrendCmd(flags))
	rootCmd.AddCommand(newNovelQbrCmd(flags))
	rootCmd.AddCommand(newNovelRepeatClickersCmd(flags))
	rootCmd.AddCommand(newNovelReportRateCmd(flags))
	rootCmd.AddCommand(newNovelRiskDriftCmd(flags))
	rootCmd.AddCommand(newNovelRiskLeaderboardCmd(flags))
	rootCmd.AddCommand(newNovelUntrainedClickersCmd(flags))
