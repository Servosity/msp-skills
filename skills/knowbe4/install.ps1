# install.ps1 - install knowbe4-cli and knowbe4-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (knowbe4-v*).
...
$Skill   = "knowbe4"
$CliBin  = "knowbe4-cli.exe"
$McpBin  = "knowbe4-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (knowbe4-vX.Y.Z),
...
Write-Host "  knowbe4-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/knowbe4#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/knowbe4/mcp-install.md"
