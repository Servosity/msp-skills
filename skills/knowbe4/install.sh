#!/usr/bin/env bash
# install.sh - install knowbe4-cli and knowbe4-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (knowbe4-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/knowbe4#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/knowbe4/mcp-install.md"
