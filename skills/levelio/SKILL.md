...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [levelio-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/levelio/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/levelio/install.ps1
---
...
The installer places the `levelio-cli` and `levelio-mcp` binaries on your PATH. It does not
