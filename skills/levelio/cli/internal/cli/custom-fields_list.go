...
func newCustomFieldsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Returns a list of custom fields.",
		Example:     "  levelio-cli custom-fields list",
		Annotations: map[string]string{"pp:endpoint": "custom-fields.list", "pp:method": "GET", "pp:path": "/v2/custom_fields", "mcp:read-only": "true"},
