# install.ps1 - install levelio-cli and levelio-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (levelio-v*).
...
$Skill   = "levelio"
$CliBin  = "levelio-cli.exe"
$McpBin  = "levelio-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (levelio-vX.Y.Z),
...
Write-Host "  levelio-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/levelio#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/levelio/mcp-install.md"
