#!/usr/bin/env bash
# install.sh - install levelio-cli and levelio-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (levelio-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/levelio#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/levelio/mcp-install.md"
