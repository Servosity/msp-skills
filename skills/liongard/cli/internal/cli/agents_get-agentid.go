...
func newAgentsGetAgentidCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  liongard-cli agents get-agentid 42",
		Annotations: map[string]string{"pp:endpoint": "agents.get-agentid", "pp:method": "GET", "pp:path": "/agents/{AgentID}", "mcp:read-only": "true"},
