...
func newDetectionsDetectionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "detections",
		Aliases:     []string{"list"},
		Short:       "Returns a list of all detection events.",
		Example:     "  liongard-cli detections list --agent --select ID,EnvironmentID,Name",
		Annotations: map[string]string{"pp:endpoint": "detections.detections", "pp:method": "GET", "pp:path": "/detections", "mcp:read-only": "true"},
