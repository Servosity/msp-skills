...
func newDetectionsDetectionsbyIdCmd(flags *rootFlags) *cobra.Command {
	var flagFields string

	cmd := &cobra.Command{
		Use:         "detectionsby-id <DetectionID>",
		Aliases:     []string{"get"},
		Short:       "Gets a specific detection.",
		Example:     "  liongard-cli detections detectionsby-id 42",
		Annotations: map[string]string{"pp:endpoint": "detections.detectionsby-id", "pp:method": "GET", "pp:path": "/detections/{DetectionID}", "mcp:read-only": "true"},
