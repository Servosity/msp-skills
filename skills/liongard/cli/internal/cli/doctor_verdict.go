...
//
// See issue #282 and skills/liongard/handfixes.json.
//
...
import (
	...
	"liongard-pp-cli/internal/client"
)
...
const doctorBaseURLEnv = "LIONGARD_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://{instance}.app.liongard.com/api/v1"
