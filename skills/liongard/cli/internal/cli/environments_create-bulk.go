...
func newEnvironmentsCreateBulkCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-bulk",
		Short:       "Create many environments at once.",
		Example:     "  liongard-cli environments create-bulk",
		Annotations: map[string]string{"pp:endpoint": "environments.create-bulk", "pp:method": "POST", "pp:path": "/environments/bulk"},
