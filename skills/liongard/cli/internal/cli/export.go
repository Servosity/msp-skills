...
large datasets as it has no memory pressure.`,
  ...
  liongard-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  liongard-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  liongard-cli export <resource> --format jsonl | jq '.id'`,
