...
func newInspectorTemplatesGetInspectorsCmd(flags *rootFlags) *cobra.Command {
	var flagFields string

	cmd := &cobra.Command{
		Use:         "get-inspectors <InspectorId>",
		Aliases:     []string{"get"},
		Short:       "Get Inspector Config and SecureConfig Fields.",
		Example:     "  liongard-cli inspector templates get-inspectors 42",
		Annotations: map[string]string{"pp:endpoint": "templates.get-inspectors", "pp:method": "GET", "pp:path": "/inspector/{InspectorId}/templates", "mcp:read-only": "true"},
