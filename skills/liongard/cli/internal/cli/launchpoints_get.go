...
func newLaunchpointsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "get",
		Aliases:     []string{"list"},
		Short:       "Lists all launchpoints.",
		Example:     "  liongard-cli launchpoints get",
		Annotations: map[string]string{"pp:endpoint": "launchpoints.get", "pp:method": "GET", "pp:path": "/launchpoints", "mcp:read-only": "true"},
