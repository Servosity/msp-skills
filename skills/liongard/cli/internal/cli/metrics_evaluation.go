...
func newMetricsEvaluationCmd(flags *rootFlags) *cobra.Command {
	var flagSystems string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !cmd.Flags().Changed("systems") && !flags.dryRun {
				return fmt.Errorf("required flag \"%s\" not set", "systems")
			}
	...
	cmd.Flags().StringVar(&flagSystems, "systems", "", "List of system IDs")
	cmd.Flags().StringVar(&flagMetrics, "metrics", "", "List of metric IDs")
	cmd.Flags().StringVar(&flagUuids, "uuids", "", "List of metric UUIDs")
	cmd.Flags().BoolVar(&flagIncludeNonVisible, "include-non-visible", false, "If you want to include non-enabled metrics to be evaluated")
