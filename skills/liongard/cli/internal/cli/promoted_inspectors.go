...
func newInspectorsPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagFields string

	cmd := &cobra.Command{
		Use:         "inspectors",
		Short:       "Lists all avaialble Inspectors in Liongard",
		Long:        "Lists all avaialble Inspectors in Liongard",
		Example:     "  liongard-cli inspectors",
		Annotations: map[string]string{"pp:endpoint": "inspectors.get", "pp:method": "GET", "pp:path": "/inspectors", "mcp:read-only": "true"},
