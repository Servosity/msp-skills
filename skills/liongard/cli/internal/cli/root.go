...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "liongard-cli",
		Short: `Liongard CLI — Every Liongard endpoint, plus an offline copy of your whole MSP estate you can join, search, and drift-check from one c…`,
		Long: `Liongard CLI — Every Liongard endpoint, plus an offline copy of your whole MSP estate you can join, search, and drift-check from one c…
...
Health check: run 'liongard-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("liongard-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'liongard-cli profile list')")
	...
	rootCmd.AddCommand(newAccessKeysCmd(flags))
	rootCmd.AddCommand(newAgentsCmd(flags))
	rootCmd.AddCommand(newAuthenticationCmd(flags))
	rootCmd.AddCommand(newDetectionsCmd(flags))
	rootCmd.AddCommand(newEnvironmentsCmd(flags))
	rootCmd.AddCommand(newInspectorCmd(flags))
	rootCmd.AddCommand(newLaunchpointsCmd(flags))
	rootCmd.AddCommand(newMetricsCmd(flags))
	rootCmd.AddCommand(newSystemsCmd(flags))
	...
	rootCmd.AddCommand(newInspectorsPromotedCmd(flags))
