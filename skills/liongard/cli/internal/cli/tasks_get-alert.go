...
func newTasksGetAlertCmd(flags *rootFlags) *cobra.Command {
	var flagFields string

	cmd := &cobra.Command{
		Use:         "get-alert <TaskID>",
		Aliases:     []string{"get"},
		Short:       "Returns a single alert that has been raised.",
		Example:     "  liongard-cli tasks get-alert 42",
		Annotations: map[string]string{"pp:endpoint": "tasks.get-alert", "pp:method": "GET", "pp:path": "/tasks/{TaskID}", "mcp:read-only": "true"},
