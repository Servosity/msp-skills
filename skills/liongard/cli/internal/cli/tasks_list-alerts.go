...
func newTasksListAlertsCmd(flags *rootFlags) *cobra.Command {
	var flagFields string

	cmd := &cobra.Command{
		Use:         "list-alerts",
		Short:       "Returns a list of alerts that have been raised.",
		Example:     "  liongard-cli tasks list-alerts",
		Annotations: map[string]string{"pp:endpoint": "tasks.list-alerts", "pp:method": "GET", "pp:path": "/tasks", "mcp:read-only": "true"},
