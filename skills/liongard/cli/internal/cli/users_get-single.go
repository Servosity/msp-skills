...
func newUsersGetSingleCmd(flags *rootFlags) *cobra.Command {
	var flagFields string

	cmd := &cobra.Command{
		Use:         "get-single <UserID>",
		Short:       "Returns a Single User",
		Example:     "  liongard-cli users get-single 42",
		Annotations: map[string]string{"pp:endpoint": "users.get-single", "pp:method": "GET", "pp:path": "/users/{UserID}", "mcp:read-only": "true"},
