...
func (c *Config) SaveCredential(token string) error {
	...
	delete(c.envOverrides, "LiongardApiKey")
	c.updateFileConfigField("LiongardApiKey")
	return c.save()
}
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["LiongardApiKey"] {
			out.LiongardApiKey = c.fileConfig.LiongardApiKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "LiongardApiKey":
		c.fileConfig.LiongardApiKey = c.LiongardApiKey
	}
}
