...
Config file: `~/.config/liongard-cli/config.toml`
...
| `LIONGARD_API_KEY` | per_call | No | Set to your API credential. |
| `LIONGARD_ENDPOINTS_API_KEY` | per_call | No | Set to your API credential. |
