# install.ps1 - install liongard-cli and liongard-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (liongard-v*).
...
$Skill   = "liongard"
$CliBin  = "liongard-cli.exe"
$McpBin  = "liongard-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (liongard-vX.Y.Z),
...
Write-Host "  liongard-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/liongard#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/liongard/mcp-install.md"
