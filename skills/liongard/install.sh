#!/usr/bin/env bash
# install.sh - install liongard-cli and liongard-mcp on macOS / Linux.
#
...
SKILL="liongard"
CLI_BIN="liongard-cli"
MCP_BIN="liongard-mcp"
...
# Each skill is versioned and tagged independently (liongard-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/liongard#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/liongard/mcp-install.md"
