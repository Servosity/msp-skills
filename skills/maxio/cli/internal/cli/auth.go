...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Maxio Advanced Billing",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  maxio-cli auth setup\n  maxio-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			w := cmd.OutOrStdout()
			fmt.Fprintln(w, "Get a key at: https://app.chargify.com/signup/maxio-billing-sandbox")
			fmt.Fprintln(w, "")
			fmt.Fprintln(w, "Then set:")
			fmt.Fprintln(w, "  export MAXIO_USERNAME=\"your-username\"")
			fmt.Fprintln(w, "  export MAXIO_PASSWORD=\"your-password\"")
			if !launch {
				return nil
			}
			launchURL := "https://app.chargify.com/signup/maxio-billing-sandbox"
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  maxio-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("MAXIO_USERNAME") != "" {
				envStillSet = "MAXIO_USERNAME"
			}
			if envStillSet == "" && os.Getenv("MAXIO_PASSWORD") != "" {
				envStillSet = "MAXIO_PASSWORD"
			}
