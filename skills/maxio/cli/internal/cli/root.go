...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "maxio-cli",
		Short: `Maxio CLI — The first open, local revenue-intelligence CLI for Maxio Advanced Billing — MRR waterfalls, retention, and per-client h…`,
		Long: `Maxio CLI — The first open, local revenue-intelligence CLI for Maxio Advanced Billing — MRR waterfalls, retention, and per-client h…
...
Health check: run 'maxio-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("maxio-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'maxio-cli profile list')")
	...
	rootCmd.AddCommand(newApiExportsCmd(flags))
	...
	rootCmd.AddCommand(newCustomersJsonCmd(flags))
	rootCmd.AddCommand(newEndpointsJsonCmd(flags))
	rootCmd.AddCommand(newEventBasedBillingCmd(flags))
	rootCmd.AddCommand(newEventsCmd(flags))
	rootCmd.AddCommand(newInvoicesCmd(flags))
	rootCmd.AddCommand(newOffersJsonCmd(flags))
	rootCmd.AddCommand(newPaymentProfilesCmd(flags))
	rootCmd.AddCommand(newPaymentProfilesJsonCmd(flags))
	rootCmd.AddCommand(newPortalCmd(flags))
	rootCmd.AddCommand(newPricePointsCmd(flags))
	rootCmd.AddCommand(newProductFamiliesJsonCmd(flags))
	rootCmd.AddCommand(newProductPricePointsCmd(flags))
	rootCmd.AddCommand(newProductsCmd(flags))
	rootCmd.AddCommand(newReasonCodesCmd(flags))
	rootCmd.AddCommand(newReasonCodesJsonCmd(flags))
	rootCmd.AddCommand(newSellersCmd(flags))
	rootCmd.AddCommand(newSubscriptionGroupsCmd(flags))
	rootCmd.AddCommand(newSubscriptionGroupsJsonCmd(flags))
	rootCmd.AddCommand(newSubscriptionsCmd(flags))
	rootCmd.AddCommand(newSubscriptionsJsonCmd(flags))
	...
	rootCmd.AddCommand(newNovelCohortCmd(flags))
	rootCmd.AddCommand(newNovelMrrCmd(flags))
	rootCmd.AddCommand(newNovelReconcileCmd(flags))
	rootCmd.AddCommand(newNovelRetentionCmd(flags))
	rootCmd.AddCommand(newNovelTriageCmd(flags))
	rootCmd.AddCommand(newNovelUsageDriversCmd(flags))
	rootCmd.AddCommand(newNovelArpaCmd(flags))
	rootCmd.AddCommand(newNovelChurnCmd(flags))
	rootCmd.AddCommand(newNovelConcentrationCmd(flags))
	rootCmd.AddCommand(newNovelNewCustomersCmd(flags))
	rootCmd.AddCommand(newNovelRenewalsCmd(flags))
	rootCmd.AddCommand(newNovelRevenueMixCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newChargifyJsKeysJsonPromotedCmd(flags))
	rootCmd.AddCommand(newComponentsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newComponentsPricePointsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newCouponsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newCreditNotesPromotedCmd(flags))
	rootCmd.AddCommand(newCreditNotesJsonPromotedCmd(flags))
	rootCmd.AddCommand(newEndpointsPromotedCmd(flags))
	rootCmd.AddCommand(newEventsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newInvoicesJsonPromotedCmd(flags))
	rootCmd.AddCommand(newMrrJsonPromotedCmd(flags))
	rootCmd.AddCommand(newMrrMovementsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newOffersPromotedCmd(flags))
	rootCmd.AddCommand(newOneTimeTokensPromotedCmd(flags))
	rootCmd.AddCommand(newProductFamiliesPromotedCmd(flags))
	rootCmd.AddCommand(newProductsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newProductsPricePointsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newProformaInvoicesPromotedCmd(flags))
	rootCmd.AddCommand(newReferralCodesPromotedCmd(flags))
	rootCmd.AddCommand(newSiteJsonPromotedCmd(flags))
	rootCmd.AddCommand(newSitesPromotedCmd(flags))
	rootCmd.AddCommand(newStatsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newSubscriptionsComponentsJsonPromotedCmd(flags))
	rootCmd.AddCommand(newSubscriptionsMrrJsonPromotedCmd(flags))
	rootCmd.AddCommand(newWebhooksJsonPromotedCmd(flags))
