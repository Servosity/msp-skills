...
Resource scoping:
  ...
  maxio-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  maxio-cli sync --full

  # Incremental sync: only records from the last 7 days
  maxio-cli sync --since 7d

  # Parallel sync with 8 workers
  maxio-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  maxio-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("maxio-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/maxio-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	switch resource {
	case "chargify-js-keys-json":
		return true
	case "codes_json":
		return true
	case "components-json":
		return true
	case "components-price-points-json":
		return true
	case "coupons-json":
		return true
	case "credit-notes-json":
		return true
	case "customers-json":
		return true
	case "events":
	...
	case "products-json":
		return true
	case "products-price-points-json":
		return true
	case "reason-codes-json":
		return true
	case "segments_json":
		return true
	case "service_credits":
		return true
	case "subscription-groups-json":
		return true
	case "subscriptions-components-json":
		return true
	case "subscriptions-json":
		return true
	case "subscriptions-mrr-json":
		return true
	case "subscriptions_allocations_json":
		return true
	...
	case "subscriptions_proforma_invoices_json":
		return true
	case "subscriptions_usages_json":
		return true
	case "webhooks-json":
		return true
	}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "api-exports":
		return db.UpsertApiExports(data)
	case "verification_json":
		return db.UpsertVerificationJson(data)
	case "components_price_points":
		return db.UpsertComponentsPricePoints(data)
	case "components_price_points_json":
		return db.UpsertComponentsPricePointsJson(data)
	case "codes":
		return db.UpsertCodes(data)
	case "codes_json":
		return db.UpsertCodesJson(data)
	case "coupons_currency_prices_json":
		return db.UpsertCouponsCurrencyPricesJson(data)
	case "credit-notes":
		return db.UpsertCreditNotes(data)
	case "customers_subscriptions_json":
		return db.UpsertCustomersSubscriptionsJson(data)
	case "endpoints-json":
		return db.UpsertEndpointsJson(data)
	case "events":
		return db.UpsertEvents(data)
	case "bulk_json":
		return db.UpsertBulkJson(data)
	case "invoices":
		return db.UpsertInvoices(data)
	case "customer_information":
		return db.UpsertCustomerInformation(data)
	case "customer_information_json":
		return db.UpsertCustomerInformationJson(data)
	case "invoices_deliveries_json":
		return db.UpsertInvoicesDeliveriesJson(data)
	case "issue_json":
		return db.UpsertIssueJson(data)
	case "invoices_payments_json":
		return db.UpsertInvoicesPaymentsJson(data)
	case "refunds_json":
		return db.UpsertRefundsJson(data)
	case "reopen_json":
		return db.UpsertReopenJson(data)
	case "segments_json":
		return db.UpsertSegmentsJson(data)
	case "invoices_void_json":
		return db.UpsertInvoicesVoidJson(data)
	case "archive_json":
		return db.UpsertArchiveJson(data)
	case "unarchive_json":
		return db.UpsertUnarchiveJson(data)
	case "payment-profiles":
		return db.UpsertPaymentProfiles(data)
	case "payment-profiles-json":
		return db.UpsertPaymentProfilesJson(data)
	case "portal":
		return db.UpsertPortal(data)
	case "price_points_currency_prices_json":
		return db.UpsertPricePointsCurrencyPricesJson(data)
	case "product_families_components":
		return db.UpsertProductFamiliesComponents(data)
	case "product_families_components_json":
		return db.UpsertProductFamiliesComponentsJson(data)
	case "product_families_coupons":
		return db.UpsertProductFamiliesCoupons(data)
	case "product_families_coupons_json":
		return db.UpsertProductFamiliesCouponsJson(data)
	case "event_based_components_json":
		return db.UpsertEventBasedComponentsJson(data)
	case "metered_components_json":
		return db.UpsertMeteredComponentsJson(data)
	case "on_off_components_json":
		return db.UpsertOnOffComponentsJson(data)
	case "prepaid_usage_components_json":
		return db.UpsertPrepaidUsageComponentsJson(data)
	case "product_families_products_json":
		return db.UpsertProductFamiliesProductsJson(data)
	case "quantity_based_components_json":
		return db.UpsertQuantityBasedComponentsJson(data)
	case "product_price_points_currency_prices_json":
		return db.UpsertProductPricePointsCurrencyPricesJson(data)
	case "products_price_points":
		return db.UpsertProductsPricePoints(data)
	case "products_price_points_json":
		return db.UpsertProductsPricePointsJson(data)
	case "proforma-invoices":
		return db.UpsertProformaInvoices(data)
	case "proforma_invoices_deliveries_json":
		return db.UpsertProformaInvoicesDeliveriesJson(data)
	case "proforma_invoices_void_json":
		return db.UpsertProformaInvoicesVoidJson(data)
	case "sales_commission_settings_json":
		return db.UpsertSalesCommissionSettingsJson(data)
	case "sales_reps":
		return db.UpsertSalesReps(data)
	case "sales_reps_json":
		return db.UpsertSalesRepsJson(data)
	case "stats-json":
		return db.UpsertStatsJson(data)
	case "subscription-groups":
		return db.UpsertSubscriptionGroups(data)
	case "cancel_json":
		return db.UpsertCancelJson(data)
	case "subscription_groups_delayed_cancel_json":
		return db.UpsertSubscriptionGroupsDelayedCancelJson(data)
	case "subscription_groups_payment_profiles":
		return db.UpsertSubscriptionGroupsPaymentProfiles(data)
	case "subscription_groups_prepayments_json":
		return db.UpsertSubscriptionGroupsPrepaymentsJson(data)
	case "subscription_groups_proforma_invoices_json":
		return db.UpsertSubscriptionGroupsProformaInvoicesJson(data)
	case "subscription_groups_reactivate_json":
		return db.UpsertSubscriptionGroupsReactivateJson(data)
	case "subscription_groups_service_credit_deductions_json":
		return db.UpsertSubscriptionGroupsServiceCreditDeductionsJson(data)
	case "subscription_groups_service_credits_json":
		return db.UpsertSubscriptionGroupsServiceCreditsJson(data)
	case "account_balances_json":
		return db.UpsertAccountBalancesJson(data)
	case "activate_json":
		return db.UpsertActivateJson(data)
	case "add_coupon_json":
		return db.UpsertAddCouponJson(data)
	case "advance_invoice":
		return db.UpsertAdvanceInvoice(data)
	case "advance_invoice_json":
		return db.UpsertAdvanceInvoiceJson(data)
	case "allocations":
		return db.UpsertAllocations(data)
	case "allocations_json":
		return db.UpsertAllocationsJson(data)
	case "cancel_dunning_json":
		return db.UpsertCancelDunningJson(data)
	case "subscriptions_components":
		return db.UpsertSubscriptionsComponents(data)
	case "subscriptions_components_json":
		return db.UpsertSubscriptionsComponentsJson(data)
	case "subscriptions_delayed_cancel_json":
		return db.UpsertSubscriptionsDelayedCancelJson(data)
	case "subscriptions_events_json":
		return db.UpsertSubscriptionsEventsJson(data)
	case "group_json":
		return db.UpsertGroupJson(data)
	case "hold_json":
		return db.UpsertHoldJson(data)
	case "subscriptions_invoices_json":
		return db.UpsertSubscriptionsInvoicesJson(data)
	case "migrations":
		return db.UpsertMigrations(data)
	case "migrations_json":
		return db.UpsertMigrationsJson(data)
	case "notes":
		return db.UpsertNotes(data)
	case "notes_json":
		return db.UpsertNotesJson(data)
	case "override_json":
		return db.UpsertOverrideJson(data)
	case "subscriptions_payment_profiles":
		return db.UpsertSubscriptionsPaymentProfiles(data)
	case "subscriptions_payments_json":
		return db.UpsertSubscriptionsPaymentsJson(data)
	case "prepaid_configurations_json":
		return db.UpsertPrepaidConfigurationsJson(data)
	case "prepayments":
		return db.UpsertPrepayments(data)
	case "subscriptions_prepayments_json":
		return db.UpsertSubscriptionsPrepaymentsJson(data)
	case "subscriptions_price_points":
		return db.UpsertSubscriptionsPricePoints(data)
	case "subscriptions_price_points_json":
		return db.UpsertSubscriptionsPricePointsJson(data)
	case "subscriptions_proforma_invoices":
		return db.UpsertSubscriptionsProformaInvoices(data)
	case "subscriptions_proforma_invoices_json":
		return db.UpsertSubscriptionsProformaInvoicesJson(data)
	case "purge_json":
		return db.UpsertPurgeJson(data)
	case "subscriptions_reactivate_json":
		return db.UpsertSubscriptionsReactivateJson(data)
	case "remove_coupon_json":
		return db.UpsertRemoveCouponJson(data)
	case "renewals":
		return db.UpsertRenewals(data)
	case "request_payment_profiles_update_json":
		return db.UpsertRequestPaymentProfilesUpdateJson(data)
	case "resume_json":
		return db.UpsertResumeJson(data)
	case "retry_json":
		return db.UpsertRetryJson(data)
	case "scheduled_renewals":
		return db.UpsertScheduledRenewals(data)
	case "scheduled_renewals_json":
		return db.UpsertScheduledRenewalsJson(data)
	case "subscriptions_service_credit_deductions_json":
		return db.UpsertSubscriptionsServiceCreditDeductionsJson(data)
	case "service_credits":
		return db.UpsertServiceCredits(data)
	case "subscriptions_service_credits_json":
		return db.UpsertSubscriptionsServiceCreditsJson(data)
	case "webhooks":
...
func defaultSyncResources() []string {
	// The core revenue-intelligence surface: a bare `sync` must populate the
	// data the mrr/retention/triage/reconcile/usage-drivers commands read.
	// (The generator's default picked only 3 minor resources; these are the
	// real list endpoints. Pair with `mrr sync` for MRR snapshots + movements.)
	return []string{
		"customers-json",
		"subscriptions-json",
		"invoices-json",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"chargify-js-keys-json":         "/chargify_js_keys.json",
		"components-json":               "/components.json",
		"components-price-points-json":  "/components_price_points.json",
		"coupons":                       "/coupons/find.json",
		"coupons-json":                  "/coupons.json",
		"credit-notes-json":             "/credit_notes.json",
		"customers-json":                "/customers.json",
		"endpoints-json":                "/endpoints.json",
		"events":                        "/events/count.json",
		"events-json":                   "/events.json",
		"invoices":                      "/invoices/events.json",
		"invoices-json":                 "/invoices.json",
		"mrr-movements-json":            "/mrr_movements.json",
		"offers-json":                   "/offers.json",
		"payment-profiles-json":         "/payment_profiles.json",
		"product-families-json":         "/product_families.json",
		"products-json":                 "/products.json",
		"products-price-points-json":    "/products_price_points.json",
		"reason-codes-json":             "/reason_codes.json",
		"subscription-groups-json":      "/subscription_groups.json",
		"subscriptions":                 "/subscriptions/lookup.json",
		"subscriptions-components-json": "/subscriptions_components.json",
		"subscriptions-json":            "/subscriptions.json",
		"subscriptions-mrr-json":        "/subscriptions_mrr.json",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "codes_json", ParentTable: "coupons", ParentIDParam: "coupon_id", PathTemplate: "/coupons/{coupon_id}/codes.json", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "coupon_id", Field: "id"},
		}},
		{Name: "notes_json", ParentTable: "subscriptions", ParentIDParam: "subscription_id", PathTemplate: "/subscriptions/{subscription_id}/notes.json", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "subscription_id", Field: "id"},
		}},
		{Name: "segments_json", ParentTable: "invoices", ParentIDParam: "invoice_uid", PathTemplate: "/invoices/{invoice_uid}/segments.json", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "invoice_uid", Field: "invoice_uid"},
		}},
		{Name: "service_credits", ParentTable: "subscriptions", ParentIDParam: "subscription_id", PathTemplate: "/subscriptions/{subscription_id}/service_credits/list.json", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "subscription_id", Field: "id"},
		}},
		{Name: "subscriptions_allocations_json", ParentTable: "subscriptions", ParentIDParam: "component_id", PathTemplate: "/subscriptions/{subscription_id}/components/{component_id}/allocations.json", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "subscription_id", Field: "subscriptions_id"},
			{Param: "component_id", Field: "id"},
		}},
		{Name: "subscriptions_events_json", ParentTable: "subscriptions", ParentIDParam: "subscription_id", PathTemplate: "/subscriptions/{subscription_id}/events.json", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "subscription_id", Field: "id"},
		}},
		{Name: "subscriptions_prepayments_json", ParentTable: "subscriptions", ParentIDParam: "subscription_id", PathTemplate: "/subscriptions/{subscription_id}/prepayments.json", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "subscription_id", Field: "id"},
		}},
		{Name: "subscriptions_proforma_invoices_json", ParentTable: "subscriptions", ParentIDParam: "subscription_id", PathTemplate: "/subscriptions/{subscription_id}/proforma_invoices.json", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "subscription_id", Field: "id"},
		}},
		{Name: "subscriptions_usages_json", ParentTable: "subscriptions", ParentIDParam: "component_id", PathTemplate: "/subscriptions/{subscription_id_or_reference}/components/{component_id}/usages.json", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "subscription_id_or_reference", Field: "subscriptions_id"},
			{Param: "component_id", Field: "id"},
		}},
	}
}
