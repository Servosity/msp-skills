...
func newWebhooksReplayCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short:       "Replays webhooks. Posting to this endpoint does not immediately resend the webhooks.",
		Example:     "  maxio-cli webhooks replay",
		Annotations: map[string]string{"pp:endpoint": "webhooks.replay", "pp:method": "POST", "pp:path": "/webhooks/replay.json"},
