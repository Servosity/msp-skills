# install.ps1 - install maxio-cli and maxio-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (maxio-v*).
...
$Skill   = "maxio"
$CliBin  = "maxio-cli.exe"
$McpBin  = "maxio-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (maxio-vX.Y.Z),
...
Write-Host "  maxio-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/maxio#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/maxio/mcp-install.md"
