#!/usr/bin/env bash
# install.sh - install maxio-cli and maxio-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (maxio-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/maxio#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/maxio/mcp-install.md"
