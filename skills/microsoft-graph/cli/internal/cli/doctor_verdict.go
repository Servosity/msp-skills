...
//
// See issue #282 and skills/microsoft-graph/handfixes.json.
//
...
const doctorBaseURLEnv = "MICROSOFT_GRAPH_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://graph.microsoft.com/v1.0"
