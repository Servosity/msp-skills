...
large datasets as it has no memory pressure.`,
  ...
  microsoft-graph-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  microsoft-graph-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  microsoft-graph-cli export <resource> --format jsonl | jq '.id'`,
