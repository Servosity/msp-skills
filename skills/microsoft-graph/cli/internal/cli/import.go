...
but do not stop the import.`,
  ...
  microsoft-graph-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  microsoft-graph-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | microsoft-graph-cli import <resource> --input -`,
