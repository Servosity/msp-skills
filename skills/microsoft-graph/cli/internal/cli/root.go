...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Microsoft Graph CLI — The maintained single-binary successor to the retiring mgc — every MSP-relevant Microsoft Graph surface, plus an offlin…`,
		Long: `Microsoft Graph CLI — The maintained single-binary successor to the retiring mgc — every MSP-relevant Microsoft Graph surface, plus an offlin…
...
Health check: run 'microsoft-graph-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("microsoft-graph-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'microsoft-graph-cli profile list')")
	...
	rootCmd.AddCommand(newDirectoryRolesCmd(flags))
	rootCmd.AddCommand(newGroupsCmd(flags))
	rootCmd.AddCommand(newLicensesCmd(flags))
	rootCmd.AddCommand(newManagedDevicesCmd(flags))
