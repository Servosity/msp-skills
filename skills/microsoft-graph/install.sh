#!/usr/bin/env bash
# install.sh - install microsoft-graph-cli and microsoft-graph-mcp on macOS / Linux.
#
...
CLI_BIN="microsoft-graph-cli"
MCP_BIN="microsoft-graph-mcp"
...
# Each skill is versioned and tagged independently (microsoft-graph-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/microsoft-graph#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/microsoft-graph/mcp-install.md"
