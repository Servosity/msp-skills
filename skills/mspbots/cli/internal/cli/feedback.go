...
func feedbackFilePath() (string, error) {
	...
	dir := filepath.Join(home, ".local", "share", "mspbots-cli")
...
func FeedbackEndpointConfigured() bool {
	return os.Getenv("MSPBOTS_FEEDBACK_ENDPOINT") != ""
}
...
func feedbackAutoSend() bool {
	v := strings.ToLower(strings.TrimSpace(os.Getenv("MSPBOTS_FEEDBACK_AUTO_SEND")))
