...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "mspbots-cli",
		Short: `Mspbots CLI — The first MSPbots tool anywhere — readable filters, alias-named resources, full exports, and the KPI history MSPbots it…`,
		Long: `Mspbots CLI — The first MSPbots tool anywhere — readable filters, alias-named resources, full exports, and the KPI history MSPbots it…
...
Health check: run 'mspbots-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("mspbots-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'mspbots-cli profile list')")
	...
	rootCmd.AddCommand(newNovelDescribeCmd(flags))
	...
	rootCmd.AddCommand(newNovelRegistryCmd(flags))
	rootCmd.AddCommand(newNovelSnapshotCmd(flags))
	rootCmd.AddCommand(newNovelTrendCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newDatasetPromotedCmd(flags))
	rootCmd.AddCommand(newWidgetPromotedCmd(flags))
