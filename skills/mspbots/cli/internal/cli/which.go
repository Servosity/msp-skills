...
var whichIndex = []whichEntry{
	{Command: "registry", Description: "Name your bound datasets and widgets once, then use readable aliases everywhere instead of 19-digit resource IDs.", Group: "Local state that compounds", WhyItMatters: "Agents and scripts can address resources by stable, human-readable names instead of copy-pasted snowflake IDs."},
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  mspbots-cli which "stale tickets"
  mspbots-cli which "bottleneck"
  mspbots-cli which --limit 1 "send message"
  mspbots-cli which                                # list the full capability index`,
