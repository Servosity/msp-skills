# install.ps1 - install mspbots-cli and mspbots-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (mspbots-v*).
...
$Skill   = "mspbots"
$CliBin  = "mspbots-cli.exe"
$McpBin  = "mspbots-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (mspbots-vX.Y.Z),
...
Write-Host "  mspbots-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/mspbots#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/mspbots/mcp-install.md"
