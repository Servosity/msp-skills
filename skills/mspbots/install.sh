#!/usr/bin/env bash
# install.sh - install mspbots-cli and mspbots-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (mspbots-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/mspbots#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/mspbots/mcp-install.md"
