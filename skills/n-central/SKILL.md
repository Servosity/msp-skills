...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [n-central-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/n-central/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/n-central/install.ps1
---
...
The installer places the `n-central-cli` and `n-central-mcp` binaries on your PATH. It does not
