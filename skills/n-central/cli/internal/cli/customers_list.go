...
func newCustomersListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List all customers across the instance.",
		Example:     "  n-central-cli customers list",
	...
	cmd.Flags().StringVar(&flagSortBy, "sort-by", "", "Field to sort by (e.g. customerName)")
