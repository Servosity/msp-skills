...
large datasets as it has no memory pressure.`,
  ...
  n-central-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  n-central-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  n-central-cli export <resource> --format jsonl | jq '.id'`,
