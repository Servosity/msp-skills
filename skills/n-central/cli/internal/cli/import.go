...
but do not stop the import.`,
  ...
  n-central-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  n-central-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | n-central-cli import <resource> --input -`,
