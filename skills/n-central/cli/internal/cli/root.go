...
Run 'n-central-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("n-central-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'n-central-cli profile list')")
	...
	rootCmd.AddCommand(newOrgUnitsCmd(flags))
	rootCmd.AddCommand(newScheduledTasksCmd(flags))
	rootCmd.AddCommand(newServerCmd(flags))
	rootCmd.AddCommand(newServiceOrgsCmd(flags))
	...
	rootCmd.AddCommand(newNovelGuardianCmd(flags))
	rootCmd.AddCommand(newNovelMaintCmd(flags))
	rootCmd.AddCommand(newNovelPropsCmd(flags))
	rootCmd.AddCommand(newNovelTriageCmd(flags))
	rootCmd.AddCommand(newNovelWhereisCmd(flags))
