...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  n-central-cli which "stale tickets"
  n-central-cli which "bottleneck"
  n-central-cli which --limit 1 "send message"
  n-central-cli which                                # list the full capability index`,
