# install.ps1 - install n-central-cli and n-central-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (n-central-v*).
...
$Skill   = "n-central"
$CliBin  = "n-central-cli.exe"
$McpBin  = "n-central-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (n-central-vX.Y.Z),
...
Write-Host "  n-central-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/n-central#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/n-central/mcp-install.md"
