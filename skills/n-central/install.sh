#!/usr/bin/env bash
# install.sh - install n-central-cli and n-central-mcp on macOS / Linux.
#
...
SKILL="n-central"
CLI_BIN="n-central-cli"
MCP_BIN="n-central-mcp"
...
# Each skill is versioned and tagged independently (n-central-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/n-central#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/n-central/mcp-install.md"
