...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "nerdio-cli",
		Short: `Manage Azure Virtual Desktop fleets through the Nerdio Manager for MSP Partner API - customer accounts, host pools, session hosts, autoscale, desktop images, Intune devices, backup, reservations, and…`,
		Long: `Manage Azure Virtual Desktop fleets through the Nerdio Manager for MSP Partner API - customer accounts, host pools, session hosts, autoscale, desktop images, Intune devices, backup, reservations, and…
...
Health check: run 'nerdio-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("nerdio-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'nerdio-cli profile list')")
	...
	rootCmd.AddCommand(newAppRolesCmd(flags))
	rootCmd.AddCommand(newAutoscaleProfilesCmd(flags))
	rootCmd.AddCommand(newBackupCmd(flags))
	rootCmd.AddCommand(newCostEstimatorCmd(flags))
	rootCmd.AddCommand(newDesktopImagesCmd(flags))
	rootCmd.AddCommand(newDevicesCmd(flags))
	rootCmd.AddCommand(newDirectoriesCmd(flags))
	rootCmd.AddCommand(newEnvironmentVariablesCmd(flags))
	rootCmd.AddCommand(newHostPoolsCmd(flags))
	rootCmd.AddCommand(newHostsCmd(flags))
	rootCmd.AddCommand(newInvoicesCmd(flags))
	rootCmd.AddCommand(newJobCmd(flags))
	rootCmd.AddCommand(newNetworksCmd(flags))
	rootCmd.AddCommand(newProvisioningCmd(flags))
	rootCmd.AddCommand(newRecoveryVaultsCmd(flags))
	...
	rootCmd.AddCommand(newScriptedActionsCmd(flags))
	rootCmd.AddCommand(newSecureVariablesCmd(flags))
	...
	rootCmd.AddCommand(newFslogixPromotedCmd(flags))
