# install.ps1 - install nerdio-cli and nerdio-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (nerdio-v*).
...
$Skill   = "nerdio"
$CliBin  = "nerdio-cli.exe"
$McpBin  = "nerdio-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (nerdio-vX.Y.Z),
...
Write-Host "  nerdio-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/nerdio#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/nerdio/mcp-install.md"
