#!/usr/bin/env bash
# install.sh - install nerdio-cli and nerdio-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (nerdio-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/nerdio#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/nerdio/mcp-install.md"
