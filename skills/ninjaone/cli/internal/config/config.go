...
func Load(configPath string) (*Config, error) {
	...
	if path == "" {
		...
		path = filepath.Join(home, ".config", "ninjaone-cli", "config.toml")
	}
	cfg.Path = path
...
const NoConfigWriteEnv = "NINJAONE_NO_CONFIG_WRITE"
...
// material. It is the ONLY save path NINJAONE_NO_CONFIG_WRITE suppresses;
