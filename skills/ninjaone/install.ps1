# install.ps1 - install ninjaone-cli and ninjaone-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (ninjaone-v*).
...
$Skill   = "ninjaone"
$CliBin  = "ninjaone-cli.exe"
$McpBin  = "ninjaone-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (ninjaone-vX.Y.Z),
...
Write-Host "  ninjaone-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/ninjaone#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/ninjaone/mcp-install.md"
