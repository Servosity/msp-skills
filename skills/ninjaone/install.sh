#!/usr/bin/env bash
# install.sh - install ninjaone-cli and ninjaone-mcp on macOS / Linux.
#
...
SKILL="ninjaone"
CLI_BIN="ninjaone-cli"
MCP_BIN="ninjaone-mcp"
...
# Each skill is versioned and tagged independently (ninjaone-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/ninjaone#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/ninjaone/mcp-install.md"
