...
large datasets as it has no memory pressure.`,
  ...
  pagerduty-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pagerduty-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pagerduty-cli export <resource> --format jsonl | jq '.id'`,
