...
but do not stop the import.`,
  ...
  pagerduty-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pagerduty-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pagerduty-cli import <resource> --input -`,
