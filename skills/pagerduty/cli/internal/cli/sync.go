...
Resource scoping:
  ...
  pagerduty-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  pagerduty-cli sync --full

  # Incremental sync: only records from the last 7 days
  pagerduty-cli sync --since 7d

  # Parallel sync with 8 workers
  pagerduty-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  pagerduty-cli sync --latest-only

  # Sync historical data for a date range
  pagerduty-cli sync --dates 20250101-20250131`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("pagerduty-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/pagerduty-cli/data.db)")
...
func resourceSupportsPagination(resource string) bool {
	...
	case "automation-actions":
		return true
	case "automation-actions-runners":
		return true
	...
	case "incident-workflows":
		return true
	case "incident-workflows-actions":
		return true
	case "incident-workflows-triggers":
		return true
	case "incidents":
		return true
	...
	case "workflows":
		return true
	case "workflows-integrations-connections":
		return true
	}
	return false
}
...
func syncResourceFieldSelector(resource string) (string, string) {
	switch resource {
	case "incidents":
		return "sort_by", "incidents.id,limit,more,offset,total"
	case "schedules":
		return "since", "limit,more,offset,schedules.id,total"
	case "alerts":
		return "sort_by", "alerts.id,limit,more,offset,total"
	}
	return "", ""
}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "automation-actions":
		return db.UpsertAutomationActions(data)
	case "business-services":
		return db.UpsertBusinessServices(data)
	case "account_subscription":
		return db.UpsertAccountSubscription(data)
	case "subscribers":
		return db.UpsertSubscribers(data)
	case "supporting_services":
		return db.UpsertSupportingServices(data)
	case "unsubscribe":
		return db.UpsertUnsubscribe(data)
	case "change-events":
		return db.UpsertChangeEvents(data)
	case "escalation-policies":
		return db.UpsertEscalationPolicies(data)
	case "escalation_policies_audit":
		return db.UpsertEscalationPoliciesAudit(data)
	case "event-orchestrations":
		return db.UpsertEventOrchestrations(data)
	case "cache_variables":
		return db.UpsertCacheVariables(data)
	case "event_orchestrations_enablements":
		return db.UpsertEventOrchestrationsEnablements(data)
	case "global":
		return db.UpsertGlobal(data)
	case "event_orchestrations_integrations":
		return db.UpsertEventOrchestrationsIntegrations(data)
	case "router":
		return db.UpsertRouter(data)
	case "unrouted":
		return db.UpsertUnrouted(data)
	case "extension-schemas":
		return db.UpsertExtensionSchemas(data)
	case "extensions":
		return db.UpsertExtensions(data)
	case "extensions_enable":
		return db.UpsertExtensionsEnable(data)
	case "incident-workflows":
		return db.UpsertIncidentWorkflows(data)
	case "instances":
		return db.UpsertInstances(data)
	case "incidents":
		return db.UpsertIncidents(data)
	case "alerts":
		return db.UpsertAlerts(data)
	case "incidents_business_services":
		return db.UpsertIncidentsBusinessServices(data)
	case "incidents_custom_fields":
		return db.UpsertIncidentsCustomFields(data)
	case "incidents_log_entries":
		return db.UpsertIncidentsLogEntries(data)
	case "merge":
		return db.UpsertMerge(data)
	case "notes":
		return db.UpsertNotes(data)
	case "outlier_incident":
		return db.UpsertOutlierIncident(data)
	case "past_incidents":
		return db.UpsertPastIncidents(data)
	case "related_change_events":
		return db.UpsertRelatedChangeEvents(data)
	case "related_incidents":
		return db.UpsertRelatedIncidents(data)
	case "responder_requests":
		return db.UpsertResponderRequests(data)
	case "snooze":
		return db.UpsertSnooze(data)
	case "status_updates":
		return db.UpsertStatusUpdates(data)
	case "ip-allow-lists":
		return db.UpsertIpAllowLists(data)
	case "license-allocations":
		return db.UpsertLicenseAllocations(data)
	case "licenses":
		return db.UpsertLicenses(data)
	case "log-entries":
		return db.UpsertLogEntries(data)
	case "channel":
		return db.UpsertChannel(data)
	case "maintenance-windows":
		return db.UpsertMaintenanceWindows(data)
	case "notifications":
		return db.UpsertNotifications(data)
	case "oauth-delegations":
		return db.UpsertOauthDelegations(data)
	case "oncalls":
		return db.UpsertOncalls(data)
	case "pagerduty-analytics":
		return db.UpsertPagerdutyAnalytics(data)
	case "priorities":
		return db.UpsertPriorities(data)
	case "rulesets":
		return db.UpsertRulesets(data)
	case "rulesets_rules":
		return db.UpsertRulesetsRules(data)
	case "schedules":
		return db.UpsertSchedules(data)
	case "schedules_audit":
		return db.UpsertSchedulesAudit(data)
	case "custom_shifts":
		return db.UpsertCustomShifts(data)
	case "overrides":
		return db.UpsertOverrides(data)
	case "rotations":
		return db.UpsertRotations(data)
	case "schedules_users":
		return db.UpsertSchedulesUsers(data)
	case "service-dependencies":
		return db.UpsertServiceDependencies(data)
	case "services":
		return db.UpsertServices(data)
	case "services_audit":
		return db.UpsertServicesAudit(data)
	case "services_change_events":
		return db.UpsertServicesChangeEvents(data)
	case "services_custom_fields":
		return db.UpsertServicesCustomFields(data)
	case "services_enablements":
		return db.UpsertServicesEnablements(data)
	case "services_integrations":
		return db.UpsertServicesIntegrations(data)
	case "services_rules":
		return db.UpsertServicesRules(data)
	case "session-configurations":
		return db.UpsertSessionConfigurations(data)
	case "standards":
		return db.UpsertStandards(data)
	case "status-dashboards":
		return db.UpsertStatusDashboards(data)
	case "service_impacts":
		return db.UpsertServiceImpacts(data)
	case "status-pages":
		return db.UpsertStatusPages(data)
	case "impacts":
		return db.UpsertImpacts(data)
	case "posts":
		return db.UpsertPosts(data)
	case "status_pages_services":
		return db.UpsertStatusPagesServices(data)
	case "severities":
		return db.UpsertSeverities(data)
	case "statuses":
	...
	case "teams_audit":
		return db.UpsertTeamsAudit(data)
	case "teams_escalation_policies":
		return db.UpsertTeamsEscalationPolicies(data)
	case "members":
		return db.UpsertMembers(data)
	case "teams_notification_subscriptions":
		return db.UpsertTeamsNotificationSubscriptions(data)
	case "teams_users":
		return db.UpsertTeamsUsers(data)
	case "templates":
	...
	case "users_audit":
		return db.UpsertUsersAudit(data)
	case "contact_methods":
		return db.UpsertContactMethods(data)
	case "license":
		return db.UpsertLicense(data)
	case "notification_rules":
		return db.UpsertNotificationRules(data)
	case "users_notification_subscriptions":
		return db.UpsertUsersNotificationSubscriptions(data)
	case "users_oauth_delegations":
		return db.UpsertUsersOauthDelegations(data)
	case "oncall_handoff_notification_rules":
		return db.UpsertOncallHandoffNotificationRules(data)
	case "sessions":
		return db.UpsertSessions(data)
	case "status_update_notification_rules":
		return db.UpsertStatusUpdateNotificationRules(data)
	case "vendors":
		return db.UpsertVendors(data)
	case "webhook-subscriptions":
		return db.UpsertWebhookSubscriptions(data)
	case "webhook_subscriptions_enable":
		return db.UpsertWebhookSubscriptionsEnable(data)
	case "ping":
...
func defaultSyncResources() []string {
	return []string{
		...
		"audit",
		"automation-actions",
		"automation-actions-invocations",
		"automation-actions-runners",
		"business-services",
		"business-services-impactors",
		"business-services-impacts",
		"change-events",
		"escalation-policies",
		...
		"webhook-subscriptions-oauth-clients",
		"workflows",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"abilities":                           "/abilities",
		"addons":                              "/addons",
		"alert-grouping-settings":             "/alert_grouping_settings",
		"audit":                               "/audit/records",
		"automation-actions":                  "/automation_actions/actions",
		"automation-actions-invocations":      "/automation_actions/invocations",
		"automation-actions-runners":          "/automation_actions/runners",
		"business-services":                   "/business_services",
		"business-services-impactors":         "/business_services/impactors",
		"business-services-impacts":           "/business_services/impacts",
		"change-events":                       "/change_events",
		"escalation-policies":                 "/escalation_policies",
		"event-orchestrations":                "/event_orchestrations",
		"extension-schemas":                   "/extension_schemas",
		"extensions":                          "/extensions",
		"incident-workflows":                  "/incident_workflows",
		"incident-workflows-actions":          "/incident_workflows/actions",
		"incident-workflows-triggers":         "/incident_workflows/triggers",
		"incidents":                           "/incidents",
		"incidents-custom-fields":             "/incidents/custom_fields",
		"incidents-types":                     "/incidents/types",
		"ip-allow-lists":                      "/ip_allow_lists",
		"license-allocations":                 "/license_allocations",
		"licenses":                            "/licenses",
		...
		"schedules":                           "/schedules",
		"services":                            "/services",
		"services-custom-fields":              "/services/custom_fields",
		"session-configurations":              "/session_configurations",
		"sre-agent":                           "/sre_agent/memories",
		"standards":                           "/standards",
		"status-dashboards":                   "/status_dashboards",
		"status-pages":                        "/status_pages",
		"tags":                                "/tags",
		"teams":                               "/teams",
		"templates":                           "/templates",
		"templates-fields":                    "/templates/fields",
		"users":                               "/users",
		"vendors":                             "/vendors",
		"webhook-subscriptions":               "/webhook_subscriptions",
		"webhook-subscriptions-oauth-clients": "/webhook_subscriptions/oauth_clients",
		"workflows":                           "/workflows/integrations",
		"workflows-integrations-connections":  "/workflows/integrations/connections",
	}
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "alerts", ParentTable: "incidents", ParentIDParam: "id", PathTemplate: "/incidents/{id}/alerts", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "custom_shifts", ParentTable: "schedules", ParentIDParam: "id", PathTemplate: "/v3/schedules/{id}/custom_shifts", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "escalation_policies_audit", ParentTable: "escalation-policies", ParentIDParam: "id", PathTemplate: "/escalation_policies/{id}/audit/records", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "incidents_log_entries", ParentTable: "incidents", ParentIDParam: "id", PathTemplate: "/incidents/{id}/log_entries", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "members", ParentTable: "teams", ParentIDParam: "id", PathTemplate: "/teams/{id}/members", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "overrides", ParentTable: "schedules", ParentIDParam: "id", PathTemplate: "/v3/schedules/{id}/overrides", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "past_incidents", ParentTable: "incidents", ParentIDParam: "id", PathTemplate: "/incidents/{id}/past_incidents", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "related_change_events", ParentTable: "incidents", ParentIDParam: "id", PathTemplate: "/incidents/{id}/related_change_events", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "rotations", ParentTable: "schedules", ParentIDParam: "id", PathTemplate: "/v3/schedules/{id}/rotations", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "rulesets_rules", ParentTable: "rulesets", ParentIDParam: "id", PathTemplate: "/rulesets/{id}/rules", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "schedules_audit", ParentTable: "schedules", ParentIDParam: "id", PathTemplate: "/v3/schedules/{id}/audit/records", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "schedules_audit", ParentTable: "schedules", ParentIDParam: "id", PathTemplate: "/schedules/{id}/audit/records", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "services_audit", ParentTable: "services", ParentIDParam: "id", PathTemplate: "/services/{id}/audit/records", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "services_change_events", ParentTable: "services", ParentIDParam: "id", PathTemplate: "/services/{id}/change_events", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "services_rules", ParentTable: "services", ParentIDParam: "id", PathTemplate: "/services/{id}/rules", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "teams_audit", ParentTable: "teams", ParentIDParam: "id", PathTemplate: "/teams/{id}/audit/records", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "users_audit", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/users/{id}/audit/records", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "users_oauth_delegations", ParentTable: "users", ParentIDParam: "id", PathTemplate: "/users/{id}/oauth_delegations", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "rotations_events", ParentTable: "rotations", ParentIDParam: "rotation_id", PathTemplate: "/v3/schedules/{id}/rotations/{rotation_id}/events", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "schedules_id"},
			{Param: "rotation_id", Field: "id"},
		}},
	}
}
