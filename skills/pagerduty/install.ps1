# install.ps1 - install pagerduty-cli and pagerduty-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (pagerduty-v*).
...
$Skill   = "pagerduty"
$CliBin  = "pagerduty-cli.exe"
$McpBin  = "pagerduty-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (pagerduty-vX.Y.Z),
...
Write-Host "  pagerduty-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/pagerduty#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/pagerduty/mcp-install.md"
