#!/usr/bin/env bash
# install.sh - install pagerduty-cli and pagerduty-mcp on macOS / Linux.
#
...
SKILL="pagerduty"
CLI_BIN="pagerduty-cli"
MCP_BIN="pagerduty-mcp"
...
# Each skill is versioned and tagged independently (pagerduty-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/pagerduty#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/pagerduty/mcp-install.md"
