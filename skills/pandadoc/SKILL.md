...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [pandadoc-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/pandadoc/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/pandadoc/install.ps1
---
...
The installer places the `pandadoc-cli` and `pandadoc-mcp` binaries on your PATH. It does not
