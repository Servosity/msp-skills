...
func newContactsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "This method returns a list of contacts associated with a workspace.",
		Example:     "  pandadoc-cli contacts list",
	...
	cmd.Flags().StringVar(&flagEmail, "email", "", "Optional search parameter. Filter results by exact match.")
