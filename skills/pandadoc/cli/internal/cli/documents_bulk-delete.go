...
func newDocumentsBulkDeleteCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "bulk-delete",
		Short:       "Delete multiple documents in one request by sending a JSON array.",
		Example:     "  pandadoc-cli documents bulk-delete",
		Annotations: map[string]string{"pp:endpoint": "documents.bulk-delete", "pp:method": "DELETE", "pp:path": "/documents"},
