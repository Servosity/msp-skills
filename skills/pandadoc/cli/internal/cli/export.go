...
large datasets as it has no memory pressure.`,
  ...
  pandadoc-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pandadoc-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pandadoc-cli export <resource> --format jsonl | jq '.id'`,
		Args: cobra.MinimumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				"contacts":              true,
				"content-library-items": true,
				"documents":             true,
				"forms":                 true,
				"logs":                  true,
				"members":               true,
