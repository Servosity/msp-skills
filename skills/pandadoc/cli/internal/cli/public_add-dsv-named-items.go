...
func newPublicAddDsvNamedItemsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "public", data, "results")
			}
	...
	cmd.Flags().StringVar(&bodyItems, "items", "", "List of named items representing structural elements of the document.")
