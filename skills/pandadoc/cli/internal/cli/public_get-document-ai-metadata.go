...
func newPublicGetDocumentAiMetadataCmd(flags *rootFlags) *cobra.Command {
	var flagLimit int
	...
	cmd.Flags().IntVar(&flagLimit, "limit", 100, "Maximum number of fields to return in one response.")
	cmd.Flags().StringVar(&flagOffset, "offset", "0", "Number of fields to skip before starting to collect the result set. For predictable paging, use multiples of `limit`.")
