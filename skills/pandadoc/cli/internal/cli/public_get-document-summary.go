...
func newPublicGetDocumentSummaryCmd(flags *rootFlags) *cobra.Command {
	var flagType string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cmd.Flags().Changed("type") {
				allowedType := []string{"detailed", "short", "headline", "xshort"}
				validType := false
	...
	cmd.Flags().StringVar(&flagType, "type", "", "Document summary granularity to return. (one of: detailed, short, headline, xshort)")
