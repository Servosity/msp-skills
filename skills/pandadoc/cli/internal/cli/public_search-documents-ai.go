...
func newPublicSearchDocumentsAiCmd(flags *rootFlags) *cobra.Command {
	var flagQ string
	...
	cmd.Flags().StringVar(&flagQ, "q", "", "Natural-language search query. Supports filtering by status, owner, dates, and folder.")
