...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "pandadoc-cli",
		Short: `Pandadoc CLI — Every PandaDoc endpoint, plus an offline document pipeline no other PandaDoc tool has — stalled deals, aging, recipient…`,
		Long: `Pandadoc CLI — Every PandaDoc endpoint, plus an offline document pipeline no other PandaDoc tool has — stalled deals, aging, recipient…
...
Health check: run 'pandadoc-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("pandadoc-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'pandadoc-cli profile list')")
	...
	rootCmd.AddCommand(newContentLibraryItemsCmd(flags))
	...
	rootCmd.AddCommand(newWebhookEventsCmd(flags))
	...
	rootCmd.AddCommand(newNovelColdClientsCmd(flags))
	rootCmd.AddCommand(newNovelEngagementCmd(flags))
	rootCmd.AddCommand(newNovelFollowupCmd(flags))
	rootCmd.AddCommand(newNovelForecastCmd(flags))
	rootCmd.AddCommand(newNovelPipelineCmd(flags))
	rootCmd.AddCommand(newNovelReminderGapsCmd(flags))
	rootCmd.AddCommand(newNovelSinceCmd(flags))
	rootCmd.AddCommand(newNovelStalledCmd(flags))
	rootCmd.AddCommand(newNovelTemplateStatsCmd(flags))
	rootCmd.AddCommand(newNovelValueCmd(flags))
	rootCmd.AddCommand(newNovelWebhookCoverageCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newContentLibraryItemsUploadPromotedCmd(flags))
	rootCmd.AddCommand(newDocumentsUploadPromotedCmd(flags))
	rootCmd.AddCommand(newDocumentsUploadMarkdownPromotedCmd(flags))
	rootCmd.AddCommand(newFormsPromotedCmd(flags))
	rootCmd.AddCommand(newSmsOptOutsPromotedCmd(flags))
	rootCmd.AddCommand(newTemplatesUploadPromotedCmd(flags))
