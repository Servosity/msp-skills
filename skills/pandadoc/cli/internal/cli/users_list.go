...
func newUsersListCmd(flags *rootFlags) *cobra.Command {
	var flagCount int
	var flagPage string
	var flagShowRemoved bool
	var flagAll bool

	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Get a list of all users with membership in your organization, with their contact information, license type",
		Example:     "  pandadoc-cli users list",
	...
	cmd.Flags().BoolVar(&flagShowRemoved, "show-removed", true, "Filter option - show users with removed memberships.")
