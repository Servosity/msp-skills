# install.ps1 - install pandadoc-cli and pandadoc-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (pandadoc-v*).
...
$Skill   = "pandadoc"
$CliBin  = "pandadoc-cli.exe"
$McpBin  = "pandadoc-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (pandadoc-vX.Y.Z),
...
Write-Host "  pandadoc-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/pandadoc#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/pandadoc/mcp-install.md"
