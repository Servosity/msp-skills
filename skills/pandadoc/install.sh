#!/usr/bin/env bash
# install.sh - install pandadoc-cli and pandadoc-mcp on macOS / Linux.
#
...
SKILL="pandadoc"
CLI_BIN="pandadoc-cli"
MCP_BIN="pandadoc-mcp"
...
# Each skill is versioned and tagged independently (pandadoc-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/pandadoc#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/pandadoc/mcp-install.md"
