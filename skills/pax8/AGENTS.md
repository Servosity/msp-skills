# Pax8 Printed CLI Agent Guide

This directory is a generated `pax8-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
```bash
pax8-cli doctor --json
pax8-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
pax8-cli which "<capability>" --json
pax8-cli <command> --help
```
...
```bash
pax8-cli <command> --help
pax8-cli <command> --dry-run --agent
```
