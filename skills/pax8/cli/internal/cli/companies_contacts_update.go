...
func newCompaniesContactsUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !flags.dryRun && statusCode >= 200 && statusCode < 300 && (partialFailure == nil || flags.allowPartialFailure) {
				writeMutationResponseToStore(cmd.Context(), "contacts", data, "types")
			}
	...
	cmd.Flags().StringVar(&bodyCreatedDate, "created-date", "", "The created date")
	cmd.Flags().StringVar(&bodyEmail, "email", "", "The email")
	cmd.Flags().StringVar(&bodyFirstName, "first-name", "", "The first name")
	cmd.Flags().StringVar(&bodyId, "id", "", "The id")
	cmd.Flags().StringVar(&bodyLastName, "last-name", "", "The last name")
	cmd.Flags().StringVar(&bodyPhone, "phone", "", "The phone number")
