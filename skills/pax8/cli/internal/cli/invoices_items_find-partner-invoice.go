...
func newInvoicesItemsFindPartnerInvoiceCmd(flags *rootFlags) *cobra.Command {
	var flagPage string
	...
	cmd.Flags().StringVar(&flagPage, "page", "0", "The page number to request in the invoices items list")
	cmd.Flags().Float64Var(&flagSize, "size", 10.000000, "Returns _this_ number of invoices items per page")
