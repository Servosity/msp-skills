...
func newProductsPricingFindByProductIdCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagCompanyId, "company-id", "", "Use the companyId in the query to see company-specific pricing")
