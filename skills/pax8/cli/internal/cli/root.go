...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "pax8-cli",
		Short: `Pax8 CLI — Every Pax8 Partner API endpoint, plus an offline store that reconciles billing, tracks MRR, and catches usage overages …`,
		Long: `Pax8 CLI — Every Pax8 Partner API endpoint, plus an offline store that reconciles billing, tracks MRR, and catches usage overages …
...
Health check: run 'pax8-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("pax8-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'pax8-cli profile list')")
	...
	rootCmd.AddCommand(newNovelOverageCmd(flags))
	...
	rootCmd.AddCommand(newUsageSummariesPromotedCmd(flags))
