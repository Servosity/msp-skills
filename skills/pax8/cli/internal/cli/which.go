...
var whichIndex = []whichEntry{
	...
	{Command: "spend", Description: "Roll up invoice-items by company to show what each customer is costing across invoices.", Group: "Local state that compounds", WhyItMatters: "Reach for this to rank customers by spend without exporting every invoice."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  pax8-cli which "stale tickets"
  pax8-cli which "bottleneck"
  pax8-cli which --limit 1 "send message"
  pax8-cli which                                # list the full capability index`,
