...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("PAX8_CLIENT_ID"); v != "" {
		cfg.ClientID = v
		cfg.markEnvOverride("ClientID")
		cfg.AuthSource = "env:PAX8_CLIENT_ID"
	}
	if v := os.Getenv("PAX8_CLIENT_SECRET"); v != "" {
		cfg.ClientSecret = v
		cfg.markEnvOverride("ClientSecret")
		cfg.AuthSource = "env:PAX8_CLIENT_SECRET"
	}
	...
	if v := os.Getenv("PAX8_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := os.Getenv("PAX8_TOKEN_URL"); v != "" {
		cfg.TokenURL = v
	}
	return cfg, nil
}
...
const NoConfigWriteEnv = "PAX8_NO_CONFIG_WRITE"
...
// material. It is the ONLY save path PAX8_NO_CONFIG_WRITE suppresses;
