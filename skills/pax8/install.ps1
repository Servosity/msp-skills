# install.ps1 - install pax8-cli and pax8-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (pax8-v*).
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (pax8-vX.Y.Z),
...
Write-Host "  pax8-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/pax8#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/pax8/mcp-install.md"
