#!/usr/bin/env bash
# install.sh - install pax8-cli and pax8-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (pax8-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/pax8#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/pax8/mcp-install.md"
