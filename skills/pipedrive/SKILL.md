...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [pipedrive-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/pipedrive/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/pipedrive/install.ps1
---
...
The installer places the `pipedrive-cli` and `pipedrive-mcp` binaries on your PATH. It does not
