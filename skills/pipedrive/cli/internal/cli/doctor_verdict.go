...
//
// See issue #282 and skills/pipedrive/handfixes.json.
//
...
import (
	...
	"pipedrive-pp-cli/internal/client"
)
...
const doctorBaseURLEnv = "PIPEDRIVE_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://api.pipedrive.com/v1"
