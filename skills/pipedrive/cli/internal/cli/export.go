...
large datasets as it has no memory pressure.`,
  ...
  pipedrive-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  pipedrive-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  pipedrive-cli export <resource> --format jsonl | jq '.id'`,
