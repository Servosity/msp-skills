...
but do not stop the import.`,
  ...
  pipedrive-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  pipedrive-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | pipedrive-cli import <resource> --input -`,
