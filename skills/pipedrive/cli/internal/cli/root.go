...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "pipedrive-cli",
		Short: `Pipedrive CLI — Full Pipedrive CRUD plus a local SQLite pipeline copy: stale deals, forecasts, aging, dupes, rep leaderboards.`,
		Long: `Pipedrive CLI — Full Pipedrive CRUD plus a local SQLite pipeline copy: stale deals, forecasts, aging, dupes, rep leaderboards.
...
Health check: run 'pipedrive-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'pipedrive-cli profile list')")
	...
	rootCmd.AddCommand(newNovelLostCmd(flags))
	rootCmd.AddCommand(newNovelNextActivityCmd(flags))
