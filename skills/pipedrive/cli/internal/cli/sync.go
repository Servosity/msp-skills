...
import (
	...
	"pipedrive-pp-cli/internal/cliutil"
...
Resource scoping:
  ...
  pipedrive-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  pipedrive-cli sync --full

  # Incremental sync: only records from the last 7 days
  pipedrive-cli sync --since 7d

  # Parallel sync with 8 workers
  pipedrive-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  pipedrive-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("pipedrive-cli")
			}
...
func syncResourceFieldSelector(resource string) (string, string) {
	switch resource {
	case "legacy-teams":
		return "order_by", "data.id,success"
	case "deals_flow":
		return "all_changes", "success"
	case "organizations_flow":
		return "all_changes", "success"
	case "persons_flow":
		return "all_changes", "success"
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "projects_activities":
		return db.UpsertProjectsActivities(data)
	case "archive":
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		...
		{Name: "organizations_changelog", ParentTable: "organizations", ParentIDParam: "id", PathTemplate: "/organizations/{id}/changelog", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "organizations_files", ParentTable: "organizations", ParentIDParam: "id", PathTemplate: "/organizations/{id}/files", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "organizations_flow", ParentTable: "organizations", ParentIDParam: "id", PathTemplate: "/organizations/{id}/flow", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "organizations_mail_messages", ParentTable: "organizations", ParentIDParam: "id", PathTemplate: "/organizations/{id}/mailMessages", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		...
		{Name: "persons_changelog", ParentTable: "persons", ParentIDParam: "id", PathTemplate: "/persons/{id}/changelog", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "persons_files", ParentTable: "persons", ParentIDParam: "id", PathTemplate: "/persons/{id}/files", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "persons_flow", ParentTable: "persons", ParentIDParam: "id", PathTemplate: "/persons/{id}/flow", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "persons_mail_messages", ParentTable: "persons", ParentIDParam: "id", PathTemplate: "/persons/{id}/mailMessages", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "persons_products", ParentTable: "persons", ParentIDParam: "id", PathTemplate: "/persons/{id}/products", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "pipelines_deals", ParentTable: "pipelines", ParentIDParam: "id", PathTemplate: "/pipelines/{id}/deals", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "products_deals", ParentTable: "products", ParentIDParam: "id", PathTemplate: "/products/{id}/deals", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "products_files", ParentTable: "products", ParentIDParam: "id", PathTemplate: "/products/{id}/files", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		{Name: "products_followers", ParentTable: "products", ParentIDParam: "id", PathTemplate: "/products/{id}/followers", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
		...
		{Name: "stages_deals", ParentTable: "stages", ParentIDParam: "id", PathTemplate: "/stages/{id}/deals", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "id", Field: "id"},
		}},
	}
}
