...
type ActivitiesGetAllItem struct {
...
type ActivitiesGetResponse struct {
	Data    json.RawMessage `json:"data"`
	Success bool            `json:"success"`
}
...
type OrganizationsGetAllItem struct {
	ActiveFlag       bool   `json:"active_flag"`
	ActivitiesCount  int    `json:"activities_count"`
	AddTime          string `json:"add_time"`
...
type PersonsAddResponse struct {
	Data    json.RawMessage `json:"data"`
	Success bool            `json:"success"`
}

type PersonsDeleteResponse struct {
	Success bool `json:"success"`
}

type PersonsGetAllItem struct {
	ActiveFlag       bool            `json:"active_flag"`
	ActivitiesCount  int             `json:"activities_count"`
	AddTime          string          `json:"add_time"`
	ClosedDealsCount int             `json:"closed_deals_count"`
...
type PersonsGetResponse struct {
	Data    json.RawMessage `json:"data"`
	Success bool            `json:"success"`
}
...
type PipelinesGetAllItem struct {
	Active          bool   `json:"active"`
	AddTime         string `json:"add_time"`
...
type ProductsGetAllItem struct {
	ActiveFlag bool            `json:"active_flag"`
	AddTime    string          `json:"add_time"`
