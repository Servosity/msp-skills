# install.ps1 - install pipedrive-cli and pipedrive-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (pipedrive-v*).
...
$Skill   = "pipedrive"
$CliBin  = "pipedrive-cli.exe"
$McpBin  = "pipedrive-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (pipedrive-vX.Y.Z),
...
Write-Host "  pipedrive-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/pipedrive#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/pipedrive/mcp-install.md"
