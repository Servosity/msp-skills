#!/usr/bin/env bash
# install.sh - install pipedrive-cli and pipedrive-mcp on macOS / Linux.
#
...
SKILL="pipedrive"
CLI_BIN="pipedrive-cli"
MCP_BIN="pipedrive-mcp"
...
# Each skill is versioned and tagged independently (pipedrive-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/pipedrive#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/pipedrive/mcp-install.md"
