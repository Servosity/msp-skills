...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [proofpoint-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/proofpoint/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/proofpoint/install.ps1
---
...
The installer places the `proofpoint-cli` and `proofpoint-mcp` binaries on your PATH. It does not
