...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Proofpoint",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  proofpoint-cli auth setup\n  proofpoint-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			launchURL := "https://help.proofpoint.com/Threat_Insight_Dashboard/API_Documentation"
...
func newAuthStatusCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  proofpoint-cli auth status",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  proofpoint-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  proofpoint-cli auth logout",
		RunE: func(cmd *cobra.Command, args []string) error {
			cfg, err := config.Load(flags.configPath)
			if err != nil {
				return configErr(err)
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("PROOFPOINT_SERVICE_PRINCIPAL") != "" {
				envStillSet = "PROOFPOINT_SERVICE_PRINCIPAL"
			}
			if envStillSet == "" && os.Getenv("PROOFPOINT_API_SECRET") != "" {
				envStillSet = "PROOFPOINT_API_SECRET"
			}
