...
func newCampaignListIdsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagInterval, "interval", "", "ISO8601 interval (min 30s, max 1 day), e.g. 2026-06-05T00:00:00Z/2026-06-06T00:00:00Z")
	cmd.Flags().IntVar(&flagSize, "size", 100, "Maximum campaign IDs per page (default 100, max 200)")
