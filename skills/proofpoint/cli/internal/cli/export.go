...
large datasets as it has no memory pressure.`,
  ...
  proofpoint-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  proofpoint-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  proofpoint-cli export <resource> --format jsonl | jq '.id'`,
