...
but do not stop the import.`,
  ...
  proofpoint-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  proofpoint-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | proofpoint-cli import <resource> --input -`,
