# install.ps1 - install proofpoint-cli and proofpoint-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (proofpoint-v*).
...
$Skill   = "proofpoint"
$CliBin  = "proofpoint-cli.exe"
$McpBin  = "proofpoint-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (proofpoint-vX.Y.Z),
...
Write-Host "  proofpoint-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/proofpoint#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/proofpoint/mcp-install.md"
