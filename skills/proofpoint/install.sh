#!/usr/bin/env bash
# install.sh - install proofpoint-cli and proofpoint-mcp on macOS / Linux.
#
...
SKILL="proofpoint"
CLI_BIN="proofpoint-cli"
MCP_BIN="proofpoint-mcp"
...
# Each skill is versioned and tagged independently (proofpoint-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/proofpoint#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/proofpoint/mcp-install.md"
