...
metadata:
  openclaw:
    ...
    install:
      - kind: go
        bins: [quickbooks-cli]
        module: github.com/mvanhorn/printing-press-library/library/accounting/quickbooks/cmd/quickbooks-cli
---
...
```bash
go install github.com/mvanhorn/printing-press-library/library/accounting/quickbooks/cmd/quickbooks-cli@latest
```
...
1. Install the MCP server:
   ```bash
   go install github.com/mvanhorn/printing-press-library/library/accounting/quickbooks/cmd/quickbooks-mcp@latest
   ```
