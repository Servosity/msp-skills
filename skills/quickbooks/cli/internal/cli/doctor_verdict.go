...
//
// See issue #282 and skills/quickbooks/handfixes.json.
//
...
const doctorBaseURLEnv = "QUICKBOOKS_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://quickbooks.api.intuit.com/v3/company/YOUR_REALM_ID"
