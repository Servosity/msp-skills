...
large datasets as it has no memory pressure.`,
  ...
  quickbooks-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  quickbooks-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  quickbooks-cli export <resource> --format jsonl | jq '.id'`,
