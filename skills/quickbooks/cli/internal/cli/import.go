...
but do not stop the import.`,
  ...
  quickbooks-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  quickbooks-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | quickbooks-cli import <resource> --input -`,
