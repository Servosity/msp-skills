...
func newChangesPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagEntities, "entities", "Customer,Vendor,Item,Account,Invoice,Payment,Bill,JournalEntry", "Comma-separated entity names to track")
	cmd.Flags().StringVar(&flagChangedSince, "changed-since", "", "RFC3339 timestamp; returns objects changed at/after this time")
