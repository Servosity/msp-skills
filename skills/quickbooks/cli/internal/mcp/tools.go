...
func newMCPClient() (*client.Client, error) {
	...
	cfgPath := filepath.Join(home, ".config", "quickbooks-cli", "config.toml")
...
func dbPath() string {
	home, _ := os.UserHomeDir()
	return filepath.Join(home, ".local", "share", "quickbooks-cli", "data.db")
}
...
func handleContext(_ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	ctx := map[string]any{
		...
		"tool_surface": "MCP exposes typed endpoint tools plus a runtime mirror of user-facing CLI commands. Endpoint tools keep typed schemas; command-mirror tools shell out to the companion quickbooks-cli binary.",
		"auth": map[string]any{
			"type": "bearer_token",
		...
		"resources": []map[string]any{
			{
				"name":        "accounts",
				"description": "Accounts — the chart of accounts",
			...
			{
				"name":        "bills",
				"description": "Bills — accounts-payable transactions",
			...
			{
				"name":        "changes",
				"description": "Change Data Capture — entities changed since a timestamp (powers incremental sync)",
				"endpoints":   []string{"cdc"},
				"searchable":  true,
			},
			{
				"name":        "customers",
				"description": "Customers — the people and companies you invoice",
				"endpoints":   []string{"create", "get", "list", "update"},
				"syncable":    true,
				"searchable":  true,
			},
			{
				"name":        "invoices",
				"description": "Invoices — accounts-receivable transactions",
				"endpoints":   []string{"create", "delete", "get", "list", "update"},
				"syncable":    true,
				"searchable":  true,
			},
			{
				"name":        "items",
				"description": "Items — products and services you sell or buy",
				"endpoints":   []string{"create", "get", "list", "update"},
				"syncable":    true,
				"searchable":  true,
			},
			{
				...
				"description": "Journal entries — manual debits and credits",
				"endpoints":   []string{"create", "delete", "get", "list", "update"},
				"syncable":    true,
				"searchable":  true,
			},
			{
				"name":        "payments",
				"description": "Payments — customer payments received against invoices",
				"endpoints":   []string{"create", "delete", "get", "list", "update"},
				"syncable":    true,
				"searchable":  true,
			},
			{
				"name":        "query",
				"description": "Raw QBO query passthrough — run any SQL-like SELECT against any entity",
				"endpoints":   []string{"run"},
				"searchable":  true,
			},
			{
				"name":        "vendors",
				"description": "Vendors — the people and companies you pay",
				"endpoints":   []string{"create", "get", "list", "update"},
				"syncable":    true,
				"searchable":  true,
			},
