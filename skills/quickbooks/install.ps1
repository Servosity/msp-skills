# install.ps1 - install quickbooks-cli and quickbooks-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (quickbooks-v*).
...
$Skill   = "quickbooks"
$CliBin  = "quickbooks-cli.exe"
$McpBin  = "quickbooks-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (quickbooks-vX.Y.Z),
...
Write-Host "  quickbooks-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/quickbooks#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/quickbooks/mcp-install.md"
