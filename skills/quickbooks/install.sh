#!/usr/bin/env bash
# install.sh - install quickbooks-cli and quickbooks-mcp on macOS / Linux.
#
...
SKILL="quickbooks"
CLI_BIN="quickbooks-cli"
MCP_BIN="quickbooks-mcp"
...
# Each skill is versioned and tagged independently (quickbooks-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/quickbooks#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/quickbooks/mcp-install.md"
