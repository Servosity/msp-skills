  ...
  openclaw:
    ...
    install:
      - kind: script
        ...
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/resourceguru/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/resourceguru/install.ps1
---
...
The installer places the `resourceguru-cli` and `resourceguru-mcp` binaries on your PATH. It does not
