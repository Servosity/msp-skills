...
//
// See issue #282 and skills/resourceguru/handfixes.json.
//
...
const doctorBaseURLEnv = "RESOURCEGURU_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://api.resourceguruapp.com"
