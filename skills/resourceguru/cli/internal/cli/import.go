...
but do not stop the import.`,
  ...
  resourceguru-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  resourceguru-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | resourceguru-cli import <resource> --input -`,
