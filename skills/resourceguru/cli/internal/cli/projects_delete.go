...
func newProjectsDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  resourceguru-cli projects delete example-corp 1",
		Annotations: map[string]string{"pp:endpoint": "projects.delete", "pp:method": "DELETE", "pp:path": "/v1/{account}/projects/{id}"},
