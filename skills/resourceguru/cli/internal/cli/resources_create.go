...
func newResourcesCreateCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create <account>",
		Short:       "Create a new resource. The availability will be created with the default availability settings set within the app",
		Example:     "  resourceguru-cli resources create example-corp",
		Annotations: map[string]string{"pp:endpoint": "resources.create", "pp:method": "POST", "pp:path": "/v1/{account}/resources"},
