...
func newResourcesUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  resourceguru-cli resources update example-corp 1",
		Annotations: map[string]string{"pp:endpoint": "resources.update", "pp:method": "PUT", "pp:path": "/v1/{account}/resources/{id}"},
