...
Resource scoping:
  ...
  resourceguru-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  resourceguru-cli sync --full

  # Incremental sync: only records from the last 7 days
  resourceguru-cli sync --since 7d

  # Parallel sync with 8 workers
  resourceguru-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  resourceguru-cli sync --latest-only`,
...
func determinePaginationDefaults(resource string) paginationDefaults {
	switch resource {
	case "accounts/accounts_bookings":
	...
	case "projects/projects_bookings":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
	...
	case "resources/resources_bookings":
		return paginationDefaults{
			cursorParam: "offset",
			cursorType:  "offset",
			limitParam:  "limit",
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "remind":
		return db.UpsertRemind(data)
	case "resolve":
		return db.UpsertResolve(data)
	case "bookings_split":
		return db.UpsertBookingsSplit(data)
	case "calendars":
		return db.UpsertCalendars(data)
	case "clients":
		return db.UpsertClients(data)
	case "clients_bookings":
		return db.UpsertClientsBookings(data)
	case "custom-available-periods":
		return db.UpsertCustomAvailablePeriods(data)
	case "custom-field-options":
		return db.UpsertCustomFieldOptions(data)
	case "custom-fields":
		return db.UpsertCustomFields(data)
	case "downtime-types":
		return db.UpsertDowntimeTypes(data)
	case "downtimes":
		return db.UpsertDowntimes(data)
	case "downtimes_split":
		return db.UpsertDowntimesSplit(data)
	case "me":
		return db.UpsertMe(data)
	case "projects":
		return db.UpsertProjects(data)
	case "projects_bookings":
		return db.UpsertProjectsBookings(data)
	case "rates":
	...
	case "resources_bookings":
		return db.UpsertResourcesBookings(data)
	case "invite":
		return db.UpsertInvite(data)
	case "timesheets":
		return db.UpsertTimesheets(data)
	case "dismiss":
	...
	case "send_payload_batch":
		return db.UpsertSendPayloadBatch(data)
	case "test":
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "accounts_bookings", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/{account}/bookings", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.account", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
		}},
		{Name: "accounts_queue", ParentTable: "accounts", ParentIDParam: "id", PathTemplate: "/v1/{account}/webhooks/{id}/queue", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
			{Param: "id", Field: "id"},
		}},
		{Name: "clients", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/{account}/clients", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.account", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
		}},
		{Name: "clients", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/{account}/clients/archived", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.account", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
		}},
		{Name: "downtimes", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/{account}/downtimes", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.account", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
		}},
		{Name: "projects", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/{account}/projects", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.account", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
		}},
		{Name: "projects", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/{account}/projects/archived", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.account", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
		}},
		{Name: "resources", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/{account}/resources/archived", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
		}},
		{Name: "resources", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/{account}/resources", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
		}},
		{Name: "timesheets", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/{account}/timesheets", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.account", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
		}},
		{Name: "users", ParentTable: "accounts", ParentIDParam: "account", PathTemplate: "/v1/{account}/users", KeyField: "", ReconcileMode: "per_parent", GenericScopeJSONPath: "$.account", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "id"},
		}},
		{Name: "clients_bookings", ParentTable: "clients", ParentIDParam: "id", PathTemplate: "/v1/{account}/clients/{id}/bookings", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "v1_id"},
			{Param: "id", Field: "id"},
		}},
		{Name: "projects_bookings", ParentTable: "projects", ParentIDParam: "id", PathTemplate: "/v1/{account}/projects/{id}/bookings", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "v1_id"},
			{Param: "id", Field: "id"},
		}},
		{Name: "resources_bookings", ParentTable: "resources", ParentIDParam: "id", PathTemplate: "/v1/{account}/resources/{id}/bookings", KeyField: "", ReconcileMode: "none", GenericScopeJSONPath: "", PathParams: []dependentPathParamDef{
			{Param: "account", Field: "v1_id"},
			{Param: "id", Field: "id"},
		}},
	}
...
func responsePathForResource(resource, path string) []string {
	...
	case "accounts\x00/v1/accounts/{id}":
		return []string{"default_booking_approver_ids"}
	case "activity-types\x00/v1/{account}/activity_types":
		return []string{"project_ids"}
	case "activity-types\x00/v1/{account}/activity_types/{id}":
		return []string{"project_ids"}
	case "custom-available-periods\x00/v1/{account}/custom_available_periods":
		return []string{"custom_available_periods"}
	case "downtimes\x00/v1/{account}/downtimes":
		return []string{"resource_ids"}
	case "downtimes\x00/v1/{account}/downtimes/clashes":
		return []string{"resource_ids"}
	case "downtimes\x00/v1/{account}/downtimes/{id}":
		return []string{"resource_ids"}
	case "rates\x00/v1/{account}/rates":
		return []string{"resource_ids"}
	case "rates\x00/v1/{account}/rates/{id}":
		return []string{"resource_ids"}
	case "reports\x00/v1/{account}/reports/clients":
		return []string{"clients"}
	case "reports\x00/v1/{account}/reports/projects":
		return []string{"projects"}
	case "reports\x00/v1/{account}/reports/resources":
		return []string{"resources"}
	case "reports\x00/v2/{account}/reports/resources":
		return []string{"resources"}
	case "reports\x00/v1/{account}/reports/clients/{id}":
		return []string{"resources"}
	case "reports\x00/v1/{account}/reports/projects/{id}":
		return []string{"resources"}
	case "webhooks\x00/v1/{account}/webhooks":
		return []string{"events"}
	case "webhooks\x00/v1/{account}/webhooks/{id}":
		return []string{"events"}
	}
	return nil
}
