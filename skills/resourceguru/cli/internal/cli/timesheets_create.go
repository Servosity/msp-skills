...
func newTimesheetsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  resourceguru-cli timesheets create example-corp",
		Annotations: map[string]string{"pp:endpoint": "timesheets.create", "pp:method": "POST", "pp:path": "/v1/{account}/timesheets"},
	...
	cmd.Flags().StringVar(&flagAction, "action", "", "Add multiple timesheet entries")
