...
func newTimesheetsUpdateCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "update <account>",
		Short:       "Update multiple timesheet entries by their unique identifiers.",
		Example:     "  resourceguru-cli timesheets update example-corp",
		Annotations: map[string]string{"pp:endpoint": "timesheets.update", "pp:method": "PUT", "pp:path": "/v1/{account}/timesheets/update"},
