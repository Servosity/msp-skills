...
func newWebhooksDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  resourceguru-cli webhooks delete example-corp 1",
		Annotations: map[string]string{"pp:endpoint": "webhooks.delete", "pp:method": "DELETE", "pp:path": "/v1/{account}/webhooks/{id}"},
