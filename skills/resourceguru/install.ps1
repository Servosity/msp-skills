# install.ps1 - install resourceguru-cli and resourceguru-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (resourceguru-v*).
...
$Skill   = "resourceguru"
$CliBin  = "resourceguru-cli.exe"
$McpBin  = "resourceguru-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (resourceguru-vX.Y.Z),
...
Write-Host "  resourceguru-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/resourceguru#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/resourceguru/mcp-install.md"
