#!/usr/bin/env bash
# install.sh - install resourceguru-cli and resourceguru-mcp on macOS / Linux.
#
...
SKILL="resourceguru"
CLI_BIN="resourceguru-cli"
MCP_BIN="resourceguru-mcp"
...
# Each skill is versioned and tagged independently (resourceguru-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/resourceguru#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/resourceguru/mcp-install.md"
