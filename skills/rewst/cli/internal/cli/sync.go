...
Resource scoping:
  ...
  rewst-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  rewst-cli sync --full

  # Incremental sync: only records from the last 7 days
  rewst-cli sync --since 7d

  # Parallel sync with 8 workers
  rewst-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  rewst-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "action-options":
		return db.UpsertActionOptions(data)
	case "actions":
		return db.UpsertActions(data)
	case "active-conversation-requests":
		return db.UpsertActiveConversationRequests(data)
	case "api-clients":
		return db.UpsertApiClients(data)
	case "app-platform-reserved-domains":
		return db.UpsertAppPlatformReservedDomains(data)
	case "commonly-used-actions":
		return db.UpsertCommonlyUsedActions(data)
	case "component-instances":
		return db.UpsertComponentInstances(data)
	case "component-trees":
		return db.UpsertComponentTrees(data)
	case "components":
		return db.UpsertComponents(data)
	case "conversation-message-votes":
		return db.UpsertConversationMessageVotes(data)
	case "conversation-messages":
		return db.UpsertConversationMessages(data)
	case "conversations":
		return db.UpsertConversations(data)
	case "crate-override-options":
		return db.UpsertCrateOverrideOptions(data)
	case "crate-overrides":
		return db.UpsertCrateOverrides(data)
	case "crate-unpacking-argument-sets":
		return db.UpsertCrateUnpackingArgumentSets(data)
	case "crate-use-cases":
		return db.UpsertCrateUseCases(data)
	case "crates":
		return db.UpsertCrates(data)
	case "database-notification-errors":
		return db.UpsertDatabaseNotificationErrors(data)
	case "dropdown-options":
		return db.UpsertDropdownOptions(data)
	case "feature-preview-settings":
		return db.UpsertFeaturePreviewSettings(data)
	case "foreign-object-references":
		return db.UpsertForeignObjectReferences(data)
	case "form-audit-entries":
		return db.UpsertFormAuditEntries(data)
	case "form-permission-states":
		return db.UpsertFormPermissionStates(data)
	case "forms":
		return db.UpsertForms(data)
	case "integration-workflow-outputs":
		return db.UpsertIntegrationWorkflowOutputs(data)
	case "integrations":
		return db.UpsertIntegrations(data)
	case "interpreter-versions":
		return db.UpsertInterpreterVersions(data)
	case "jinja-render-sessions":
		return db.UpsertJinjaRenderSessions(data)
	case "jinja2-documentations":
		return db.UpsertJinja2Documentations(data)
	case "logins":
		return db.UpsertLogins(data)
	case "microsoft-c-s-p-customers":
		return db.UpsertMicrosoftCSPCustomers(data)
	case "monaco-completion-items":
		return db.UpsertMonacoCompletionItems(data)
	case "onboarding-questionnaire-responses":
		return db.UpsertOnboardingQuestionnaireResponses(data)
	case "org-breadcrumbs":
		return db.UpsertOrgBreadcrumbs(data)
	case "org-form-field-instances":
		return db.UpsertOrgFormFieldInstances(data)
	case "org-search-results":
		return db.UpsertOrgSearchResults(data)
	case "org-support-accesses":
		return db.UpsertOrgSupportAccesses(data)
	case "org-trigger-instances":
		return db.UpsertOrgTriggerInstances(data)
	case "org-variables":
		return db.UpsertOrgVariables(data)
	case "organization-imports":
		return db.UpsertOrganizationImports(data)
	case "organization-onboarding-crate-requirements":
		return db.UpsertOrganizationOnboardingCrateRequirements(data)
	case "organization-onboarding-pack-requirements":
		return db.UpsertOrganizationOnboardingPackRequirements(data)
	case "organization-onboarding-requirements":
		return db.UpsertOrganizationOnboardingRequirements(data)
	case "organizations":
		return db.UpsertOrganizations(data)
	case "pack-action-options":
		return db.UpsertPackActionOptions(data)
	case "pack-bundles":
		return db.UpsertPackBundles(data)
	case "pack-configs":
		return db.UpsertPackConfigs(data)
	case "pack-delete-responses":
		return db.UpsertPackDeleteResponses(data)
	case "packs":
		return db.UpsertPacks(data)
	case "page-nodes":
		return db.UpsertPageNodes(data)
	case "pages":
		return db.UpsertPages(data)
	case "permissions":
		return db.UpsertPermissions(data)
	case "psa-organizations":
		return db.UpsertPsaOrganizations(data)
	case "public-crates":
		return db.UpsertPublicCrates(data)
	case "reserved-organization-names":
		return db.UpsertReservedOrganizationNames(data)
	case "role-organization-rows":
		return db.UpsertRoleOrganizationRows(data)
	case "roles":
		return db.UpsertRoles(data)
	case "sensor-types":
		return db.UpsertSensorTypes(data)
	case "site-domain-valids":
		return db.UpsertSiteDomainValids(data)
	case "sites":
		return db.UpsertSites(data)
	case "tags":
		return db.UpsertTags(data)
	case "task-count-by-dates":
		return db.UpsertTaskCountByDates(data)
	case "task-logs":
		return db.UpsertTaskLogs(data)
	case "templates":
		return db.UpsertTemplates(data)
	case "time-saved-by-dates":
		return db.UpsertTimeSavedByDates(data)
	case "time-saved-group-by-orgs":
		return db.UpsertTimeSavedGroupByOrgs(data)
	case "time-saved-group-by-workflows":
		return db.UpsertTimeSavedGroupByWorkflows(data)
	case "trigger-types":
		return db.UpsertTriggerTypes(data)
	case "triggers":
		return db.UpsertTriggers(data)
	case "user-delegated-accesses":
		return db.UpsertUserDelegatedAccesses(data)
	case "user-favorite-actions":
		return db.UpsertUserFavoriteActions(data)
	case "user-invites":
		return db.UpsertUserInvites(data)
	case "user-preferenceses":
		return db.UpsertUserPreferenceses(data)
	case "user-robo-rewsty-preferenceses":
		return db.UpsertUserRoboRewstyPreferenceses(data)
	case "users":
		return db.UpsertUsers(data)
	case "workflow-execution-statses":
		return db.UpsertWorkflowExecutionStatses(data)
	case "workflow-executions":
		return db.UpsertWorkflowExecutions(data)
	case "workflow-notes":
		return db.UpsertWorkflowNotes(data)
	case "workflow-patches":
		return db.UpsertWorkflowPatches(data)
	case "workflow-stats-by-orgs":
		return db.UpsertWorkflowStatsByOrgs(data)
	case "workflow-tasks":
		return db.UpsertWorkflowTasks(data)
	case "workflows":
