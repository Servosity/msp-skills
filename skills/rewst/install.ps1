# install.ps1 - install rewst-cli and rewst-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (rewst-v*).
...
$Skill   = "rewst"
$CliBin  = "rewst-cli.exe"
$McpBin  = "rewst-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (rewst-vX.Y.Z),
...
Write-Host "  rewst-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/rewst#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/rewst/mcp-install.md"
