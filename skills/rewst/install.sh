#!/usr/bin/env bash
# install.sh - install rewst-cli and rewst-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (rewst-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/rewst#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/rewst/mcp-install.md"
