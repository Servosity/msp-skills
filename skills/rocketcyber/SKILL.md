  ...
  openclaw:
    ...
    install:
      - kind: script
        ...
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/rocketcyber/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/rocketcyber/install.ps1
---
...
The installer places the `rocketcyber-cli` and `rocketcyber-mcp` binaries on your PATH. It does not
