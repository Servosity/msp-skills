...
//
// See issue #282 and skills/rocketcyber/handfixes.json.
//
...
const doctorBaseURLEnv = "ROCKETCYBER_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://api-us.rocketcyber.com/v3"
