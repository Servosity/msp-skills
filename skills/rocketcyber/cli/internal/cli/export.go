...
large datasets as it has no memory pressure.`,
  ...
  rocketcyber-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  rocketcyber-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  rocketcyber-cli export <resource> --format jsonl | jq '.id'`,
