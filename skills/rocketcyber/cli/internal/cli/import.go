...
but do not stop the import.`,
  ...
  rocketcyber-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  rocketcyber-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | rocketcyber-cli import <resource> --input -`,
