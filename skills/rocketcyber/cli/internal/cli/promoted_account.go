...
func newAccountPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagAccountId, "account-id", "", "Account ID to scope the lookup (omit for your provider account)")
	cmd.Flags().BoolVar(&flagDetails, "details", false, "Include extended account details")
