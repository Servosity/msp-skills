#!/usr/bin/env bash
# install.sh - install rocketcyber-cli and rocketcyber-mcp on macOS / Linux.
#
...
SKILL="rocketcyber"
CLI_BIN="rocketcyber-cli"
MCP_BIN="rocketcyber-mcp"
...
# Each skill is versioned and tagged independently (rocketcyber-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/rocketcyber#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/rocketcyber/mcp-install.md"
