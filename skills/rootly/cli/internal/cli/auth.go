...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Rootly",
...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  rootly-cli auth setup\n  rootly-cli auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			launchURL := "https://api.rootly.com/v1"
...
func newAuthStatusCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  rootly-cli auth status",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  rootly-cli auth set-token YOUR_TOKEN_HERE",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  rootly-cli auth logout",
		RunE: func(cmd *cobra.Command, args []string) error {
			cfg, err := config.Load(flags.configPath)
			if err != nil {
				return configErr(err)
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("ROOTLY_API_KEY") != "" {
				envStillSet = "ROOTLY_API_KEY"
			}
			if envStillSet == "" && os.Getenv("ROOTLY_API_TOKEN") != "" {
				envStillSet = "ROOTLY_API_TOKEN"
			}
