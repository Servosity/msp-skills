...
Resource scoping:
  ...
  rootly-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  rootly-cli sync --full

  # Incremental sync: only records from the last 7 days
  rootly-cli sync --since 7d

  # Parallel sync with 8 workers
  rootly-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  rootly-cli sync --latest-only`,
...
func resourceSupportsPagination(resource string) bool {
	...
	case "alert-routes":
		return true
	case "alert-routing-rules":
		return true
	case "alert-sources":
		return true
	case "alert-urgencies":
		return true
	case "alerts":
		return true
	case "alerts_events":
	...
	case "booleans":
		return true
	case "catalog-checklist-templates":
		return true
	case "catalog-entity-checklists":
		return true
	case "catalogs":
		return true
	case "causes":
		return true
	case "causes-properties":
		return true
	case "communications":
		return true
	case "communications-groups":
		return true
	case "communications-stages":
		return true
	...
	case "dashboards":
		return true
	case "edge-connectors":
		return true
	case "entities":
		return true
	case "environments":
		return true
	case "environments-properties":
		return true
	...
	case "functionalities":
		return true
	case "functionalities-properties":
		return true
	case "groups":
		return true
	case "heartbeats":
		return true
	case "incident-permission-sets":
		return true
	case "incident-roles":
		return true
	case "incident-types":
		return true
	case "incident-types-properties":
		return true
	...
	case "incidents_sub_statuses":
		return true
	case "live-call-routers":
		return true
	case "on-call-pay-reports":
		return true
	case "on-call-roles":
		return true
	case "panels":
	...
	case "resources":
		return true
	case "retrospective-configurations":
		return true
	case "retrospective-processes":
		return true
...
func syncResourceFieldSelector(resource string) (string, string) {
	...
	case "severities":
		return "include", "attributes"
	case "shifts":
		return "include", "attributes,relationships"
	case "status-pages":
		return "include", "attributes"
	case "statuses":
		return "include", "attributes"
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	switch resource {
	case "acknowledge":
		return db.UpsertAcknowledge(data)
	case "alerts_events":
		return db.UpsertAlertsEvents(data)
	case "alerts_resolve":
		return db.UpsertAlertsResolve(data)
	case "rotate":
		return db.UpsertRotate(data)
	case "trigger":
		return db.UpsertTrigger(data)
	case "catalog_entities_properties":
		return db.UpsertCatalogEntitiesProperties(data)
	case "entities":
		return db.UpsertEntities(data)
	case "catalogs_properties":
		return db.UpsertCatalogsProperties(data)
	case "custom_fields_options":
		return db.UpsertCustomFieldsOptions(data)
	case "dashboard_panels_duplicate":
		return db.UpsertDashboardPanelsDuplicate(data)
	case "dashboards_duplicate":
		return db.UpsertDashboardsDuplicate(data)
	case "panels":
		return db.UpsertPanels(data)
	case "set_default":
		return db.UpsertSetDefault(data)
	case "actions":
	...
	case "escalation_paths_escalation_levels":
		return db.UpsertEscalationPathsEscalationLevels(data)
	case "escalation_policies_escalation_levels":
		return db.UpsertEscalationPoliciesEscalationLevels(data)
	case "escalation_policies_escalation_paths":
		return db.UpsertEscalationPoliciesEscalationPaths(data)
	case "events_functionalities":
		return db.UpsertEventsFunctionalities(data)
	case "events_services":
		return db.UpsertEventsServices(data)
	case "form_field_placements_conditions":
		return db.UpsertFormFieldPlacementsConditions(data)
	case "form_fields_options":
		return db.UpsertFormFieldsOptions(data)
	case "placements":
		return db.UpsertPlacements(data)
	case "positions":
		return db.UpsertPositions(data)
	case "form_sets_conditions":
		return db.UpsertFormSetsConditions(data)
	case "functionalities_incidents_chart":
		return db.UpsertFunctionalitiesIncidentsChart(data)
	case "functionalities_uptime_chart":
		return db.UpsertFunctionalitiesUptimeChart(data)
	case "ping":
		return db.UpsertPing(data)
	case "booleans":
		return db.UpsertBooleans(data)
	case "resources":
		return db.UpsertResources(data)
	case "incident_roles_incident_role_tasks":
		return db.UpsertIncidentRolesIncidentRoleTasks(data)
	case "incidents_action_items":
		return db.UpsertIncidentsActionItems(data)
	case "add_subscribers":
		return db.UpsertAddSubscribers(data)
	case "incidents_alerts":
		return db.UpsertIncidentsAlerts(data)
	case "assign_role_to_user":
		return db.UpsertAssignRoleToUser(data)
	case "cancel":
		return db.UpsertCancel(data)
	case "incidents_custom_field_selections":
		return db.UpsertIncidentsCustomFieldSelections(data)
	case "detach_from_parent":
		return db.UpsertDetachFromParent(data)
	case "incidents_duplicate":
		return db.UpsertIncidentsDuplicate(data)
	case "incidents_events":
		return db.UpsertIncidentsEvents(data)
	case "incidents_feedbacks":
		return db.UpsertIncidentsFeedbacks(data)
	case "form_field_selections":
		return db.UpsertFormFieldSelections(data)
	case "in_triage":
		return db.UpsertInTriage(data)
	case "incidents_meeting_recordings":
		return db.UpsertIncidentsMeetingRecordings(data)
	case "mitigate":
		return db.UpsertMitigate(data)
	case "remove_subscribers":
		return db.UpsertRemoveSubscribers(data)
	case "incidents_resolve":
		return db.UpsertIncidentsResolve(data)
	case "restart":
		return db.UpsertRestart(data)
	case "incidents_status_page_events":
		return db.UpsertIncidentsStatusPageEvents(data)
	case "incidents_sub_statuses":
		return db.UpsertIncidentsSubStatuses(data)
	case "unassign_role_from_user":
		return db.UpsertUnassignRoleFromUser(data)
	case "unmark_as_duplicate":
		return db.UpsertUnmarkAsDuplicate(data)
	case "delete_video":
		return db.UpsertDeleteVideo(data)
	case "leave":
	...
	case "playbooks_playbook_tasks":
		return db.UpsertPlaybooksPlaybookTasks(data)
	case "steps":
		return db.UpsertSteps(data)
	case "groups":
		return db.UpsertGroups(data)
	case "retrospective_processes_retrospective_steps":
		return db.UpsertRetrospectiveProcessesRetrospectiveSteps(data)
	case "schedule_rotations_schedule_rotation_active_days":
		return db.UpsertScheduleRotationsScheduleRotationActiveDays(data)
	case "schedule_rotations_schedule_rotation_users":
		return db.UpsertScheduleRotationsScheduleRotationUsers(data)
	case "schedules_on_call_shadows":
		return db.UpsertSchedulesOnCallShadows(data)
	case "schedules_override_shifts":
		return db.UpsertSchedulesOverrideShifts(data)
	case "schedules_schedule_rotations":
		return db.UpsertSchedulesScheduleRotations(data)
	case "schedules_shifts":
		return db.UpsertSchedulesShifts(data)
	case "services_incidents_chart":
		return db.UpsertServicesIncidentsChart(data)
	case "services_uptime_chart":
		return db.UpsertServicesUptimeChart(data)
	case "status_pages_templates":
		return db.UpsertStatusPagesTemplates(data)
	case "teams_incidents_chart":
		return db.UpsertTeamsIncidentsChart(data)
	case "users_email_addresses":
		return db.UpsertUsersEmailAddresses(data)
	case "users_notification_rules":
		return db.UpsertUsersNotificationRules(data)
	case "users_phone_numbers":
		return db.UpsertUsersPhoneNumbers(data)
	case "workflows_custom_field_selections":
		return db.UpsertWorkflowsCustomFieldSelections(data)
	case "form_field_conditions":
		return db.UpsertFormFieldConditions(data)
	case "workflow_runs":
		return db.UpsertWorkflowRuns(data)
	case "workflows_workflow_tasks":
		return db.UpsertWorkflowsWorkflowTasks(data)
	default:
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"action-items":                 "/v1/action_items",
		"alert-fields":                 "/v1/alert_fields",
		"alert-groups":                 "/v1/alert_groups",
		"alert-routes":                 "/v1/alert_routes",
		"alert-routing-rules":          "/v1/alert_routing_rules",
		"alert-sources":                "/v1/alert_sources",
		"alert-urgencies":              "/v1/alert_urgencies",
		"alerts":                       "/v1/alerts",
		"api-keys":                     "/v1/api_keys",
		"audits":                       "/v1/audits",
		"authorizations":               "/v1/authorizations",
		"catalog-checklist-templates":  "/v1/catalog_checklist_templates",
		"catalog-entity-checklists":    "/v1/catalog_entity_checklists",
		"catalogs":                     "/v1/catalogs",
		"causes":                       "/v1/causes",
		"causes-properties":            "/v1/causes/properties",
		"communications":               "/v1/communications/types",
		"communications-groups":        "/v1/communications/groups",
		"communications-stages":        "/v1/communications/stages",
		"communications-templates":     "/v1/communications/templates",
		"custom-fields":                "/v1/custom_fields",
		"custom-forms":                 "/v1/custom_forms",
		"dashboards":                   "/v1/dashboards",
		"edge-connectors":              "/v1/edge_connectors",
		"environments":                 "/v1/environments",
		"environments-properties":      "/v1/environments/properties",
		"escalation-policies":          "/v1/escalation_policies",
		"form-fields":                  "/v1/form_fields",
		"form-sets":                    "/v1/form_sets",
		"functionalities":              "/v1/functionalities",
		"functionalities-properties":   "/v1/functionalities/properties",
		"heartbeats":                   "/v1/heartbeats",
		"incident-permission-sets":     "/v1/incident_permission_sets",
		"incident-roles":               "/v1/incident_roles",
		"incident-types":               "/v1/incident_types",
		"incident-types-properties":    "/v1/incident_types/properties",
		"incidents":                    "/v1/incidents",
		"ip-ranges":                    "/v1/ip_ranges",
		"live-call-routers":            "/v1/live_call_routers",
		"on-call-pay-reports":          "/v1/on_call_pay_reports",
		"on-call-roles":                "/v1/on_call_roles",
		"oncalls":                      "/v1/oncalls",
		"playbooks":                    "/v1/playbooks",
		"post-mortem-templates":        "/v1/post_mortem_templates",
		"post-mortems":                 "/v1/post_mortems",
		"pulses":                       "/v1/pulses",
		"retrospective-configurations": "/v1/retrospective_configurations",
		"retrospective-processes":      "/v1/retrospective_processes",
		"roles":                        "/v1/roles",
		"schedules":                    "/v1/schedules",
		"secrets":                      "/v1/secrets",
		"services":                     "/v1/services",
		"services-properties":          "/v1/services/properties",
		"severities":                   "/v1/severities",
		"shifts":                       "/v1/shifts",
		"slas":                         "/v1/slas",
		"status-pages":                 "/v1/status-pages",
		"statuses":                     "/v1/statuses",
		"sub-statuses":                 "/v1/sub_statuses",
		"teams":                        "/v1/teams",
		"teams-properties":             "/v1/teams/properties",
		"users":                        "/v1/users",
		"users-me":                     "/v1/users/me",
		"webhooks":                     "/v1/webhooks/endpoints",
		"workflow-groups":              "/v1/workflow_groups",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "alerts_events", ParentTable: "alerts", ParentIDParam: "alert_id", PathTemplate: "/v1/alerts/{alert_id}/events", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "alert_id", Field: "id"},
		}},
		{Name: "booleans", ParentTable: "incident-permission-sets", ParentIDParam: "incident_permission_set_id", PathTemplate: "/v1/incident_permission_sets/{incident_permission_set_id}/booleans", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_permission_set_id", Field: "id"},
		}},
		{Name: "custom_fields_options", ParentTable: "custom-fields", ParentIDParam: "custom_field_id", PathTemplate: "/v1/custom_fields/{custom_field_id}/options", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "custom_field_id", Field: "id"},
		}},
		{Name: "entities", ParentTable: "catalogs", ParentIDParam: "catalog_id", PathTemplate: "/v1/catalogs/{catalog_id}/entities", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "catalog_id", Field: "id"},
		}},
		{Name: "escalation_policies_escalation_levels", ParentTable: "escalation-policies", ParentIDParam: "escalation_policy_id", PathTemplate: "/v1/escalation_policies/{escalation_policy_id}/escalation_levels", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "escalation_policy_id", Field: "id"},
		}},
		{Name: "escalation_policies_escalation_paths", ParentTable: "escalation-policies", ParentIDParam: "escalation_policy_id", PathTemplate: "/v1/escalation_policies/{escalation_policy_id}/escalation_paths", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "escalation_policy_id", Field: "id"},
		}},
		{Name: "form_field_conditions", ParentTable: "workflows", ParentIDParam: "workflow_id", PathTemplate: "/v1/workflows/{workflow_id}/form_field_conditions", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workflow_id", Field: "id"},
		}},
		{Name: "form_field_selections", ParentTable: "incidents", ParentIDParam: "incident_id", PathTemplate: "/v1/incidents/{incident_id}/form_field_selections", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_id", Field: "id"},
		}},
		{Name: "form_fields_options", ParentTable: "form-fields", ParentIDParam: "form_field_id", PathTemplate: "/v1/form_fields/{form_field_id}/options", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "form_field_id", Field: "id"},
		}},
		{Name: "form_sets_conditions", ParentTable: "form-sets", ParentIDParam: "form_set_id", PathTemplate: "/v1/form_sets/{form_set_id}/conditions", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "form_set_id", Field: "id"},
		}},
		{Name: "groups", ParentTable: "retrospective-processes", ParentIDParam: "retrospective_process_id", PathTemplate: "/v1/retrospective_processes/{retrospective_process_id}/groups", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "retrospective_process_id", Field: "id"},
		}},
		{Name: "incident_roles_incident_role_tasks", ParentTable: "incident-roles", ParentIDParam: "incident_role_id", PathTemplate: "/v1/incident_roles/{incident_role_id}/incident_role_tasks", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_role_id", Field: "id"},
		}},
		{Name: "incidents_action_items", ParentTable: "incidents", ParentIDParam: "incident_id", PathTemplate: "/v1/incidents/{incident_id}/action_items", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_id", Field: "id"},
		}},
		{Name: "incidents_custom_field_selections", ParentTable: "incidents", ParentIDParam: "incident_id", PathTemplate: "/v1/incidents/{incident_id}/custom_field_selections", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_id", Field: "id"},
		}},
		{Name: "incidents_events", ParentTable: "incidents", ParentIDParam: "incident_id", PathTemplate: "/v1/incidents/{incident_id}/events", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_id", Field: "id"},
		}},
		{Name: "incidents_feedbacks", ParentTable: "incidents", ParentIDParam: "incident_id", PathTemplate: "/v1/incidents/{incident_id}/feedbacks", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_id", Field: "id"},
		}},
		{Name: "incidents_meeting_recordings", ParentTable: "incidents", ParentIDParam: "incident_id", PathTemplate: "/v1/incidents/{incident_id}/meeting_recordings", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_id", Field: "id"},
		}},
		{Name: "incidents_status_page_events", ParentTable: "incidents", ParentIDParam: "incident_id", PathTemplate: "/v1/incidents/{incident_id}/status-page-events", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_id", Field: "id"},
		}},
		{Name: "incidents_sub_statuses", ParentTable: "incidents", ParentIDParam: "incident_id", PathTemplate: "/v1/incidents/{incident_id}/sub_statuses", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_id", Field: "id"},
		}},
		{Name: "panels", ParentTable: "dashboards", ParentIDParam: "dashboard_id", PathTemplate: "/v1/dashboards/{dashboard_id}/panels", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "dashboard_id", Field: "id"},
		}},
		{Name: "placements", ParentTable: "form-fields", ParentIDParam: "form_field_id", PathTemplate: "/v1/form_fields/{form_field_id}/placements", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "form_field_id", Field: "id"},
		}},
		{Name: "playbooks_playbook_tasks", ParentTable: "playbooks", ParentIDParam: "playbook_id", PathTemplate: "/v1/playbooks/{playbook_id}/playbook_tasks", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "playbook_id", Field: "id"},
		}},
		{Name: "positions", ParentTable: "form-fields", ParentIDParam: "form_field_id", PathTemplate: "/v1/form_fields/{form_field_id}/positions", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "form_field_id", Field: "id"},
		}},
		{Name: "resources", ParentTable: "incident-permission-sets", ParentIDParam: "incident_permission_set_id", PathTemplate: "/v1/incident_permission_sets/{incident_permission_set_id}/resources", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "incident_permission_set_id", Field: "id"},
		}},
		{Name: "retrospective_processes_retrospective_steps", ParentTable: "retrospective-processes", ParentIDParam: "retrospective_process_id", PathTemplate: "/v1/retrospective_processes/{retrospective_process_id}/retrospective_steps", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "retrospective_process_id", Field: "id"},
		}},
		{Name: "schedules_on_call_shadows", ParentTable: "schedules", ParentIDParam: "schedule_id", PathTemplate: "/v1/schedules/{schedule_id}/on_call_shadows", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "schedule_id", Field: "id"},
		}},
		{Name: "schedules_override_shifts", ParentTable: "schedules", ParentIDParam: "schedule_id", PathTemplate: "/v1/schedules/{schedule_id}/override_shifts", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "schedule_id", Field: "id"},
		}},
		{Name: "schedules_schedule_rotations", ParentTable: "schedules", ParentIDParam: "schedule_id", PathTemplate: "/v1/schedules/{schedule_id}/schedule_rotations", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "schedule_id", Field: "id"},
		}},
		{Name: "status_pages_templates", ParentTable: "status-pages", ParentIDParam: "status_page_id", PathTemplate: "/v1/status-pages/{status_page_id}/templates", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "status_page_id", Field: "id"},
		}},
		{Name: "users_notification_rules", ParentTable: "users", ParentIDParam: "user_id", PathTemplate: "/v1/users/{user_id}/notification_rules", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "user_id", Field: "id"},
		}},
		{Name: "workflow_runs", ParentTable: "workflows", ParentIDParam: "workflow_id", PathTemplate: "/v1/workflows/{workflow_id}/workflow_runs", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workflow_id", Field: "id"},
		}},
		{Name: "workflows_custom_field_selections", ParentTable: "workflows", ParentIDParam: "workflow_id", PathTemplate: "/v1/workflows/{workflow_id}/custom_field_selections", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workflow_id", Field: "id"},
		}},
		{Name: "workflows_workflow_tasks", ParentTable: "workflows", ParentIDParam: "workflow_id", PathTemplate: "/v1/workflows/{workflow_id}/workflow_tasks", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "workflow_id", Field: "id"},
		}},
	}
}
