...
func newWebhooksListEndpointsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  rootly-cli webhooks list-endpoints",
		Annotations: map[string]string{"pp:endpoint": "webhooks.list-endpoints", "pp:method": "GET", "pp:path": "/v1/webhooks/endpoints", "mcp:read-only": "true"},
