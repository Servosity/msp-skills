# install.ps1 - install rootly-cli and rootly-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (rootly-v*).
...
$Skill   = "rootly"
$CliBin  = "rootly-cli.exe"
$McpBin  = "rootly-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (rootly-vX.Y.Z),
...
Write-Host "  rootly-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/rootly#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/rootly/mcp-install.md"
