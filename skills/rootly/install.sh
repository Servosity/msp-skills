#!/usr/bin/env bash
# install.sh - install rootly-cli and rootly-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (rootly-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/rootly#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/rootly/mcp-install.md"
