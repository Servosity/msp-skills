...
func newAccountCreateAssetOwnershipTypesCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "create-asset-ownership-types",
		Aliases:     []string{"create"},
		Short:       "Create new asset ownership types",
		Example:     "  runzero-cli account create-asset-ownership-types",
		Annotations: map[string]string{"pp:endpoint": "account.create-asset-ownership-types", "pp:method": "POST", "pp:path": "/account/assets/ownership-types"},
