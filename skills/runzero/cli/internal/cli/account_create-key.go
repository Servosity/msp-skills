...
func newAccountCreateKeyCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  runzero-cli account create-key",
		Annotations: map[string]string{"pp:endpoint": "account.create-key", "pp:method": "PUT", "pp:path": "/account/keys"},
