...
func newAccountDeleteAssetOwnershipTypesCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "delete-asset-ownership-types",
		Short:       "Delete asset ownership types",
		Example:     "  runzero-cli account delete-asset-ownership-types",
		Annotations: map[string]string{"pp:endpoint": "account.delete-asset-ownership-types", "pp:method": "DELETE", "pp:path": "/account/assets/ownership-types"},
