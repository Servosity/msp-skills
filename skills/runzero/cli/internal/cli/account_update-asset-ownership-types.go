...
func newAccountUpdateAssetOwnershipTypesCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "update-asset-ownership-types",
		Short:       "Update asset ownership types",
		Example:     "  runzero-cli account update-asset-ownership-types",
		Annotations: map[string]string{"pp:endpoint": "account.update-asset-ownership-types", "pp:method": "PUT", "pp:path": "/account/assets/ownership-types"},
