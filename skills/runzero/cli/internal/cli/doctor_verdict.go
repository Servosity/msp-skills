...
//
// See issue #282 and skills/runzero/handfixes.json.
//
...
import (
	...
	"runzero-pp-cli/internal/client"
)
...
const doctorBaseURLEnv = "RUNZERO_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://console.runzero.com/api/v1.0"
