...
large datasets as it has no memory pressure.`,
  ...
  runzero-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  runzero-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  runzero-cli export <resource> --format jsonl | jq '.id'`,
