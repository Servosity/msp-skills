...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "runzero-cli",
		Short: `Runzero CLI — Every runZero query, plus a local SQLite copy of your whole attack surface that diffs over time, joins assets to vulner…`,
		Long: `Runzero CLI — Every runZero query, plus a local SQLite copy of your whole attack surface that diffs over time, joins assets to vulner…
...
Health check: run 'runzero-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("runzero-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'runzero-cli profile list')")
	...
	rootCmd.AddCommand(newRunzeroExportCmd(flags))
	...
	rootCmd.AddCommand(newNovelAffectedCmd(flags))
	rootCmd.AddCommand(newNovelCertsExpiringCmd(flags))
	rootCmd.AddCommand(newNovelDiffCmd(flags))
	rootCmd.AddCommand(newNovelExposureDeltaCmd(flags))
	rootCmd.AddCommand(newNovelExposureMapCmd(flags))
	rootCmd.AddCommand(newNovelScanWatchCmd(flags))
	rootCmd.AddCommand(newNovelSoftwareCmd(flags))
	...
	rootCmd.AddCommand(newRunzeroImportPromotedCmd(flags))
