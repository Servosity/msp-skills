...
Resource scoping:
  ...
  runzero-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  runzero-cli sync --full

  # Incremental sync: only records from the last 7 days
  runzero-cli sync --since 7d

  # Parallel sync with 8 workers
  runzero-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  runzero-cli sync --latest-only`,
...
func resourceSupportsPagination(resource string) bool {
	switch resource {
	case "account-events-json":
		return true
	case "runzero-export-assets-json":
		return true
	case "runzero-export-services-json":
		return true
	case "runzero-export-software-json":
		return true
	case "runzero-export-vulnerabilities-json":
		return true
	case "runzero-export-wireless-json":
		return true
	}
	return false
}
...
func syncResourceFieldSelector(resource string) (string, string) {
	switch resource {
	case "org-assets":
		return "fields", "id,agent_name,alive,comments,created_at,detected_by,eol_os,eol_os_ext,finding_count,first_seen,hw,last_agent_id,last_seen,last_task_id,lowest_rtt,lowest_ttl,newest_mac,newest_mac_age,newest_mac_vendor,org_name,organization_id,os,os_version,risk,risk_rank,scanned,service_count,service_count_arp,service_count_icmp,service_count_tcp,service_count_udp,site_id,site_name,type,updated_at,vulnerability_count"
	case "runzero-export":
		return "fields", "id,created_at,description,excludes,name,scope,updated_at"
	case "runzero-export-groups-json":
		return "fields", "id,directory_group_created_at,directory_group_description,directory_group_display_name,directory_group_email,directory_group_email_normalized,directory_group_group_id,directory_group_id,directory_group_name,directory_group_organization_id,directory_group_site_id,directory_group_source_id,directory_group_updated_at,directory_group_user_count"
	case "runzero-export-tasks-json":
		return "fields", "id,agent_id,client_id,created_at,created_by,created_by_user_id,cruncher_id,custom_integration_id,description,error,hidden,hosted_zone_id,name,organization_id,parent_id,recur,recur_frequency,recur_last,recur_last_task_id,recur_next,site_id,source_id,start_time,status,template_id,type,updated_at"
	case "runzero-export-users-json":
		return "fields", "id,directory_user_created_at,directory_user_description,directory_user_display_name,directory_user_email,directory_user_email_normalized,directory_user_first_name,directory_user_id,directory_user_last_logon_at,directory_user_last_name,directory_user_location,directory_user_name,directory_user_organization_id,directory_user_phone,directory_user_site_id,directory_user_source_id,directory_user_title,directory_user_updated_at,directory_user_user_id"
	}
	return "", ""
}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "runzero-export":
		return db.UpsertRunzeroExport(data)
	case "runzero-import":
		return db.UpsertRunzeroImport(data)
	default:
...
func defaultSyncResources() []string {
	return []string{
		...
		"org-wireless",
		"runzero-export",
		"runzero-export-assets-json",
		"runzero-export-assets-servicegraph-json",
		"runzero-export-assets-servicenow-json",
		"runzero-export-certificates-json",
		"runzero-export-findings-csv",
		"runzero-export-findings-json",
		"runzero-export-findings-jsonl",
		"runzero-export-groups-json",
		"runzero-export-services-json",
		"runzero-export-software-json",
		"runzero-export-tasks-json",
		"runzero-export-users-json",
		"runzero-export-vulnerabilities-json",
		"runzero-export-wireless-json",
	}
}
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"account-assets-ownership-types": "/account/assets/ownership-types",
		"account-credentials":            "/account/credentials",
		"account-events-json":            "/account/events.json",
		"account-orgs":                   "/account/orgs",
		"account-sites":                  "/account/sites",
		"account-tasks":                  "/account/tasks",
		"account-tasks-templates":        "/account/tasks/templates",
		"account-users":                  "/account/users",
		"org":                            "/org/sites",
		"org-agents":                     "/org/agents",
		"org-assets":                     "/org/assets",
		"org-explorers":                  "/org/explorers",
		"org-hosted-zones":               "/org/hosted-zones",
		"org-metrics":                    "/org/metrics",
		"org-services":                   "/org/services",
		"org-tasks":                      "/org/tasks",
		"org-wireless":                   "/org/wireless",
		"runzero-export":                 "/export/org/sites.json",
		"runzero-export-assets-json":     "/export/org/assets.json",
		"runzero-export-assets-servicegraph-json": "/export/org/assets.servicegraph.json",
		"runzero-export-assets-servicenow-json":   "/export/org/assets.servicenow.json",
		"runzero-export-certificates-json":        "/export/org/certificates.json",
		"runzero-export-findings-csv":             "/export/org/findings.csv",
		"runzero-export-findings-json":            "/export/org/findings.json",
		"runzero-export-findings-jsonl":           "/export/org/findings.jsonl",
		"runzero-export-groups-json":              "/export/org/groups.json",
		"runzero-export-services-json":            "/export/org/services.json",
		"runzero-export-software-json":            "/export/org/software.json",
		"runzero-export-tasks-json":               "/export/org/tasks.json",
		"runzero-export-users-json":               "/export/org/users.json",
		"runzero-export-vulnerabilities-json":     "/export/org/vulnerabilities.json",
		"runzero-export-wireless-json":            "/export/org/wireless.json",
	}
