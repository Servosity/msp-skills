# install.ps1 - install runzero-cli and runzero-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (runzero-v*).
...
$Skill   = "runzero"
$CliBin  = "runzero-cli.exe"
$McpBin  = "runzero-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (runzero-vX.Y.Z),
...
Write-Host "  runzero-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/runzero#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/runzero/mcp-install.md"
