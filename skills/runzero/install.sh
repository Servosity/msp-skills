#!/usr/bin/env bash
# install.sh - install runzero-cli and runzero-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (runzero-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/runzero#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/runzero/mcp-install.md"
