  ...
  openclaw:
    ...
    install:
      - kind: script
        ...
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/salesbuildr/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/salesbuildr/install.ps1
---
...
The installer places the `salesbuildr-cli` and `salesbuildr-mcp` binaries on your PATH. It does not
