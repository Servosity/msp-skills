...
//
// See issue #282 and skills/salesbuildr/handfixes.json.
//
...
const doctorBaseURLEnv = "SALESBUILDR_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://{tenant}.salesbuildr.com/public-api"
