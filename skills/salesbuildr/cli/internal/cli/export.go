...
large datasets as it has no memory pressure.`,
  ...
  salesbuildr-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  salesbuildr-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  salesbuildr-cli export <resource> --format jsonl | jq '.id'`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				...
				"product":               true,
				"quote":                 true,
				"quote-discount-group":  true,
				"quote-template":        true,
				"quote-widget-template": true,
			}
