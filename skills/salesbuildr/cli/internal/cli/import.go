...
but do not stop the import.`,
  ...
  salesbuildr-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  salesbuildr-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | salesbuildr-cli import <resource> --input -`,
