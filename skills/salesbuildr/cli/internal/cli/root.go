...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "salesbuildr-cli",
		Short: `Salesbuildr CLI — Every Salesbuildr resource as a scriptable command, plus offline margin and pipeline analytics.`,
		Long: `Salesbuildr CLI — Every Salesbuildr resource as a scriptable command, plus offline margin and pipeline analytics.
...
Health check: run 'salesbuildr-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("salesbuildr-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'salesbuildr-cli profile list')")
	...
	rootCmd.AddCommand(newPricingBookCmd(flags))
	rootCmd.AddCommand(newProductCmd(flags))
	rootCmd.AddCommand(newQuoteCmd(flags))
	rootCmd.AddCommand(newQuoteDiscountGroupCmd(flags))
	rootCmd.AddCommand(newQuoteTemplateCmd(flags))
	rootCmd.AddCommand(newQuoteWidgetTemplateCmd(flags))
	...
	rootCmd.AddCommand(newNovelPricingCmd(flags))
	rootCmd.AddCommand(newNovelReconcilePsaCmd(flags))
	rootCmd.AddCommand(newSQLCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newContractPromotedCmd(flags))
	rootCmd.AddCommand(newSyncStatePromotedCmd(flags))
