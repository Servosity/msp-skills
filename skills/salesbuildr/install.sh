#!/usr/bin/env bash
# install.sh - install salesbuildr-cli and salesbuildr-mcp on macOS / Linux.
#
...
SKILL="salesbuildr"
CLI_BIN="salesbuildr-cli"
MCP_BIN="salesbuildr-mcp"
...
# Each skill is versioned and tagged independently (salesbuildr-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/salesbuildr#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/salesbuildr/mcp-install.md"
