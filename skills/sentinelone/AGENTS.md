# SentinelOne Printed CLI Agent Guide

This directory is a generated `sentinelone-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
sentinelone-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
sentinelone-cli which "<capability>" --json
sentinelone-cli <command> --help
```
...
```bash
sentinelone-cli <command> --help
sentinelone-cli <command> --dry-run --agent
```
