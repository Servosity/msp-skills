  ...
  openclaw:
    ...
    install:
      - kind: script
        ...
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/sentinelone/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/sentinelone/install.ps1
---
...
The installer places the `sentinelone-cli` and `sentinelone-mcp` binaries on your PATH. It does not
