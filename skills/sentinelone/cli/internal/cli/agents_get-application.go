...
func newAgentsGetApplicationCmd(flags *rootFlags) *cobra.Command {
	var flagIds string
	...
	cmd.Flags().StringVar(&flagIds, "ids", "", "Agent ID list. Example: '225494730938493804,225494730938493915'.")
