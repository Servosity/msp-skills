...
func newApplicationsForensicsExportApplicationCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if len(args) < 2 {
				return usageErr(fmt.Errorf("export_format is required\nUsage: %s <%s>", cmd.CommandPath(), "export_format"))
			}
