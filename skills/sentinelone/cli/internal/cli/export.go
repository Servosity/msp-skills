...
large datasets as it has no memory pressure.`,
  ...
  sentinelone-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  sentinelone-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  sentinelone-cli export <resource> --format jsonl | jq '.id'`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			validResources := map[string]bool{
				...
				"activities":                   true,
				"agents":                       true,
				"application-inventory":        true,
				"application-inventory-counts": true,
				"config-override":              true,
				"device-control":               true,
				"exclusions":                   true,
				"filters":                      true,
				"firewall-control":             true,
				"groups":                       true,
				"installed-applications":       true,
				"last-activity-as-syslog":      true,
				"locations":                    true,
				"remote-scripts":               true,
				"report-tasks":                 true,
				"reports":                      true,
