...
but do not stop the import.`,
  ...
  sentinelone-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  sentinelone-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | sentinelone-cli import <resource> --input -`,
