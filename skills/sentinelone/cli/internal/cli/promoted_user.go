...
func newUserPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "user",
		Short:       "Get a user by token.",
		Long:        "Get a user by token.",
		Example:     "  sentinelone-cli user",
		Annotations: map[string]string{"pp:endpoint": "user.by-token", "pp:method": "GET", "pp:path": "/user", "mcp:read-only": "true"},
