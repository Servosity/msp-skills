...
func newTagsDeleteCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "delete",
		Short:       "Delete tags by given filter.",
		Example:     "  sentinelone-cli tags delete",
		Annotations: map[string]string{"pp:endpoint": "tags.delete", "pp:method": "DELETE", "pp:path": "/tags"},
