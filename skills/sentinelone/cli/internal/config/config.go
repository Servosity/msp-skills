...
func (c *Config) AuthHeader() string {
	...
	// Guard against a token that already carries the scheme prefix so we never
	// double it. (Spec declares x-auth-value-prefix: "ApiToken "; the generator
	// does not consume it yet — hand-carried from the prior print.)
