# install.ps1 - install sentinelone-cli and sentinelone-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (sentinelone-v*).
...
$Skill   = "sentinelone"
$CliBin  = "sentinelone-cli.exe"
$McpBin  = "sentinelone-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (sentinelone-vX.Y.Z),
...
Write-Host "  sentinelone-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/sentinelone#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/sentinelone/mcp-install.md"
