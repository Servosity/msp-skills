#!/usr/bin/env bash
# install.sh - install sentinelone-cli and sentinelone-mcp on macOS / Linux.
#
...
SKILL="sentinelone"
CLI_BIN="sentinelone-cli"
MCP_BIN="sentinelone-mcp"
...
# Each skill is versioned and tagged independently (sentinelone-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/sentinelone#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/sentinelone/mcp-install.md"
