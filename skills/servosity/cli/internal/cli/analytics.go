...
Data must be synced first with the sync command.`,
  ...
  servosity-cli analytics --type messages

  # Group by a field
  servosity-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  servosity-cli analytics --type messages --group-by channel_id --limit 10 --json`,
