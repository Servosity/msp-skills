...
func newContractsPartialUpdateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				...
				if !cmd.Flags().Changed("identifier-2") && !flags.dryRun {
					return fmt.Errorf("required flag \"%s\" not set", "identifier-2")
				}
	...
	cmd.Flags().StringVar(&bodyIdentifier2, "identifier-2", "", "Identifier")
