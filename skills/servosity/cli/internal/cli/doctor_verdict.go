...
//
// See issue #282 and skills/servosity/handfixes.json.
//
...
const doctorBaseURLEnv = "SERVOSITY_MSP_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://api.servosity.com/api/v1"
