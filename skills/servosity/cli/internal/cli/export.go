...
large datasets as it has no memory pressure.`,
  ...
  servosity-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  servosity-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  servosity-cli export <resource> --format jsonl | jq '.id'`,
