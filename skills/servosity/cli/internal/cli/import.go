...
but do not stop the import.`,
  ...
  servosity-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  servosity-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | servosity-cli import <resource> --input -`,
