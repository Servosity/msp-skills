...
func init() {
	...
	for _, f := range []string{
		...
		"finalized_at",
		"finished_at",
		"google_last_backup_at",
		"ignored_until",
		"instances_last_started_at",
		"last_billed_at",
		"last_fetch_at",
		"last_login_at",
		"last_offline_chkdsk_at",
		"last_reboot_request_at",
		"last_request_at",
		"last_seen_at",
		"last_sent_at",
		"last_updated_at",
		...
		"next_assessment_at",
		"reboot_at",
		"restic_restore_completed_at",
		"snapshot_created_at",
		"snapshot_time",
		"spx_restore_completed_at",
		"started_at",
		"updated_at",
	} {
		if !seen[f] {
...
the specified number of days. Useful for identifying forgotten or blocked work.`,
  ...
  servosity-cli stale --days 14

  # Filter by team
  servosity-cli stale --days 7 --team backend

  # Output as JSON
  servosity-cli stale --days 30 --json`,
