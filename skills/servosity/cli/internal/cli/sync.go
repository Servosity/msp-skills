...
import (
	...
	"servosity-msp-pp-cli/internal/learn/lookups"
...
Resource scoping:
  ...
  servosity-cli sync --resources agent-login,backup-plans

  # Full resync (ignore previous checkpoint)
  servosity-cli sync --full

  # Incremental sync: only records from the last 7 days
  servosity-cli sync --since 7d

  # Parallel sync with 8 workers
  servosity-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  servosity-cli sync --latest-only`,
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "backup-search":
		return db.UpsertBackupSearch(data)
	case "backup-sets":
	...
	case "fully_managed_companies":
		return db.UpsertFullyManagedCompanies(data)
	case "issue-comments":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{ // #nosec G101 -- endpoint paths, not credentials.
		...
		"contracts":                     "/contracts/",
		"contracts-get-by-token":        "/contracts/get-by-token/",
...
var reconcileTypedTables = map[string]string{
	...
	"agent_install_token":               "agent_install_token",
	"agent_logs":                        "agent_logs",
	"agent_service_stop":                "agent_service_stop",
	"agent_service_stop_error":          "agent_service_stop_error",
	"archive":                           "archive",
	"backup-plans":                      "backup_plans",
	"backup-search":                     "backup_search",
	"backup-sets":                       "backup_sets",
	"backup_set_templates":              "backup_set_templates",
	"backup_stores":                     "backup_stores",
	"backups":                           "backups",
	"backups_encryption_key":            "backups_encryption_key",
	"backups_encryption_key_versions":   "backups_encryption_key_versions",
	"backups_guarantee_eligible":        "backups_guarantee_eligible",
	"backups_guaranteed_recovery_point": "backups_guaranteed_recovery_point",
	"backups_reissue_spx_key":           "backups_reissue_spx_key",
	"bill":                              "bill",
	"billing_info":                      "billing_info",
	"c2c":                               "c2c",
	"cloud_to_cloud_dashboard":          "cloud_to_cloud_dashboard",
	"comments":                          "comments",
	"companies":                         "companies",
	"companies_agent_session":           "companies_agent_session",
	"companies_agents":                  "companies_agents",
	"companies_email_report_subscription_delete": "companies_email_report_subscription_delete",
	"companies_email_report_subscriptions":       "companies_email_report_subscriptions",
	"companies_issues":                           "companies_issues",
	"companies_notes":                            "companies_notes",
	"company-notes":                              "company_notes",
	"config_ini":                                 "config_ini",
	"connectwise_download_url":                   "connectwise_download_url",
	"contracts":                                  "contracts",
	"credentials":                                "credentials",
	"current-user":                               "current_user",
	"dr-backups":                                 "dr_backups",
	"dr_backups_agent_session":                   "dr_backups_agent_session",
	"dr_backups_agent_token":                     "dr_backups_agent_token",
	"dr_backups_encryption_key":                  "dr_backups_encryption_key",
	"dr_backups_encryption_key_versions":         "dr_backups_encryption_key_versions",
	"dr_backups_failures":                        "dr_backups_failures",
	"dr_backups_guarantee_eligible":              "dr_backups_guarantee_eligible",
	"dr_backups_guaranteed_recovery_point":       "dr_backups_guaranteed_recovery_point",
	"dr_backups_issues":                          "dr_backups_issues",
	"dr_backups_latest_success":                  "dr_backups_latest_success",
	"dr_backups_reissue_spx_key":                 "dr_backups_reissue_spx_key",
	"dr_backups_snapshots":                       "dr_backups_snapshots",
	"dr_backups_tunnel":                          "dr_backups_tunnel",
	"dr_snapshots":                               "dr_snapshots",
	"dr_upload":                                  "dr_upload",
	"draas":                                      "draas",
	"events":                                     "events",
	"finalize":                                   "finalize",
	"fully_managed_companies":                    "fully_managed_companies",
	"fully_managed_ng":                           "fully_managed_ng",
	"fully_managed_setup_stage":                  "fully_managed_setup_stage",
	"fully_managed_status":                       "fully_managed_status",
	"ignore":                                     "ignore",
	"imagemanager_info":                          "imagemanager_info",
	"install_imagemanager":                       "install_imagemanager",
	"install_spx":                                "install_spx",
	"issue-comments":                             "issue_comments",
	"issues":                                     "issues",
	"latest_offsite":                             "latest_offsite",
	"log_upload":                                 "log_upload",
	"log_upload_list":                            "log_upload_list",
	"login":                                      "login",
	"migrate_dr":                                 "migrate_dr",
	"other_info":                                 "other_info",
	"password":                                   "password",
	"postmark_rotate":                            "postmark_rotate",
	"prices":                                     "prices",
	"reactivate":                                 "reactivate",
	"reboot_events":                              "reboot_events",
	"recent_success":                             "recent_success",
	"report-subscriptions":                       "report_subscriptions",
	"resellers":                                  "resellers",
	"resellers_agents":                           "resellers_agents",
	"resellers_contracts":                        "resellers_contracts",
	"resellers_email_report_subscription_delete": "resellers_email_report_subscription_delete",
	"resellers_email_report_subscriptions":       "resellers_email_report_subscriptions",
	"resellers_issues":                           "resellers_issues",
	"resellers_notes":                            "resellers_notes",
	"restart_imagemanager":                       "restart_imagemanager",
	"restart_spx":                                "restart_spx",
	"restic-backups":                             "restic_backups",
	"restic_backup_failures":                     "restic_backup_failures",
	"restic_backups_agent_session":               "restic_backups_agent_session",
	"restic_backups_agent_token":                 "restic_backups_agent_token",
	"restic_backups_backup_sets":                 "restic_backups_backup_sets",
	"restic_backups_encryption_key":              "restic_backups_encryption_key",
	"restic_backups_encryption_key_versions":     "restic_backups_encryption_key_versions",
	"restic_backups_failures":                    "restic_backups_failures",
	"restic_backups_guarantee_eligible":          "restic_backups_guarantee_eligible",
	"restic_backups_guaranteed_recovery_point":   "restic_backups_guaranteed_recovery_point",
	"restic_backups_issues":                      "restic_backups_issues",
	"restic_backups_latest_success":              "restic_backups_latest_success",
	"restic_backups_snapshots":                   "restic_backups_snapshots",
	"restic_backups_tunnel":                      "restic_backups_tunnel",
	"restic_check":                               "restic_check",
	"restic_env":                                 "restic_env",
	"restic_interrupt":                           "restic_interrupt",
	"restic_migrate":                             "restic_migrate",
	"restic_prune":                               "restic_prune",
	"restic_repair_index":                        "restic_repair_index",
	"restic_repair_snapshots":                    "restic_repair_snapshots",
	"restic_snapshots":                           "restic_snapshots",
	"restic_unlock":                              "restic_unlock",
	"restore_queues":                             "restore_queues",
	"reverify":                                   "reverify",
	"rotate":                                     "rotate",
	"selected_volumes":                           "selected_volumes",
	"servosity_one":                              "servosity_one",
	"servosity_one_conversion_request":           "servosity_one_conversion_request",
	"snapshot":                                   "snapshot",
	"snapshot_chkdsk_results":                    "snapshot_chkdsk_results",
	"snapshot_ls":                                "snapshot_ls",
	"spx_activate":                               "spx_activate",
	"spx_backup_failures":                        "spx_backup_failures",
...
func responsePathForResource(resource, path string) []string {
	...
	case "backup-search\x00/backup-search/":
		return []string{"results"}
	case "backups\x00/backups/":
		return []string{"results"}
	case "backups\x00/backups/mfa_codes/":
		return []string{"results"}
	case "backups\x00/backups/{id}/":
		return []string{"shadowprotect_keys"}
	case "companies\x00/companies/fully-managed/":
		return []string{"results"}
	case "companies\x00/companies/":
		return []string{"results"}
	case "companies\x00/companies/summary/":
		return []string{"results"}
	case "companies\x00/companies/summary-ng/":
		return []string{"results"}
	case "company-notes\x00/company-notes/":
		return []string{"results"}
	case "contracts\x00/contracts/get-by-token/":
		return []string{"results"}
	case "contracts\x00/contracts/":
		return []string{"results"}
	case "contracts\x00/contracts/signatures/":
		return []string{"results"}
	case "credentials\x00/credentials/":
		return []string{"results"}
	case "dr-backups\x00/dr-backups/":
		return []string{"results"}
	case "dr-backups\x00/dr-backups/{id}/":
		return []string{"shadowprotect_keys"}
	case "issues\x00/issues/":
		return []string{"results"}
	case "issues\x00/issues/{id}/":
		return []string{"comments"}
	case "restic-backups\x00/restic-backups/":
		return []string{"results"}
	}
	return nil
}
