...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"servosity-cli auth login",
		"servosity-cli doctor",
		"servosity-cli help items",
		"servosity-cli sync",
		"servosity-cli profile list",
		"servosity-cli feedback list",
		"servosity-cli which",
		"servosity-cli agent-context",
		"servosity-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"servosity-cli teach",
		"servosity-cli recall",
		"servosity-cli learnings",
		"servosity-cli teach-pattern",
		"servosity-cli teach-lookup",
		"servosity-cli items list",
	}
