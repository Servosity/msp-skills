#!/usr/bin/env bash
# install.sh - install servosity-cli and servosity-mcp on macOS / Linux.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (servosity-v*).
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/servosity#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/servosity/mcp-install.md"
