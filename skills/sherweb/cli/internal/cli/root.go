...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "sherweb-cli",
		Short: `Sherweb CLI — Every Sherweb Partner API capability, plus a local SQLite store, offline analytics, and margin/drift/orphan joins no ot…`,
		Long: `Sherweb CLI — Every Sherweb Partner API capability, plus a local SQLite store, offline analytics, and margin/drift/orphan joins no ot…
...
Health check: run 'sherweb-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("sherweb-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'sherweb-cli profile list')")
	...
	rootCmd.AddCommand(newServiceProviderCmd(flags))
	...
	rootCmd.AddCommand(newDeepSyncCmd(flags))
	rootCmd.AddCommand(newNovelAmendPreviewCmd(flags))
	rootCmd.AddCommand(newNovelDriftCmd(flags))
	rootCmd.AddCommand(newNovelFleetSubsCmd(flags))
	rootCmd.AddCommand(newNovelMarginCmd(flags))
	rootCmd.AddCommand(newNovelMarginTrendCmd(flags))
	rootCmd.AddCommand(newNovelOrphansCmd(flags))
	rootCmd.AddCommand(newNovelRightSizeCmd(flags))
	rootCmd.AddCommand(newNovelSubChangesCmd(flags))
	rootCmd.AddCommand(newNovelUsageLeakCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newDistributorPromotedCmd(flags))
