...
type Config struct {
	...
	SherwebSubscriptionKey string          `toml:"subscription_key"`
}
...
func Load(configPath string) (*Config, error) {
	...
	path := configPath
	if path == "" {
		path = os.Getenv("SHERWEB_CONFIG")
	}
	if path == "" {
		home, _ := os.UserHomeDir()
		path = filepath.Join(home, ".config", "sherweb-cli", "config.toml")
	}
	cfg.Path = path
	...
	// Env var overrides
	if v := os.Getenv("SHERWEB_CLIENT_ID"); v != "" {
		cfg.ClientID = v
		cfg.markEnvOverride("ClientID")
		cfg.AuthSource = "env:SHERWEB_CLIENT_ID"
	}
	if v := os.Getenv("SHERWEB_CLIENT_SECRET"); v != "" {
		cfg.ClientSecret = v
		cfg.markEnvOverride("ClientSecret")
		cfg.AuthSource = "env:SHERWEB_CLIENT_SECRET"
	}
	...
	if v := os.Getenv("SHERWEB_SUBSCRIPTION_KEY"); v != "" {
		cfg.SherwebSubscriptionKey = v
		cfg.markEnvOverride("SherwebSubscriptionKey")
	}
	...
	if v := os.Getenv("SHERWEB_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	if v := os.Getenv("SHERWEB_TOKEN_URL"); v != "" {
		cfg.TokenURL = v
	}
	return cfg, nil
}
...
func (c *Config) ClearTokens() error {
	...
	c.updateFileConfigField("ClientID")
	c.updateFileConfigField("ClientSecret")
	c.SherwebSubscriptionKey = ""
	delete(c.envOverrides, "SherwebSubscriptionKey")
	return c.save()
}
...
func (c *Config) configForSave() Config {
	...
	if c.fileConfig != nil {
		...
		if c.envOverrides["SherwebSubscriptionKey"] {
			out.SherwebSubscriptionKey = c.fileConfig.SherwebSubscriptionKey
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "SherwebSubscriptionKey":
		c.fileConfig.SherwebSubscriptionKey = c.SherwebSubscriptionKey
	}
}
...
const NoConfigWriteEnv = "SHERWEB_NO_CONFIG_WRITE"
...
// material. It is the ONLY save path SHERWEB_NO_CONFIG_WRITE suppresses;
