# install.ps1 - install sherweb-cli and sherweb-mcp on Windows.
#
...
$Skill   = "sherweb"
$CliBin  = "sherweb-cli.exe"
$McpBin  = "sherweb-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (sherweb-vX.Y.Z),
...
Write-Host "  sherweb-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/sherweb#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/sherweb/mcp-install.md"
