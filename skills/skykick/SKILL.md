...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [skykick-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/skykick/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/skykick/install.ps1
---
...
The installer places the `skykick-cli` and `skykick-mcp` binaries on your PATH. It does not
