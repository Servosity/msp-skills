...
//
// See issue #282 and skills/skykick/handfixes.json.
//
...
const doctorBaseURLEnv = "SKYKICK_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://apis.cloudservices.connectwise.com"
