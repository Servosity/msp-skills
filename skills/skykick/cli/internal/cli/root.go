...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "skykick-cli",
		Short: `Skykick CLI — Fleet-wide M365 backup assurance for SkyKick Cloud Backup - posture, stale snapshots, and coverage gaps no portal or wr…`,
		Long: `Skykick CLI — Fleet-wide M365 backup assurance for SkyKick Cloud Backup - posture, stale snapshots, and coverage gaps no portal or wr…
...
Health check: run 'skykick-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("skykick-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'skykick-cli profile list')")
	...
	rootCmd.AddCommand(newNovelAlertSweepCmd(flags))
	rootCmd.AddCommand(newNovelAutodiscoverAuditCmd(flags))
	...
	rootCmd.AddCommand(newNovelFleetSyncCmd(flags))
	rootCmd.AddCommand(newNovelPartnerRollupCmd(flags))
	rootCmd.AddCommand(newNovelRetentionAuditCmd(flags))
	rootCmd.AddCommand(newNovelStaleSnapshotsCmd(flags))
	rootCmd.AddCommand(newNovelWatchOperationCmd(flags))
