...
func Load(configPath string) (*Config, error) {
	...
	path := configPath
	if path == "" {
		path = os.Getenv("SKYKICK_CONFIG")
	}
	if path == "" {
		home, _ := os.UserHomeDir()
		path = filepath.Join(home, ".config", "skykick-cli", "config.json")
	}
	cfg.Path = path
	...
	if v := os.Getenv("SKYKICK_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
...
const NoConfigWriteEnv = "SKYKICK_NO_CONFIG_WRITE"
...
// material. It is the ONLY save path SKYKICK_NO_CONFIG_WRITE suppresses;
