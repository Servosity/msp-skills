...
Exit codes: `0` success, `2` usage error, `3` not found, `4` auth error, `5` API error, `6` partial failure (bulk action), `7` rate limited, `10` config error.
...
Config file: `~/.config/skykick-cli/config.json`
