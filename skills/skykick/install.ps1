# install.ps1 - install skykick-cli and skykick-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (skykick-v*).
...
$Skill   = "skykick"
$CliBin  = "skykick-cli.exe"
$McpBin  = "skykick-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (skykick-vX.Y.Z),
...
Write-Host "  skykick-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/skykick#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/skykick/mcp-install.md"
