#!/usr/bin/env bash
# install.sh - install skykick-cli and skykick-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (skykick-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/skykick#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/skykick/mcp-install.md"
