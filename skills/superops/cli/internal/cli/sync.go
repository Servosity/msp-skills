...
Exit codes & warnings:
  ...
  superops-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  superops-cli sync --full

  # Parallel sync with 8 workers
  superops-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  superops-cli sync --latest-only`,
...
func graphqlSyncDefs() map[string]graphqlSyncDef {
	return map[string]graphqlSyncDef{
		"alerts": {
			Query:     client.AlertsListQuery,
			FieldPath: "getAlertList",
			PageSize:  50,
		},
		"assets": {
			Query:     client.AssetsListQuery,
			FieldPath: "getAssetList",
			PageSize:  50,
		},
		"clients": {
			Query:     client.ClientsListQuery,
			FieldPath: "getClientList",
			PageSize:  50,
		},
		"contracts": {
			Query:     client.ContractsListQuery,
			FieldPath: "getClientContractList",
			PageSize:  50,
		},
		"invoices": {
			Query:     client.InvoicesListQuery,
			FieldPath: "getInvoiceList",
			PageSize:  50,
		},
		"it-docs": {
			Query:     client.ItDocsListQuery,
			FieldPath: "getItDocumentationList",
			PageSize:  50,
		},
		"kb": {
			Query:     client.KbListQuery,
			FieldPath: "getKbItems",
			PageSize:  50,
		},
		"service-items": {
			Query:     client.ServiceItemsListQuery,
			FieldPath: "getServiceItemList",
			PageSize:  50,
		},
		"sites": {
			Query:     client.SitesListQuery,
			FieldPath: "getClientSiteList",
			PageSize:  50,
		},
		"tasks": {
			Query:     client.TasksListQuery,
			FieldPath: "getTaskList",
			PageSize:  50,
		},
		"technicians": {
			Query:     client.TechniciansListQuery,
			FieldPath: "getTechnicianList",
			PageSize:  50,
		},
		"tickets": {
			Query:     client.TicketsListQuery,
			FieldPath: "getTicketList",
			PageSize:  50,
		},
		"users": {
			Query:     client.UsersListQuery,
			FieldPath: "getClientUserList",
			PageSize:  50,
		},
		"worklogs": {
			Query:     client.WorklogsListQuery,
			FieldPath: "getWorklogEntries",
			PageSize:  50,
		},
	}
}
