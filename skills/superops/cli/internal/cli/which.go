...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  superops-cli which "stale tickets"
  superops-cli which "bottleneck"
  superops-cli which --limit 1 "send message"
  superops-cli which                                # list the full capability index`,
