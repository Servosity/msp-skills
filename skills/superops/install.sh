#!/usr/bin/env bash
# install.sh - install superops-cli and superops-mcp on macOS / Linux.
#
...
SKILL="superops"
CLI_BIN="superops-cli"
MCP_BIN="superops-mcp"
...
# Each skill is versioned and tagged independently (superops-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/superops#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/superops/mcp-install.md"
