...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [syncro-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/syncro/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/syncro/install.ps1
---
...
The installer places the `syncro-cli` and `syncro-mcp` binaries on your PATH. It does not
