...
func newContactsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "Required permission: Customers - View Detail Single-Customer Users can only access own contacts.",
		Example:     "  syncro-cli contacts list",
	...
	cmd.Flags().StringVar(&flagCustomerId, "customer-id", "", "Any contacts attached to a Customer ID")
