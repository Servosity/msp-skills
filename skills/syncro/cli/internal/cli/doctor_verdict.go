...
//
// See issue #282 and skills/syncro/handfixes.json.
//
...
const doctorBaseURLEnv = "SYNCRO_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://{subdomain}.syncromsp.com/api/v1"
