...
large datasets as it has no memory pressure.`,
  ...
  syncro-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  syncro-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  syncro-cli export <resource> --format jsonl | jq '.id'`,
