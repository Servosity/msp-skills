...
func newItemsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "items",
		Short:       "Required permission: Parts Orders - List/Search",
		Long:        "Required permission: Parts Orders - List/Search",
		Example:     "  syncro-cli items",
	...
	cmd.Flags().BoolVar(&flagCompleted, "completed", false, "Returns only completed part orders")
