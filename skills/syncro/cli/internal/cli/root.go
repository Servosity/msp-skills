...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "syncro-cli",
		Short: `Syncro CLI — Every Syncro PSA and RMM workflow in your terminal, plus a local database, offline search, and cross-entity reports no …`,
		Long: `Syncro CLI — Every Syncro PSA and RMM workflow in your terminal, plus a local database, offline search, and cross-entity reports no …
...
Health check: run 'syncro-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("syncro-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'syncro-cli profile list')")
	...
	rootCmd.AddCommand(newCustomerAssetsCmd(flags))
	...
	rootCmd.AddCommand(newNewTicketFormsCmd(flags))
	rootCmd.AddCommand(newPaymentsCmd(flags))
	rootCmd.AddCommand(newPolicyFoldersCmd(flags))
	rootCmd.AddCommand(newPortalUsersCmd(flags))
	rootCmd.AddCommand(newProductsCmd(flags))
	rootCmd.AddCommand(newPurchaseOrdersCmd(flags))
	rootCmd.AddCommand(newRmmAlertsCmd(flags))
	rootCmd.AddCommand(newSchedulesCmd(flags))
	rootCmd.AddCommand(newSettingsCmd(flags))
	rootCmd.AddCommand(newTicketTimersCmd(flags))
	rootCmd.AddCommand(newTicketsCmd(flags))
	rootCmd.AddCommand(newTimelogsCmd(flags))
	rootCmd.AddCommand(newUserDevicesCmd(flags))
	rootCmd.AddCommand(newUsersCmd(flags))
	rootCmd.AddCommand(newVendorsCmd(flags))
	rootCmd.AddCommand(newWikiPagesCmd(flags))
	...
	rootCmd.AddCommand(newNovelAlertsCmd(flags))
	rootCmd.AddCommand(newNovelAssetsCmd(flags))
	rootCmd.AddCommand(newNovelBillingCmd(flags))
	rootCmd.AddCommand(newNovelSnapshotCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newCalleridPromotedCmd(flags))
	...
	rootCmd.AddCommand(newOtpLoginPromotedCmd(flags))
	rootCmd.AddCommand(newPaymentMethodsPromotedCmd(flags))
	rootCmd.AddCommand(newRemoteSearchPromotedCmd(flags))
	rootCmd.AddCommand(newTicketBlueprintsPromotedCmd(flags))
	rootCmd.AddCommand(newTicketCommentsPromotedCmd(flags))
