# install.ps1 - install syncro-cli and syncro-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (syncro-v*).
...
$Skill   = "syncro"
$CliBin  = "syncro-cli.exe"
$McpBin  = "syncro-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (syncro-vX.Y.Z),
...
Write-Host "  syncro-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/syncro#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/syncro/mcp-install.md"
