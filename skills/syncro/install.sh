#!/usr/bin/env bash
# install.sh - install syncro-cli and syncro-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (syncro-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/syncro#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/syncro/mcp-install.md"
