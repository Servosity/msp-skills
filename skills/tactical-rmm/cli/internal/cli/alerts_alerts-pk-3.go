...
func newAlertsAlertsPk3Cmd(flags *rootFlags) *cobra.Command {
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "alerts-pk-3 <pk>",
		Short:       "PUT /alerts/{pk}/",
		Example:     "  tactical-rmm-cli alerts alerts-pk-3 42",
		Annotations: map[string]string{"pp:endpoint": "alerts.alerts-pk-3", "pp:method": "PUT", "pp:path": "/alerts/{pk}/"},
