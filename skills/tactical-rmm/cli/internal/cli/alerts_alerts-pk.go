...
func newAlertsAlertsPkCmd(flags *rootFlags) *cobra.Command {

	cmd := &cobra.Command{
		Use:         "alerts-pk <pk>",
		Aliases:     []string{"delete"},
		Short:       "DELETE /alerts/{pk}/",
		Example:     "  tactical-rmm-cli alerts alerts-pk 42",
		Annotations: map[string]string{"pp:endpoint": "alerts.alerts-pk", "pp:method": "DELETE", "pp:path": "/alerts/{pk}/"},
