...
func newAlertsAlertsCmd(flags *rootFlags) *cobra.Command {
	var stdinBody bool
	...
	cmd := &cobra.Command{
		...
		Short:       "PATCH /alerts/",
		Example:     "  tactical-rmm-cli alerts alerts",
		Annotations: map[string]string{"pp:endpoint": "alerts.alerts", "pp:method": "PATCH", "pp:path": "/alerts/"},
