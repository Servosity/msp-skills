...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  tactical-rmm-cli workflow archive

  # Full re-archive (ignore previous sync state)
  tactical-rmm-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"accounts", "accounts-apikeys", "accounts-users", "agents", "agents-actions-bulk", "agents-bulkrecovery", "agents-history", "agents-installer", "agents-maintenance-bulk", "agents-notes", "agents-scripthistory", "agents-update", "agents-versions", "alerts", "automation", "automation-policies-overview", "autotasks", "checks", "clients", "clients-deployments", "clients-sites", "core", "core-clearcache", "core-codesign", "core-customfields", "core-dashinfo", "core-emailtest", "core-keystore", "core-schedules", "core-servermaintenance", "core-settings", "core-urlaction", "core-v2-status", "core-version", "core-webtermperms", "logs", "scripts", "scripts-snippets", "software", "software-chocos"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  tactical-rmm-cli workflow status

  # Show status as JSON
  tactical-rmm-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("tactical-rmm-cli")
			}
