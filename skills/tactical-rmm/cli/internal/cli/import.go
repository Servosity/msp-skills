...
but do not stop the import.`,
  ...
  tactical-rmm-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  tactical-rmm-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | tactical-rmm-cli import <resource> --input -`,
