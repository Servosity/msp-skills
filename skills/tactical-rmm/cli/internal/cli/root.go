...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "tactical-rmm-cli",
		Short: `Tactical Rmm CLI — Every Tactical RMM endpoint as a typed command, plus an offline SQLite mirror and cross-entity fleet queries the web UI…`,
		Long: `Tactical Rmm CLI — Every Tactical RMM endpoint as a typed command, plus an offline SQLite mirror and cross-entity fleet queries the web UI…
...
Health check: run 'tactical-rmm-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("tactical-rmm-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'tactical-rmm-cli profile list')")
	...
	rootCmd.AddCommand(newAutotasksCmd(flags))
	rootCmd.AddCommand(newChecksCmd(flags))
	...
	rootCmd.AddCommand(newWinupdateCmd(flags))
	...
	rootCmd.AddCommand(newNovelActionsCmd(flags))
	rootCmd.AddCommand(newNovelCoverageCmd(flags))
	rootCmd.AddCommand(newNovelFleetCmd(flags))
	rootCmd.AddCommand(newNovelMaintenanceCmd(flags))
	rootCmd.AddCommand(newNovelPatchCmd(flags))
