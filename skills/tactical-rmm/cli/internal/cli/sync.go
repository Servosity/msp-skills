...
Resource scoping:
  ...
  tactical-rmm-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  tactical-rmm-cli sync --full

  # Incremental sync: only records from the last 7 days
  tactical-rmm-cli sync --since 7d

  # Parallel sync with 8 workers
  tactical-rmm-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  tactical-rmm-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("tactical-rmm-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/tactical-rmm-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "agents_checks":
		return db.UpsertAgentsChecks(data)
	case "cmd":
		return db.UpsertCmd(data)
	case "eventlog":
		return db.UpsertEventlog(data)
	case "agents_history":
		return db.UpsertAgentsHistory(data)
	case "meshcentral":
		return db.UpsertMeshcentral(data)
	case "notes":
		return db.UpsertNotes(data)
	case "pendingactions":
		return db.UpsertPendingactions(data)
	case "ping":
		return db.UpsertPing(data)
	case "processes":
		return db.UpsertProcesses(data)
	case "reboot":
	...
	case "runscript":
		return db.UpsertRunscript(data)
	case "shutdown":
		return db.UpsertShutdown(data)
	case "tasks":
		return db.UpsertTasks(data)
	case "webvnc":
		return db.UpsertWebvnc(data)
	case "wmi":
		return db.UpsertWmi(data)
	case "wol":
		return db.UpsertWol(data)
	case "autotasks_run":
		return db.UpsertAutotasksRun(data)
	case "csbulkrun":
		return db.UpsertCsbulkrun(data)
	case "checks_history":
		return db.UpsertChecksHistory(data)
	case "reset":
		return db.UpsertReset(data)
	case "resetall":
		return db.UpsertResetall(data)
	case "checks_run":
		return db.UpsertChecksRun(data)
	case "deploy":
		return db.UpsertDeploy(data)
	case "download":
		return db.UpsertDownload(data)
	case "test":
		return db.UpsertTest(data)
	case "uninstall":
		return db.UpsertUninstall(data)
	case "install":
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"agents":                       "/agents/",
		"agents-actions-bulk":          "/agents/actions/bulk/",
		"agents-bulkrecovery":          "/agents/bulkrecovery/",
		"agents-history":               "/agents/history/",
		"agents-installer":             "/agents/installer/",
		"agents-maintenance-bulk":      "/agents/maintenance/bulk/",
		"agents-notes":                 "/agents/notes/",
		"agents-scripthistory":         "/agents/scripthistory/",
		"agents-update":                "/agents/update/",
		"agents-versions":              "/agents/versions/",
		"alerts":                       "/alerts/templates/",
		"automation":                   "/automation/policies/",
		"automation-policies-overview": "/automation/policies/overview/",
		"autotasks":                    "/autotasks/",
		"checks":                       "/checks/",
		"clients":                      "/clients/",
		...
		"core":                         "/core/status/",
		"core-clearcache":              "/core/clearcache/",
		"core-codesign":                "/core/codesign/",
		"core-customfields":            "/core/customfields/",
		"core-dashinfo":                "/core/dashinfo/",
		"core-emailtest":               "/core/emailtest/",
		"core-keystore":                "/core/keystore/",
		"core-schedules":               "/core/schedules/",
		"core-servermaintenance":       "/core/servermaintenance/",
		"core-settings":                "/core/settings/",
		"core-urlaction":               "/core/urlaction/",
		"core-v2-status":               "/core/v2/status/",
		"core-version":                 "/core/version/",
		"core-webtermperms":            "/core/webtermperms/",
		"logs":                         "/logs/pendingactions/",
		"scripts":                      "/scripts/",
		"scripts-snippets":             "/scripts/snippets/",
		"software":                     "/software/",
		"software-chocos":              "/software/chocos/",
	}
