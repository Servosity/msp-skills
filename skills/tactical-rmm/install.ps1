# install.ps1 - install tactical-rmm-cli and tactical-rmm-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (tactical-rmm-v*).
...
$Skill   = "tactical-rmm"
$CliBin  = "tactical-rmm-cli.exe"
$McpBin  = "tactical-rmm-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (tactical-rmm-vX.Y.Z),
...
Write-Host "  tactical-rmm-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/tactical-rmm#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/tactical-rmm/mcp-install.md"
