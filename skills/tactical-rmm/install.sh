#!/usr/bin/env bash
# install.sh - install tactical-rmm-cli and tactical-rmm-mcp on macOS / Linux.
#
...
SKILL="tactical-rmm"
CLI_BIN="tactical-rmm-cli"
MCP_BIN="tactical-rmm-mcp"
...
# Each skill is versioned and tagged independently (tactical-rmm-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/tactical-rmm#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/tactical-rmm/mcp-install.md"
