...
func newApprovalsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List approval requests. statusId 1=Pending,4=Approved,10=Ignored,13=Escalated. Use --child-orgs to span tenants.",
		Example:     "  threatlocker-cli approvals list --child-orgs --agent",
		Annotations: map[string]string{"pp:endpoint": "approvals.list", "pp:method": "POST", "pp:path": "/ApprovalRequest/ApprovalRequestGetByParameters", "mcp:read-only": "true"},
