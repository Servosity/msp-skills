...
func newComputerGroupsDropdownCmd(flags *rootFlags) *cobra.Command {
	var flagComputerGroupOSTypeId string
	var flagHideGlobals bool

	cmd := &cobra.Command{
		Use:         "dropdown",
		Short:       "Simple group dropdown (label/value)",
	...
	cmd.Flags().BoolVar(&flagHideGlobals, "hide-globals", false, "Hide global groups")
