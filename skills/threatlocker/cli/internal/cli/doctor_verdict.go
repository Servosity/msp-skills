...
//
// See issue #282 and skills/threatlocker/handfixes.json.
//
...
const doctorBaseURLEnv = "THREATLOCKER_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://portalapi.g.threatlocker.com/portalapi"
