...
but do not stop the import.`,
  ...
  threatlocker-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  threatlocker-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | threatlocker-cli import <resource> --input -`,
