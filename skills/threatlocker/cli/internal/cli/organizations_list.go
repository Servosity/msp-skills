...
func newOrganizationsListCmd(flags *rootFlags) *cobra.Command {
	...
	var bodyIncludeAllChildren bool
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List child/managed organizations (paginated)",
		Example:     "  threatlocker-cli organizations list --agent",
		Annotations: map[string]string{"pp:endpoint": "organizations.list", "pp:method": "POST", "pp:path": "/Organization/OrganizationGetChildOrganizationsByParameters", "mcp:read-only": "true"},
