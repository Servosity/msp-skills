...
func newPoliciesCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create a policy. policyActionId 1=Permit,2=Deny,6=Permit+Ringfence.",
		Example:     "  threatlocker-cli policies create --name example-resource",
		Annotations: map[string]string{"pp:endpoint": "policies.create", "pp:method": "POST", "pp:path": "/Policy/PolicyInsert"},
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !stdinBody {
				...
				if !cmd.Flags().Changed("computer-group") && !flags.dryRun {
