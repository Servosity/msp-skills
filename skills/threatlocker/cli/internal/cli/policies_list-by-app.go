...
func newPoliciesListByAppCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().BoolVar(&bodyIncludeDenies, "include-denies", false, "Include deny policies")
