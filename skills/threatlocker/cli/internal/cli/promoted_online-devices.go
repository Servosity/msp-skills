...
func newOnlineDevicesPromotedCmd(flags *rootFlags) *cobra.Command {
	var flagPageNumber int
	var flagPageSize int

	cmd := &cobra.Command{
		Use:         "online-devices",
		Short:       "List currently-online devices (paginated)",
		Long:        "List currently-online devices (paginated)",
		Example:     "  threatlocker-cli online-devices",
		Annotations: map[string]string{"pp:endpoint": "online-devices.list", "pp:method": "GET", "pp:path": "/OnlineDevices/OnlineDevicesGetByParameters", "mcp:read-only": "true"},
