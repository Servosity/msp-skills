...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		...
		Short: `Threatlocker CLI — Every ThreatLocker Portal API feature, plus the write operations the read-only tools lack and a cross-tenant offline st…`,
		Long: `Threatlocker CLI — Every ThreatLocker Portal API feature, plus the write operations the read-only tools lack and a cross-tenant offline st…
...
See README.md or the bundled SKILL.md for recipes.`,
	...
	rootCmd.AddCommand(newNovelDevicesCmd(flags))
...
func (f *rootFlags) newClient() (*client.Client, error) {
	...
	if org != "" {
		...
		cfg.Headers["ManagedOrganizationId"] = org
		cfg.Headers["OverrideManagedOrganizationId"] = org
	}
