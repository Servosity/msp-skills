...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"audit search",
		"computer-groups",
		"computer-groups dropdown",
		"computer-groups list",
		"computers",
		"computers baseline-rescan",
		"computers checkins",
		"computers delete",
		"computers enable-protection",
		"computers get",
		"computers install-info",
		"computers list",
		"computers maintenance",
		"computers maintenance-update",
		"computers move-org",
		"computers restart-service",
		"maintenance",
		"network-policies",
		...
		"online-devices",
		"organizations",
		"organizations auth-key",
		"organizations for-move",
		"organizations list",
		"policies",
		"policies copy",
		"policies create",
		...
		"policies deploy",
		"policies get",
		"policies list-by-app",
		"reports",
		"reports data",
		"reports list",
		"scheduled-actions",
		"scheduled-actions get",
		"scheduled-actions list",
		"scheduled-actions search",
		"storage-policies",
		"storage-policies get",
		"storage-policies list",
		"system-audit",
		"system-audit health-center",
		"system-audit search",
		"tags",
		"tags dropdown",
		"tags get",
