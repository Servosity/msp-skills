...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"threatlocker-cli auth login",
		"threatlocker-cli doctor",
		"threatlocker-cli help items",
		"threatlocker-cli sync",
		"threatlocker-cli profile list",
		"threatlocker-cli feedback list",
		"threatlocker-cli which",
		"threatlocker-cli agent-context",
		"threatlocker-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"threatlocker-cli recall",
		"threatlocker-cli learnings",
		"threatlocker-cli teach-pattern",
		"threatlocker-cli teach-lookup",
		"threatlocker-cli items list",
	}
