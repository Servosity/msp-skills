# install.ps1 - install threatlocker-cli and threatlocker-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (threatlocker-v*).
...
$Skill   = "threatlocker"
$CliBin  = "threatlocker-cli.exe"
$McpBin  = "threatlocker-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (threatlocker-vX.Y.Z),
...
Write-Host "  threatlocker-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/threatlocker#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/threatlocker/mcp-install.md"
