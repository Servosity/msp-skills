#!/usr/bin/env bash
# install.sh - install threatlocker-cli and threatlocker-mcp on macOS / Linux.
#
...
SKILL="threatlocker"
CLI_BIN="threatlocker-cli"
MCP_BIN="threatlocker-mcp"
...
# Each skill is versioned and tagged independently (threatlocker-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/threatlocker#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/threatlocker/mcp-install.md"
