...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "unifi-network-cli/feedback")
...
func newFeedbackListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  unifi-network-cli feedback list
  unifi-network-cli feedback list --limit 5
  unifi-network-cli feedback list --json`,
