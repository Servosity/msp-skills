...
Resource scoping:
  ...
  unifi-network-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  unifi-network-cli sync --full

  # Incremental sync: only records from the last 7 days
  unifi-network-cli sync --since 7d

  # Parallel sync with 8 workers
  unifi-network-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  unifi-network-cli sync --latest-only`,
