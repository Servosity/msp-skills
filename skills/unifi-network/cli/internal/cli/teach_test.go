...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"unifi-network-cli auth login",
		"unifi-network-cli doctor",
		"unifi-network-cli help items",
		"unifi-network-cli sync",
		"unifi-network-cli profile list",
		"unifi-network-cli feedback list",
		"unifi-network-cli which",
		"unifi-network-cli agent-context",
		"unifi-network-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"unifi-network-cli recall",
		"unifi-network-cli learnings",
		"unifi-network-cli teach-pattern",
		"unifi-network-cli teach-lookup",
		"unifi-network-cli items list",
	}
