...
large datasets as it has no memory pressure.`,
  ...
  unifi-network-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  unifi-network-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  unifi-network-cli export <resource> --format jsonl | jq '.id'`,
