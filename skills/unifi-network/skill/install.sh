#!/usr/bin/env bash
# install.sh - install unifi-network-cli and unifi-network-mcp on macOS / Linux.
#
...
SKILL="unifi-network"
CLI_BIN="unifi-network-cli"
MCP_BIN="unifi-network-mcp"
...
# Each skill is versioned and tagged independently (unifi-network-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/unifi-network#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/unifi-network/mcp-install.md"
