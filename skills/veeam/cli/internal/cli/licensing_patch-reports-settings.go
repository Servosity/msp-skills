...
func newLicensingPatchReportsSettingsCmd(flags *rootFlags) *cobra.Command {
	var flagBodyJSON string
	var stdinBody bool

	cmd := &cobra.Command{
		Use:         "patch-reports-settings",
		Short:       "Modifies the Veeam licenses usage reports settings.",
		Example:     "  veeam-cli licensing patch-reports-settings",
		Annotations: map[string]string{"pp:endpoint": "licensing.patch-reports-settings", "pp:method": "PATCH", "pp:path": "/licensing/reports/settings"},
