...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "veeam-cli",
		Short: `Veeam CLI — Every Veeam Service Provider Console endpoint as a typed command, plus a local multi-tenant mirror, cross-company rollu…`,
		Long: `Veeam CLI — Every Veeam Service Provider Console endpoint as a typed command, plus a local multi-tenant mirror, cross-company rollu…
...
Health check: run 'veeam-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("veeam-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'veeam-cli profile list')")
	...
	rootCmd.AddCommand(newAsyncActionsCmd(flags))
	rootCmd.AddCommand(newAuthenticationCmd(flags))
	rootCmd.AddCommand(newConfigurationCmd(flags))
	rootCmd.AddCommand(newDeploymentCmd(flags))
	rootCmd.AddCommand(newDiscoveryCmd(flags))
	rootCmd.AddCommand(newEventLogsCmd(flags))
	rootCmd.AddCommand(newInfrastructureCmd(flags))
	rootCmd.AddCommand(newLicensingCmd(flags))
	rootCmd.AddCommand(newMiscCmd(flags))
	...
	rootCmd.AddCommand(newProtectedWorkloadsCmd(flags))
	rootCmd.AddCommand(newPulseCmd(flags))
	rootCmd.AddCommand(newSubscriptionPlansCmd(flags))
	rootCmd.AddCommand(newUsersCmd(flags))
	rootCmd.AddCommand(newVdcVaultCmd(flags))
	...
	rootCmd.AddCommand(newNovelAlarmsTriageCmd(flags))
	rootCmd.AddCommand(newNovelAtRiskCmd(flags))
	rootCmd.AddCommand(newNovelCompanyOverviewCmd(flags))
	rootCmd.AddCommand(newNovelFleetHealthCmd(flags))
	rootCmd.AddCommand(newNovelLicenseUsageCmd(flags))
	rootCmd.AddCommand(newNovelSinceCmd(flags))
	rootCmd.AddCommand(newNovelStaleBackupsCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newProxyPromotedCmd(flags))
	rootCmd.AddCommand(newTokenPromotedCmd(flags))
	rootCmd.AddCommand(newVeeamServiceProviderAboutPromotedCmd(flags))
