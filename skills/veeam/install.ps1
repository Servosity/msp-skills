# install.ps1 - install veeam-cli and veeam-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (veeam-v*).
...
$Skill   = "veeam"
$CliBin  = "veeam-cli.exe"
$McpBin  = "veeam-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (veeam-vX.Y.Z),
...
Write-Host "  veeam-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/veeam#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/veeam/mcp-install.md"
