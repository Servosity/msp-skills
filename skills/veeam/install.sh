#!/usr/bin/env bash
# install.sh - install veeam-cli and veeam-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (veeam-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/veeam#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/veeam/mcp-install.md"
