...
//
// See issue #282 and skills/wordpress/handfixes.json.
//
...
const doctorBaseURLEnv = "WORDPRESS_BASE_URL"
...
// other way.
const doctorShippedBaseURL = "https://wordpress.org/news/wp-json/wp/v2"
