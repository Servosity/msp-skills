...
large datasets as it has no memory pressure.`,
  ...
  wordpress-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  wordpress-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  wordpress-cli export <resource> --format jsonl | jq '.id'`,
