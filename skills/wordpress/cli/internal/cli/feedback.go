...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "wordpress-cli/feedback")
...
func newFeedbackListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  wordpress-cli feedback list
  wordpress-cli feedback list --limit 5
  wordpress-cli feedback list --json`,
