...
but do not stop the import.`,
  ...
  wordpress-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  wordpress-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | wordpress-cli import <resource> --input -`,
