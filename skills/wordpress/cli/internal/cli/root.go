...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "wordpress-cli",
		Short: "Manage wordpress resources via the wordpress API",
		Long: `Manage wordpress resources via the wordpress API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'wordpress-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("wordpress-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'wordpress-cli profile list')")
