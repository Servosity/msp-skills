...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  wordpress-cli which "stale tickets"
  wordpress-cli which "bottleneck"
  wordpress-cli which --limit 1 "send message"
  wordpress-cli which                                # list the full capability index`,
