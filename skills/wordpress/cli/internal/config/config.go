...
func Load(configPath string) (*Config, error) {
	...
	if v := os.Getenv("WORDPRESS_BASIC_AUTH"); v != "" {
		...
		cfg.CredentialSource = "env:WORDPRESS_BASIC_AUTH"
	}
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "wordpress-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	credentials := basicAuthPayload("Basic {token}", map[string]string{
		"basic_auth":           c.WordpressBasicAuth,
		"WORDPRESS_BASIC_AUTH": c.WordpressBasicAuth,
		"token":                c.WordpressBasicAuth,
		"access_token":         c.WordpressBasicAuth,
	}, true)
	if credentials == "" {
		return ""
	}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		WordpressBasicAuth: c.WordpressBasicAuth,
	}
}
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["WordpressBasicAuth"] {
			out.WordpressBasicAuth = c.fileConfig.WordpressBasicAuth
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "WordpressBasicAuth":
		c.fileConfig.WordpressBasicAuth = c.WordpressBasicAuth
	}
}
