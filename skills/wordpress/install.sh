#!/usr/bin/env bash
# install.sh - install wordpress-cli and wordpress-mcp on macOS / Linux.
#
...
SKILL="wordpress"
CLI_BIN="wordpress-cli"
MCP_BIN="wordpress-mcp"
...
# Each skill is versioned and tagged independently (wordpress-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/wordpress#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/wordpress/mcp-install.md"
