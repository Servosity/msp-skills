#!/usr/bin/env bash
# install.sh - install xero-cli and xero-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (xero-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/xero#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/xero/mcp-install.md"
