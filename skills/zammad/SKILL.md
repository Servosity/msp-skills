...
metadata:
  openclaw:
    ...
    install:
      - kind: script
        bins: [zammad-cli]
        sh: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/zammad/install.sh
        ps1: https://raw.githubusercontent.com/Servosity/msp-skills/main/skills/zammad/install.ps1
---
...
The installer places the `zammad-cli` and `zammad-mcp` binaries on your PATH. It does not
