...
large datasets as it has no memory pressure.`,
  ...
  zammad-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  zammad-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  zammad-cli export <resource> --format jsonl | jq '.id'`,
