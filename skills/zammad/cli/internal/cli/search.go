...
In local mode: searches locally synced data only.`,
  ...
  zammad-cli search "error timeout"

  # Force local search only
  zammad-cli search "status" --data-source local
  # Search a specific resource type locally
  zammad-cli search "status" --type articles --data-source local
  # JSON output for piping
  zammad-cli search "critical" --json --limit 20`,
