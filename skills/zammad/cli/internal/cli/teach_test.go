...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"zammad-cli auth login",
		"zammad-cli doctor",
		"zammad-cli help items",
		"zammad-cli sync",
		"zammad-cli profile list",
		"zammad-cli feedback list",
		"zammad-cli which",
		"zammad-cli agent-context",
		"zammad-cli completion bash",
		"zammad-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"zammad-cli teach",
		"zammad-cli recall",
		"zammad-cli learnings",
		"zammad-cli teach-pattern",
		"zammad-cli teach-lookup",
		"zammad-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("zammad-cli")); err == nil {
