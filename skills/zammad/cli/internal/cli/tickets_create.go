...
func newTicketsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	var bodyArticleInternal bool
	var bodyArticleContentType string
	var stdinBody bool
	...
	cmd.Flags().BoolVar(&bodyArticleInternal, "article-internal", false, "true = internal note, false = customer-visible")
	cmd.Flags().StringVar(&bodyArticleContentType, "article-content-type", "", "text/html or text/plain")
