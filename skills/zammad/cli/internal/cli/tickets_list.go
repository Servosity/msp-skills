...
func newTicketsListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "list",
		Short:       "List tickets (paginated)",
		Example:     "  zammad-cli tickets list",
	...
	cmd.Flags().BoolVar(&flagExpand, "expand", true, "Expand referenced ids (state, priority, owner) into names")
