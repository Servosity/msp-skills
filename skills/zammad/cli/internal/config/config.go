...
type Config struct {
	...
	ZammadApiToken   string          `toml:"api_token"`
}

func Load(configPath string) (*Config, error) {
	cfg := &Config{
		BaseURL: "https://your-instance.zammad.com/api/v1",
	}
	...
	if v := os.Getenv("ZAMMAD_API_TOKEN"); v != "" {
		...
		cfg.CredentialSource = "env:ZAMMAD_API_TOKEN"
	}
...
func resolveConfigPath(configPath string) (string, bool, error) {
	...
	if path := os.Getenv("ZAMMAD_CONFIG"); path != "" {
...
func LegacyConfigPath() (string, error) {
	...
	return filepath.Join(home, ".config", "zammad-cli", "config.toml"), nil
}
...
func (c *Config) AuthHeader() string {
	...
	replacements := map[string]string{
		"token":            token,
		"api_token":        c.ZammadApiToken,
		"ZAMMAD_API_TOKEN": c.ZammadApiToken,
	}
...
func (c *Config) credentials() *cliutil.Credentials {
	return &cliutil.Credentials{
		...
		ZammadApiToken: c.ZammadApiToken,
	}
}
...
func (c *Config) configForSave() Config {
	out := *c
	if c.fileConfig != nil {
		if c.envOverrides["ZammadApiToken"] {
			out.ZammadApiToken = c.fileConfig.ZammadApiToken
		}
	}
...
func (c *Config) updateFileConfigField(field string) {
	...
	case "ZammadApiToken":
		c.fileConfig.ZammadApiToken = c.ZammadApiToken
	}
}
