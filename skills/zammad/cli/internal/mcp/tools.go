...
func openMCPReadOnlyStore(path string) (*store.Store, *mcplib.CallToolResult) {
	...
	if err != nil {
		return nil, mcplib.NewToolResultError(fmt.Sprintf("opening local data store %s: %v. Run zammad-cli sync to refresh the store, or use live endpoint MCP tools for unsynced data.", path, err))
	}
	return db, nil
}

func mcpMissingStoreMessage(path string) string {
	return fmt.Sprintf("No local data store found at %s. Run zammad-cli sync before using MCP search/sql, or use live endpoint MCP tools for unsynced data.", path)
}
...
func handleContext(_ context.Context, _ mcplib.CallToolRequest) (*mcplib.CallToolResult, error) {
	...
	ctx := map[string]any{
		...
		"resources": []map[string]any{
			{
				"name":        "articles",
				"description": "Read and add ticket articles (notes and emails)",
				"endpoints":   []string{"by-ticket", "create", "get"},
				"searchable":  true,
				"writable":    true,
			},
			{
				"name":        "groups",
				"description": "Ticket routing groups",
				"endpoints":   []string{"get", "list"},
				"syncable":    true,
			},
			{
				"name":        "kb",
				"description": "Knowledge Base categories and answers",
				"endpoints":   []string{"answer-create", "answer-delete", "answer-internal", "answer-publish", "category-create", "init"},
				"searchable":  true,
				"writable":    true,
			},
			{
				"name":        "organizations",
				"description": "Read and manage organizations (customers / partners)",
				"endpoints":   []string{"create", "get", "list", "search", "update"},
				"syncable":    true,
				"searchable":  true,
				"writable":    true,
			},
			{
				"name":        "overviews",
				"description": "Agent ticket overviews (saved views)",
				"endpoints":   []string{"get", "list"},
				"syncable":    true,
			},
			{
				"name":        "priorities",
				"description": "Ticket priority reference (id -> name map)",
				"endpoints":   []string{"list"},
				"syncable":    true,
			},
			{
				"name":        "states",
				"description": "Ticket state reference (id -> name map)",
				"endpoints":   []string{"list"},
				"syncable":    true,
			},
			{
				...
				"endpoints":   []string{"add", "all", "list", "remove"},
				"syncable":    true,
				"searchable":  true,
				"writable":    true,
			},
			{
				"name":        "tickets",
				"description": "Read, search, create, and change Zammad tickets",
			...
			{
				"name":        "users",
				"description": "Read and manage users (agents and customers)",
				"endpoints":   []string{"create", "get", "list", "me", "search", "update"},
				"syncable":    true,
				"searchable":  true,
				"writable":    true,
			},
