# install.ps1 - install zammad-cli and zammad-mcp on Windows.
#
# Pulls prebuilt binaries from this skill's latest GitHub Release (zammad-v*).
...
$Skill   = "zammad"
$CliBin  = "zammad-cli.exe"
$McpBin  = "zammad-mcp.exe"
...
$ReleaseBase = if ($env:MSP_SKILLS_RELEASE_BASE) {
  ...
  # Each skill is versioned/tagged independently (zammad-vX.Y.Z),
...
Write-Host "  zammad-cli --version"
Write-Host ""
Write-Host "Next:"
Write-Host "  First command + auth: https://github.com/$Owner/$Repo/tree/main/skills/zammad#readme"
Write-Host "  Claude Desktop / ChatGPT wire-up: https://github.com/$Owner/$Repo/blob/main/skills/zammad/mcp-install.md"
