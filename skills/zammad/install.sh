#!/usr/bin/env bash
# install.sh - install zammad-cli and zammad-mcp on macOS / Linux.
#
...
# Each skill is versioned and tagged independently (zammad-vX.Y.Z), so we
...
echo ""
echo "Next:"
echo "  First command + auth: https://github.com/${OWNER}/${REPO}/tree/main/skills/zammad#readme"
echo "  Claude Desktop / ChatGPT wire-up: https://github.com/${OWNER}/${REPO}/blob/main/skills/zammad/mcp-install.md"
